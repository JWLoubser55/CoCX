	...
	public class AnzuScene extends DungeonAbstractContent// implements TimeAwareInterface
	{
		...
		public function anzuTransition():void {
			if (anzuRelationshipLevel() == 1) {
				...
				outputText("\n\nSince your principal task was to protect the portal, and the camp is situated in the barrens, there isn’t much that you can do there. You relate to him about some of your endeavors in the land, fighting monsters in the wilderness and hunting demons across the lands. Judging by the look he gives when you say that, he surely knows how most of the fights in this land end.");
		...
		private function suckOffDeitysCock():void {
			...
			outputText("\n\nThis time your tongue goes to his tip. Beads of pre leak from his cumslit, and your tongue eagerly delights on then, enjoying as the salty flavor inundates your tastebuds. Soon, the desire is too much, and your start sinking the meaty rod on your eager mouth. Having a long way to the end, you decide to start safely, and, bobbing down on it with pleasure, you engulf in your mouth on the first inches of his length, as your hand wraps around the base of Anzu’s manhood.");
		...
		private function eatFoodWithAnzu():void {
			...
			if (model.time.hours == 8) {
				...
				outputText("\n\nYou give him more details about the bakery and its particular workers, especially its chef. The gym isn’t less strange either, especially with the additional exercise programs that some trainers are willing to teach. The mage’s tower is the heavily protected plate where most mages reside, keeping the barrier stable. Not much is what can you say about the park, little more than a patch of neglected dirt and grass between the city’s blocks. In the center are some restaurants too, while the market has a pawn shop, and some others specialized in selling construction materials, weapons, armors, clothes. An acupuncture treatment clinic and a tattoo parlor have their places on the market too. Finally, you explain all you know about the Watch and how they protect the city from both the inside as from the outside menaces.");
		...
		private function acceptSleepingWithAnzu():void {
			...
			if (player.armor.isNothing) { //Not wearing clothes/armor?

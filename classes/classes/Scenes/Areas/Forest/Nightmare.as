	...
	public class Nightmare extends Monster
	{
		...
		public function usingHeal():void {
			if (hasStatusEffect(StatusEffects.Uber)) {
				...
				|| hasStatusEffect(StatusEffects.Pounce) || hasStatusEffect(StatusEffects.Polymorphed) || hasStatusEffect(StatusEffects.HypnosisNaga) || hasStatusEffect(StatusEffects.Sleep) || hasStatusEffect(StatusEffects.MysticWeb) || hasStatusEffect(StatusEffects.BloodWeb) || hasStatusEffect(StatusEffects.Fascinated)) {
		...
		public function Nightmare() 
		{
			...
			this.hairLength = 5;
			initStrTouSpeInte(60, 260, 280, 40);
			initWisLibSensCor(40, 320, 180, 100);

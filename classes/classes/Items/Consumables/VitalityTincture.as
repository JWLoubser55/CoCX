...
/**
	...
	public class VitalityTincture extends Consumable
	{
		...
		override public function useItem():Boolean
		{
			...
			if (pc.HPChange(50*player.postConsumptionMlt(), false, false)) outputText("  Any aches, pains and bruises you have suffered no longer hurt and you feel much better.");

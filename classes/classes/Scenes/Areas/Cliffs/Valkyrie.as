...
public class Valkyrie extends Monster
	{
		...
		{
			SceneLib.cliffs.valkyrieScene.winAgainstValkyrie();
		}
		
		override public function won(hpVictory:Boolean, pcCameWorms:Boolean):void
		{
			SceneLib.cliffs.valkyrieScene.loseToValkyrie();
		}
		...
		public function Valkyrie() 
		{
			...
			this.hairLength = 12;
			initStrTouSpeInte(795, 705, 625, 250);
			initWisLibSensCor(250, 120, 150, -70);
			...
			this.lustVuln = 0.46;
			this.level = 97;
			this.gems = 151 + rand(50);
			this.drop = new WeightedDrop()
					.add(weapons.SPEAR, 1)
					.add(shields.GREATSH, 2)
					.add(consumables.G__BOOK, 4)					
					.add(null, 10);

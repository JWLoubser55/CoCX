...
public final class WeaponRangeLib extends ItemConstants
	{
		...
		public const FAILNAU:Failnaught = new Failnaught();
		...
		public const ENERGYG:WeaponRange = new WeaponRange("EnergyG", "EnergyGun", "Energy Gun", "an Energy Gun", "shot", 25, 1280, "A gun made by the ancient civilisation. Perhaps the original design from wich the goblins created their firearms. Instead of physical projectile it fires tiny blast of energy and does not seem to run off ammunition like other firearms.\n\nGoblin Mech Compatible", "Pistol");

...
public function sheilaName():String {
	return flags[kFLAGS.KNOWS_SHEILA_NAME] ? "Harriet" : "Sheila";
}
...
public function sheilaCorruption(arg:Number = 0):Number {
	//No upper limit - grow these boobs yooo
	if(flags[kFLAGS.SHEILA_CORRUPTION] + arg < 0) flags[kFLAGS.SHEILA_CORRUPTION] = 0;
...
internal function sheilaCup():String {
	return Appearance.BREAST_CUP_NAMES[flags[kFLAGS.SHEILA_CORRUPTION] / 5];
}
...
private function sheilaApology():void {
	clearOutput();
	sceneHunter.print("Some scenes have Libido checks. So... you'd better have it high.");
...
private function apologySheilaSayNothing():void {
	...
	outputText("\n\n\"<i>All right; please yourself, ya tosser,</i>\" [sheilaname] says, resetting the trap and backing away from you.  \"<i>Just watch where you're walking.</i>\"");
...
private function sheilaIsSorrySheRapedYou():void {
	clearOutput();
	outputText("You stalk through the plains, hunting for a bite to eat or something to give you an advantage in this harsh land.  A rustle follows you as you move into some tall grass; it takes several minutes before you realize with alarm that it's slightly out of phase with your steps.  You whirl around, only to find... [sheilaname], staring at you sheepishly.  Has she been following you this whole time?  You watch each other for a few minutes, neither of you making any move but her cheeks glowing brighter red with every word that doesn't pass between you.");
	...
	else sceneHunter.print("If you knew Arouse spell, you could try something... special.")
...
private function sheilaPologyFight():void {
	clearOutput();
	outputText("Saying nothing, you raise your [weapon] and take a swing!  [sheilaname] starts a bit and dodges just in time, then with a look of resignation, raises her fists as well.  \"<i>That'll be right, I guess.  For what it's worth, I really am sorry.</i>\"");
...
private function sheilaPologyCastArouse():void {
	...
	outputText("\n\n\"<i>I'm glad there're no hard feelings and... uh,</i>\" [sheilaname] continues.  \"<i>I h-hope that, ah, we c-can...</i>\"  Her knees begin to quiver.  \"<i>... c-can get st-started off on the r-r-right ffff-</i>\"");
	...
	outputText("\n\nFaking concern, you ask her if she's allright.  She looks up at you sheepishly.  \"<i>I d-don't know!</i>\" she whimpers.  \"<i>Something's wrong with - ah...</i>\"  [sheilaname] blushes brightly.  \"<i>... with my... body.</i>\"");
	...
	outputText("\n\n\"<i>Can I what?  What do you want me to do?</i>\" you ask, narrowing your eyes.  [sheilaname] lowers her head, embarrassed, until she's peering out at you from under hair that's fallen over her face.  \"<i>Well?</i>\"");
...
private function sheilaReallyMad():void {
	clearOutput();
	outputText("A rustle in the bush claims your attention, and you turn your head to see [sheilaname], standing up suddenly.  Her eyes narrow when she recognizes you, and she takes off running!");
	
	outputText("\n\nIt doesn't take long, of course, until she realizes she's forgotten her catch; when you pick the bundle of game up and hold it out to her, [sheilaname] trots guiltily back and stops a few paces in front.");
...
private function sheilaReallyMadStandGround():void {
	...
	if(!silly()) {
		...
		outputText("\n\n[sheilaname] shivers, then speaks.  \"<i>Alright, mate.  If that's the way it has to be.</i>\"  She raises her fists half-heartedly.");
	}
	//(silly mode)
	else {
		outputText("Throwing the bundle to the side dramatically, you call the name of your stand!  [sheilaname]'s eyes widen as your body surges with renewed energy, and she jumps back as a ghostly other self materializes next to you.");
		outputText("\n\n\"<i>So... it has to be like this, then?  Alright!</i>\"  [sheilaname] thrusts a fist in the air, eyes glinting, and yells \"<i>Come out!  'Ready, World'!</i>\"  A form flows from her, taking the shape of a slim, dark woman with curly, almost liquid hair, in a loose vest and billowing, long-sleeved tunic.  [sheilaname] jumps at you, and both the woman and her glamorous stand draw back to punch!");
	}
...
private function sheilaReconcile():void {
	...
	outputText("\n\nYou turn around quickly, panning the horizon for the source.  It doesn't take you long to pick out the head and long ears of [sheilaname], sitting up above the grass she must have been lying in until now.  A simple wave answers her greeting, but you keep a buttoned lip, remembering the last chilly reception.");
...
private function sheilaReconcileDunWanna():void {
	clearOutput();
	outputText("Raising your hands in a palms-out gesture, you decline.  [sheilaname] colors a bit, misinterpreting your reluctance.  \"<i>Hey, it's not like I'm cracking onto you or anything.  I was just looking for a reason to eat half a rabbit myself, is all.</i>\"");
...
private function sheilaGettingFamiliar():void {
	...
	outputText("\n\n[sheilaname]'s voice rings out from your right.  You turn and face her; the formerly-reticent woman smiles warmly from her seat in the grass.  \"<i>Ya just missed tucker,</i>\" she opens, \"<i>a pity.</i>\"");
	
	outputText("\n\nThere's no campfire in evidence nearby, a face which makes you raise an eyebrow.  \"<i>Cut lunch,</i>\" [sheilaname] amends.  \"<i>Just some dried meat and fruit on bread.  A real shame you didn't show up sooner, I enjoyed our barbecue pit.</i>\"  Even having just eaten, [sheilaname]'s eyes light with appetite.");
...
private function sheilaFriendlyNoQuestions():void {
	...
	outputText("\n\nYou raise your head to look, and see [sheilaname] already on her feet, adjusting her catch to sit across her shoulders for easy carrying.");
...
private function sheilaFriendlyHerPeoples():void {
	...
	//(lib >=50)
		...
		outputText("\n\n[sheilaname] turns pink.  \"<i>Pig's arse!  Got tickets on yourself, you ninny?</i>\"");
...
private function sheilaFriendlyCurfew():void {
	...
	outputText("\n\n\"<i>Bet your ass!  Moles haven't got anything on us; we could dig right under you and you'd never know it until the invasion popped up under your butt and moved in,</i>\" the girl answers proudly, when you mention it.  \"<i>You're not wrong, though... we love the surface and sun; there's not one person on the dig crew now who's not dreaming of the day he or she gets to rotate off of it and onto hunting or war crew.  Exigencies, you know?  The first shelters were only half-underground when the demons attacked and survived by the grace of whatever gods are left, but we took the hint.</i>\"  [sheilaname] climbs to her feet, and nods at you.  \"<i>Enough for now... I should really get back.  Catch me later and we can talk more, ok?</i>\"");
...
public function sheilaXPThreeSexyTime():void {
	...
	outputText("You prowl through the twilit grasslands, lazily looking for anything interesting before the bleak, red moon brings on the night and its restrictions.  Nothing much catches your eye, except for a rounded shape cast in silhouette against the horizon.  Initially taking it for a rock, you're surprised when it shivers at the sound of your approach!  It unbends and raises a head, turning toward you and revealing the flushed face of the bush girl, [sheilaname].  Her eyes quickly change from terror to relief as they settle on you, and she cries out.  \"<i>[name]!  Oh thank god; please help me!</i>\"");
	outputText("\n\n\"<i>What's wrong?</i>\"");
	
	outputText("\n\n[sheilaname] clings to you, wrapping her arms around, and answers, \"<i>I... imp... there was an imp.  He snuck up on me and cast that spell they use, and my body just went soft!  I kicked him and ran, but... but he's still following me!  I've seen him...</i>\"");
	
	//[(lib < 50)]
	if(player.lib < 50) outputText("\n\nAn imp?  Really?  Your incredulity must show on your face, because [sheilaname] squeezes harder.  \"<i>Please, [name]!  Don't leave me alone... I don't want to be ruined by an imp just because he got lucky!</i>\"  You idly lay a hand on her head as you consider.");
	//(else lib >=50)
	else {
		outputText("\n\nHer body went crazy?  Really?  You pull her face up with a hand under her chin.  \"<i>Just one spell, and you lost control?</i>\" you ask.  \"<i>Were you thinking about me all day?</i>\"  [sheilaname]'s gaze drifts to the side as she stammers.  Bingo.");
	...
	outputText("\n\n\"<i>Hard luck,</i>\" you say.  [sheilaname] shivers again, hiding her face.");
...
private function sheilaXPThreeSexyTimeDitchHer():void {
	...
	outputText("\n\nYou don't have to do any such thing.  It's getting darker and you should head home, so you bid the girl farewell and depart, leaving [sheilaname] calling your name - until the sound suddenly cuts off.");
...
private function sheilaXPThreeSexyTimeSex():void {
	clearOutput();
	outputText("[sheilaname]'s eyes widen with your smile, and she pulls back from you.  \"<i>That's, um...</i>\"");
...
private function shielaXPThreeSexyTimePostSexStay():void {
	clearOutput();
	if (!recalling) flags[kFLAGS.SHEILA_XP] = 4;
	...
	outputText("\n\n\"<i>Oh... oh [sheilaname]; let me love you 'til the morning comes!</i>\"");
	
	outputText("\n\n[sheilaname] blushes.  \"<i>You dork... you know that's not my real name, right?</i>\"  She lowers herself next you, allowing you to slip your hands around her waist.  \"<i>Do you really want to stay up with me?</i>\"  You answer her with a kiss on the cheek, and she sighs, finally relaxing into your arms.  [sheilaname] snuggles up, then turns and kisses you back.  Breaking the connection only at length, she hums to herself.  \"<i>It's strange... how you feel so comfortable,</i>\" she says, and then halfheartedly adds, \"<i>I must have been lonely, right?</i>\"");
	
	outputText("\n\nYou contrive to look hurt, and she laughs lightly - but there's something behind it.  \"<i>Were you?</i>\" you ask.");
	
	outputText("\n\nShe frowns and her expression clouds; even her ears droop.  Several seconds pass awkwardly before she answers you.  \"<i>Yes.  I was.</i>\"  [sheilaname] shakes her head, then wraps her arms around you.  \"<i>I don't want to remember that... let me pretend that we can stay like this, mate.  At least, for a while.</i>\"");
	
	outputText("\n\nYou lie with the woman, stroking her skin as she sighs and hums softly, for almost an hour.  Just when you feel like you should mention arranging a place to sleep and a watch order, [sheilaname]'s fingers begin to roam over you.  \"<i>[name]...</i>\" she whispers, \"<i>I'm...</i>\"");
	
	outputText("\n\n\"<i>Horny again?</i>\" you supply helpfully.  [sheilaname] bites her lip, then nods.");
...
private function shielaXPThreeSexyTimePostSexStayII():void {
	clearOutput();
	sceneHunter.selectGender(dickFitF, vagF, ["FingerHer", fingerF], null, 1,
		player.cockThatFits(32) >= 0, "Req. a cock fitting 32 area.");
	...
	function dickFitF():void {
		...
		outputText(" onto your back; [sheilaname] slips her leg over you");
		...
		outputText("\n\n[sheilaname] struggles against her own impulses, trying to make good on her promise to 'punish' you, but it's a losing battle.  Her hips slide back and forth even as she pulls in and out now, shifting angle to aim the tip of your dick against her vaginal walls when she sinks down on it, and her mouth hangs open constantly.  You grit your teeth, trying to endure the sensations as she uses your tool to scratch every one of her itches, but your lover has no such reserve left.  \"<i>No... n-no,</i>\" [sheilaname] moans, \"<i>too soon!  Oh, too soon!</i>\"");
		
		outputText("\n\nGod, this girl really is easy.  [sheilaname]'s vagina convulses around your dick, and she falls forward again as most of her body locks up, covering your ");
		//(horse)
		...
		if(player.cor >= 90 || player.cor > flags[kFLAGS.SHEILA_CORRUPTION]) {
			outputText("  The tight, rippling muscles of her pussy clamp down on you, nearly holding your cock in place as she tries to ride you still but only manages to jerk your dick up and down and squeeze pre-cum from it.  \"<i>S-so full,</i>\" [sheilaname] groans, \"<i>did you just get bigger in me?</i>\"  Her lungs inflate as she sucks in her breath, and her hard nipples push into your " + player.skinFurScales() + ".");
		}
		else if(player.cor < flags[kFLAGS.SHEILA_CORRUPTION]) outputText("  Her pussy clamps down around you, the rippling muscles so tight that she wouldn't even be able to pump if it weren't for the hot river of juice you feel around your tool.  \"<i>A-ah,</i>\" [sheilaname] groans, \"<i>you thrust too!  Rail me silly!</i>\"  She tries to push against you with her hands, to return herself to an upright position, but can barely pull her chest apart from you - her nipples just narrowly recede from the surface of your " + player.skinFurScales() + " as her efforts peak.");
		...
		outputText("  Your dick twitches and swells, as if to fulfill her words, and your pelvis rocks into [sheilaname]'s as you begin to ejaculate.  \"<i>No... pull out, or you'll get me pregnant,</i>\" she cries, when ");
		//[(single cox)
		...
		outputText("\n\n[sheilaname] attempts to lift her still-spasming pussy off of your shaft, but wracked by her own orgasm, goes tense again.  \"<i>F-fuck it!  Can't!  Come inside me, [name]!</i>\"  At the invitation, your walls break down, and your penis sprays your held-back semen into your lover");
		//[(multi)]
		...
		outputText(".");
		//[(big skeet)
		if(player.cumQ() >= 1000) outputText("  It rolls out of you in waves, packing [sheilaname]'s cunt until she fills to capacity and the excess is forced out, sliming your own crotch.");
	...
	function vagF():void {
		outputText("Her hand slips to your groin and, overcoming its trepidation, slides two fingers into your [vagina], stimulating you and forcing hardness back into your [clit].  \"<i>I don't know what's the matter with me,</i>\" [sheilaname] says, nervously.  \"<i>I'm not usually aroused by " + player.mf("hermaphrodites unless they have a donger that'll fit","girls") + ", but you're different.  I wonder what this feeling is...</i>\"");
		
		outputText("\n\n\"<i>Love, of course,</i>\" you answer, smiling smugly despite the pleasure tightening your body.");
		
		outputText("\n\n[sheilaname]'s hand stops and she looks upset for a moment, as if she were worried that might actually be the case.  \"<i>Do you really think so, mate?</i>\"");
		
		outputText("\n\nIrritated, you pull away from her and sit up, then push the timorous woman onto her back.  \"<i>Don't dwell on it so much.  Be happy you have someone who wants you as well.</i>\"  Spreading her legs, you expose her slight, smooth labia and tickle them with a finger, opening them gently.  [sheilaname] gasps, tensing and relaxing in the waves of sensation, and her pussy begins to drool clear lubricant onto your finger.  \"<i>If you can get into it like this, what's the problem?</i>\"");
		...
		//[(horse)]
		if(player.isTaur()) outputText("You turn around and straddle a leg, squatting to bring your [vagina] atop her crotch.  \"<i>Push up,</i>\" you order, and [sheilaname] obeys eagerly, twisting her body to connect her excited pussy with yours.");
		//(else if naga)
		else if(player.isNaga()) outputText("You slide it under her and lift gently; [sheilaname] plays along with a disquieted expression, rolling over and raising her pussy into the air, and you press your own against her butt as your tail slides between her legs.  \"<i>See, you just need to be more... flexible,</i>\" you quip.");
		//(else if not horse and not naga)
		else outputText("You straddle her legs with your own, pressing her pussy into yours; [sheilaname] gasps as the hot flesh connects and you tentatively rock your hips, dragging your lower lips across.");
		...
		if(player.isNaga()) {
			...
			outputText("\n\nYou smile at her insecurity, and slide your hands under her chest to cup her tits.  \"<i>Do you like having your breasts touched?  Does it make you feel womanly?</i>\"  [sheilaname] answers by writhing in your grip, moaning again and pushing her ass against your [vagina].");
			...
			sceneHunter.print("Failed check: Naga body.");
		...
		outputText("\n\n\"<i>[name],</i>\" [sheilaname] pants, \"<i>I'm gonna come soon if you keep doing that!</i>\"");
		...
		outputText("\n\n[sheilaname]'s skin turns ruddy red in embarrassment as her body locks up, and her climax starts.  \"<i>Oh god... oh... I wish you'd kiss me!</i>\"");
		//[(pc corr >= 90 or > sheila corruption)
		...
		function normalEnd():void {
			outputText("\n\n[sheilaname] cuddles up to you, slipping an arm over your body, and you lie like that for a while before she speaks.  \"<i>[name]... ");
			//(not horse)
			if(!player.isTaur()) outputText("maybe I do love you...</i>\"\n\nYou turn over and look in her eyes and she abandons the thought.  \"<i>Only having you on,</i>\" she says, smiling and caressing your cheek.");
				...
				outputText("\n\n\"<i>God dammit, stop!</i>\" [sheilaname] gasps, almost crying in laughter as you push your face closer to hers.  You relent and close your mouth, then kiss her on the cheek as she calms down.");
			}
			...
			if (!recalling) sheilaCorruptionUpdate();
			sharedEnd();
		}
	}
	//(else if no cockFit 32 and no vag)
	function fingerF():void {
		outputText("Her hand lowers to her crotch and slides her middle finger into her pussy.  \"<i>I don't know what's wrong with me,</i>\" [sheilaname] says, nervously.  \"<i>I'm not even sure why I get hot when I think of you... you don't have anything I can use.</i>\"");
		...
		outputText("\n\n[sheilaname] reddens a bit and nods again, still frigging herself.  \"<i>But I feel like an arse, ogling you without reason or sense; like I'm a goblin or something, getting wet for anyone she meets.</i>\"");
		
		outputText("\n\n\"<i>And yet,</i>\" you reply.  Emphasizing your unspoken point, you grab [sheilaname]'s hand and pull it out of her crotch, popping the finger into your mouth.  [sheilaname] shivers as you roll it on your tongue, and her pussy drools a drop of lube.  Smiling, you substitute your own hand for hers, penetrating the slick hole.  The woman's free hand quickly goes to yours, but simply rests atop it, caressing you and offering no resistance as you draw your fingers in and out of her.  Her mouth forms the word 'no', but the only sound that comes out is a soft sigh.");
		
		//[(coc, new PG)
		if(player.hasCock()) {
			outputText("\n\n[sheilaname] pulls her finger from your mouth as she shifts closer to you, giving you yet more leverage over her vagina.  The hand ");
			//(mans)
			...
			outputText("[sheilaname] winces as your probing fingers send a shudder through her.  \"<i>Shut up, you tosser,</i>\" she retorts, yanking on your dick slightly harder in her irritation.");
		}
		//(new PG)
		outputText("\n\nYou work her soaked pussy over, plunging fingers in deep with little regard for anything but hitting nerves, and caressing her small, erect clitoris with your palm as you go.  At every touch, you whisper to her what a naughty girl she is; she responds by flicking her ear at you, but you reverse by blowing and nibbling on the long auricles, sending shivers through her body.  \"<i>Oh, my... seems this wanton woman has sensitive ears, doesn't it?</i>\" you tease, drawing out the syllables to hum into her skin.  Soon [sheilaname]'s melting against you, crying out her climax into your shoulder.");
		//[(pc corr >= 90 or > sheila corruption)]
		...
		function normalEnd():void {
			//[(cocks)
			if(player.hasCock()) {
				outputText("\n\nYou reclaim your hand and rest it atop [sheilaname]'s, forcing the climax-addled woman to stroke again; she gasps apologetically and resumes with jerky, weak motions.  Irritated and almost at your peak, you up the pace, getting your hips into it until you're practically fucking her palm.  You tilt your pelvis toward [sheilaname], angling your prick at her face as you prepare to blow your load; she recoils slightly at first, but guiltily moves her mouth to your [cockHead], kissing the tip and playing her tongue over the hole.  The tingle of nerves pushes you over the brink, and you grab her head and hold it as you squirt seed past her lips.");
				//[(big skeet)
			...
			//[(cock.length > 0)
			if(player.hasCock()) outputText(", even after [sheilaname] finishes wiping her face clean and stares at you");
	...
	function sharedEnd():void {
		...
		outputText("\n\n[sheilaname] colors again.  \"<i>I don't use it around anyone!  O-okay... just for tonight, but promise you won't tease me!  Promise!</i>\"  She looks you in the eye imploringly, then continues.  \"<i>I was named after a famous bloke, so it's a little too silly for me.  But if you want, you can call me... Harriet.</i>\"");
		outputText("\n\nYou nod sagely and get up to dress.  [sheilaname], or Harriet, does the same, shimmying into her panties and shorts quickly and pulling her top on.  Finished, she drags you off to the night's lodgings anxiously, hat in hand and body language more closely resembling a giddy girl's on her first date than a grizzled, solitary hunter's.");
		//advance time to 6:00, gain 3 hours rest
		if (!recalling) {
			flags[kFLAGS.KNOWS_SHEILA_NAME] = 1;
...
private function sheilaXPThreeSexyTimeGuardDuty():void {
	clearOutput();
	outputText("You fold your arms and frown at [sheilaname], but consent to help.  She brightens, then looks confused when you make no further motion.  \"<i>So...</i>\" she begins, \"<i>what should I do?</i>\"");
	...
	outputText("\n\n[sheilaname] releases you and turns around as well, folding her legs under herself and sitting on her knees to consider.  True to your word, you scan the horizon and sky for anything that could pose a threat");
	//[(PC level >=8)
	...
	outputText(".  You stand there for so long that you nearly slip into a daydream, and are only roused by the noise of a leather belt being carefully unfastened.  Focused again, you can hear [sheilaname]'s ragged breathing and her thighs rubbing together, then a hand sliding against skin and fabric... seems like she's made her decision.");
	
	//[(lib<40)
	if(player.lib < 40) {
		sceneHunter.print("Check failed: libido should be higher!");
		outputText("\n\nWell, that's none of your concern.  Although you wouldn't really consider these erotic surroundings, the choice does make a certain kind of sense, based on what she's told you.  You continue studiously monitoring the plains, trying to ignore the wet sounds of female masturbation.  The scrapes of cloth intensify as well, as another hand is slipped into something else - the new noises seem to coincide with [sheilaname]'s breaths, as each sound is followed by the soft 'haahh' of her exhalation.");
	
		outputText("\n\nThis continues for several minutes, the wet sounds gradually drowning out all the others, increasing in tempo and volume, until suddenly they stop.  \"<i>Nnnn...</i>\" [sheilaname] moans, quietly.  \"<i>Oh god, [name], you're amazing!</i>\"");
		
		outputText("\n\nOk, that's too much.  You turn back; [sheilaname]'s seated with shorts pulled down slightly and legs spread, one hand in her crotch and another roughly groping her breast, and is staring over her shoulder at you with an expression of total horror.  \"<i>Did you-</i>\" you begin, only to be cut off as she shakes her head violently.");
	...
	//(else lib >= 40)
		...
		outputText("\n\nInteresting choice... you look over your shoulder at her.  [sheilaname]'s sitting with her shorts pulled down slightly and legs spread and, as you expected, has slid a hand into her panties.  While you watch, the other one ducks under her shirt, knuckles cresting visibly as she begins to squeeze and knead her breast.  She rubs vigorously, moaning softly whenever she grinds her erect nipple against her palm, and her other elbow jigs in the air as she works two fingers into and out of her pussy.  On one particularly deep plunge, her head rolls back and her eyes open - and she freezes as your gazes meet.");
		
		outputText("\n\nThe two of you stare at each other for a while, [sheilaname] slowly getting redder and redder, until you cough and break the silence.  \"<i>You might be more comfortable if you pulled your panties down a bit,</i>\" you suggest.");
		...
		outputText("\n\nYou smile approvingly.  \"<i>That looks just about right.  Perfect, almost.  It's only missing one thing.</i>\"  [sheilaname] stares at you without understanding, fingering herself only halfheartedly while she tries to work out your meaning, until you ");
		//[(cock.length > 0)
		...
		outputText("\n\n\"<i>You're right, mate,</i>\" she says, with a sigh and a shiver as she begins massaging her breast once more.  \"<i>I'd love to get one of those soon, but my supplier is holding out on me.</i>\"  [sheilaname] colors a bit as she realizes what she just implied, but shakes it off and ups the pace again, arching her back as her fingers search out the best spots inside her.  \"<i>Ahh, ahh, god... gonna come soon, [name]!</i>\"");
		
		outputText("\n\nShe closes her eyes and tightens up, drawing her legs in to hold her hand in place and, sadly, blocking your view of her quaking pussy with a pair of long, auburn-furred feet.  Her body practically folds up as she orgasms, until she's tucked into a fetal position with her face buried in her knees, screaming her joy into her skin, ears twitching wildly.  [sheilaname] exhausts herself after a minute, and uncurls, then dutifully begins re-dressing with a smile, darting glances at you.");
	}
	//merge
	outputText("\n\n\"<i>[name],</i>\" [sheilaname] begins, leaving the thought unfinished.  She puts out a hand, and you absently reach out to shake it, until you notice the glistening wetness at the tips of her fingers.  [sheilaname] looks down, following your gaze, then starts and wipes the liquid hurriedly on her shorts.  \"<i>... can't believe I did that,</i>\" she mumbles.  \"<i>Um, I'll be alright now.  Bye.</i>\"");
	
	outputText("\n\nYou smile and offer to stay with her a bit longer, but [sheilaname] turns beet-red and shakes her head, departing without another word.");
...
private function fuckBuddySheilaMeeting():void {
	clearOutput();
	outputText("\"<i>Hey...</i>\"");
	outputText("\n\nThe soft voice, coming from a shrub, halts your progress.  You peer around it; [sheilaname] is sitting with her hat in her lap, and looking up at you.  She smiles shyly when you make eye contact.  \"<i>Fancy meeting you here,</i>\" she says.");
	...
	outputText("\n\n[sheilaname] rests like that for a minute before speaking again.  \"<i>So... want to hang out?  Or do something?</i>\"");
...
private function fuckBuddySheilaMeetingJustHangOut():void {
	...
	outputText("\n\nYou relax, letting your mind wander as cloud patterns drift placidly in and out of your field of vision, until you're stirred to get moving again.  A glance at [sheilaname] confirms that the woman has indeed fallen asleep, trusting you to keep her safe.  You nudge her in the shoulder and she starts.");
...
private function fuckBuddySheilaMeetingChat():void {
	clearOutput();
	outputText("\"<i>Feeling talkative?</i>\" [sheilaname] asks.  \"<i>Have at yer.</i>\"");
...
private function fuckBuddySheilaMeetingChatFamilyAndFriends():void {
	clearOutput();
	outputText("\"<i>Them?  They're doing fine.</i>\"  [sheilaname] stares at you obtusely, trying to will you into changing the subject; you stare right back.  She sighs.  \"<i>No go, huh?</i>\"");
	...
	outputText("\n\n[sheilaname] frowns.  \"<i>My mum is... kind of a big deal.  She's a nurse, which means she's exempt from regular duty and is only in the reserves.  She takes care of kids in the creche all the time.</i>\"");
	outputText("\n\nThat sounds nice enough... curious that [sheilaname] doesn't seem to think so.");
	
	outputText("\n\n\"<i>Nurses have to help maintain the nursery, mate.  They're encouraged to take chemicals to ensure they're always heavily lactating.  Conventionally, they're also expected to make babies - a nurse that doesn't have children is at the bottom of the social ladder as far as respect goes, so all of them are also on fertility drugs, or having a root at all hours, or both.  Most days the first thing dad did when he got home was take mum into an empty wing for ten minutes... though when the nurseries were full, it was us who'd have to vacate so he could use the main room.</i>\"  [sheilaname] looks at you glumly.  \"<i>I used to be secretly so rapt when he was in the military crew.  He'd come home too tired from training to shag, so I'd actually get to spend uninterrupted time with him, reading him the daily bulletins or washing his clothes in a little basin while he told me stories from his platoon.  On the other duties it was always 'Hattie, run 'round and catch your brothers and sisters, and start the cooking so your mum and I can have some alone time.'</i>\"");
	outputText("\n\nYou crack a smile at that nickname, and [sheilaname] reddens a bit before continuing.  \"<i>Nobody ever calls me that anymore but him.  Anyway, my mum being what she is, our captain thinks a lot of our family.  Most of my sisters are in training under her to follow in her footsteps, never mind how few openings there are... though the older ones are training under their blokes, instead.  Nurses' daughters pair off early, since men like it when a gal wants them all the time - maybe you don't believe me?</i>\"");
	outputText("\n\n\"<i>So you have a lot of siblings around?</i>\" you ask, rolling your eyes.");
	outputText("\n\n\"<i>Probably,</i>\" [sheilaname] answers, laconically.  Only when you fix her with another stare does she bother to explain.  \"<i>It's a nursery, you know?  Mum takes in kids from the whole colony so the oldies can do their jobs without worrying; everyone's your brother.  I'm the eldest of her actual tads, but there's likely one or two in about every year under me.  We sprout pretty fast once we get planted; probably be a fourth generation soon.  One of my sister's kids called me 'old Auntie [sheilaname]' the other day and I nearly kicked him.  Like I'm some maiden spinster.</i>\"");
	
	outputText("\n\nWatching her jaw work angrily, you decide on a change of subject.  \"<i>What about your friends?</i>\"");
	
	outputText("\n\n\"<i>Guess you'd call them work buddies.  I'm the girl in the group, so eventually I got upgraded from 'the sheila' to just '[sheilaname]'.  Like I said... wankers.  They're mostly blokes who glued themselves to me when they heard who my mum was, probably hoping I'd take after her eventually.  Too bad for them, I always wanted to be like my dad instead.</i>\"  She grins wickedly.");
	...
	if(player.lib >= 50) {
		...
		outputText("\n\n[sheilaname] blushes.  \"<i>I... am as interested as any girl.  Maybe more since it was such a normal, everyday thing in our family.  Dad was always hanging onto mum, like her breasts and hips were where his hands belonged.  My sisters definitely take to it; you wouldn't believe how they act.  Half of them are still wearing their old shirts even though they've started on lactation drugs and their tits have swelled up four sizes.  Or stealing mine when they rip theirs at the seams.</i>\"");
...
private function fuckBuddySheilaMeetingChatOldLoves():void {
	clearOutput();
	outputText("\"<i>[name], I don't want to talk about that,</i>\" [sheilaname] says, \"<i>it leaves a bad taste in my mouth.</i>\"");
	...
	outputText("\n\nChanging tack, you point out that [sheilaname] would have inherited some personality from them, thanks to her... situational empathy... so it's only fair if you know a little bit, right?");
	
	outputText("\n\nShe lowers her eyelids at you.  \"<i>That's a boomer of an assumption.  And, it's not like you can do anything special even if you know, mate.  What I am is what I am.  It doesn't really matter anyway, since I'll be getting closer to </i>your<i> personality if... well.</i>\"  [sheilaname] looks at you coquettishly.");
	...
	//(else lib >=50)
		...
		outputText("\n\n[sheilaname] blushes bright red.  \"<i>No.</i>\"");
...
private function fuckBuddySheilaMeetingChatLiveWithMe():void {
	clearOutput();
	outputText("You ask [sheilaname] to move in with you at your camp, and she turns bright red.");
...
private function fuckBuddySheilaMeetingChatKids():void {
	...
	if(flags[kFLAGS.SHEILA_JOEYS] == 1) {
		...
		//else if PC masculine or andro, no new PG)
			...
			outputText("\n\n[sheilaname] sighs.  \"<i>I'm a daddy's girl.  His first child, got all the benefits of his time, and one without kids and a husband of her own to pull her emotions away from him.  I've always just been his baby... maybe longer than I should have, but I was lonely, mate.  We're close.</i>\"");
		}
		//merge gender/sex fork
		outputText("\n\n\"<i>So, is he serious... about meeting?</i>\" you persist carefully.");
		
		outputText("\n\n[sheilaname] looks into your eyes, trying to read your expression.  \"<i>Yeah, I think so.  I hope he's not set to bail you up, but... he says he aims to search you out when he gets switched back to the hunting crew.</i>\"");
		...
		outputText("\n\nYou nod, trying to hide your laughter at the mental image of her dad in a pink gardening smock with a spade in hand and two bags of root vegetables on his shoulders.  [sheilaname] looks at your barely-concealed grin, and pokes you in the side.  \"<i>Something funny, mate?</i>\"");
	...
	//if 1 < joeycount < 10
		...
		outputText("\n\n[sheilaname] smiles under her downcast eyes.  \"<i>They're fine, love.  Some are getting pretty big.</i>\"");
		...
		outputText("\n\n\"<i>Well,</i>\" [sheilaname] says, \"<i>I dunno about yours, but two years or so is enough for purebred kids to be up and helping around the colony - they're about three or four feet then.  Just basic stuff, like carrying small bags of food home from the storage for their mum or dad.  Two more years and they're basically adults... not as wise as one, of course, but they start perving and pairing off around then, no matter how much their oldies urge them not to.  Magic of hormones, world's your oyster, and all that.</i>\"");
		
		outputText("\n\nThe implications come to you in a hurry.  \"<i>So... how old are you?  Five?  Ten?</i>\"");
		outputText("\n\n[sheilaname] laughs.  \"<i>No, mate; much older than that.  I'm not going to tell you how much, though.</i>\"  Her eyes narrow in mock suspicion, and she smiles broadly.  \"<i>A " + player.mf("gentleman","lady") + " doesn't ask a");
		...
		if(player.lib >= 50) {
			...
			outputText("\n\n\"<i>[name]!</i>\" [sheilaname] shrieks, pulling back and slapping you across the face.  \"<i>You nasty root rat!</i>\"");
	...
	//if joeycount >= 10
		...
		if(player.lib < 50) {
			...
			outputText("\n\n[sheilaname]'s eyes harden.  \"<i>Yeah... my mum has volunteered.  A few of my neighbors tried to as well, but my mum quietly chased those off, saying she'd be happy to handle it and keep it in family.</i>\"");
			outputText("\n\n\"<i>So...?</i>\"");
			...
			outputText("\n\n[sheilaname] sighs and gets up, nodding to you, and collects her stuff.  \"<i>Love you.  See you soon.</i>\"");
			//corruption down if corr < 40
			if(player.cor < 40) dynStats("cor", -1);
		}
		//(else lib >=50)
		else {
			outputText("\n\n\"<i>I'm still turned on by you,</i>\" you persist with a whisper.  \"<i>I want your body any time, anywhere.  Here, for example.  Or... here.</i>\"  This last comment is accompanied by your hand sliding into her shirt and over a " + sheilaCup() + " breast.  [sheilaname] blushes.");
...
private function fuckBuddySheilaMeetingChatKidsRest4Now():void {
	...
	outputText("\n\n[sheilaname] kisses you on the forehead and then lays her head against your ");
...
private function sheilaXP4Sex(display:Boolean = false):void {
	if(display) {
		...
		outputText("\n\n[sheilaname] fidgets as your fingers begin to rove under her shirt and up her back while you wait for her answer.  \"<i>Horny bastard...</i>\" she mumbles.  \"<i>I figured that was what you'd want.</i>\"");
...
private function consensualSheila69(x:int):void {
	var cock:Boolean = x >= 0;
	var fits:Boolean = cock && player.cockArea(x) < 32;
	var x1:int = x + 1;
	clearOutput();
	...
	if(cock) {
		if(fits) {
			outputText("  Though, she smiles openly when you produce your [cock "+x1+"].");
			outputText("\n\n\"<i>Will you be putting that in me, then?</i>\" [sheilaname] asks, spreading her labia softly in anticipation.  You make no reply, drawing a look of surprise.");
		}
		else {
			...
			outputText("\n\n\"<i>[name]... you really do take it too far.  There's no way I can... I mean, the size of it!</i>\"  Even despite a point-blank refusal, [sheilaname]'s eyes don't leave your crotch, drinking in the sight of your dick");
	...
	//(vag)
		...
		outputText("\n\n\"<i>Cute little flower...</i>\" [sheilaname] says, playing with her own.  You mimic her, slipping a finger between your labia to stimulate yourself");
	...
	if(cock) {
		...
		//(big)
		if(fits) outputText(" and guiding it to bend comfortably against her chest, drooling a trail of pre-cum as she slides it into position");
		outputText(".");
	}
	//(vag)
	...
	if(cock) {
		...
		//[(small cock)
		if(fits) outputText(" into her warm, waiting mouth");
	...
	if(!player.isTaur()) {
		...
		if(cock && !fits) outputText("shaking, teasing nipples and heaving chest");
		else outputText("mouth, humming in delight");
		outputText(".");
	}
	//(horse)
	else {
		outputText("\n\nFeeling sure that [sheilaname] will keep working on your sex after your remonstration, you focus on bringing her more sensation than she can possibly endure.  Two fingers of one hand hold her labia open, exposing her vagina to your questing middle digits; the other hand works busily at her clitoris, alternately rolling the petit button with a thumb and dragging it against the flat surface of the palm.  You make sure to collect the moisture oozing from [sheilaname] to keep the nub slippery at all times and work it faster, stroking it up, down, and all over.  The poor woman under you moans and shudders, transferring the vibration to you with her ");
		if(cock && !fits) outputText("hard nipples");
		else outputText("throat");
		outputText(".");
	}
	//merge horse with rider
	//[(big cox)
	if(cock && !fits) outputText("\n\n\"<i>[name]!  I'm coming!</i>\" [sheilaname] cries.");
	else outputText("\n\n\"<i>Mmmh!  Mm mmnnn!</i>\" [sheilaname] moans, muffled by your body.  The import doesn't hit you until a second later.");
	...
	if(player.cor >= 90 || player.cor > flags[kFLAGS.SHEILA_CORRUPTION]) {
		...
		outputText(" in ravenously.  You can literally feel her internal muscles rippling and undulating, stroking you as if they could coax out an ejaculation.  [sheilaname] sucks in her breath as she climaxes, filling her chest; you can feel her tits pushing harder and harder against you.");
	}
	//(PC corr < sheila corruption)
	...
	outputText("  [sheilaname] jams her face upward, ");
	//[(big cox)
	...
	//(else if vag-focus)
		...
		//[(cock fits)
		if(fits) {
			outputText("pouring out into your lover's waiting throat.  She gags and you can feel the gooey seed oozing back against your [cockheadFit "+x1+"]");
			//[(small cum)
		...
		//(else doesn't fit)
			...
			outputText(" squirting onto and between your intertwined bodies to soak your [chest] and neck, and [sheilaname]'s softly pumping crotch.");
			//(big skeet)
	...
	if (!recalling) player.sexReward("vaginalFluids", cock ? "Dick" : "Vaginal");

	if (recalling) normalEnd();
	else if(player.cor >= 90 && sheilaCorruption() >= 90) {
		outputText("\n\nYou could finish what you've started and fully corrupt the woman. Are you ready?")
		doYesNo(sheilaGoesDemon, normalEnd);
	...
	function normalEnd():void {
		...
		//[(sheila xp = 3)
		if(recalling || flags[kFLAGS.SHEILA_XP] == 3) {
			outputText("\"<i>[name]... thanks.  Even being covered in your mess is better than being stuck outside all night, too scared to touch myself and too horny to run.</i>\"  [sheilaname] kisses you on the cheek.  \"<i>My sloppy hero, eh?  I'm okay now; I can make it 'til morning when the gate reopens.</i>\"");
			outputText("\n\nWhatever that means... does she plan to spend all night outside, alone and covered in drying sexual fluids?");
			outputText("\n\n\"<i>Er... pretty much, yeah?  It won't be the first time - the staying up all night, I mean.</i>\"  [sheilaname] colors a bit.  \"<i>That's how it goes if I can't make curfew; gotta watch out for myself.  But it'll be okay now that you've... helped, and I can actually focus.</i>\"");
			outputText("\n\n[sheilaname] gives you a small hug and starts to pull away; she really intends to stay awake until morning, running and hiding from whatever might come close.  Doesn't sound like much fun.");
...
private function consentacleVagSexForKangarooSlutBitches():void {
	...
	outputText("You fuck harder, stuffing [sheilaname] with such force that her ");
	...
	if(player.cor >= 90 || player.cor > flags[kFLAGS.SHEILA_CORRUPTION]) {
		...
		outputText("  The intense sensation begins to ascend your dick slowly; your body works itself into overdrive and your partner's moans increase sympathetically as it nears the tip.  Finally, it exits your body with an enormous squeeze, alongside a jet of jism.  [sheilaname] gives a complementary gasp as this pulse enters her, and her pussy convulses in a second orgasm, causing her back to arch.  Her breasts seem to jiggle more wildly than before as she thrashes on the ground in the grip of her pleasure.");
	}
	//(PC corruption < sheila corruption)
	else if(player.cor < flags[kFLAGS.SHEILA_CORRUPTION]) {
		outputText("your resistance is condemned to die in failure as [sheilaname] lets out a quavering scream of pleasure and wraps her arms and legs around you, pinning you inside.  Her vagina convulses around your cock powerfully; you could swear you feel yourself stretching longer and longer as her rippling pussy pulls you deeper in.  Just when you think that your dick must be a mile long, her whole body tenses up and her fingernails dig into your back.  Wearing a madwoman's expression, [sheilaname] stares open-mouthed at you as her muscles lock and her pussy quivers out its fitful orgasm; even her ");
	...
	if(!player.hasKnot(x)) {
		...
		outputText(".");
		//[(Huge skeet)
		if(player.cumQ() >= 1500) outputText("  More and more globs of semen shoot from the end of " + sMultiCockDesc() + ", pasting [sheilaname] to the dry grass as you paint her body white.");
	}
	//(dog cock)
	else {
	...
	outputText("; the two of you lie there breathing raggedly for several minutes.  [sheilaname] breaks the silence first.");
	...
	if (recalling) normalEnd();
		...
		outputText("\n\n[sheilaname] appears to stagger at this, sending a pleasing jiggle through her huge breasts.  You can feel yourself getting ");
	...
	function normalEnd():void {
		...
		if(recalling || flags[kFLAGS.SHEILA_XP] == 3) {
			outputText("  [sheilaname] looks over, thankfulness written on every inch of her brow.  \"<i>[name]... I really appreciate what you did.  I'd rather be knocked up than caught by some nightmare because I was too horny to hide properly until the colony opened - er, not that I want to be knocked up by you, sweet as you are.</i>\"");

			outputText("\n\nHuh... so she's planning to hide the rest of the night?");
			outputText("\n\n\"<i>Yeah,</i>\" [sheilaname] answers, when prompted.  \"<i>It's not really so hard, you know, in the dark.  I can just dig a hole or something.</i>\"  She squeezes your hand, then gets up.  This girl actually wants to hide alone in a hole for the entire night...");
			//[Stay With Her][Let Her Be]
			menu();
			addButton(0,"Let Her Be",sheilaXPThreeSexyTimePostSexLetHerBe);
			addButton(1,"Stay With Her",shielaXPThreeSexyTimePostSexStay);
...
private function sheilaMutualMasturbation():void {
	...
	outputText("You snatch [sheilaname]'s hat and pack, tossing them away, then slide a hand into the girl's shirt, slipping one of her nipples between two fingers as you nibble on her neck, and use the gentle pressure to push her onto her back.  She sighs, moving a hand under her clothes to caress yours.  \"<i>Ah,</i>\" she pants, letting out a soft puff of air, \"<i>what're we gonna do on the grass, [name]");
	if(silly()) outputText("-chan");
	outputText("?</i>\"");
	
	outputText("\n\nYou offer no answer, withdrawing from her shirt and turning your attention to her belt, which you unfasten.  With it out of the way, you unbutton her shorts and pull them down, panties and all, slipping them right off her legs.  [sheilaname] shifts nervously and squeezes her knees together as you tug her paws free of the bottoms and cast the latter aside.  Briefly, you slide your hand into the open space between her thighs to stroke her pussy once, but then you're up again, peeling off her vest and pushing her shirt over her head, getting in a good grope on her breasts as you strip her.  With [sheilaname] in the buff and waiting eagerly, you stand up and shuck your own [armor], dropping it carelessly.");
	...
	outputText("\n\nYou lie down next to [sheilaname]");
	//[(horse)
	...
	outputText(".  \"<i>Oh... are you going to touch me, or just play with that?</i>\" [sheilaname] asks, grinning.");
	
	outputText("\n\n\"<i>The latter,</i>\" you answer with a sly smile.  A particularly deep pump sends an anticipatory shiver through you as [sheilaname]'s smile fades.");
	
	outputText("\n\n\"<i>[name]...</i>\" she begins dubiously.  You cut her off with your other hand, held out, and she warily places hers in it.  Smiling, you lift it to your lips, smothering it in kisses and tracing on it with your wet finger.  [sheilaname] giggles, but with restraint, still unsure about your methods.  Once you've finished playing with her hand, you tuck it between her thighs, cupping it and forcing two of her digits into her pussy.  \"<i>Ah, ah, ahh,</i>\" [sheilaname] gasps, \"<i>what are you doing?</i>\"");

	
	outputText("\n\n\"<i>Making sure you know how to fool around,</i>\" you tease.  \"<i>Use your imagination.</i>\"  [sheilaname] blushes at that, allowing you to sink her fingers into her pussy with increasing vigor.  Just as she starts to moan, you pull your hand away, returning it to duty on your own body.  Her eyes sink, but as you ");
	...
	else if(target == "cunt") outputText("You slide your hand between your [legs] again, intent on recovering the march [sheilaname]'s stolen on you, and begin rubbing your [clit] vigorously while sighing into her breast.");
	//(else if RNG disgusting nipplecunts)
	else if(target == "nipplecunt") outputText("Your hand returns to your chest, slipping inside the sensitive flesh of your nipple, and you groan into [sheilaname]'s as a trickle of moisture falls from your chest.");
	//(else if non-centaur asshole)
	else if(!player.isTaur()) outputText("Your hand reaches back to your [asshole], neglected for too long, and a finger spears your pucker, stroking the nerves inside as you hurry to bring your arousal in line with [sheilaname]'s.");
	...
	outputText("\n\n[sheilaname] places a hand alongside your head even as she gasps and shoves her fingers deep inside her pussy.  \"<i>[name], as long as you'll touch me like this, I'll be your star; I'll beg on my knees!</i>\"  Her hand moves irregularly now, as her hips jerk and swivel");
	//[(if fucking nothing)
	...
	if(target == "cock") {
		...
		outputText(" to twitch, ejaculating a stroke onto [sheilaname]'s midriff and wrist.  The girl groans in your mouth at the new heat, and her body shakes in orgasm.");
	}
	//(vag)
	else if(target == "cunt") {
		...
		outputText(" around your hand.  As your body shakes and your lips rattle against [sheilaname]'s, she shivers and her own orgasm begins.");
	}
	//(nipcunts)
	else if(target == "nipplecunt") {
		outputText("nipple constricts around your fingers in climax, oozing lubrication onto your partner.  As the drops from your " + breastDescript(0) + " hit her own, [sheilaname]'s back arches again and her own orgasm begins.");
	}
	//(jack shit)
	else outputText("fingers are pulled into her vagina by her muscles as her orgasm begins.");
	//[( pc corr >= 90 or > sheila corruption)
	if(player.cor >= 90 || player.cor > flags[kFLAGS.SHEILA_CORRUPTION]) {
		outputText("\n\nHer lips seem to draw yours in when she comes, until it feels like you've been pressing them into her since time began; her chest rises as she sucks, and you can clearly see her breasts swelling up - it's too much to bear, and you grab one with your free hand and squeeze.  [sheilaname] answers you by sticking her tongue even deeper into your mouth.");
	}
	...
	if(player.cor >= 90 && sheilaCorruption() >= 90) {
		...
		outputText("\n\nThey certainly do, at that.  You feel like jumping into them and doing this again, but settle for giving one a healthy rub.  [sheilaname]'s lower lip quivers with momentary abandon, but she slaps your hand away.");
	...
	function normalEnd():void {
		if (!recalling) sheilaCorruptionUpdate();
		outputText("\n\n[sheilaname] strokes your " + hairDescript() + " as you lie ");
		...
		if(flags[kFLAGS.SHEILA_XP] == 3) {
			...
			outputText("\n\n\"<i>Still gotta find a place to hide tonight,</i>\" [sheilaname] replies.  \"<i>Then I can hit the town again in the morning.  I'll remember you the next time I feel like hanky-panky, though.</i>\"  The girl's cheeks color a bit.");
...
internal function sheilaGotWhomped():void {
	clearOutput();
	outputText("[sheilaname] collapses, ");
	//[(HP)
	...
	if(player.lust >= 33) {
		menu();
		addButton(0,"Fuck Pussy",rapeSheilasCooter)
		...
		addButton(3, "Use Dildo", sheilaGetsRapedWithADildont)
			.disableIf(player.hasKeyItem("Deluxe Dildo") < 0, "Requires Deluxe Dildo.");
...
private function rapeSheilasCooter():void {
	...
	sceneHunter.selectPureCor(["Tease Her", teaseHer], ["Be Rough", beRough], 90, 60);

	//fuck-fork
	//[(corruption < 50)
	function teaseHer():void {
	...
	function beRough():void {
		...
		outputText("\n\n[sheilaname] shivers and tries to speak again, but her head jerks as you crook your fingers abruptly into her, then yank your hand back.  Her panties stretch as you tug, taut against her ass.  \"<i>S-stop!</i>\" she cries.  \"<i>Please!</i>\"");
		...
		outputText(", and she actually rears back to scratch at you with her fingernails.  You catch her hand and hold it, and she responds by spitting at you!  \"<i>Fuck you, arsehole!</i>\" [sheilaname] shrieks.  \"<i>Take it out!</i>\"  Reaching down, you slap her in the face.");
		...
		outputText("  \"<i>Of course I won't,</i>\" you answer sweetly.  \"<i>What would be the point?</i>\"  [sheilaname] winces as you hilt yourself, sinking your [cockFit 48] so far into her that your crotch meets hers.  You shudder");
		//[(nonhors)
...
private function forcedSheilaOral(x:int):void {
	var dick:Boolean = x >= 0;
	var x1:int = x + 1;
	clearOutput();
	//set sheila xp = -4
	flags[kFLAGS.SHEILA_XP] = -4;
	if (dick) sceneHunter.print("Real differences in scene the scene appear when your dick is longer than 8 inches or thicker than 6 inches.");
	...
	outputText("\n\n[sheilaname] shudders as you squeeze, then gasps sharply when you rub her areola with two fingers.  \"<i>N-no,</i>\" she whimpers, trying to pull away from your hand.");
	...
	outputText("  Smiling at the sight, you grab the garment's hem and pull it up roughly.  [sheilaname] blinks dumbly as you expose her erect nipples to the air, then blushes and covers them with her hands.");
	...
	outputText("  [sheilaname] watches your face as you slip into a fantasy, half-playing with her nipples - but just when you start to get into your daydream, she turns and tries to scramble to her feet!");
	...
	if(dick) {
		outputText("\n\nYou seize the girl by her hair, cutting off her escape and depositing her in front of you once again.  Still holding her tight, you guide her shut mouth to the tip of your [cock "+x1+"].  \"<i>Oral,</i>\" you demand tersely, grabbing your shaft and smearing her lips with the pre-cum you're beginning to drip.  [sheilaname]'s eyes close like her mouth and she tries to pull away, but you shake her until she's looking at you again and point at your cock insistently.  \"<i>Oral,</i>\" you repeat, pulling her hair harder.  \"<i>Or we can slip you out of those pants instead, if you prefer...</i>\"");
		...
		if(player.cocks[x].cockThickness <= 6) {
			outputText("parting her lips to pop neatly between them.  It feels good, but one-sided, and you order [sheilaname] to get to work.");
		}
		else {
			outputText("jabbing at her undersized mouth with your enormous [cockHead "+x1+"].  \"<i>It's too thick!</i>\" she complains, trying to turn away.");
		...
		//(else dick length > 8)
			...
			outputText("\n\n\"<i>God,</i>\" you groan, \"<i>you're terrible at this.</i>\"  [sheilaname]'s eyes widen with concern and her palms turn toward you in a futile defensive gesture, but too late; ");
			...
			///(else width > 6)
				...
				outputText("you grab the shaft and stroke once, forcing out a truly impressive dollop of backed-up pre-cum that dribbles onto [sheilaname]'s face and into her open maw.  The woman coughs and sputters, drooling the slick fluid from mouth and nose, then tries to scrub it away with the back of her hand; she only succeeds in smearing it into a complete mess.");
		...
		if(player.cor >= 70 && player.statusEffectv1(StatusEffects.Infested) == 5) {
			...
			outputText("\n\nYou lean over to [sheilaname]; her face is already pale and horrified as she holds her gut, feeling the worms inside.  \"<i>Hope you enjoy today's catch,</i>\" you whisper.  \"<i>I'll come see you again when I have some more.</i>\"  Re-donning and refastening your [armor], you leave the woman behind just as she begins to retch violently, dumping worms and cum onto the grass.");
		}
		//(else if corr < 70 or PC cannot use Infest at will)
		else  {
			outputText("\n\n\"<i>Swallow it, bitch!</i>\" you cry, holding [sheilaname]'s head against your cock as your ejaculation begins.  Not like she has much choice, with the way you're holding her; she can either swallow or drown in semen.  Your orgasm fills her mouth, forcing its way down her throat");
			//[(big skeet)
			if(player.cumQ() >= 1000) outputText(", and soon you can feel it lapping at the end of your shaft");
			outputText(".");
			//[(mega skeet)
			if(player.cumQ() >= 3000) outputText("  Your body's not done with that, though, and keeps pushing out cum until it spurts around your prick and out [sheilaname]'s nose in little squirts.");
			outputText("  Emptying yourself, you pull [sheilaname]'s mouth away from your [cock "+x1+"] and drag the slimy member on her chest, smearing her tits with spit and semen and wiping away the last of the mess on her shirt.");
			
			outputText("\n\nYou pull the soiled garment down over [sheilaname]'s breasts");
			//[(big+ skeet)
		...
		outputText(".  Straddling her, you lower your [vagOrAss] to her face.  \"<i>Lick,</i>\" you order, rubbing your [butt] on [sheilaname]'s nose");
		//[(not horse)
		...
		outputText("\n\nYour [vagOrAss] squeezes around [sheilaname]'s hesitant tongue, turned on more by the spectacle of selling her body than by any of her poor efforts.  She squirms under you, rubbing her thighs together as you paint the worst pictures of her future you can imagine, and you climax");
...
private function sheilaGetsRapedWithADildont():void {
	...
	outputText("\n\n\"<i>Wait!</i>\" [sheilaname] yelps.  \"<i>Take it out!</i>\"  Instead, you give the toy a squeeze, forcing lust-inspiring goblin fluids from the end and into her body.  Swirling it around, you smear the chemicals into the walls of her pussy; soon she's panting greedily, having all but forgotten her desire to escape.  You watch her push herself off the ground with one hand and grope her breast with the other...");
	
	outputText("\n\nSeems the perfect time to pull back out.  You release [sheilaname] and begin to back away - she notices the painful absence immediately.  \"<i>Uh?  Where are you going?  Hey!</i>\"");
	...
	outputText("\n\nYou lean forward until your face is level with her ear, and whisper, \"<i>From anal alone?  You really are a slut!</i>\"  [sheilaname] doesn't even seem to care, pumped with goblin drugs; she raises one hand and places it alongside your face, leaning in to kiss your cheek as she sinks herself on the dildo one last time.");
...
internal function getBeatUpBySheila():void {
	clearOutput();
	outputText("You slump down before [sheilaname], breathing heavily; the woman ");
	...
	//(else monster lust >= 75)
		...
		outputText("\n\n\"<i>[name]... you're not a demon?</i>\" [sheilaname] asks, with smoldering eyes.");
...
private function sheilaLossRapeRouter():void {
	sceneHunter.selectLossMenu([
			[0, "Oral", sheilaForcedOralGeneric],
			[1, "Cowgirl", sheilaCowgirlRapesYou, "Req. a cock.", player.hasCock()]
		],
		"\n\nSeems like she's too horny to think straight... would you give her an oral, or let her ride you cowgirl?"
	);
}
...
private function sheilaCowgirlRapesYou():void {
	clearOutput();
	outputText("[sheilaname] pushes insistently, and you allow her to force you to the ground and then onto your back");
	...
	outputText("breast in each, squeezing them softly and rubbing the hard nipples with your thumbs.  [sheilaname] shudders as you amuse yourself with her body, placing her hands atop yours and guiding you to her favorite spots.  You watch her as she moans; your gazes meet as she rolls her head, and she quickly restrains herself and looks away again.  \"<i>Stop staring at me...</i>\"");
	
	outputText("\n\nEager to see anything but your curious face, [sheilaname] pushes your hands away from her breasts and turns to your crotch.  She ");
	...
	sceneHunter.selectFitNofit(fitF, nofitF, 32);
	...
	function nofitF():void {
		...
		outputText("\n\n[sheilaname] bites her lip and nods.  \"<i>I could never fit that inside... I can't use it.</i>\"");
		
		outputText("\n\nRather, she means she's not imaginative enough to use it?  [sheilaname] seems to see some of your assumed insult in your eyes, and she sets her jaw.  \"<i>Alright,</i>\" she says ominously, \"<i>challenge accepted.</i>\"  The woman unfastens her belt, stripping off her shorts and panties with the same haste as her top.  Her underwear comes away with ease, sticking hardly a bit - maybe she plans to make up the deficit in her arousal with willpower?  [sheilaname] pushes your back flat against the ground again");
		//[(horse)
		...
		outputText("\n\n\"<i>Ahh... ah.  N-not bad,</i>\" she sighs.  She wraps her thighs lightly around your [cock biggest] and begins to shift up and down, stroking herself.  The space between her legs is nearly the perfect size, and when she squeezes you, you moan as well.  \"<i>So,</i>\" [sheilaname] whispers, shuddering, \"<i>enjoying this, are you?</i>\"");
		...
		outputText(" as her gasps and the picture in your head both intensify.  [sheilaname] grabs one with her own hand, pulling it up to her mouth to smother it in kisses");
		if(!player.isTaur()) outputText("and suck on your fingers");
		outputText(".  \"<i>Oh... [name]...</i>\"");
		
		outputText("\n\nYou grunt a response, too involved in thrusting between her warm, juice-slicked thighs to form sentences.  \"<i>[name]... I-I'm... coming!</i>\" [sheilaname] shrieks.");
		...
		outputText("[sheilaname] shivers and leans back, hair dangling, as her hips buck and her thighs squeeze your shaft.  ");
		//(PC corr >=90 or > sheila corruption)
		if(player.cor >= 90 || sheilaCorruption() < player.cor) {
		...
		else if(player.cor < sheilaCorruption()) outputText("Her orgasm wets your prick, coating it with fluid as she comes.  [sheilaname] wraps herself tighter in your limbs, squeezing her breasts against her chest, and you think you can feel them get a little smaller as your head fuzzes over with her excess emotion.");
		else outputText("Her hips lock up when she comes, leaving you to try and finish yourself as she heats up around your shaft.");
		
		//[(sens >=50)
		if(player.sens >= 50) {
			outputText("\n\nThe warm, smooth, wetness of her thighs is enough to bring out your own climax, and " + sMultiCockDesc() + " unburdens itself, forcing globs of semen into the air to rain down on your entwined bodies.  [sheilaname] laughs as you coat her midriff with your mess, and playfully strokes your sensitized [cock] with one hand, sending shivers through you as she helps force your cum up your shaft.");
			//[(mega skeet)
			if(player.cumQ() >= 2000) outputText("  The giggles and the strokes stop long before your orgasm, though; eventually [sheilaname] just lies there, dumbfounded, as you deposit layer after layer of white lattice on her skin.  \"<i>Bloody hell,</i>\" she mumbles vaguely, either stone-sober or drunk from the sight of it.");
			...
			if(player.cor >= 90 && sheilaCorruption() >= 90) {
				outputText("\n\nYou could finish what you've started and fully corrupt the woman. Are you ready?")
				doYesNo(sheilaGoesDemon, normalEndHiSens);
			} else normalEndHiSens();

			function normalEndHiSens():void {
				outputText("\n\n\"<i>Well... what do you think of that, then?</i>\"  [sheilaname] laughs and cleans herself on the grass, then picks up her stuff and leaves you to sleep off the fatigue and defeat.");
				cleanupAfterCombat();
				sheilaCorruptionUpdate();
			}
		}
		//(else sens < 50)
			...
			outputText("\n\nYou thrust vigorously, trying to push yourself over the edge, but [sheilaname]'s orgasm is already winding down - she scoots up and pulls her pussy away from your rubbing, tormenting shaft, leaving you alone in a painful vacuum of sensation.");
			dynStats("sen", 3, "lus", 50+player.lib/10, "scale", false);

			if(player.cor >= 90 && sheilaCorruption() >= 90) {
				outputText("\n\nYou could finish what you've started and fully corrupt the woman. Are you ready?")
				doYesNo(sheilaGoesDemon, normalEndLoSens);
			} else normalEndLoSens();

			function normalEndLoSens():void {
				outputText("\n\n\"<i>What are you doing, mate?  You're gonna make me horny again!</i>\"");

				outputText("\n\nShe looks over her shoulder at you, and the drawn expression on your face tells the whole story.  Her eyes glimmer with mischief, and she leans down to you.  \"<i>I told you a donger like that wasn't suitable for loving a woman,</i>\" [sheilaname] says, tracing a circle on your chest.  \"<i>Don't suppose you have anyone to blame but yourself, eh?</i>\"");
	...
	//(else if cock fit 32)
	function fitF():void {
		outputText("as you lean over to catch her expression, you can see her eyes glimmer with desire.  [sheilaname] notices you from her peripheral vision, and her face reddens again.  She turns her back to you.");
		
		outputText("\n\n\"<i>I mean it... look somewhere else!</i>\"");
		outputText("\n\n\"<i>Where shall I look?</i>\" you ask, innocently.");
		
		outputText("\n\n[sheilaname]'s ears prick up, but she doesn't answer, instead ");
		//[(multicock)]
		if(player.cockTotal() > 1) outputText("separating out and ");
		outputText("stroking your [cockFit 32].  A drop of precum forms, and she touches it with the index finger of her free hand, sending a tingle through you; she pulls the finger away, drawing a string of slick moisture out.  [sheilaname] passes the finger between her breasts, wiping the fluid away on her chest and shivering.  The display is too much for you, and you reach forward, navigating your hands around her waist quietly until you can reach the buckle of her belt.  The girl sighs as you begin to unfasten it, but an errant thought brings her back to reality - she grabs your hands abruptly.");
		...
		outputText("\n\n\"<i>That's... we're not lovers!</i>\" [sheilaname] stammers.  \"<i>Don't just undress me as you please!</i>\"");
		...
		outputText("\n\n\"<i>What I want...</i>\" [sheilaname] trails off; shaking herself free she stands up, shorts half-unfastened.  \"<i>Fine!  If you're intent on seeing it, then look!</i>\"  She quickly pulls her belt apart and drops her bottoms to the ground, followed more carefully by her underwear.  \"<i>Here!</i>\"");
		
		//[(lib < 25)
		if(player.lib < 25) {
			sceneHunter.print("Check failed: you have too low libido!");
			outputText("\n\nInstead of focusing on her pussy, you continue to stare into her guilty face.  [sheilaname]'s lips quaver and her eyes water; she seems almost on the verge of crying as your unceasing scrutiny breaks down her resolve.  \"<i>Please...</i>\" she whimpers unhappily, \"<i>stop staring at me like that.</i>\"");
			outputText("\n\n\"<i>But you're using me just for my dick?</i>\"");
			
			outputText("\n\n\"<i>No, I'm...</i>\" she attempts, frowning, then slumps her shoulders in defeat.  \"<i>You're right.  This is wrong.  I'm sorry.</i>\"  [sheilaname] turns and quietly pulls her shorts back up, fastening her belt, then locates her top and slips it over her breasts.  She picks up the rest of her stuff, looks back at you once, then lopes off.  You watch her go with high energy and mixed feelings - of all things, the image of her pulling the shirt down over her flushed, sweating back sticks in your head, taunting you and keeping your prick hard long after she's gone.");
		...
		//(else lib >= 25)
			...
			outputText("\n\n\"<i>Bastard,</i>\" [sheilaname] whispers under her breath as your body pushes out another drop of precum.  \"<i>You want this... I knew it.</i>\"");
			...
			outputText("; looking into your face, her frown evolves into a mischievous grin.  [sheilaname] about-faces, turning her back to you.  \"<i>Blame yourself for this; it's rude to stare,</i>\" she giggles, hovering over your [cockHeadFit 32].  The woman sinks down with an audible sigh, parting her slick, smooth labia with your tip and swallowing your " +  player.cockVsClitCockLenght(player, player.cockThatFits(32)) + " inches.  \"<i>Ohh...</i>\" [sheilaname] moans.  She slips a hand down to your crotch to check how much of your prick is left to go, and starts a bit when she realizes she's taken the entire shaft on the first stroke!");
			
			outputText("\n\n\"<i>Guess I wasn't the only one,</i>\" you tease softly.  [sheilaname]'s neck turns red, but she only begins to move her hips, saying nothing.  Her snub tail dances in the air as she pumps your cock, beating out a tattoo on your stomach");
			...
			//[(small cum)]
			if(player.cumQ() <= 250) {
				outputText("  [sheilaname] continues moving her hips even as she comes, lost in bliss; on one particularly lofty ascent, your cock flops out, squirting a line of jizz along ");
			...
			//(big cum)
				...
				outputText("  With how much [sheilaname] is still moving her hips, it's only a matter of time before she notices the mounting pressure in her cunt... on one particularly deep push, she forces out a squirt of white, and her eyes go wide as she pulls off and lets you finish on the grass.");
			}
			sheilaPreg(true);
			player.sexReward("vaginalFluids", "Dick");
			...
			if(player.cor >= 90 && sheilaCorruption() >= 90) {
				outputText("\n\nYou could finish what you've started and fully corrupt the woman. Are you ready?")
				doYesNo(sheilaGoesDemon, normalEndFits);
			} else normalEndFits();

			function normalEndFits():void {
...
private function sheilaForcedOralGeneric():void {
	clearOutput();
	outputText("[sheilaname] kisses you once more, forcing her tongue into your mouth, and slides a hand into your [armor]; you stare wonderingly into her affectionate, hungry eyes at the sudden change.  It isn't until ");
	...
	outputText(".  [sheilaname] rubs the smooth slit on your [face], trying to part her labia on you, and shivers a bit when your lips brush hers.");
	...
	outputText(" and shallowly penetrate [sheilaname]'s vagina with it.");
	...
	//(else no long tongue)
		...
		outputText("\n\nYou use the increased leverage to baste her small, smooth vulva in your saliva, dragging your tongue from the bottom to the top and then scraping the broadside against her little clit as you angle it back down to search out her entrance.  \"<i>Yes...</i>\" [sheilaname] moans, wrapping herself around your head, \"<i>yes!  Oh god, rub my button harder!</i>\"");
	...
	if(player.cor >= 90 || player.cor > sheilaCorruption()) {
		...
		//[(demon/dragon tongue)
		if(player.tongue.type > Tongue.HUMAN) outputText("  As tired as you are, you simply go along with it, allowing her rippling walls to slowly draw your tip deeper inside until it bumps against her cervix; she shivers and kisses the top of your head as you groggily run your tongue over the entrance to her womb.");
		else outputText("  However, it doesn't get very far; you lazily flop it around inside her as she works through her arousal.");
		outputText("  [sheilaname] groans loudly and your vision fades; through the fog, you can swear you feel her breasts growing larger against your forehead.");
	}
	//(else PC corr < sheila corruption)
	else if(player.cor < sheilaCorruption()) {
	...
	function normalEnd():void {
		outputText("\n\n[sheilaname] twitches her last twitch and pulls apart from you slowly, ");
		//[(str < 61)
...
private function normalSheilaPregNotifNumberOne():void {
	...
	clearOutput();
	outputText("Traipsing through the grass, you can see [sheilaname] sitting under the shade of a low tree from a long way off.  The reverse is also true, as she waves to you from her seat, beckoning you over.  You make your way to her curiously.");
...
private function normalSheilaPregNotifNumberOneYepIssue():void {
	clearOutput();
	outputText("\"<i>I see,</i>\" [sheilaname] says, nonplussed.  \"<i>I'm sorry you feel that way...  Truth be told, I'm not keen myself on the idea of having a kid, but what's out is out.</i>\"");
...
private function normalSheilaPregNotifNumberOneCoolDeal():void {
	...
	if(flags[kFLAGS.SHEILA_XP] < 0) {
		...
		outputText("\n\nEarnest eyes turn on you, and you put a hand on the girl's head.  She smiles, taking your answer for granted.  \"<i>Spiffy... you're me mate, now.</i>\"  [sheilaname] cuddles a bit closer, resting her head on your chest and making you wonder just which interpretation of the word she was using.  You sit there for several minutes before she gets up and bids you goodbye with a shy glance.");
	}
	else {
		outputText("\n\n[sheilaname] sits for a while, sniffling and rubbing her nose, before she speaks again.  \"<i>Ah... something ya might like.  My captain was always as cross as a frog in a sock that I hadn't contributed more hands to the colony yet, so when I showed up with a joey and told him where it... uh, came from, he decided to extend my time on the hunting crew.  We can see each other for a good while longer before I get shuffled back to digging or soldiering - if you want to, that is.</i>\"  [sheilaname] slips an arm around you possessively.  \"<i>I wasn't sure enough to mention it before, but... if you really fancy me, I reckon I could convince him to extend it for as long as we're together.</i>\"  The woman blushes crimson.  \"<i>... So long as we keep making more.</i>\"");
...
private function normalSheilaPregNotifREPEATEDED():void {
	clearOutput();
	outputText("[sheilaname] is here as you step into the plains, with a grass-wrapped parcel of food open on her lap and her hat sitting upturned next to her, and waves you over.");
	...
	outputText("\n\n[sheilaname] slips her hand into yours");
...
private function normalSheilaPregNotifREPEATEDEDLetHerGo():void {
	...
	outputText(".  [sheilaname] smiles weakly and takes it, folding the grass around again.  \"<i>Thanks, [name].  I'll see you soon... ish.</i>\"");
...
private function normalSheilaPregNotifREPEATEDEDWalkWithHer():void {
	clearOutput();
	outputText("You pick up her forgotten hat and rise as well, carefully refolding the grass around [sheilaname]'s uneaten lunch and tucking it back into her pack for her.  She takes her hat back from you distantly.");
	...
	outputText("\n\n[sheilaname] blushes.  \"<i>Kind of you... want to stay until I can get some snares set up and find a good place to hide and lie down?  That'd be ace.</i>\"");
	
	outputText("\n\nThe woman slips her empty hand into yours again, half to lead and half for comfort, and the two of you walk solemnly through the grass for a while as [sheilaname] looks about with heavy-lidded eyes, setting down snares from her pack.");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOut():void {
	...
	outputText("\n\n\"<i>Ah, thanks mate,</i>\" [sheilaname] says.  She looks uncertain for a minute, then comes to a decision and wraps her arms around you, hugging you weakly.");
	...
	if(player.isTaur()) {
		...
		outputText("\n\n[sheilaname] stares muzzily as you jerk a thumb toward your equine half, slowly turning red as your intention penetrates her sleep-deprived psyche.");
		...
		outputText("\n\nYou break into a trot, and [sheilaname] leans her head against you, torpidly flicking her ears as she looks to one side or the other.  Occasionally she pats your side to get your attention, calling out a spot where she'd like to dismount and set up a trap, but for the most part the ride passes in silence.  You make several circuits of the plains, checking snares and adding caught animals to the bundle she slings over your back; once, you arrive at the site of a sprung trap, only to realize by the sound of [sheilaname]'s breathing that she's asleep and must have been for some time!  With a tug on her hand, you rouse the woman.");
		...
		outputText("\n\n[sheilaname] slips down from you quickly and wipes her mouth, then retrieves her catch.  \"<i>Um... really, I'm sorry,</i>\" she mumbles, fastening it to the bundle.  She rests her hand on your flank for a moment, then begins unloading you.  \"<i>This is more than enough.  Thanks.  I'll be alright now...</i>\"");
		...
		outputText("\n\nWaving off her embarrassment dismissively, you allow [sheilaname] to hug you once more and hang the game animals - and hat - around her shoulders, then leave her to head back.");
	}
	//(else naga)
	else if(player.isNaga()) {
		outputText("\n\n\"<i>Just do what you normally do and I'll think of something.</i>\"");
		
		outputText("\n\n[sheilaname] nods slowly and takes your hand, pulling you forward.  You slither alongside the woman for several minutes until she stops suddenly, putting a hand over your mouth before you can ask why.  Following her gaze, you see what caused her to pull up short: two large pheasants sit up cautiously, eyes on [sheilaname] and yourself as they prepare to bolt at the slightest sign of aggression.  The woman next to you is already cursing under her breath at losing the element of surprise.");
		
		outputText("\n\nThis is more than enough surprise for you, though.  Staring down the animals, you begin to glide slowly toward them.  [sheilaname] tries to grab your hand again, but you're already past her, closing in on the birds even as their bodies relax.  You stop around fifteen yards away, and begin undulating your body, shaping patterns even as you hold their eyes with your own.  Your coils shift to circles, then squares, then oozy triangles, over and over, as you compel the prey with your stare.  Unable to stir hand or foot without your permission, the animals come forward as you beckon until they're sitting in front of you.");
		
		outputText("\n\nA touch on your shoulder almost rouses you from your trance.  [sheilaname], beside you and beside herself with incredulity, speaks in a whisper.  \"<i>That's... it's almost like cheating, mate.</i>\"  You barely resist the urge to answer with a cliché smirk.");
	
		outputText("\n\nThe woman takes the opportunity to secure your 'catch', and the two of you move across the grasslands, quickly meeting her quota and more by working together like this.  \"<i>Well?</i>\" you ask [sheilaname], once she's loaded down with game.");
		...
		outputText("\n\nYou quirk an eyebrow at her as she affects tiredness, yawning theatrically.  \"<i>Oh no, [name], what are you doing?  Don't hypnotize me too...</i>\"  [sheilaname] breaks the embrace and sits down, laying your catch and her pack beside her, then turns a hopeful face on you.  \"<i>Not to be cheeky but... care to join me for a nap?</i>\"");
	...
	//less QQ, more pew pew
		...
		outputText("\n\nHer question cuts off when she sees you, arrow nocked on your bow, beating your wings against the ground and pushing yourself into the air.  Without so much as a how-do-you do, you ascend until you're high in the sky with the sun on your quarter.  Almost imperceptibly, [sheilaname] shrugs below you and resumes walking.");
		
		outputText("\n\nIt's not long before she points toward a small thatch of grass; at the motion of her arm a pheasant takes flight, trying to flee from her.  You pull the bow, carefully aim your shot ahead of the fleeting target, and let the arrow go.  Gravity takes it, making up for your shallow draw, and pins the bird to the ground on the first try, killing it instantly.  [sheilaname] wanders over to claim it.  This continues for several hours, your companion chasing animals from cover and your arrows finding them more often than not.  The misses you do experience give you some insight on how the slight wind plays with the trajectory, and by the time you're too tired to pull anymore, you feel like you might have gotten better.  Slowly, you allow your weary wings to return you to the ground next to your companion, who is laden with game.");
	...
	//(else spd >= 80 and Runner perk)
		...
		outputText("\n\n[sheilaname] looks at you blankly, but takes your hand and begins walking.  Or rather, more like meandering.  Her head turns listlessly as she drags you onward.");
		
		outputText("\n\n\"<i>So what are we looking for?</i>\" you ask.");
		
		outputText("\n\n[sheilaname] starts, then mumbles out her answer.  \"<i>Uh.  Whatever's useful - spoor, live animals, fresh kills... a quiet place to curl up and die...</i>\"");
		...
		outputText("\n\n[sheilaname] simply grunts at that, but sobers up a bit.  You walk together a bit longer until a rustling in the grass startles you both; a hare breaks from cover and bolts away, and your companion swears an oath at missing quarry so close to hand.");
		
		outputText("\n\n\"<i>Go that way and keep still... lay a trap or something,</i>\" you interrupt, pointing at a perpendicular to the hare's path.");
		
		outputText("\n\n[sheilaname] pulls a queer face, but complies, loping off in the indicated direction.  After stretching yourself, you break into an easy ");
		...
		outputText("\n\nThe prey, perhaps sensing something amiss, begins to jink away from the line.  To compensate, you put on an extra burst of speed, using your facility at running to draw even with it in a sprint whenever it tries to turn away, and force it back on track.  Just when it crosses the line, [sheilaname] pulls it taut, catching the hare mid-stride and sending it tumbling; you're on it before it can recover, holding it still as your partner draws closer to deliver the killing blow.");
		
		outputText("\n\n\"<i>[name], you're pretty fast,</i>\" she says, warmly.");
		
		outputText("\n\n\"<i>Race you sometime,</i>\" you reply.");
		
		outputText("\n\n[sheilaname] shakes her head, then looks at you sidelong from half-closed eyes.  \"<i>Ah... but finishing quickly isn't what matters most.  You need the endurance to keep at it all day.</i>\"  She smiles.");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOutANDWELP():void {
	...
	//[(corr <50)
	if(player.cor < 50) outputText("  You set a hand on [sheilaname]'s shoulder to steady her a bit as the tears start to fall.");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE():void {
	...
	outputText("\n\n[sheilaname] nods and looks around for a while, moping.  Suddenly, her eyes widen with wakefulness as the full import of your words hits her.  \"<i>Um... [name], you said... us?</i>\" she asks, flushing.");
	
	outputText("\n\n\"<i>Something cozy,</i>\" you affirm.");
	
	outputText("\n\n[sheilaname] smiles a bit at that, but forces her face into a stern expression.  \"<i>Usually I like a thatch of tall grass - you can beat down or dig up the middle and pull the sides in with some string so it looks normal from the air, and you can tear out of there fast if something finds you.  We'll need a big patch for two mugs... like that one,</i>\" she decides, pointing off a ways.");
	
	outputText("\n\nIt doesn't take long to arrange the grass and place yourselves inside, though there's not enough room for both of you to lie down.  [sheilaname] snuggles up to you after you ");
	...
	if(player.isGoo()) {
		...
		outputText(" give assent with little more than a broad smile.  [sheilaname] pulls her shirt over her head, revealing her " + sheilaCup() + " breasts, but raises her face to you hesitantly when her hands get to her belt.");
		outputText("\n\nYou roll your eyes skyward.  \"<i>We have kids together.  I've seen it.</i>\"");
		
		outputText("\n\n[sheilaname]'s blush deepens, but she nods and finishes undressing, pulling down her shorts and panties to expose her smooth pussy, then puts the clothing in a pile.  She turns her back to you and scoots in once more, leaving a tingle that spurs you to hold her closer when her flushed, embarrassed skin touches yours. \"<i>This feels good,</i>\" she says, \"<i>like a warm bath.</i>\"  [sheilaname] giggles nervously as you instinctively pull her naked body deeper into your own.  \"<i>H-hey, [name].  Don't swallow me, mate.</i>\"  You bubble happily as you relax around her, covering most of the exposed skin below her collarbone with a thin layer of yourself.");
		//(apply libido AND sens-based lust damage)
		dynStats("lus", player.lib/5+player.sens/3, "scale", false);
	}
	//(naga)
	else if(player.isNaga()) {
		outputText("\n\nYou wrap your tail around her as she settles in position, and [sheilaname] wriggles against it.  \"<i>This is... weird,</i>\" she says, \"<i>but not bad.  Kinda like a smooth, firm blanket.  Can you loosen a bit, mate?</i>\"  With an unseen smile, you slacken the loops around her waist and hips");
		if(player.lib >= 40) outputText(" - but tighten the one sliding across her breasts just slightly.  [sheilaname]'s neck turns red and her ears twitch as you rub her nipples, and you plant a kiss on her nape");
	...
	//(harpy - minimum score for birdlegs at least)
		...
		outputText("\n\n\"<i>Sorry, mate... your feathers are tickling me,</i>\" [sheilaname] protests.");
	...
	//(bees with boots)
		...
		outputText("\n\n[sheilaname] frowns unhappily.  \"<i>I know, mate... I'm just in a terrible mood lately.</i>\"  She slips her hand into yours and tries to rest her head on your shoulder.  \"<i>Don't let it diminish me in your eyes... I still think you're the bee's knees.</i>\"");
	...
	//(eight-legged freaks)
		...
		outputText("\n\nYou raise an eyebrow at her assumptions, and [sheilaname] turns her face downward, staring at the ground as her ears twitch furiously in embarrassment.  Resting your head against hers seems to calm her a bit.");
		
		outputText("\n\n\"<i>I'm keeping this,</i>\" [sheilaname] whispers.  And so softly you can barely hear it, adds, \"<i>It's the nicest thing someone's given me lately.</i>\"");
	...
	outputText(" flowing, unsure if you'll be able to get to sleep, but [sheilaname] has no such problems.  Within minutes, the woman is out, head nodding forward.  You suppose that means the first watch is yours... it passes slowly, despite the scenery, but eventually you nudge your partner awake when you can stay up no longer.");
	...
	if(player.cor < 60) outputText("\n\nYou nearly consider it, tired as you are, until you remember that a sleeping person's fifteen minutes are two hours in the waking world and shake her again until she gets up.");
		...
		outputText("\n\n[sheilaname]'s head jerks up instantly, looking around in panic; when no imp appears, she turns, staring daggers at you, and slaps you in the face!  \"<i>That's not funny, arsehole!  Goddammit, I thought my heart was going to jump out of my chest!</i>\"");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE2():void {
	...
	model.time.hours = 5;
	statScreenRefresh();
	outputText("Your sleep is fitful, but not totally useless, and you yawn and stir a few hours later when [sheilaname] wakes you");
	...
	if(player.lust >= 30) {
		...
		outputText("\n\n\"<i>Well,</i>\" you answer, \"<i>perhaps that's why it's called 'making' love.</i>\"  [sheilaname] doesn't answer, but smiles shyly.");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP():void {
	clearOutput();
	outputText("Wordlessly, you lift the bundle of game animals off of [sheilaname]'s shoulders and sling it over your own.  She looks up at you, confused enough to forget about her tears.  \"<i>What're you doing?</i>\"");
	
	outputText("\n\n\"<i>Come with me,</i>\" you answer simply, taking her by the hand.");
	
	outputText("\n\n[sheilaname] follows you stumblingly as you pull her along.  \"<i>Where are we going, mate?</i>\"");
	outputText("\n\n\"<i>Home.</i>\"");
	...
	outputText("\n\n\"<i>Seems... nice,</i>\" [sheilaname] says quietly, taking a seat, \"<i>but it's exposed - not to mention the big target sign.</i>\"  She looks at the portal, casting an ominous silhouette against the sky.  \"<i>I dunno about this.</i>\"");
	...
	else if(flags[kFLAGS.ANEMONE_WATCH] > 0) outputText("\n\nYou wave off [sheilaname]'s objections, pointing to the large barrel housing your skinny tenant and explaining that she watches the camp at night for you in exchange for a place to stay.  [sheilaname] looks dubious as the tall blue girl shuffles over and sits down, shyly hiding herself behind you.  \"<i>Um... hi,</i>\" the anemone mumbles.");
	//(else if PC has no night watch turned on)
	else {
		outputText("\n\nYou sagely point out that even as such, spending the night trading shifts with someone she knows in a comfortable camp with a bedroll and hot food is infinitely preferable to slapping yourself awake in a dirty hole, hungry and scared.  [sheilaname] nods, tight-lipped.  \"<i>D'you mind if I get second shift, then?</i>\" she asks, apologetically.  \"<i>I feel like you could knock me over with a feather.</i>\"  You shrug.");
	}
	
	outputText("\n\nSoon you've got a small fire lit and [sheilaname] has numbly plucked and spitted some small birds from the catch.  As she twirls them in the flames, she sighs occasionally.  ");
	//[(int >=60)]
	...
	//(if watch)
		...
		outputText("\n\nYou grin and get up, and [sheilaname] tails you to your bed.  ");
		if(flags[kFLAGS.SLEEP_WITH] != 0 && flags[kFLAGS.SLEEP_WITH] != "") outputText("She looks with some distaste at the nearby sleeper, and steps past.  You pick up the bedroll and follow her, reasoning that if she keeps her promise to be gone before dawn, it shouldn't raise any questions.  \"<i>Making friends, I see,</i>\" [sheilaname] mutters... but as you unroll the bed again, her eyes zero in on it like a drowning man's on a raft, and she says nothing else.  ");
		outputText("She lies down first, allowing you to cozy up to her as far as you dare.  Just as you're about to drift off, you feel [sheilaname] take your hand and pull your arm over her body.");
	}
...
private function sheilaGoesDemon():void {
	clearOutput();
	outputText("[sheilaname] pulls away from you, showing her back; she remains quiet for a few minutes, shivering occasionally.  By the position of her arm, she's already touching herself again!  Her elbow dances and her head rolls as she works her cunt, but she gives up.  \"<i>Nnnn...</i>\" the woman finally whispers, \"<i>... it's not enough.  I have to have another go.</i>\"  She looks around and settles on you with half-focused, wild eyes, and she stands up and advances on you with obvious intent.");
	
	outputText("\n\nYou're barely upright before [sheilaname]'s pressed up against you again; she pushes you back down insistently with strength borne of desire, staring at you.  \"<i>[name], I still can't clear my head... I need to get off again, so I've gotta use your body.  You're okay with it, yeah?</i>\"");
	
	outputText("\n\nBefore you can answer, [sheilaname] jumps on you and wraps her thighs around your face!  Her pussy is already slick with fluids, and she grinds it relentlessly against your lips.  \"<i>Fucking... lick me or something, before I go crazy!  Come on, you're ");
	...
	outputText("\n\nHer legs tense around your head, suddenly hard as all the muscles in them lock up.  [sheilaname]'s head rolls and you can feel her hot hole squeeze as her feet dig into your back; the nails on them begin to lengthen and curve, leaving several shallow gouges while she holds them close, and a small talon emerges from her heel, poking into you uncomfortably.  \"<i>Ah... ah!</i>\" she moans, convulsing to the new growth as your eyebrows knit with the pain and your attention flags.  \"<i>I'm sorry!  I'm so sorry!  I can't help it; please don't be mad!  Don't stop... I need you!</i>\"");
	
	outputText("\n\nThe woman's stubby tail thrashes wildly as she begs, leaving shed fur all over your [chest] and lashing at your hands; you grab the end, trying to restrain it, and can feel it growing a bit longer.  \"<i>My tail... don't pull my tail!</i>\" [sheilaname] pleads, pushing her cunt into you once more.  \"<i>It's driving me starkers!</i>\"  None of it is your doing, however, and the tail continues to grow - until it stops and bulges obscenely.  The end swells in your hand, growing rounded lobes that shift just under the skin as if a creature were inside.  It strains again and [sheilaname] screams in pleasure as the skin tears and her tail splits in two; one half comes away with your hand and the outer skin falls apart, sloughing off with the remainder of the fur.  Tentative exploration reveals two distinct, slender tails.  They sway under her, giving you a glimpse as she resumes pumping at your face; one is the same color as her now-hairless skin but the other is so dark-brown it's almost black - as it peeks at you, the lobes reveal themselves to be a stubby spade.  A little slit on the end drools a dark, oily fluid and it jabs at you, trying to get inside your mouth; you're forced to fend it off with one hand as you lick and suck at the cunt in front of you, trying to turn [sheilaname] to goo in your arms.");
	
	outputText("\n\n\"<i>Oh god... yes... stick it out farther, so I can hit all the good spots!  I'm almost there!</i>\" [sheilaname] says encouragingly, squeezing and massaging her breasts, strange changes already forgotten.  You try, ");
	if(player.tongue.type > Tongue.HUMAN) outputText("extending your oral muscle until it's all the way to the back of her pussy.  ");
	...
	outputText("\n\n\"<i>Really?</i>\" she calls after you, eagerly.  \"<i>Will you still make love to me next time we meet?  Because... I could go again anytime, you know?  I don't care about hunting anymore... we could just root all day!  As long as I'm with you!</i>\"  [sheilaname]'s voice cuts off abruptly as the magic of the realm brings you out of the plains and back to camp.");
...
private function demonSheilaResist():void {
	clearOutput();
	outputText("You back away from the demon and raise your [weapon] with a dour glower.  [sheilaname] purses her lips at you, then says, \"<i>Not in the mood, eh mate?  I'm so horny though... I bet I could get you into it.  Let me show you how much I love you...</i>\"  Her ears twitch furiously, belying her intentions as she");
	//[(sheila corruption < 30)
...
private function demonSheilaTalk():void {
	clearOutput();
	outputText("Questions nag at you, and you ask [sheilaname] if she wouldn't mind answering a few of them.  She struts over and ");
	//[(not horse)
...
private function askDemonSheilaAboutDahChange():void {
	...
	if(flags[kFLAGS.SHEILA_CITE] >= 1) {
		outputText("[sheilaname] blushes deeply.  \"<i>Silly.  You were there.</i>\"  She looks at you, pupils dancing as she remembers the lovemaking session that led to her current form.  \"<i>I suppose that's not what you're asking, though.</i>\"");
	...
	if(player.femininity < 50) {
		outputText("\n\nThe girl leans in and lowers her voice.  \"<i>I feel most rapt, you know, when a bloke ejaculates in me.  It feels... pure, and right, like he's admitting his purpose in life is to give me babies.  Without pretense or bullshit.  I love it, and if you come inside me, I love you too.</i>\"  [sheilaname] blushes again.  \"<i>That sounds sappy, but... would you like to be loved?</i>\"");
	}
...
private function askDemonSheilaAboutHerColony():void {
	clearOutput();
	outputText("\"<i>That place?  Do you wanna go there?</i>\"  [sheilaname] smiles duplicitously, then lifts your chin and steals a kiss before you can pull away.  \"<i>Got no qualms about showing you the way to that nest of prudes, but...</i>\"  Her eyes darken.  \"<i>There's nothing left now.  A shame you didn't insist earlier, they could have stood to learn what a ripper " + player.mf("man","woman") + " is.</i>\"");
	...
	outputText(", you ask what happened to him.  [sheilaname] smiles serenely before answering.  \"<i>Unsurprisingly, his prick was all too eager to fill me with sperm after the countless sermons he preached about it being every woman's duty to expand the clan.  He barely lasted three minutes when I climbed atop him.  Oh, that little squirt was the most satisfying one.  Watching him melt under me drove home how much power I've always had... I wish I could have known when I was just an awkward little girl, sitting through his browbeating lectures on loyalty and servitude.</i>\"");
	outputText("\n\n[sheilaname] reaches up to tug at her earring.  \"<i>This is his... the lethicite, I mean.  The remains of his mortality after he devoted himself to my pussy and became a demon.  Small, right?  I nearly laughed when I saw how piddly and meager his soul really was.</i>\"");
	...
	outputText(".  [sheilaname], peeking at you with one eye from under her bangs, interprets your expression correctly.  \"<i>Wondering where the others went, love?</i>\"  She releases her grip on your arm and holds out the hand that's not exploring your [armor], displaying several rings.  \"<i>The rings are my closest.  I kept them for sentimental reasons.  The rest, well... I ate them.</i>\"");
...
private function talkToDemonSheilaAboutWhatNow():void {
	...
	outputText("\"<i>What will I do now?  What else, my silly love?</i>\"  [sheilaname] looks out over the plains.  \"<i>I'm always hot for you.  We could have a bit of a naughty, and make each other feel good.</i>\"");
	...
	outputText(" [sheilaname] says, \"<i>I'm going to save that one for our honeymoon, instead.</i>\"  Her eyes twinkle with infatuation.  \"<i>I could even pull the taint of this land out of your body and use it to make mine more lewd for you, my " + player.mf("knight-champion","great lady") + "...</i>\"");
	...
	outputText("\n\n[sheilaname] releases your face and looks forward again.  \"<i>I want you.  I want children with you too, if you'll ");
...
private function sheilaLetHerFuckYou():void {
	clearOutput();
	outputText("The naked flesh pressed against you fills your mind with indulgent daydreams, and [sheilaname] reads them right from your distracted face as if you were a book.  \"<i>That'll be a yes, then?</i>\" she asks, playing the slitted tip of her spade along your fingers.  \"<i>Or are you going to make me use this on myself again?  I get quite lonely, you know.</i>\"");
...
private function demonImpChildren():void {
	clearOutput();
	outputText("\"<i>[name]!</i>\"  A swishing in the grass behind you is the only prelude you get to a nude [sheilaname] pressing herself against you in a hug, ");
	...
	addButton(1,"Knock Up",pregDemonSheilaKnockUp).disableIf(!player.hasCock(), "Req. a cock.");
...
private function pregDemonSheilaOtherSex():void {
	...
	if(player.hasCock()) {
		...
		outputText(", and runs her hands distractingly along the curves of her hips.  \"<i>You can do what you like with my body, love... if you can convince me.  Of course, I'll claim the same privilege!</i>\"  [sheilaname] jumps at you, leaving no doubt what kind of 'convincing' she expects to do!");
		startCombat(new Sheila());
	}
	//(if no cock)
...
private function pregDemonSheilaKnockUp():void {
	clearOutput();
	outputText("As she smears the entrance to her snatch with the slippery slime drooling out of her slitted spade, your [cock] hardens painfully.  The eye-fucking she's giving you while teasing her breasts doesn't help matters, and soon you're so erect that you have to expose your shaft just to relieve the pressure.  With the bulk of your dick bobbing free of your [armor], [sheilaname] waggles her eyebrows at you.  \"<i>So... yes?</i>\"");
	sceneHunter.selectFitNofit(missionaryForThePurposesOfCreatingImpsWithSheila, bigDickAndThighs, 56);
}
...
internal function loseToSheila(consensual:Boolean = false):void {
	...
	if(player.HP < 1 && !consensual) {
		...
		if(player.gender == 0)
			aintGotNoGenderAndKangarooRaped();
		else sceneHunter.selectLossMenu([
				[0, "UseDick", loseToNormalSheilaAndGetRidden, "Req. a cock fitting 56 area.", player.cockThatFits(56) >= 0],
				[1, "BigDick", tailSpadeSoundingForFuckHugeDongsWithDemonSheila, "Req. a cock with area bigger than 56.", player.findCock(1, 56, -1) >= 0],
				[2, "PussyFun", clitSwellingDemonSheilaClitSoundingAnal, "Req. a vagina", player.hasVagina()],
			],
			"Your erstwhile opponent's eyes glimmer with excitement as you collapse from your overwhelming desire, and she runs over to you. Not so much time to decide what to do... but maybe asking may still work?\n\n"
		);
	}
}
...
private function loseToNormalSheilaAndGetRidden():void {
	clearOutput();
	outputText("[sheilaname] pushes you onto the ground");
	...
	outputText("She wraps her hand around it and begins pumping up and down, squeezing out a drop of precum that she smears onto her palm.  \"<i>You're so eager,</i>\" [sheilaname] giggles.  \"<i>Are you already about to burst?  That's no good... I wanted to play a bit more.</i>\"");
	...
	outputText("\n\n[sheilaname] grins viciously and sinks down on your [cockFit 56], sliding it into her pussy at a painstaking pace");
	//[(multi)
	...
	if(player.hasBalls()) {
		...
		//(not horse)
		if(!player.isTaur()) outputText("  [sheilaname] takes your face in her hands and presses it into her breasts as she reassures you.");
		...
		outputText("\n\nAs if you could help it at this point... your [cockFit 56] fills her pussy with thick spunk and the pressure begins forcing it into her womb; as [sheilaname]'s mouth hangs open in awe, your balls shift upwards again and a second orgasm begins!  You force her down to the base of your cock using your ");
	...
	//(else if no balls)
		...
		outputText("\n\n\"<i>Oi, [name],</i>\" [sheilaname] says, pausing now that she's reached the base of your [cockFit 56].  You look up at her, waiting for the other shoe to drop.  \"<i>Where do you suppose your seed comes from?</i>\"");
		outputText("\n\n\"<i>... What?</i>\" you ask.");
		...
		outputText("\n\n[sheilaname]'s eyes twinkle mischievously.  \"<i>I will when I see him, love.  In the meanwhile, you get all the benefits of my misplaced affection.</i>\"  She descends your cock again, shifting her hips to rub you against a different side of her pussy.  \"<i>I notice our little conversation kept you from shooting your wad too early, like a virgin...</i>\"");
		
		//corr fork
		//[(corr < 70)]
		if(player.cor < 70) {
			outputText("\n\nYou stiffen in embarrassment.  [sheilaname] smiles and plants a kiss on your " + player.skinFurScales() + ", then looks at you innocently.  \"<i>Don't be mad, mate.  I just wanted our time together to last.</i>\"");
			outputText("\n\n\"<i>Is that so?</i>\" you reply, beginning to fuck the demon harder to make up the arousal she frittered away.  [sheilaname] moans as you work your [cockFit 56] into her hole vigorously, dragging it against the entrance and smearing your intermingled fluids on her groin.");
		...
		//(else)
			...
			outputText("\n\n[sheilaname] kneads her breasts as you berate her and batter her cunt.  \"<i>Haha... is that what you want your woman for?  To suck the spunk from your fat dick and then bring you dinner?  I can do that... though I don't promise to not jerk my tail off over your food.  I get mean if I don't come every day.</i>\"");
		}
		//end corr fork
...
private function tailSpadeSoundingForFuckHugeDongsWithDemonSheila():void {
	clearOutput();
	outputText("The demon opens your [armor] and undresses you, inspecting your crotch.  \"<i>Going a bit overboard, aren't you, [name]?</i>\" she taunts, rubbing your [cock biggest] with her knee.  \"<i>I'm not quite magical enough to take this monster - maybe after a few months of fucking everything I met, I'd be that loose.</i>\"  [sheilaname] giggles at you.");
	...
	outputText("\n\n[sheilaname] takes a half-step forward and bends over, letting your dick out from between her legs; her brown tail catches it, lassoing the shaft just behind the crown.  The smooth skin feels quite nice, and [sheilaname] looks over her shoulder at you.  \"<i>Enjoying the view?</i>\" she asks, shaking her round ass and swinging your [cock biggest] side to side with it.  Another drop of precum answers her.");
	
	outputText("\n\n\"<i>Hold on tight,</i>\" she warns.  Before you can ask what she means, [sheilaname] raises her black spade to the tip of your dick, smearing its oozing secretions onto your slit.  It burns a lot; all you can do is bite your lip and not call out.  Carefully watching your expression, the demon presses her spade insistently into the exit of your urethra, working it wider and inundating your [cockHead biggest] with her dark oils.  You can feel it nearly penetrating you now - [sheilaname] shivers and squeezes her breasts as the widest part of the spade slips into your hole.  As soon as it passes the ring, she smiles wickedly.  \"<i>Here it comes!</i>\"");
...
private function clitSwellingDemonSheilaClitSoundingAnal():void {
	clearOutput();
	//(no horse)
	if(!player.isTaur()) outputText("[sheilaname] places her hand in the small of your back and leans in, drawing closer to your face even as she pulls your waist inward.");
	else outputText("[sheilaname] sets her hand atop your withers, pressing down gently as she looks into your eyes.");
	...
	outputText("\n\nBefogged but still reserved, you nonetheless allow [sheilaname] to lower you to the grass and remove your [armor].  She ");
	//[(not horse)
	...
	outputText("\n\nThe burning has tapered off near the end of your clitoris, now more properly a lever than a button; only the base still tingles with the barely-bearable sensation that you realize to be new growth.  \"<i>Bloody hell, [name],</i>\" [sheilaname] calls, forcing her elbows to straighten under her again.  \"<i>If you get much thicker, you'll split me off another tail.</i>\"  Your mouth only opens dumbly at this.");

	sceneHunter.print("Fork: clit size, more or less 6\"?");
	...
	if(player.clitLength <= 6) {
		...
		outputText(".  \"<i>Ffuck, even your girl parts are amazing.</i>\"  [sheilaname] plants kiss after kiss on your ");
		...
		if(player.cor < 50) {
			...
			outputText(", and your clit swells even further inside your tormented partner.  [sheilaname] groans, \"<i>Fuck you, [name]...</i>\"");
	...
	//(else if clit >6" initially)
		...
		outputText("  Suddenly she stops mid-stroke as her asshole quivers, sending shivers up your orgasm-sensitized clitoris.  \"<i>Fffuck!  So soon!  I'm coming too, [name]!</i>\"  [sheilaname] sinks down, burying your " + clitDescript() + " into her asshole.");
		//(clit>12")
		if(player.clitLength <= 12) {
			...
			outputText("  Buried in your pussy, the spade begins drooling its black fluids in greater and greater volume as [sheilaname] is wracked by her orgasm.");
		}
		
		//(PC corr<50)
		if(player.cor < 50) {
			outputText("  The demon's pussy gushes and pours with unnatural levels of fluids, soaking your crotch as a miniature cataract makes its way out of her lower lips.  [sheilaname] spills herself onto you for at least a minute, producing more hot fluid than you thought possible, until she looks utterly dehydrated - even her breasts seem to be smaller and less jiggly.");
		}
		...
		outputText("\n\n\"<i>Ahh, [name],</i>\" [sheilaname] says, after a minute to recover.  \"<i>It feels good in my butt.</i>\"  Slowly, she pulls apart from you, letting your clit out of her backdoor at an agonizing pace, and stands up.");
...
private function aintGotNoGenderAndKangarooRaped():void {
	clearOutput();
	outputText("[sheilaname] sashays over to you and brazenly sticks her hand in your featureless crotch.  \"<i>It's too bad you've mutilated yourself like this, love... or did you do it just to tease me?  You know, it doesn't bug me that much.</i>\"");
	...
	outputText("\n\n\"<i>Or would you rather be the sheila?  I'd be a bit of a possessive bloke, though; keep you knocked up at home so you couldn't get away from me.</i>\"  Shaking your head at her presumptuousness doesn't seem to interrupt her daydream.  [sheilaname] places her hand on your forehead and looks into your eyes.");
	
	outputText("\n\n\"<i>Hah,</i>\" she says as her irises flare with lavender light, \"<i>you don't have to decide right now.  Just think it over; you could even be both.</i>\"  An odd fantasy washes through your mind as she stares, one of [sheilaname] tucking your penis into your own vagina and pouring vial after vial into you, forcing you to come inside yourself every time a draft pushes you to your peak.  The sadistic quality of the vision she's sending suggests that she's not nearly as laid-back about being unable to play with you right now as she's affecting to be, and you can feel your body heating up as cock after chemically-granted cock sprouts on you and is shoved inside your cunt by your demon captor.  Suddenly, the demon blinks and the fantasy is suspended; she's lowered you to the ground while you were lost in her daydream, and plants a chaste kiss on your lips before pulling away.");
...
internal function beatUpDemonSheila(output:Boolean = true):void {
	if(output) {
		clearOutput();
		outputText("\"<i>Ahh, you win, mate.  I give up.</i>\"  [sheilaname] slumps to the ground, ");
	...
	menu();
	addButton(0, "Missionary", missionaryForThePurposesOfCreatingImpsWithSheila)
		.disableIf(player.cockThatFits(56) < 0, "Req. a cock fitting 56 area.");
	addButton(1, "AnalHateFuck", analHateFuck)
		.disableIf(player.cockThatFits(56) < 0, "Req. a cock fitting 56 area.");
	addButton(2, "UseHerThighs", bigDickAndThighs)
		.disableIf(player.findCock(1, 56, -1) < 0, "Req. a cock with area larger than 56.");
	addButton(3, "Clit-Fuck", winAgainstDemoNSheilaForVaginas)
		.disableIf(!player.hasVagina(), "Req. a vagina.");
}
...
private function missionaryForThePurposesOfCreatingImpsWithSheila():void {
	clearOutput();
	outputText("You unfasten your [armor] and strip down completely, as [sheilaname]'s eyes drink up your bare flesh.  Denuded, you caress your cock with several strokes, producing a drop of precum.");
	
	outputText("\n\n\"<i>Oh my, are you going to force that slimy thing into my little flower?  How awful!</i>\" [sheilaname] shrieks, throwing an arm across her forehead and swooning.  ");
	...
	outputText(", pouring your semen into [sheilaname]'s ravenous pussy");
	...
	outputText("\n\nDid this bitch just...  [sheilaname] breaks into a wide grin as your eyes pop out.  \"<i>Kidding, mate!  Stay cool!  ");
	//[(RNG decides if scene ends here, bias toward short scene)
	if(rand(10) <= 6) {
		outputText("I used a bit of power to help you finish.  Don't hate me for it; your orgasm face is just so cute when you're giving up your seed to me.</i>\"  The woman places her hand on her stomach, below her navel.  \"<i>Thank you for this.  I hope it takes, so I can raise a big strong imp to be just as " + player.mf("productive as his father","sexy as his mother") + ".</i>\"  She kisses you softly again, and you roll off with a groan.  \"<i>Your sperm are the best,</i>\" [sheilaname] whispers, \"<i>so come see me again soon.  I'll be wantin' more.</i>\"  Your demon stands up and winks at you, then walks off, tails swishing happily as a trickle of white runs down the brown skin of her naked thigh.");
		//(end scene)
		player.sexReward("vaginalFluids", "Dick");
		sheilaPreg();
	...
	//(else if RNG doesn't end scene)
		...
		outputText("I gave you a little push, because I wanted your semen inside me so bad... but we could keep going, if you like?  Look into my eyes, lover, and see how much I still need you.</i>\"  Spent by climax as you are, you can't really focus elsewhere, and stare dully at the girl under you.  A slow smile spreads across her face, as her eyes glitter and a picture forms in your mind: one of you fucking [sheilaname] over and over, pumping abnormally-enhanced levels of jizz into her pussy every day");
		//(if vag)
		...
		outputText(", you look away and break the connection, but [sheilaname]'s smile only widens.");
		...
		outputText("\n\nIt's too much.  ");
		if(!player.isTaur()) outputText("You kiss [sheilaname] on the lips, pushing your tongue through to play with hers, as your arms push your spent body into position to thrust again.");
		else outputText("You reach down with a hand and place it alongside [sheilaname]'s face; her ear twitches as she looks at you brightly, and for a moment you recapture your earlier impression of her as a sweet, devoted lover.  Your legs struggle to push your equine bulk upwards as you return to a thrusting position, dragging her groin into the air by your erect cock.");
		outputText("  The girl giggles as you slide your dick partway out, pulling some of your deposited jizz with it to dribble ticklishly from her and down her butt to the ground.  \"<i>That feels good... pump me again.  Remind me whose woman I am; remind me what you've left in my pussy!</i>\"  You slide in and out, at your leisure this time, feeling none of the compulsion she used on you before.  Her wet, semen-drooling sex starts to heat up around you, and the slick ease with which you can thrust into it begins to tell on your pace; soon you're sawing into [sheilaname] with the vigor you managed briefly before, under her power.");
		...
		outputText("\n\n\"<i>Oh, <b>[name]</b>!  Come with me!</i>\" [sheilaname] screams, as she wraps her body around you again and a foreign wave of arousal washes over you.  ");
		//[(PC corr <50)
		...
		if(player.cor < 50) {
			dynStats("cor", 10);
			if (flags[kFLAGS.SHEILA_CORRUPTION] > 100) sheilaCorruption(-10);
		}
		else {
			dynStats("cor", -10);
			sheilaCorruption(10);
...
private function analHateFuck():void {
	...
	else sceneHunter.print("It's a shame you don't have the corrupted mouse-monk in your camp...");
}
...
private function sheilaAnalHateFuckAGoGo():void {
	...
	outputText("\n\n\"<i>Ahh!  Stop!  You're going to tear me open!</i>\"  Even her tails flex against you, desperate to force you back out, but the feeling is too amazing to let that happen.  Instead, you push harder.  [sheilaname]'s arms collapse, dropping her torso to the grass");
	...
	outputText("\n\n\"<i>[name], stop playing!  I need you to fuck me, not fuck with me!</i>\" [sheilaname] shouts, trying to get her legs under her to continue the sex with just her own hips.");
	...
	outputText("\n\n\"<i>Ahh, no!  I really do like you!</i>\" [sheilaname] says, panicking.  \"<i>You're my favorite bloke, promise!  Just... keep going!  I need this!</i>\"");
	
	outputText("\n\nWords, words, words.  You start pumping again, teasing her asshole; the woman shifts her hips and rubs against your crotch gratuitously as you do, giving you the benefit of seeing her pleasure so you won't stop thrusting.  \"<i>Decided to finally shut up, I see,</i>\" you taunt.  [sheilaname] says nothing in reply, though her cheeks tingle and flush with shame.  With her mouth finally quiet, you actually manage to get into the fuck, rubbing your dick against her hot insides.  Your head leans back as you feel your orgasm creeping closer, and [sheilaname] notices, staring at you out of the corner of her eye.");
...
private function sheilaAnalHateFuckAGoGoNO():void {
	...
	if(player.cumQ() >= 500) outputText("  Your overproduction floods her insides, and [sheilaname] groans as it begins to leak back out, drooling over her pussy.  \"<i>Hey, you got your wish,</i>\" you tease.  The wanton woman tries to tilt her ass higher, to tip more of your overflow into her cunt, but you laugh and slap her hard on the hip, sending her to one knee again.");
	
	outputText("\n\n\"<i>Fucking... bastard,</i>\" [sheilaname] groans, as you pull your spent [cockFit 56] from her with a sucking noise.  Her tails droop over her abused hole, parting the ");
...
private function sheilaAnalHateFuckAGoGoGETYOUSOMEWORMS():void {
	...
	outputText("\n\n\"<i>You do!  God, you do, mate!  Your donger belongs in my pussy!</i>\"  [sheilaname] rubs her cunt against your wet prick, trying to coax you.");
	...
	outputText("\n\n[sheilaname] shivers as your dick erupts, packing her cunt with sperm and parasites.  \"<i>God, yes!  Stuff me!  I'm coming, [name]!  I'll take in all your anger and hate; let it all out!  I'm your bitch!</i>\"  Oh, indeed.  The demon screams, and her pussy begins lapping at your shaft, pulling in more of the tainted mix; your body obliges by sending up another load, filling her so full of slithering infestations that worms begin to poke out from between her labia.  \"<i>Ah!  Ah!  A-uh...</i>\"  [sheilaname] stops moving and clutches her stomach, a blank look pasted across her face as her vagina convulses around you in orgasm.  A particularly large bulge ascends your [cockFit 56], and your slit stretches wide when all of the fattest worms jump ship at once and are drawn into the woman in an unbroken string, rendering you clearheaded.  As you empty yourself and pull free of the squirming, slimy mess in her vagina, your body is left without a single parasite - not a twitch can be felt.");
	
	outputText("\n\nThe demon rolls over slowly and sits up, then looks up at you, head cocked slightly to the side and mouth trying to shape words.  \"<i>W-wuuu...</i>\"  She reaches down and picks up a handful of the wriggling, jizz-soaked worms oozing from her pussy, examines them, and then holds them out to you as an offering.  You shake your head and she drops them negligently, then zeroes in on your drooling, stretched dickhole.  [sheilaname] leans in so close that she's staring into it, then begins to slip a finger down your urethra.  You flinch at the sensation and pull away, and she pouts and reaches for it again.  The proffered worms, meanwhile, actually slither back toward her, smearing jizz and slime on her thighs, migrating to her crotch and then wandering around aimlessly on the bare skin, as if confused by her lack of a penis.  Her leaking spade stretches out to them absently, and some of the wandering worms curiously slip inside, producing another shiver.");
	
	outputText("\n\n\"<i>Mmm...</i>\" she hums, reaching eagerly for your [cockHeadFit 56] with her finger as if getting it inside were the only thing that mattered.  You back up again, and she crawls over and onto you, rubbing her slimy cunt against your [legs].  Her strokes trigger a small orgasm in her, and as her pussy sprays a load of worms onto your " + player.skinFurScales() + " she kisses you affectionately, looking right into your eyes; you're flooded with nebulous mental images of fucking a slender, sickly pale [sheilaname] as both of you are covered and hidden from the sunlight by a massive colony, of her riding you with her slithering, wormy pussy until the semen spitting from your [cockFit 56] leads the parasites within right to your slit, and, most disturbingly, of [sheilaname] stretching your slick urethra wide open and climbing into your penis herself!  Shaking it off, you quickly break contact, pick up your stuff, and depart, leaving the infested woman behind... but the visions don't go away.");
...
private function analHateFucksWithJojo():void {
	...
	outputText("\n\n\"<i>Slave, today you are going to demonstrate how to </i>properly<i> obey your proven superior.  Your humility and loyalty will be an object lesson to your delinquent partner.</i>\"  Turning your head slightly, you stare daggers at [sheilaname]; she smiles coyly, eyes twinkling with interest at this development.  Oh, she doesn't understand you yet... but she will.  \"<i>Sit down behind her, Jojo.</i>\"");
	
	outputText("\n\nYour little mouse pliantly seats himself on the grass to the rear of [sheilaname], then scoots forward until his throbbing prick is pressing against her lower back.  The demon shivers in anticipation as the glaze of precum smears along her spine, and you can see her tails wreathing the monk's rod.  His face pinches as she attempts to wring his cock out, but he still checks to make sure he has followed orders.  \"<i>M-[master], is this.. ok?</i>\"");
	
	outputText("\n\n\"<i>Yes, very good.  Now, place your hands on her ass and lift her into position above your dick.</i>\"");
	outputText("\n\nJojo does so, relieved as her tails release his pecker and the woman leans forward to angle her pussy toward him welcomingly, then uses one of his hands to aim himself toward her crotch.  You bend down to [sheilaname]'s face, taking her chin in one hand.  \"<i>Now, supplicate yourself to your [master].</i>\"");
	
	outputText("\n\n\"<i>Haha...</i>\"  [sheilaname] composes her expression into one of mock-gravity, and recites, \"<i>Please, [master], may I have your minion's semen in my pussy, to make you a baby?</i>\"  Her eyes are fairly lit at the prospect; it's evident she regards this as no more than a game.");
	...
	outputText("\n\n\"<i>You are disgraceful!</i>\" you shout.  Stunned by the sudden violence, [sheilaname] doesn't move; Jojo takes the opportunity presented to start working his prick in her butthole.  Grabbing and twisting one of her long ears, you begin haranguing the demon.  \"<i>Look at yourself; what about you is satisfactory?  Do you call this dirty mop on your head hair?  When's the last time you washed?  You're not even cute; I could throw a stone anywhere and find a face like yours!</i>\"  You release her ear and squeeze her breast callously.  ");
	...
	outputText("\n\nHer face fills with defiant bitterness as she digests this last statement, looking at the ground.  \"<i>Please... [master],</i>\" she says, finally, \"<i>will you have your slave cum in my unworthy pussy instead?</i>\"  She's still obviously resisting the lesson.");
	...
	if(player.cor >= 80 - player.corruptionTolerance) {
		...
		sceneHunter.print("Check failed: not enough corruption.");
...
private function jojoRuinsTheAnalHateFuck(clear:Boolean = true):void {
	...
	outputText("\n\nJojo raises his eyebrows at that, but quietly pops his oozing prick out and rubs the slimy precum off against the demon's thighs.  [sheilaname], meanwhile, is busily trying to stimulate her pussy juice; you grab her hand and pull it away.  \"<i>A proper slave won't always have the luxury of a free hand.  Your body will have to learn on its own!</i>\"");
	
	outputText("\n\nThe mouse jams his dry penis into her cunt as if to punctuate your statement, and [sheilaname] winces as it slides home.  \"<i>Ah...!  That's too much, mate!</i>\"  Ignoring her protest, you catch Jojo's eye and nod slightly.  He begins pumping at the tense woman, gritting his teeth at the friction of flesh-on-flesh.  You pull his tail taut, then wrap it tightly around his shaft to stifle his copious pre-cum.");
	
	outputText("\n\n\"<i>Too rough!</i>\" [sheilaname] whines.  \"<i>I'll never get wet if I can't enjoy it a little!</i>\"");
	...
	outputText("\n\n\"<i>I lied.  I'll never let shit like you have a baby while I'm around.</i>\"  [sheilaname]'s eyes widen at your dangerously gentle tone as her nerves fire, starting her climax.  \"<i>You are a piece of self-indulgent trash who doesn't deserve to breed.  You spout high-sounding garbage from your mouth, while all the while taking any cock that can still get hard for your ruined body - you'd fuck a dog, as long as he listened to your bullshit.  I don't love you.  I don't know how anyone could.  You would have been better off living in a hole, covered in dirt.  You are... literally... the worst woman I know.</i>\"  Her mouth hangs open and her pussy gushes torrentially, grief preventing her from regulating it into releasing only a bit of her emotion into Jojo; he starts to weep into her back as the wave of [sheilaname]'s anguish and arousal hits him, though his cock still spasms out his first useless, empty orgasm in response.");
	
	outputText("\n\n[sheilaname] begins to cry now as well, twitching and shivering as her demon body dumps taint and unwanted feeling into your slave.  His balls swell, as does his cock; you can see it thickening as the juices soak and sink into it.  A pair of small points emerge from under [sheilaname]'s arms as the corruption forces demonic horns into existence on Jojo's skull, then curl upward and over her shoulders");
	...
	outputText("he ex-monk's testicles swell again, to the size of basketballs, and his sack slips from your grip as the skin on it peels - your hand comes away with nothing more than a crumbling patch.  Finally free to come, Jojo's scrotum jerks upward and veins bulge on his cock as he begins ejaculating.  [sheilaname]'s eyes roll back in her head as Jojo dumps his semen directly into her womb, his recently engorged balls producing far more than their normal share.  With nowhere for the cum to go, her stomach stretches far and away past its normal volume, worrying you slightly.  A bump actually forms in Jojo's cock as she fills, and slowly starts to make its way upward; the ex-monk groans and thrashes as it gets stuck at the entrance to [sheilaname]'s pussy, which tightens like a vice around his ridiculously-expanded member.  He howls and tries to tilt his head, but only succeeds in jerking [sheilaname] a bit higher on his cock with his new horns.  Reaching down to help, you can actually feel something hard through the erect flesh of his prick, and you gently coax and push it upward with your hands until it slips into the vagina.");
	
	outputText("\n\nHaving ejected this last lump, Jojo relaxes, falling backwards and pulling the swollen woman with him.  You blink in surprise as he stretches out; he's at least eight feet tall now and even makes [sheilaname] look small by comparison.  The latter's face assumes a more normal mien as the reclining monk and the deflating shaft finally pull the head free from her cervix, and her hands dart to her rounded belly.  \"<i>Ohh, god... too much cum...</i>\"  A slow trickle begins to leak out around Jojo's cock from her pushes.  As the oozing slime coats his crotch, he begins panting again, and the flow cuts off as he hardens once more.  Realizing her predicament for the first time, [sheilaname] begins struggling against Jojo's horns, trying to pull her nearly-flat chest free from the bony harness, though there's not enough room to move.  Still, her thrashing must be irritating the former monk; he reaches up with two huge hands to grab and steady her hips, then begins thrusting again, squeezing leisurely splats of semen out of the stuffed pussy.  [sheilaname]'s face pinches as the head once again presses up to her cervix, and you peer under the tensing woman at your ex-mouse.  What greets you are not the meek, pliant eyes of your slave, but the hard, covetous eyes of a demon.");
	
	outputText("\n\n\"<i>Well then,</i>\" you announce.  \"<i>I'm pleased to preside over the union of these two in holy matrimony.  I now pronounce you cum and dumpster.</i>\"  Leaning over [sheilaname], you whisper, \"<i>Maybe, if you're a good enough wife, you might even be able to squeeze out a baby.  You'll have to be obedient and clever to keep your new husband from just pounding you twenty-four hours a day in revenge and never even pulling out...  but even if he doesn't, you'll be okay with that, right?  After all, fucking is what you're meant for.</i>\"");
...
private function bigDickAndThighs():void {
	clearOutput();
	outputText("As [sheilaname] diddles herself, you ");
	//[(not horse)
	if(!player.isTaur()) {
	...
	function noF():void {
		...
		outputText("\n\n\"<i>I'm going to borrow a bit of your sensation...</i>\" [sheilaname] announces quietly.  ");
		...
		outputText("\n\n\"<i>You're a bit of a quick shot, I think,</i>\" you rejoin.  [sheilaname] smiles wickedly");
		if(player.isTaur()) outputText(", unseen");
		outputText(".");
		
		outputText("\n\n\"<i>We'll see who finishes first.</i>\"  Resting herself against your [cocks] for support, she brings her other hand up and touches you; almost the full sensation is there this time, and you sign in happiness.  [sheilaname] begins stroking with the new hand as well as the old, grabbing ");
	...
	//(else corr >= 40)
	function yesF():void {
		outputText("\n\nThe fuck does it matter?  She's a demon.  You set your face and advance, and [sheilaname] turns over with a grimace, raising her ass in the air.  \"<i>Just... go slowly so I can stretch,</i>\" she insists.");
		
		outputText("\n\nPfft.  You angle your [cock biggest] toward her vagina and thrust, heedless of the woman's pleasure.  She tries to focus and spread her pussy open; indeed you can see it widen several inches before you mercilessly slam your [cockHead biggest] into it.  [sheilaname] gasps, then grits her teeth as you batter her entrance, demanding entry but being denied at each push.");
		
		outputText("\n\n\"<i>Useless,</i>\" you gripe.  \"<i>What kind of sex demon can't even open up her pussy?</i>\"");
		
		outputText("\n\n\"<i>Goddamnit, [name]; I'm trying, but it's bloody hard yakka with you touching all my fucking nerves and setting me off,</i>\" she fires back, shaking while you twist and roll your [cockHead biggest] inside her hot, stretched hole, smearing it with slippery precum.  Her tails hang down and wrap around your shaft, trying to hold it still; defiantly, you push and shift your hips harder.  Elbows buckling, [sheilaname] drops to the ground.  Her head hangs in defeat as you smugly torment her vulnerable womanhood.  \"<i>Nnnn... fuck...</i>\"");
		...
		outputText("[sheilaname] scoots backward, choking up on monster cock until her ass is pressed against your crotch, and then wraps her hands around and begins to masturbate you, using your drooling fluid and her own wetness for lubrication.");
	...
	function sharedEnd():void {
		...
		if (player.cockTotal() > 1) outputText("s");
		outputText(" and teasing each one; you thrust weakly into her hand, helping guide her hands, but your lonely tip wants for stimulation.  As the feeling becomes so acute that you prepare to say something, [sheilaname] uncannily anticipates you and scoots her pussy along your shaft, popping your [cockHead biggest] into her mouth.  Her tongue dabs at your slit, tasting your fluid, and her hands ");
		...
		outputText("focus on squeezing more drops out of you.  She fairly coats her lips with it, rubbing your hole against them before popping the whole [cockHead biggest] back into her mouth.  A moan escapes you just as another one returns from [sheilaname]'s throat, transmitted through your [cock biggest].");
		...
		//[(sheila corruption < 50)
		if (sheilaCorruption() < 50) outputText("  Though her modest breasts can't even begin to encompass your girth, [sheilaname] rubs her cleavage along your skin with gusto while she works your tip with her tongue.");
		...
		if (player.cockTotal() > 1) outputText("s");
		outputText(" through the vise of her legs; losing yourself further and further to pleasure, you don't even notice when [sheilaname]'s hips begin to buck in time with your own, pressing her mons down against your ");
		...
		if (player.cor < 50) outputText("The sensation seems to reawaken [sheilaname]; she angles her body up to press her pussy close and your embezzled sensation floods back into you - along with an unexpected gift.  You can feel your... no, <i>her</i> demonic pussy convulsing repeatedly, trying to suck up sperm in vain as her own orgasm comes off, and she looks at you with sly eyes.  \"<i>A little reciprocity for my love,</i>\" the woman coos, \"<i>to show you how much I care.</i>\"");
		else outputText("\"<i>Oh god!</i>\" [sheilaname] shrieks.  \"<i>I'm coming!  Jizz is going everywhere!</i>\"  Indeed, as your body releases streams of cum, [sheilaname] directs them by aiming " + sMultiCockDesc() + ", covering herself and moaning as her hands press out as much as possible.");

		outputText("\n\nFinished, you pull your sensitive, soaked shaft");
		if (player.cockTotal() > 1) outputText("s");
		outputText(" from between her still-squeezing thighs with a shudder; [sheilaname] shudders with you until you finally draw free and break skin contact, then lowers herself carefully to the ground.  The demon turns toward you, exposing a face and chest splattered with your semen.  She stares at your deflating prick");
		if (player.cockTotal() > 1) outputText("s");
		...
		outputText("\n\n[sheilaname] giggles at that and raises her eyes, meeting your gaze.  \"<i>But it's only yours I love, [name].  I might take it off you as long as you promise ");
...
private function winAgainstDemoNSheilaForVaginas():void {
	...
	outputText(" to present your eager [vagina].  [sheilaname] sits up and places her hands on your [hips], then slides her pelvis up, teasing your lower lips with something bulbous and warm.  They sting slightly as it smears its slime along them, a not-entirely-pleasant sensation.");
	...
	outputText("  Oh, god, it burns!  You shake violently as your pussy is assaulted by the fluid from [sheilaname]'s black tail, waves of pain twisting through it and forcing its walls to clamp down on the invader.  The demon gasps as you squeeze and leans forward onto your back");
	if(sheilaCorruption() > 0) outputText(", squashing her tits into you");
	outputText(".  \"<i>Calm down!</i>\" she barks, grabbing your arms and pulling them toward her.  With hands held behind you like this, you can do little to check her enthusiasm... but [sheilaname] doesn't begin thrusting yet.  \"<i>It'll fade soon, love, and you'll start feeling it,</i>\" she promises, kissing your ");
	...
	outputText("\n\n\"<i>Here it comes,</i>\" [sheilaname] assures you.  The trickle intensifies as more of her secretion is pushed from you, and miraculously the pain seems to lessen as it comes out, landing with soft 'pat' sounds.  Your confusion must be written on your face, as [sheilaname] leans in conspiratorially.  \"<i>That's not me doing it anymore, love.  It's you.</i>\"  To demonstrate, she pulls free of you - and the soft sounds of liquid hitting the ground only multiply!  She slides her hand in front of your pussy, cupping you gently, then pulls it away and holds it in front of your face.  It's overflowing with clear, female juices.  \"<i>Look how wet you are, my little whore,</i>\" [sheilaname] says, spreading her fingers and letting the girl-lube trickle between them.  As you process this, she rests herself on your [butt] and slips her black, spaded tail into you again; the passage is easy and marked with none of the discomfort from before, only a pleasant heat that sets your heart racing.");
	...
	outputText("\n\n\"<i>I'd visit you every day and spread you open; you'd drool your puddle on the ground, ready for me, and I'd rub my dong as you played with yourself, putting on a nice show... and then, when I couldn't stand it anymore,</i>\" [sheilaname] whispers, breathlessly, \"<i>I'd climb on top of you, and I'd root you silly... like <b>this!</b></i>\"  The woman slides her hands up to seize your waist and begins reaming you, pounding your cunt with her tail so hard that the patters of fluid change to waves, silent for a second on the in-stroke and then splashing out all at once as the bulbous tip pulls back.  Your tongue lolls from your mouth as you roll your head, and [sheilaname] takes the opportunity to grab a handful of your hair.  \"<i>Does that sound good, bitch?</i>\" she demands, yanking your head back.  \"<i>Do you want to be my sperm dumpster?  Do you want me to force myself into you and fill you with my jizz, day after day, whenever I damn well feel like it?  To come in you and tell you I love you and then leave you until I'm horny again, like a man?  Do you want to birth my babies one after the other, to make a swarm of imps to fill the sky and stain the world with our colors?</i>\"");
	
	outputText("\n\nYour [vagina] convulses in climax at the thought of being so debased - ");
	//[(lib <20)
	if(player.lib < 20) outputText("even as proud as you are, ");
	outputText("there's something appealing about the picture, something powerful in being cherished and used in equal measure.  [sheilaname] screams and releases your hair, digging her fingers into your hips, spraying the inside of your pussy with a thick, oozing heat that spreads out and then dulls as your own pouring juices force her cum out.  Peering between your legs, you can see it falling to the ground; viscous black sludge that bubbles and steams as if it were trying to reach back up to your sex.");
	if(player.cor < 50) {
		...
		outputText(".  [sheilaname] howls to the sky as she pours her demonic slime into you in one final, solid stream.  You can feel it pushing eagerly through even your copious fluids until it's at the entrance to your womb... and then inside.");

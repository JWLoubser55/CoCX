...
public final class ShieldLib extends ItemConstants
	{
		...
		public const AMBSHLD:DynamicShield = ItemTemplateLib.instance.createShield("ambershield", ItemConstants.RARITY_COMMON, 0, ItemConstants.CS_KNOWN_UNCURSED, []);
		...
		public const MABRACE:Shield = new Shield("MaBrace", "ManaBracer", "mana bracer", "a mana bracer", 2, 200,
				"Runed bracers such as this are popular amongst mages that can afford them. This silver bracer augments a mage’s spell power while leaving their hand open to making gestures used in spellcasting.",
		...
		public const PRIDWEN:Pridwen = new Pridwen();

...
public class MightyLegsMutation extends IMutationPerkType
    {
		public static const MNAME:String = "Mighty Legs";
        ...
        override public function pReqs(pCheck:int = -1):void{
            try{
                ...
                if (pTier == 0){
                    ...
                    .requireAnyRace(Races.KANGAROO, Races.BUNNY, Races.EASTERBUNNY, Races.LAQUINE, Races.HORSE, Races.CENTAUR, Races.COW, Races.MINOTAUR, Races.JABBERWOCKY, Races.SATYR, Races.DEER, Races.USHIONNA, Races.KRAMPUS);
                }
                else{

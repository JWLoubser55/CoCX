	...
	private function sellItem(item:Useable,cost:int = -1,buy:Boolean=false):void {
		...
		switch(item){
			...
			case useables.ADAMANT:
				descString = "The salamander merchant nod at your choice.\n\n\"<i>Adamantine, uh? That’s next to impossible to find on the market. Adamantine or Skymetal can only be mined from meteorites and even then only in small quantities. Damn metal is indestructible and while it can be melted with crazy high temperatures it will never bend noor break. Planning to make an armor out of that maybe? Well it's your lucky day, I have chunks of adamantine but they will not come cheaply. If you want some I will sell it to you but only for <b>" + priceToShow.toString() + " gems</b> per chunk.</i>\"";
				break;
	...
	public function pickaxesType(type:Number):void {
		...
		switch(type){
			case 1:
				...
				break;
			case 2:
				outputText("The salamander not been instructed by director Liadri what to say.\n\n\"<i>No more fuck to give to help director Liadri.</i>\" - Information Noona");

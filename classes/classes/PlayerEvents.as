...
public class PlayerEvents extends BaseContent implements TimeAwareInterface {
		...
		private function hourlyCheckRacialPerks():Boolean {
			...
			//Dark Affinity
			needNext = player.gainOrLosePerk(PerkLib.DarknessAffinity, player.isAnyRaceCached(Races.VAMPIRE, Races.APOPHIS, Races.ANUBIS, Races.DRACULA, Races.LICH) || player.hasPerk(PerkLib.Nightshade) || (player.hasMutation(IMutationsLib.UndeadMetabolismIM) && player.perkv1(IMutationsLib.UndeadMetabolismIM) >= 3), "You are at home while shrouded in darkness, seeing clearly within the shadows as if it were broad daylight.", "The inky black darkness grows hostile toward you once more as your affinity for it is lost.") || needNext;
			//Acid Affinity

...
public class KatherineThreesome extends TelAdreAbstractContent
	{
		...
		public function circlejerk():void { //Not available if Kath has no cock
			clearOutput();
			outputText("There’s no reason to not have some fun with the two of them... plus you don’t think you’d be able to resist the allure of joining two of your favorite girls in their bonding.  Stripping off your [armor] you step behind the two girls and embrace Urta into a hug, hands wandering her body to loosen the straps of her armor.\n\n");
			outputText("Urta seems to jump at your touch.  \"<i>[name]?  What are you doing, you naughty [boy]?</i>\"  She giggles.  Kath looks at you and smirks, \"<i>Couldn’t resist getting into this, huh, [name]?  Well, why not?  After all, we’re technically a </i>ménage à trois</i>, aren’t we?</i>\"\n\n");
			...
			outputText("\"<i>Is that a challenge, [name]?  That you can get vixxy here to cum before she gets me to cum, hmm?</i>\" Kath asks, grinning and showing needle-like teeth.  \"<i>Well, since you went and got so obligingly naked for us, I’m gonna make this a little more challenging...</i>\"  She reaches out, her fingers ");
			if (player.hasCock())
			...
			outputText("\"<i>You cheated, [name]!</i>\" Urta complains.\n\n");
		...
		public function roastYou():void { //Not available if Kath has no cock
			...
			outputText("Kath rocks her knot" + katherine.cockMultiple("", "s") + " back and forth and whines.  Urta grins like a wolf and says \"<i>You can do it Kath.  [name] asked for it, now give it to [him].</i>\"  Urta stands on wobbly legs and moves out of sight.  You’re still so full and out of breath that you can’t do anything to stop her, even if you wanted.\n\n");
			...
			switch (player.gender) {
				case  0: //Genderless
					outputText("\"<i>Yes, of course I’ll help you,</i>\" says Urta.  You don’t know what she’s doing back there, but you can hear Katherine’s breaths getting faster and sharper.  \"<i>Kath, I’m going to keep milking your prostate until you pump every drop inside [name]’s ass to remind [him] how much fun genitals can be.</i>\"\n\n");
					...
					break;
				case  2: //Female
					outputText("You feel Urta’s hand between your legs.  She takes hold of your clit, just as you did to her.  \"<i>Yes, of course I’ll help you,</i>\" says Urta, gently rolling your clit between her fingers.  \"<i>You just need a little something - like [name]’s wonderful pussy " + katherine.cockMultiple("squeezing your cock", "and tight little bum squeezing your cocks") + " as she cums.</i>\"\n\n");
					outputText("Urta’s playful fingers quickly cause you to cum and, as Urta predicted, your orgasm triggers Kath’s. With one last mighty heave she buries her cock" + katherine.cockMultiple("", "s") + " just a tiny bit deeper.  Then the flood begins.  Already stuffed with Urta’s load your belly expands even further.  Your " + (player.isPregnant() ? "birth canal" : "womb") + katherine.cockMultiple(" throbs", " and colon throb") + " painfully in protest but with Kath’s knot" + katherine.cockMultiple("", "s") + " mercilessly blocking the exit" + katherine.cockMultiple(" it has", "s they have") + " no choice but to take every drop.");
					break;
				default: //Male or Herm
					outputText("Urta’s fingers wrap around your cock.  Ignored until now it jumps at the attention.  \"<i>Yes, of course I’ll help you,</i>\" says Urta, softly stroking your member.  \"<i>You just need a little something - like [name]’s tight little bum squeezing your cock" + katherine.cockMultiple("", "s") + " as he cums.</i>\"\n\n");
					outputText("Urta’s playful fingers slide up and down your shaft.  You were already on edge and the added pleasure soon causes your " + (player.ballSize > 0 ? "balls" : "prostate") + " to tighten, spraying your load across the floor uselessly.  As Urta predicted, your orgasm triggers Kath’s.  With one last mighty heave she buries her prick" + katherine.cockMultiple("", "s") + " just a tiny bit deeper.  Then the flood begins.  Already stuffed with Urta’s load your belly expands even further.  Your " + (player.hasVagina() ? ("womb" + katherine.cockMultiple(" throbs", " and colon throb")) : "colon throbs") + "painfully, but with Kath’s knot" + katherine.cockMultiple("", "s") + " mercilessly blocking the exit" + (player.hasVagina() && katherine.cockNumber > 1 ? "s they have" : " it has") + " no choice but to take every drop.");
			}
		...
		public function spitroastKath():void { //Works for all except genderless characters
			...
			if (player.isTaur())
				outputText("her back is horizontal.  You carefully step over her, closing the distance with Urta until you feel your submissive pussycat " + (player.hasCock() ? "swallow the tip of your cock" : "latch onto your cunt like a remora") + ".  You pull Urta in for a kiss and think to yourself that this is how a centaur was meant to fuck");
			else
				outputText("her mouth is lined up with your " + (player.hasCock() ? "cock" : "pussy") + ".  Your submissive pussycat doesn’t need any instruction to " + (player.hasCock() ? "swallow the tip of your cock" : "slam her tongue into the depths of your pussy"));
		...
		public function pinAndFuck():void { //Kath is sober, Urta is drunk //Not available if Kath has no cock
			...
			urta.urtaLove(1);
			menu();
			addButtonIfTrue(0, "Stuff Kath", pinAndFuckStuffKath, "Req. a cock.", player.hasCock());
		...
		private function watchMainBody(urtaIsDrunk:Boolean):void { //Kath is sober, Urta is drunk
			...
			outputText(" and the tip of your tail does that little wiggle you don’t think anyone notices.  And you rush through all your paperwork once you know I’ll be at the bar because you love staring at my body" + (flags[kFLAGS.KATHERINE_URTA_DATE] == Katherine.KDATE_LITTLE ? " and you’re hoping like crazy [name] will be here so we can fuck all through the night" : ""));
		...
		public function sandwich():void { //Kath is drunk, Urta is sober //Not available if Kath has no cock
			...
			addButtonIfTrue(1, "GetLicked", sandwichGetLicked, "Req. a dick and non-taur body.", player.hasCock() && !player.isTaur());
			addButtonIfTrue(2, "GetLicked(T)", sandwichMaleCentaurLicked, "Req. a dick and tauric body.", player.hasCock() && player.isTaur());
		}
		...
		private function sandwichMaleCentaurLicked():void {
			...
			outputText("You know Urta can’t be that uncomfortable - if she just lowered her head she wouldn’t have to swallow you when Kath shoves her forward.  That and the fox tail that’s wagging between your front legs tells you your favorite fox herm has surrendered herself to being used as a living sex toy.\n\n");
			outputText("Kath really starts to pant and her hips start to jackhammer into Urta.  Looking down you get a front row seat as Kath slams her knot" + katherine.cockMultiple("", "s") + " in and out of Urta’s abused hole" + katherine.cockMultiple("", "s") + ".  Then the knots stay in and Kath’s upper body seems to liquefy in your arms, an exultant expression on her face.  Urta, still pinned between the two of you, lets out a happy gurgle as her belly is filled with Katherine’s seed and you hear spraying and splashing as her horse cock blows its load all over the floor.\n\n");
		...
		public function orgy():void { //Both Kath and Urta are drunk
			...
			if (valaHere) {
				...
				if (flags[kFLAGS.KATHERINE_VALA_TIMES_SEX] > 0)
					...
					outputText("\"<i>Hi [name],</i>\" she says cheerfully, \"<i>I see you brought a friend.  Did you save her too?</i>\"\n\n");
			...
			} else sceneHunter.print("Check failed: Vala!");
		...
		public function doubleStuffKath():void { //Both Kath and Urta are drunk
			...
			if (!player.hasCock()) {
				...
				menu();
				addButton(0, "Urta", urtaF);
				addButton(1, "Kath", kathF);
				addButtonIfTrue(2, "Both!", bothF, "Req. a second cock.", player.cockTotal() > 1);
			}
			...
			function urtaF():void { //Urta takes it
				...
				outputText("Kath realizes what’s happened" + (player.hasBalls() ? " and rubs your balls" : ", quickly inserts her finger into your ass and starts milking your prostate") + ", trying to coax an even bigger load out of " + (player.hasBalls() ? "them" : "it") + ".  ");
				if (player.cumQ() < 500)
			...
			function kathF():void { //Kath takes it
				...
				outputText("Urta realizes what’s happened" + (player.hasBalls() ? " and rubs your balls" : ", quickly inserts her finger into your ass and starts milking your prostate") + ", trying to coax an even bigger load out of " + (player.hasBalls() ? "them" : "it") + ".  ");
				if (player.cumQ() < 500)
		...
		public function doublePenetrateKath():void { //Both Kath and Urta are drunk
			...
			outputText("Kath has already cummed twice and been filled once.  You have to hold her shoulders to keep her from falling over.  Urta just keeps on fucking like Kath is a big feline onahole.  You can see it in Urta’s eyes - she’s so horny and so drunk that nothing but cumming matters right now.\n\n");
			...
			if (flags[kFLAGS.KATHERINE_URTA_AFFECTION] == 1) { //First time they’ve ever had sex together
				...
				outputText("\"<i>Mmmm yes.  I’m always ready to cum inside a hot kitty like you,</i>\" says Urta.  \"<i>You know [name], you don’t <b>have</b> to get us wasted.  Kath and I are always willing to fuck.</i>\"\n\n");
		...
		public function fistKathAndVala():void {
			...
			outputText("\"<i>[name]?</i>\" Vala asks, \"<i>aren't you going to... to... oh!</i>\"  You never learn what she was trying to say.  Your talented fingers keep her busy until Kath decides she's tired of waiting.  She grabs Vala's head and pulls her in for another kiss.\n\n");
			...
			outputText("You map out their favorite spots and wait until, you believe, they're both on the edge of cumming.  Then you hit all the good spots one after the other and are rewarded as two pussies clamp down on your fists.  The girls jerk and shake as one orgasm after another slams through their bodies.");
			if (katherine.hasCock())
			...
			outputText("Vala gets a mischievous gleam in her eye.  ");

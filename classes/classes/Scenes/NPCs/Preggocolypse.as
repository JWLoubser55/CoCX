...
public function ElectraPregProgression1():void {
		...
		outputText("The old mouse looks slightly annoyed. “...In order for you to achieve…Results…With the device, you’ll want to have an…erm…Plug…That you know will work for you.” He looks over and sees you. “I’m assuming you’d have an easier time with an imprint from [name]”.\n\n");
...
public function ElectraCleanBJ():void {
		...
		outputText("Her moans begin to get higher, more intense, and you notice that tears are falling down Electra’s face. Her eyes are wide open, and her pale face is losing its color. You realize that she’s trying to pull herself off you. Stiffly, through the electricity coursing through you, you manage to take her head in both hands, helping Electra pull your shaft out of her throat. Your orgasm rolls on, and as your [cockhead] exits her mouth with a loud *pop*, you’re still cumming.\n\n");

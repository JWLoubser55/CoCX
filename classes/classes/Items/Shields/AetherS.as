	...
	public class AetherS extends Shield {
		...
		override public function get description():String {
			...
			if (AetherTwinsFollowers.AetherTwinsShape == "Human-tier Dual Daggers") desc += "Dagger";
					 ...
					 AetherTwinsFollowers.AetherTwinsShape == "Human-tier Huge Warhammer and Large Shield" || AetherTwinsFollowers.AetherTwinsShape == "Human-tier Large Whip and Large Shield") desc += "Large Shield";
			else desc += "Gauntlet";
			desc += ")";
			//Block Rating
			desc += "\nBlock: " + String(block);

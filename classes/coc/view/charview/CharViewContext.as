		...
		public function CharViewContext(charview:CharView, character:*) {
			...
			super([
				{}, // local variables
				{
					...
					MeleeWeaponOffSprite: meleeWeaponOffSprite(),
					...
					PlayerHasASwordTwin: player.hasAetherTwinsTierWeaponMSword(),
					PlayerHasAnAxeTwin: player.hasAetherTwinsTierWeaponMAxe(),
					PlayerHasARapierTwin: player.hasAetherTwinsTierWeaponMRapier(),
					PlayerHasASpearTwin: player.hasAetherTwinsTierWeaponMSpear(),
					PlayerHasAMaceTwin: player.hasAetherTwinsTierWeaponMMace(),
					PlayerHasAWhipTwin: player.hasAetherTwinsTierWeaponMWhip(),
					PlayerHasAShieldTwin: player.hasAetherTwinsTierLeftShield(),
					PlayerHasAMediumShieldTwin: player.hasAetherTwinsTierLeftMediumShield(),
					PlayerHasALargeShieldTwin: player.hasAetherTwinsTierLeftLargeShield(),
					PlayerHasAnOffhandDaggerTwin: player.hasAetherTwinsTierLeftDagger(),
					PlayerHasAnOffhandSwordTwin: player.hasAetherTwinsTierLeftSword(),
					PlayerHasAnOffhandAxeTwin: player.hasAetherTwinsTierLeftAxe(),
					PlayerHasAnOffhandRapierTwin: player.hasAetherTwinsTierLeftRapier(),
					PlayerHasAnOffhandKatanaTwin: player.hasAetherTwinsTierLeftKatana(),
					PlayerHasAnOffhandSpearTwin: player.hasAetherTwinsTierLeftSpear(),
					PlayerHasAnOffhandMaceTwin: player.hasAetherTwinsTierLeftMace(),

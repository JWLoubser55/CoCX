...
public class LunaFollower extends NPCAwareContent implements SaveableState, TimeAwareInterface
	{
		...
		public function mainLunaMenu():void {
			...
			if (isNightTime && flags[kFLAGS.LUNA_MOON_CYCLE] == 8 && flags[kFLAGS.LUNA_FOLLOWER] >= 7 && flags[kFLAGS.LUNA_JEALOUSY] >= 400 && !player.blockingBodyTransformations()) {
				...
				outputText(" <i>[Master], I await your orders with pleasure.</i>\"\n\n");
				menu();
				...
				addButtonIfTrue(10, "Pack", LunaAndBitches, "You need to have at least 1 pup with Luna or dominate at least 1 werewolf.", (LunaTotalKidsNum > 0 || WerewolfPackMember > 0));
		...
		public function talkMenuLuna():void {
			...
			outputText("\"<i>Certainly, [Master]. What do you wish to know?</i>\"\n\n");
			menu();
		...
		public function talkMenuLunaHer():void {
			...
			outputText("\"<i>Of course, [Master]. I entered the service of my first mistress as an apprentice at the age of ten, and worked in a few other noble houses before completing my training as a young woman. The incident at the magic shop which brought me here occurred at my fifth assignment, when I was twenty-one, and that was six months ago.</i>\"\n\n");
			outputText("Does she enjoy the work?\n\n");
			outputText("\"<i>I do,[Master], very much so! Getting to care for [Master], in every <b>possible</b> way, with everything I need to do it available to me... ahhhh, the smile on [Master]'s face while eating a perfectly cooked meal, " + player.mf("his","her") + " contented sigh after I nurse " + player.mf("him","her") + " wounds... " + player.mf("his","her") + " perfect, helpless sleeping face when I-</i>\"\n\n");
			...
			outputText("\"<i><b>Ahem,</b></i>\" she quietly coughs as she recomposes herself, before resuming her normal tone of stoic professionalism. \"<i>Suffice to say, yes, I find my work quite satisfying, so please be at ease and make <b>full</b> use of my services, [Master].</i>\n\n");
		...
		public function talkMenuLunaWhatCanSheDo():void {
			...
			outputText("Just what can she do for you, exactly? Your upbringing in rural, backwoods Ingnam hardly gave you much of a chance to meet domestic servants.\n\n" +
					"\"<i>Why, [Master], what <b>can't</b> I do for you would be easier to answer! I'm highly trained in the obvious duties of cooking and cleaning, naturally, but I also have experience in medicine, massage therapy, interior decoration, sewing and tailoring, minor repairs, bookkeeping, cryptography, corporate espionage, wetworks, and... pest control.</i>\"\n\n" +
			...
			if (flags[kFLAGS.LUNA_FOLLOWER] > 6) outputText("She glances down slightly, her face flushing a bit. \"<i>Even your most... intimate needs... i-if it's your wish, I would never turn you down, [Master]...</i>\"\n\n");
		...
		public function talkMenuLunaHuman():void {
			...
			if (flags[kFLAGS.LUNA_FOLLOWER] > 6) {
				outputText("She lied to you when she said she was human. Why?\n\n" +
						"\"<i>Well, I used to be human. I still feel human, mostly. Or rather... I-I'm sorry, [Master], it's all so complicated. I never wanted to deceive you, I swear.</i>\"\n\n" +
						"You tell her to go on.\n\n" +
						"\"<i>...I came from a different world, just like [Master] did, after all. When the cursed mirror in my former place of work dropped me here, I also had to survive alone in the wild, and one night a werewolf... attacked me and turned me into the monster I am now. I believe werewolves to be demonic creations engineered to spread bestial corruption to populated areas in secret; we are perfectly suited to it, and our instincts... well, I'm lucky to have gotten off with merely a bite, I should say.</i>\n\n" +
						...
						"She giggles cutely, the very picture of innocence, at your suggestion. \"<i>Of course not, [Master], don't be silly. Why would I need to do that?</i>\"");
				...
				outputText("\"<i>You already know my body is yours to use, any time, any <b>way</b> you desire it, [Master],</i>\" she says, her tone changing to a sultry half-whisper as her eyes begin to glaze over. \"<i>And <b>I</b> already know how <b>much</b> you want it...</i>\"\n\n" +
				...
				outputText("You ask her if she is truly a full-blooded, \"pure\" human, the first you've found besides yourself in Mareth.\n\n" +
						"\"<i>Yes, [Master], I am indeed human. Like [Master], I came from a different world, though in my case it was misfortune rather than duty that brought me. My employer at the time ran a magic shop out of her first floor, and part of my duty was to clean it after hours. One night as I was doing so, some thieves attempted to break in. As I was in the process of dealing with them, one of the clumsy fools managed to break a large, enchanted mirror with his ugly, stupid face, and in a burst of dark magic the cursed thing sucked both of us in. When I awoke I was in a forest clearing, and soon discovered I was no longer in my old world.</i>\"\n\n" +
						"What happened afterward?\n\n" +
						"\"<i>Of course I ran, [Master]. It seemed no matter I went there were people or... things, trying to molest me, or worse. Truly, I should have met a sad fate were it not for a strangely dressed woman with black hair who kindly directed me toward Tel'Adre, where I eventually met you. I am ever grateful to her for that, though I don't know where she went, or even her name; nor have I seen her since.</i>\"\n\n" +
						...
						"\"<i>Oh, do not worry, [Master], he won't be troubling <b>anyone.</b></i>\"");
		...
		public function talkMenuLunaCampThoughts():void {
			...
			if (flags[kFLAGS.CAMP_CABIN_PROGRESS] >= 10) outputText("\"<i>While I can’t say your home is as... grand as those of my prior employers, it is truly charming in its rustic way. Perhaps one day [Master] will consider expanding it? I could greatly expand my services to you with a larger home.</i>\"\n\n");
			else outputText("\"<i>While I would never impose upon [Master], I will admit it would be far easier to clean if there were a proper dwelling here. I would greatly enjoy the wider scope for my services a cabin would provide.</i>\"\n\n");
			lunaJealousy(-100);
			lunaAffection(2);
			doNext(talkMenuLuna);
			advanceMinutes(15);
		...
		public function talkMenuLunaStopJealousy():void {
			...
			outputText("Luna trots elegantly over to you as usual, but her greeting dies on her lips as she sees the expression on your face. After staring blankly for two seconds, she hastily recovers and manages to address you with only a slight twitch at the side of her mouth." +
					"\n\n\"<i>Ah ha ha ha, is something on [Master]'s mind? How may I serve you today?</i>\"\n\n" +
					"The hell there is, you reply, and mention the various \"accidents\" that seem to have befallen your other campmates of late.\n\n" +
					"\"<i>I... but, I, er...</i>\" she stammers, before giving up and admitting the truth. \"<i>I apologize, [Master]. I have no excuse' I just couldn't contain myself after being ignored for so long.</i> ");
		...
		public function talkMenuLunaLycanthropy():void {
			...
			outputText("You ask her what it's like to be a werewolf, besides the monthly lunacy, as it were.\n\n" +
					...
					"\"<i>But of course, [Master], I would <b>never</b> do such a thing now! My body belongs only to you.</i>\"" +
		...
		public function talkMenuBiteMeYes():void {
			outputText("You call Luna aside to a quiet corner of the camp and place your hands on her shoulders. She looks at you wide-eyed as you very seriously ask her to do something she never expected: bite you. Luna nearly panics and tries to dissuade you the moment you request it, though you notice she also blushes.\n\n" +
					"\"<i>[Master], I can't, you... this is a terrible, permanent thing you are asking! Did you truly think it through? Once you are cursed there is no going back; you will be just... just like me...</i>\"\n\n" +
		...
		public function sparLuna():void {
			...
			outputText("You ask Luna if she would like to spar with you.\n\n" +
					"\"<i>[Master], it is best not to awaken my instincts during the day. I am a pitiful woman who cannot control her impulses...</i>\"\n\n" +
					...
					"She bows obediently. " +
					"\"<i>If [Master] so desires, I will not refuse.</i>\"\n\n" +
		...
		public function sparLunaWon():void {
			...
			outputText("Luna falls submissively to all fours in defeat.\n\n" +
					"\"<i>I yield [Master]. The victory is yours. I hope this weak servant's efforts were satisfactory.</i>\"\n\n" +
		...
		public function nurseLuna():void {
			...
			outputText("You ask the maid if is able to tend to your inuries.\n\n" +
					"\"<i>Of course, [Master], please undress and I shall do so at once.</i>\"\n\n" +
		...
		private function lunaSleepToggle():void {
			...
			if (flags[kFLAGS.SLEEP_WITH] != "Luna") {
				outputText("You ask Luna if she would mind sleeping with you.\n\n" +
						...
						"\"<i>[Master], why, I mean... that is... I never thought... yes, yes! It would be my honor to safeguard your dreams!</i>\"" +
				...
				outputText("You tell Luna you wish to sleep alone for a while.\n\n" +
						"Luna bows solemnly. \"<i>As you wish [Master]... please let me know when you desire me once more. I am ever happy to safeguard your dreams.</i>\"\n\n");
		...
		public function fullMoonEvent(PCIsAwake:Boolean = false, PCWalkedToLunaAtmaxJealousy:Boolean = false):void {
			...
			if (flags[kFLAGS.LUNA_FOLLOWER] > 6) {
				if (player.hasStatusEffect(StatusEffects.LunaWasWarned)){
					...
					outputText("\"<i>[Master], I cannot hold it back anymore. If you refuse to take me, I'll just have to take you!</i>\"\n\n" +
					...
					if (PCIsAwake) {
						if (PCWalkedToLunaAtmaxJealousy) {
							outputText("As you approach Luna she sighs resignedly, rising from the stone she was resting upon and pulling off her dress.\n\n" +
									"\"<i>[Master], I did warn you I can only hold myself back so long. Tonight I will not take 'no' for an answer.</i>\"\n\n" +
					...
					if (PCIsAwake)outputText("\"<i>We can do this two ways, [Master]: the hard way, where you resist and I take you by force until I'm happy, or the easy way, where you fuck me raw in a loving, consensual way. What is your pleasure, [Master]?</i>\"\n\n");
				...
				outputText("\"<i>I can’t control it anymore, [Master]. I tried, I tried so hard, but the things you did to me, the things you <b>wouldn't</b> do to me, it's been intolerable! It's all your fault, <b>you</b> pushed me to this!</i>\"\n\n" +
						"You vehemently deny doing anything of the sort, and ask what she's talking about.\n\n" +
						"\"<i>Cruel, wicked [Master], pretending to know nothing when you've been ignoring and neglecting me again, despite your promise! I love you, I love you <b>so much</b> but you still hurt me. Is my service not enough? Is my body not enough? I offered it to you every day, every night, and yet you turned away, [Master] But it's all ok now, now that the moon is at its peak! I’m finally ready, ready to make you realize how <b>much</b> you truly love me. Even if it's only for a few minutes I will <b>make</b> you love me! You can’t deny us anymore, [name]!</i>\"\n\n" +
						...
						"\"<i>See? You see, [Master]?! I’m a werewolf! A beast, a filthy demonic beast wearing human skin! This is the real reason my last master fired me, the terrible secret he learned! I’m a monster! I tried to hide it, for your sake, but you’ve been teasing me for so long now I can’t hold it in anymore. But it's all okay, [Master], because I'm going to make you mine, now!</i>\"" +
				...
				outputText("\"<i>I can’t control it anymore, [Master]. I tried, I tried so hard, but the things you did to me, the things you <b>wouldn't</b> do to me, it's been intolerable! It's all your fault, <b>you</b> pushed me to this!</i>\"\n\n" +
						"You vehemently deny doing anything of the sort, and ask what she's talking about.\n\n" +
						"\"<i>Cruel, wicked [Master], pretending to know nothing when you've been seducing me with your need every day and night! Every meal I made for you, every wound I nursed on your sweet body, every stone I cleaned from under your bedroll, you <b>made</b> me love you, more and more, oh and more! Do you not want my service? Is my body not beautiful, not tempting enough? I offered it to you every day, every night, and yet you turned away, [Master] But it's all ok now, now that the moon is at its peak! I’m finally ready, ready to make you realize how <b>much</b> you love me back. Even if it's only for a few minutes I will <b>make</b> you love me! You can’t deny us anymore, [name]!</i>\"\n\n" +
						"Her golden eyes turn fully fluorescent green, drawing your vision as her naked body begins to transform over you. She shivers and moans in bliss, or pain, or both, as fur begins to cover the skin of her arms and legs, and even as they pin you down you feel her hands and feet change to great, bestial paws with long, deadly claws. Her breasts and hips swell and fill out to the voluptuous curves you recognize on every corrupted female creature in this mad world, and as the transformation ends a bushy tail sprouts from her curvy, muscular buttocks and her ears shift and grow into pointed canine ears atop her head. She pants in orgasmic ecstasy at the pleasure of the change, revealing a dog like tongue and canines far too long and sharp for any human. You feel a few drops of drool begin to fall on you, from both of her mouths.\n\n" +
						"\"<i>See? You see, [Master]?! I’m a werewolf! A beast, a filthy demonic beast wearing human skin! This is the real reason my last master fired me, the terrible secret he learned! I’m a monster! I tried to hide it, for your sake, but you’ve been teasing me for so long now I can’t hold it in anymore. But it's all okay, [Master], because I'm going to make you mine, now!</i>\"" +
						" She finishes by rearing back her head and releasing a feral howl that echoes through the night, screaming her madness and her passion to the blood-red, full moon that looks down on this scene of insanity.\n\n" +
						"Before things get even more out of hand, how will you answer her advances?\n\n");
			...
			if (player.racialScore(Races.DOG, false) > 5 || player.racialScore(Races.WOLF, false) > 5) addButtonDisabled(1, "Resist", "The smell of a female wolf in heat drives your canine instincts into a frenzy. You must have her here and now!");
		...
		public function fullMoonEventAccept():void {
			...
			outputText("You declare that you won’t fight her.\n\n" +
					"She looks at you blankly, her mad mood suddenly gone, like a pricked bubble or a nightmare forgotten on waking, and she releases her hold on you to lean back in shock. \"<i>What? You.. you're just going to give in? Just like that, [Master]?</i>\"\n\n" +
		...
		public function fullMoonEventAccept2():void {
			...
			outputText("You apologize for playing hard to get, even if you didn't intend it, and tell her you'll play nice. Luna's posture goes from hostile to docile as if you had flipped a switch, and she drops to all fours awaiting her treat with a big, wolfish grin.\n\n" +
					...
					"\"<i>if you only were so kind the rest of the time I wouldn't have to jump you in the middle of the night like this. I always feel so terrible afterward, you know. Cruel, teasing [Master].</i>\"\n\n" +
			...
			outputText(" display your own naked body, visibly aroused and ready for sex. She responds with palpable ecstasy, panting and drooling with lust from both her wolfish mouths, eager for what comes next but waiting patiently on her [Master], just like the well-trained bitch in heat you know she is.\n\n");
			if (flags[kFLAGS.LUNA_FOLLOWER] == 5 || flags[kFLAGS.LUNA_FOLLOWER] == 7 || flags[kFLAGS.LUNA_FOLLOWER] == 9) flags[kFLAGS.LUNA_FOLLOWER] = 11;
			if (flags[kFLAGS.LUNA_FOLLOWER] == 6 || flags[kFLAGS.LUNA_FOLLOWER] == 8 || flags[kFLAGS.LUNA_FOLLOWER] == 10) flags[kFLAGS.LUNA_FOLLOWER] = 12;
			mooning = true;
			doNext(sexMenuVaginal, true);
		...
		public function fullMoonEventResist():void {
			...
			outputText("You shove her with all your strength and get ready for a fight.\n\n" +
					...
					"\"<i>You'll see things my way once you're no longer in any state to fight back. It's not my fault if you get hurt, [Master]. I would <b>never</b> hurt you, [Master]!</i>\"\n\n");
		...
		public function fullMoonEventResistWin():void {
			...
			outputText("Luna falls to the ground in defeat, fully submitting to you. You swiftly tie her so she can't cause further trouble.\n\n" +
					"\"<i>[Master]...</i>\" She whines at you, her voice weak and trembling like a scolded dog's. \"<i>I'm so, so sorry... I have no control over myself under the full moon. Please, [Master], I'm begging you, please, beat me, rape me, hate me, kill me... whatever you say I deserve, but please, [Master], please, please don't fire me. I'm begging you.</i>\"" +
		...
		public function fullMoonEventResistWinFireHer():void {
			...
			outputText("After you remove her chains and tell her your decision, Luna looks at you as if her world is breaking apart.\n\n" +
					"\"<i>[Master], I... no, you... you’re firing me?</i>\"\n\n" +
		...
		public function fullMoonEventResistDefeat():void {
			...
			outputText("You collapse, unable to continue the fight. Before you can blink Luna is on you, and you’re back where you started this crazy night, pinned underneath your maid's giant wolf paws as she slavers hungrily over you. But this time, there's no escape and, you fear, no more talking your way out. Luna will decide your fate.\n\n" +
					"\"<i>[Master], sweet, wonderful [name], it's ok,</i>\"" +
		...
		public function sexMenuMain():void {
			...
			outputText("You mention to Luna that you are feeling certain needs, and desire her help. She blushes furiously and looks away for a moment, though you're sure she's smiling.\n\n" +
					"\"<i>Oh, [Master]... I would be proud to attend you in any way you desire. What do you wish of your servant?</i>\"\n\n");
			menu();
		...
		public function sexMenuHeadpat():void {
			...
			outputText("Luna is so cute you can’t help yourself; you just start patting and rubbing her head! She makes a noise of surprise and objection but before long her eyes close and her face melts with delight as her ears morph into their wolfish appearance - which you promptly begin scritching, increasing her bliss even further. Her tail pops out and wags from side to side as she sighs in bliss, and you hear her foot tapping the ground. A little line of drool starts trailing down from her slack mouth." +
					...
					"\"<i>I'm so sorry, [Master], I-I don’t know what happened, it just felt so good and I... I... I have to go finish my chores!</i>\"\n\n" +
		...
		public function sexMenuVaginalIntro():void {
			...
			outputText("Long hours spent fighting, exploring, and engaging in other... rough activities, have left your body aching and fatigued, and even though it was you that propositioned her in the first place you're having a hard time mustering up any enthusiasm. Luna easily picks up on your discomfort and moves forward to embrace you gently.\n\n" +
					"\"<i>[Master], are you well? Have your travels left you weary?</i>\"" +
		...
		public function sexMenuVaginal(werewolf:Boolean = false):void {
			...
			function vagF():void {
				outputText("Luna leans forward, bracing herself against the boulder behind you with one hand and bringing her face to yours and once more kissing you, this time tickling your lips with short pecks over and over, sometimes gently nibbling or sucking on your lip, varying the pace and intensity, though never frenetic or rough; always soft, loving, tender. Meanwhile her free hand traces slowly down your side, fingers brushing teasingly down to your hip, across your thigh, and back up until she begins to graze your labia, wetness already leaking between your engorged labia. She slowly circles your sex, sometimes skipping across your lips or grazing your sensitive clit, until you find yourself bucking your hips forward for stronger contact; but she breaks off her oral ministrations to tell you quietly " +
						"\"<i>Shhhhhhh. No, [Master] just relax. I promise your sweet Luna will give you everything you need.</i>\"" +
						...
						"\"<i>That's right, [Master] just let Luna do her magic. No one knows what you need like your cute maid, no one loves you like her. Just let me handle everything, and let yourself go. I'll hold you like this until everything's right again. I'll never, ever, ever let [Master] go, never. All I want in return is to feel your love for me, who loves you better... than anyone... else... mmmmmmmmmaaahahaaaa...</i>\"\n\n" +
		...
		public function sexMenuSpearPolishing():void {
			...
			outputText("You ask your charming maid Luna if she wouldn't mind pleasuring you orally today.\n\n" +
					...
					"\"<i>I am always happy to oblige [Master] however you desire. Please, relax and let me take care of your needs.</i>\"" +
			...
			if (player.hasBalls()) outputText(", then down to your full, aching " + (player.balls == 2 ? "pair" : "quartet") + ", lavishing your tender orbs with her soft, wet lips and tongue until they are dripping with your mixed fluids");
			if (player.hasBalls() && player.hasVagina()) outputText("; then, after that, with her hands taking over for her mouth on your twitching manhood, she moves her oral worship even further");
			...
			outputText("With one last noisy 'pop' she finally pulls her mouth from your now drooping length, licks a few stray dribbles from around her lips and off her fingertips. Then she smiles at you lovingly and says, in an exaggeratedly sugary tone " +
					"\"<i>Oh my, [Master] if I'd known you were going to feed me such a sumptuous snack I wouldn't have prepared my own meal today~. You must really love your cute maid Luna to offer her such a delicious treat~. I'll have to make your dinner <b>extra</b> special tonight to thank you~!</i>\"" +
		...
		public function sexMenuBoobjob():void {
			...
			outputText("but even so you decide that right now they're ideal. As you quietly finish your lusty calculation, Luna tilts her head quizzically under your evaluating gaze. Having made up your mind, you ask her if she would be so kind as to stroke your cock to climax between her breasts.\n\n" +
					...
					"\"<i>Of course, [Master], I am always delighted to aid. My body is ever yours to use as you please.</i>\"\n\n" +
			...
			outputText(" begins to expose her chest, first untying the neck of her apron from behind her shoulder-length ash-brown hair, letting it fall forward supported by its waist-strap. She then unbuttons the front of her modest black dress, her slender fingers undoing each button quickly but carefully one at a time as you watch, mesmerized. She notices your attention and smiles, slowing her movements somewhat to draw out your anticipation, and you feel yourself becoming aroused, your member stiffening even before you've seen so much as the skin on her shoulders. With the last button above her waist undone, she slowly, deliberately opens the front to reveal her frilly white bra, which matches her headband, stockings, and apron perfectly. Then she pulls one arm, then the other, through the arms of her black dress and lets it fall back, supported also by the waist strap of her apron. Finally, she undoes the clasp at the front of her bra and opens it, slipping it over her shoulders and letting her modest, cream-skinned breasts spill out; pert and firm, with adorable pink nipples and just the right amount of jiggle. You find yourself unable to hold back anymore and rush her, kissing her and fondling her perfect breasts in your hands - they're just the right size." +
					...
					"\"<i>Mmmmmhmhm... goodness gracious, [Master],</i>\"" +
					...
					"\"<i>Are you enjoying my breasts, [Master]? Your cute maid's breasts are exposed and squished together around your cock... how disgraceful. Such a lewd maid must be disciplined, no matter how sweet and adorable she is, don't you agree, [Master]?</i>\"" +
					...
					"\"<i>I know just how you can punish your naughty, slutty maid, [Master]</i>\"" +
					...
					"\"<i>You should spray her right in the face, just like a bad dog caught with its nose in the pantry, [Master]. Spray her good, so she knows she's been naughty, until she can't even breathe or see.</i>\"\n\n" +
			...
			outputText("Luna gives you a moment to catch your breath, and to wipe off enough of her face to see and speak clearly, then says \"<i>My goodness, [Master], that was some <b>incredible</b> discipline. I am thoroughly chastened, and I promise you I won't misbehave again.</i>\" She stands up and bows, your seed still dripping off her in places, her breasts still glistening and sticky with your and her fluids, and turns to go clean herself off in the river. Just as she does, though, she turns back and adds, \"<i>Until you ask me to, of course.</i>\" Then she winks, disappears behind a nearby boulder. You remain laying for a moment to catch your breath and give your muscles time to regain their strength before you rise and follow to do the same, extremely happy you decided to act on your whim. An hour or so later you are clean and refreshed, ready to continue your day.");
			lunaJealousy(-100);
			lunaAffection(2);
		...
		public function sexMenuDoggyTreats():void {
			...
			outputText("and your vision is pink at the edges. You finish pulling her panties off one leg, noting that her foot is already warping into a heavy lupine paw, and decide that will have to be enough - because it's time to bury your face in Luna's steaming, wet pussy and ass and help speed her transformation along. You begin lapping, sucking, and nibbling voraciously at her dripping snatch, burying your face between her swelling cheeks and breathing in her sex - drenched, animalistic smell as she screams and thrashes in your grip. You're holding her ass up to your face by her hips, with her legs flailing ecstatically beside your head and her arms desperately trying to hold her face above the ground as you eat her out during her werewolf transformation.\n\n" +
					...
					"Smiling deviously you give her a couple hard slaps on the ass just beside where her tail emerges, eliciting a satisfying <i>yip</i> from your already well-fucked bitch. You remind her sternly to call you [Master], as she has forgotten to do twice now. Then you tell her you're happy she's enjoying herself, because you're <b>just getting started</b>." +
					" As soon as you scold her she begins making quiet whining sounds, and she submissively lowers her front half to the ground until her pillowy breasts are squished into the grass. Her rear is still sticking up at you. Despite her dejected posture and tone, however, you can clearly see her wolf-cunt drooling even harder than before. Her clit sticks out a good half-inch from her folds, which are splayed open and puffy, revealing her wet depths visibly throbbing and squeezing, begging for her [Master]'s rod inside it. She wriggles her behind at you, her tail curled saucily over her back, in as clear a 'come hither' as you've ever seen, and you're more than ready to oblige...\n\n");
			menu();
			addButton(0, "Dominate", sexMenuDominateHer)
		...
		public function sexMenuDoggyTreats2():void {
			...
			if (player.cumQ() <= 1000) outputText(" a dribble of your seed from her gaping, distended ring.");
					...
					"\"<i>I... I'm glad, [Master]. Thank you.</i>\"" +
		...
		public function sexMenuSandwichWithAyane():void {
			...
			if (player.hasBalls()) outputText("balls which only cause them to churn with a massive supply of cum; this is going to be one hell of a mess!");
			...
			outputText(" Luna’s own tail is out and is busy circling your anal ring with its tip which only drives you crazier.\n\n" +
					"Their combined affection and skill eventually make short work of your restraint; " + (player.cocks.length > 1 ? "you pull out of their holes, " : "") + "cum flowing " + (player.hasBalls() ? "out of your balls and " : "") + "through your [cock], splattering the space between them up to their combined breasts with a massive load of semen. Fully satisfied, the pair lick their lips as they untangle from your cock, a large puddle forming on the ground. " +
			...
			function dickF():void {
				if (player.cocks.length > 1) {
					outputText("Not one to pass up such a pleasing opportunity, you waste no time. Grabbing Luna's hips roughly you pull her back toward you and shove your cocks between her thighs, running them back and forth across her dripping slit until they are thorougly coated in her slippery juice. As she moans shamelessly at the feel of your lengths stroking her drooling lower lips and clit, you take one of your already well-lubricated thumbs and jam it in her ass to start loosening it up; she yips in surprise but makes no effor to pull back; she's already far too gone to resist whatever you have in store for her. Once you're lubricated and she's loosened, you carefully line yourself up with both of her holes and thrust in all at once.\n\n" +
							...
							"\"<i>AAAAAAAOOOOOOOOOOOOOHH! [Master], yes, yes! This is true mating! Take me, [Master], pound my holes until I can't see straight! Fuck your dirty bitch into the ground!</i>\"" +
					...
					outputText("<i> your horny, needy bitch, [Master]... </i>");
					if (player.hasKnot()) outputText("<i>lock me and </i>");
					outputText("<i>fill me with your seed, I beg you, fill me up until I'm pregnant with your puppies... please, [Master], I need your puppies... I want to give you puppies... please please please please please...</i>\"" +
					...
					outputText("Not one to pass up such a pleasing offer, you waste no time. Grabbing Luna's hips roughly you pull her back toward you and shove your cocks between her thighs, running it back and forth across her dripping slit until they are thorougly coated in her slippery juice. She moans shamelessly at the feel of your length stroking her drooling lower lips and clit. Once you're lubricated and she's loosened, you carefully line yourself up with her dripping pussy and hilt yourself.\n\n" +
							"Both of you howl at the sudden onrush of stimulation, and Luna screams " +
							"\"<i>AAAAAAAOOOOOOOOOOOOOHH! [Master], yes, yes! Fuck me, [Master], pound my pussy until I can't see straight! Fuck your dirty bitch into the ground!</i>\"" +
					...
					outputText(" until she begs. Tears in her eyes, Luna pleads with you even more desperately. " +
							"\"<i>[Master], please, I'm begging you, please</i>");
					if (player.hasKnot()) outputText("<i> knot</i>");
					else outputText("<i> cum inside</i>");
					outputText("<i> your horny, needy bitch, [Master]... </i>");
					if (player.hasKnot()) outputText("<i>lock me and </i>");
				...
				outputText("Luna manages to pull her arms around you and the two of you lay together for a moment, catching your breath and slowly coming down from the high of your rather extreme sex, then you feel Luna begin to shrink under you. Not wanting to hurt her as her body resumes its normal human shape you slide off her to one side and pull her into an embrace, facing you. You watch as her ears return to their human shape and place and her tail shrinks back into her spine; then the fur retreats on her paws as they return to being her usual delicate human hands and feet, and as she finishes transforming her head has moved to the level of your chest thanks to her reduction in height. With a sigh she buries her face in your chest, and you pull her in even tighter." +
						"\"<i>[Master]... that was <b>incredible</b>. No one's ever satisfied me like that before. You're amazing... I... I'm so glad you hired me...</i>\"" +
						...
						"\"<i>Ohhhh... oh no... I'm so sorry, [Master], this is so embarrassing. That was the heat talking; I couldn't help myself. I wanted it in the moment, so badly, but I take a herb to make sure I won't actually get pregnant. I know that as a servant I mustn't bear the " + player.mf("Master's","Mistress's") + "-</i>\"" +
		...
		public function roughFuck():void {
			...
			outputText("\"<i>Ooooh [Master], I knew you loved me! Please make me your bitch for the night!</i>\"\n\n");
		...
		public function LunaPregAnnouncement():void {
			...
			if (LunaTotalKidsNum == 0) {
				...
				outputText("\"<i>We’re going to have more children, my lovely [Master]!</i>\" Luna gives you a big hug, before returning to her usual innocent smile and demeanour. \"<i>If you need anything else, you know where I’ll be.</i>\"\n\n");
				outputText("\n\n");
		...
		public function LunaGivesBirth():void {
			...
			switch (rand(2)) {
				case 0:
					outputText("\"<i>It’s a little boy…Our son.</i>\" Luna says, a tired smile on her face. You stay with Luna and her little boy for a bit, but as they nod off, you slide out from Luna’s grip, making sure they’re tucked in before leaving.\n\n");
					LunaTotalKidsNum += 1;
					LunaSonsNum += 1;
					break;
				case 1:
					outputText("\"<i>...She’s beautiful. Our daughter.</i>\" Luna looks at you, giving you a kiss on the cheek. \"<i>I…I love you.</i>\" You stay with Luna and her little girl for a bit, but as they nod off, you slide out from Luna’s grip, making sure they’re tucked in before leaving.\n\n");
					LunaTotalKidsNum += 1;
					LunaDaughtersNum += 1;
					break;
			}
		...
		public function LunaAndBitches():void {
			...
			outputText("\"<i>Mast…Mist…My love…</i>\" Clearly Luna isn’t quite used to referring to you as anything but a superior. \"<i>We’re over here.</i>\"\n\n");
			if (WerewolfPackMember > 0) {
				outputText("As you approach, your betas raise their heads. To your surprise, they’ve taken up around Luna’s enclosure. Unlike Luna, they’ve kept to their wolf forms, and as your children get up, running over to you, they simply nod respectfully, watching intently as your children with Luna run over.\n\n");
				...
				outputText("You give Luna a look, but she simply smirks. \"<i>You’re. My. [Master]. Mine. Collect these bitches all you want, but they’re BELOW me.</i>\" Her eyes flash green for a second. You get the feeling that your maid…tolerates your bitches…But would much rather have you to herself.\n\n");
				//if (Werewolf kids) outputText("Around your bitches, (Bitchkids_Number) little wolves play near their mothers. Despite their smaller size, their teeth are still sharp, their eyes bright.\n\n");
				//outputText("\n\n");
				//outputText("\n\n");
				//outputText("\n\n");
			}
			if (LunaDaughtersNum == 1 && LunaTotalKidsNum == 1) {
				outputText("Your daughter looks up at you, eyes wide. She’s the spitting image of her mother, complete with the wobble of her lower lip when she’s nervous. She’s wearing a fancy little dress, not unlike Luna’s. \"<i>" + player.mf("Father","Mother") + ", it is good to see you.</i>\"\n\n");
				outputText("You give Luna a slight glare, and she looks up and away, whistling slightly. You kneel, opening your arms, and gently, you tell your daughter to be herself around you. You’re her " + player.mf("father","mother") + ", not someone to fear. Her eyes widen, her mouth curling up into a wide, innocent smile, before she pulls her arms in, throwing the dress up into the air. To your relief, there’s a layer underneath, a fancy-looking chemise, and she waggles her bum before jumping into your arms. Luna scrambles to catch the dress before it hits the ground, and you cradle your happily squirming daughter in your arms for a while before putting her back down.\n\n");
			}
			if (LunaSonsNum == 1 && LunaTotalKidsNum == 1) {
				outputText("You’re not sure where Luna found it, but your son’s dressed in a suit, like a little butler. He approaches quickly, yet elegantly, bowing slightly to you. \"<i>" + player.mf("Father","Mother") + "</i>\".\n\n");
			...
			if (LunaTotalKidsNum > 12) {
				...
				outputText("\"<i>Were the results of our love…overwhelming, [Master]?</i>\" She says, a rather uncharacteristically amused smile on her face. All around you are openly bared fangs, fur rubbing against your [skin]. You take Luna’s hand, and as she pulls you out of your kids, she wraps her surprisingly strong arms around your waist. \"<i>Mine. My [Master], my love.</i>\" She lets go, but is still holding your hand.\n\n");
			}
			menu();
			//addButtonIfTrue(1, "Sex Bitches", PlowYaBitches, "You need to dominate at least 5 werewolfs, have cock and is night time currently.", (WerewolfPackMember > 4 && player.hasCock() && isNightTime));
			addButton(14, "Back", mainLunaMenu);
		}
		...
		private function PlowYaBitches():void {
			...
			outputText("\"<i>O-oh, no!</i>\" Luna seems almost horrified at the thought. As you roughly push Luna onto her back, you tell her that she, as your alpha female, gets you first. And no, you aren’t asking.\n\n");
			outputText("Luna, despite her flustered state, gives you an expression that you can only describe as \"<i>Oh, fuck yes</i>\". Roughly, you pin Luna down, forcing her legs aside. Your bitches watch as you force yourself inside Luna, who arches her back, wrapping both legs and arms around you.\n\n");
			...
			outputText("\"<i>You must be tired, [Master]. Please…Let me tend to you, before you leave us.</i>\" Your [cock] is extremely sensitive, but Luna’s hands are gentle, and as she guides you into a chair, she begins to stroke, cleaning the grime from your shaft. Despite your [cock] being raw, her hands deft, barely touching you at first.\n\n");
			outputText("Your biggest bitch stands, glaring jealousy at Luna, but a glare from you puts her back to the others.\n\n");
			outputText("\"<i>That’s it, [Master]...Just relax. Let your lovely maid take care of you.</i>\" The warm water washes over you, as Luna gently cleans the grime from you. \"<i>Mmm…</i>\"\n\n");

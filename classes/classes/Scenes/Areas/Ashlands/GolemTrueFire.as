...
package classes.Scenes.Areas.Ashlands 
{
	...
	public class GolemTrueFire extends AbstractGolem
	{
		...
		override protected function performCombatAction():void
		{
			if ((this.lust100 >= 85 && rand(2) == 0) || this.lust100 < 85) {
				if (hasStatusEffect(StatusEffects.Provoke)) {
					...
					if (choiceP == 1) backhand1(2);
					if (choiceP == 2) overhandSmash1(2);
		...
		public function GolemTrueFire() 
		{
			...
			//this.plural = true;
			initStrTouSpeInte(435, 410, 285, 20);

...
public class Races {
	...
	public static const OOMUKADE:OomukadeRace              		= new OomukadeRace(31);//maybe reductand with 81
	...
	public static const ECHIDNA:EchidnaRace                		= new EchidnaRace(60);//partial NYI
	...
	public static const MAGMASLIME:MagmaSlimeRace          		= new MagmaSlimeRace(74);//partial NYI
	...
	public static const CENTIPEDE:CentipedeRace            		= new CentipedeRace(81);//maybe reductand with 31
	...
	public static const RAISUNE:RaisuneRace                		= new RaisuneRace(111);//NYI
	...
	public static const ABYSSAL_SHARK:AbyssalSharkRace     		= new AbyssalSharkRace(116);//partial NYI
	...
	public static const WEREBAT:WerebatRace				   		= new WerebatRace(128);//NYI
	public static const WERECAT:WerecatRace				   		= new WerecatRace(129);//NYI
	public static const WERERAVEN:WereravenRace			   		= new WereravenRace(130);//NYI
	public static const WEREBEAR:WerebearRace			   		= new WerebearRace(131);//NYI
	public static const RAT:RatRace						   		= new RatRace(132);//NYI
	public static const ABYSSAL_ELF:AbyssalElfRace		   		= new AbyssalElfRace(133);//NYI
	public static const SHEEP:SheepRace					   		= new SheepRace(134);//NYI
	public static const HOLLOW:HollowRace				   		= new HollowRace(135);
	public static const CAVESTALKER:CaveStalkerRace		   		= new CaveStalkerRace(136);//NYI
	public static const SUNPRAYINGMANTIS:SunPrayingMantisRace	= new SunPrayingMantisRace(137);//NYI
	public static const MOONREINDEER:MoonReindeerRace			= new MoonReindeerRace(138);//NYI
	public static const WEREDRAGON:WeredragonRace			   	= new WeredragonRace(139);//NYI
	public static const DUSKDRAKE:DuskDrakeRace			   		= new DuskDrakeRace(140);//NYI
	public static const KRAMPUS:KrampusRace			   			= new KrampusRace(141);
	public static const WYVERN:WyvernRace			   			= new WyvernRace(142);//NYI
	public static const SLOTHIEN:SlothienRace			   		= new SlothienRace(143);//partial NYI
	public static const WASP:WaspRace			   				= new WaspRace(144);//NYI
	public static const HORNET:HornetRace			   			= new HornetRace(145);//NYI
	public static const TITANUSGOJIRA:TitanusGojiraRace			= new TitanusGojiraRace(146);//NYI
	public static const MAGMAWYRM:MagmaWyrmRace			   		= new MagmaWyrmRace(147);//NYI
	public static const FROG:FrogRace			   				= new FrogRace(148);
	public static const CHAMELEON:ChameleonRace	   				= new ChameleonRace(149);
	public static const MOSQUITO:MosquitoRace	   				= new MosquitoRace(150);//NYI
	public static const GLACIALCOW:GlacialCowRace	   			= new GlacialCowRace(151);//NYI
	public static const GLACIALMINOTAUR:GlacialMinotaurRace	   	= new GlacialMinotaurRace(152);//NYI
	public static const SANDDRAKE:SandDrakeRace			   		= new SandDrakeRace(153);//NYI
	public static const ORGANIAN:OrganianAbominationRace   		= new OrganianAbominationRace(154);//NYI
	public static const MANDRAGORA:MandragoraRace			   	= new MandragoraRace(155);//NYI
	public static const BAALZEBUB:BaalzebubRace			   		= new BaalzebubRace(156);//NYI

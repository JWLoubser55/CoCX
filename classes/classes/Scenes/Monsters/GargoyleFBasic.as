...
package classes.Scenes.Monsters 
{
	...
	public class GargoyleFBasic extends AbstractGargoyle
	{
		...
		public function GargoyleFBasic() 
		{
			this.a = "the ";
			this.short = "basic gargoyle";
			this.imageName = "basic gargoyle";
			this.long = "You're currently fighting basic gargoyle. It's ten feet tall with feminine frame with bat wings and axe-like tail, but without any sexual characteristics. It stone body is without any cracks and she's using stone claws to slash enemies.";

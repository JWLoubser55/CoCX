...
public final class UndergarmentLib extends ItemConstants
	{
		...
		public const COW_BRA:Undergarment = new Undergarment("Cow Bra", "Cow Bra", "cow girl bra", "a cow girl bra", UT_TOP, 1000, 1, 1, 3, "This bra looks like an ordinary panty at first glance save for the cow-fur-like motif. They increase lacta bovina lactation rate as well as the efficiency of Milk blast. Comes with the bonus of accommodating just any breast size and letting milk flow through! \n\nType: Undergarment (Upper)");
		...
		public const F_LOIN_:Undergarment = new Undergarment("F. Loin", "Fur Loin", "Fur loincloth", "a Fur loincloth", UT_BOTTOM, 600, 0, 0, 1, "This white fur loincloth made from a material similar to yeti furs helps reduce the effect of cold environments. (+10% ice resistance) \n\nType: Undergarment (Lower)", "NagaWearable");
		...
		public const HBSHORT:Undergarment = new Undergarment("HBPanty", "HBShorts", "HB shorts", "a pair of HB shorts", UT_BOTTOM, 1500, 3, 3, 0, "these white long shorts are made from fabric capable of conducting soulforce. \n\nType: Undergarment (Lower)");
		...
		public const STPANTY:Undergarment = new Undergarment("STPanty", "S.T.Panties", "soul training panties", "a pair of soul training panties", UT_BOTTOM, 200, 0, 0, 0, "A pair of panties made from fabric capable of helping to train soulforce. \n\nType: Undergarment (Lower)");

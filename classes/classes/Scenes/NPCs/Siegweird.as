...
import classes.Scenes.SceneLib;
	...
	public class Siegweird extends Monster
	{
		...
		public function siegweirdMagicWeapon():void {
			...
			this.weaponAttack += (80 + (80 * (1 + player.newGamePlusMod)));
		...
		private function siegweirdSmash():void {
			...
			if (hasStatusEffect(StatusEffects.ChargeWeapon)) damage *= 10;
			else damage *= 7.5;
			if (hasStatusEffect(StatusEffects.BerzerkingSiegweird)) damage *= 2.5;
		...
		public function Siegweird() 
		{
			...
			this.hairLength = 5;
			initStrTouSpeInte(550, 510, 380, 360);
			initWisLibSensCor(360, 150, 150, -100);

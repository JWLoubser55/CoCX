...
public class ValkyrieScene extends BaseContent
	{
		...
		public function loseToValkyrie():void {
			...
			if (monster.lust >= 70) loseToValkyrieForcedOral();
				...
				if (player.spe > 50) player.addCurse("spe", 1, 2);
		...
		private function valkyrieLicksYou():void {
			clearOutput();
			outputText("You decide to take advantage of the valkyrie girl’s kneeling state. You walk up to her and open the crotch of your [armor], revealing your [vagina]. Before she can react, you grab the back of her blonde head and mash her face into your cunt. You tell her to lick, and to your surprise, she does so without hesitation.\n\n");

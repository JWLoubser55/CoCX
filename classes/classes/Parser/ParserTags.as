...
public class ParserTags {
    ...
    internal static var singleArgConverters:Object = {
        ...
        "bed"                   : function ():* { return CoC.instance.flags[kFLAGS.CAMP_CABIN_FURNITURE_BED] > 0 ? "bed" : "bedroll"; },
        ...
        "cabin"                 : function ():* { return CoC.instance.flags[kFLAGS.CAMP_CABIN_PROGRESS] >= 10 ? "cabin" : "tent"; },
        ...
        "font-fire"             : function ():* { return '<font color="'+"#9d4c00"+'">'; },
        "font-cold"             : function ():* { return '<font color="'+"#2199ff"+'">'; },
        "font-lightning"        : function ():* { return '<font color="'+"#766f00"+'">'; },
        "font-dark"             : function ():* { return '<font color="'+"#8000a9"+'">'; },
        ...
        "stuttername"           : function ():* { return CoC.instance.player.short[0]+"-"+CoC.instance.player.short; },
        ...
        "weaponoff"             : function ():* { return CoC.instance.player.weaponOffhandName; },
    ...
    internal static var conditionalOptions:Object = {
        ...
        "hasTail"       : function ():* { return CoC.instance.player.hasTail(); },
        "isbimbo"       : function ():* { return CoC.instance.player.hasPerk(PerkLib.BimboBrains) || CoC.instance.player.hasPerk(PerkLib.FutaFaculties) || CoC.instance.player.hasPerk(PerkLib.GentleGiant); },
        "isbro"       	: function ():* { return CoC.instance.player.hasPerk(PerkLib.BroBrains) || CoC.instance.player.hasPerk(PerkLib.FutaFaculties) || CoC.instance.player.hasPerk(PerkLib.GentleGiant); },

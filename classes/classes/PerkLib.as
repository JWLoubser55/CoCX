...
*/
		...
		public static const ExanimationII:PerkType = mk("Exanimation II", "Exanimation II",
				"You've lost the tether between your body and soul now are a Hollow. Gives racial status Hollow. Enables the use of Hollow passive 'Touch of the Damned'. (Hunger gauge deplete 30%(60%) faster, +25% Soulforce skills, +25% Hollow skills)");

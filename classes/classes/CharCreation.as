		...
		*/
		...
		private function ascensionPermeryMenu(page:int = 1):void {
			...
			if (page == 1) {
				...
				if (player.hasPerk(PerkLib.DragonPoisonousSapBreath) && player.perkv4(PerkLib.DragonPoisonousSapBreath) < 1) addButton(11, "D.PoisonSapB.", permanentizePerk1, PerkLib.DragonPoisonousSapBreath);
				else if (player.hasPerk(PerkLib.DragonPoisonousSapBreath) && player.perkv4(PerkLib.DragonPoisonousSapBreath) > 0) addButtonDisabled(11, "D.PoisonSapB.", "Dragon Poisonous Sap Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(11, "D.PoisonSapB.", "Dragon Poisonous Sap Breath");
				if (player.hasPerk(PerkLib.DragonRegalBreath) && player.perkv4(PerkLib.DragonRegalBreath) < 1) addButton(12, "D.RegalB.", permanentizePerk1, PerkLib.DragonRegalBreath);
				else if (player.hasPerk(PerkLib.DragonRegalBreath) && player.perkv4(PerkLib.DragonRegalBreath) > 0) addButtonDisabled(12, "D.RegalB.", "Dragon Regal Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(12, "D.RoyalB.", "Dragon Royal Breath");
				if (player.hasPerk(PerkLib.DragonWaterBreath) && player.perkv4(PerkLib.DragonWaterBreath) < 1) addButton(13, "D.WaterB.", permanentizePerk1, PerkLib.DragonWaterBreath);
				else if (player.hasPerk(PerkLib.DragonWaterBreath) && player.perkv4(PerkLib.DragonWaterBreath) > 0) addButtonDisabled(13, "D.WaterB.", "Dragon Water Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(13, "D.WaterB.", "Dragon Water Breath");
			}
			if (page == 2) {
				if (player.hasPerk(PerkLib.DarkSlimeEmpressCore) && player.perkv4(PerkLib.DarkSlimeEmpressCore) < 1) addButton(0, "E.D.Essence", permanentizePerk2, PerkLib.DarkSlimeEmpressCore);
				else if (player.hasPerk(PerkLib.DarkSlimeEmpressCore) && player.perkv4(PerkLib.DarkSlimeEmpressCore) > 0) addButtonDisabled(0, "E.D.Essence", "Empress's Dark Essence perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(0, "E.D.Essence", "Empress's Dark Essence");
				if (player.hasPerk(PerkLib.EnlightenedKitsune) && player.perkv4(PerkLib.EnlightenedKitsune) < 1 && player.hasPerk(PerkLib.EnlightenedNinetails) && player.perkv4(PerkLib.EnlightenedNinetails) < 1) addButton(1, "EnlightenedK", permanentizePerkEnlightenedKitsuneAndNinetails);
				else if (player.hasPerk(PerkLib.EnlightenedKitsune) && player.perkv4(PerkLib.EnlightenedKitsune) > 0 && player.hasPerk(PerkLib.EnlightenedNinetails) && player.perkv4(PerkLib.EnlightenedNinetails) > 0) addButtonDisabled(1, "EnlightenedK", "Enlightened Kitsune and Enlightened Ninetails perks are already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(1, "EnlightenedK", "Enlightened Kitsune and Enlightened Ninetails");
				if (player.hasPerk(PerkLib.FerasBoonAlpha) && player.perkv4(PerkLib.FerasBoonAlpha) < 1) addButton(2, "FerasB.A.", permanentizePerk2, PerkLib.FerasBoonAlpha);
				else if (player.hasPerk(PerkLib.FerasBoonAlpha) && player.perkv4(PerkLib.FerasBoonAlpha) > 0) addButtonDisabled(2, "FerasB.A.", "Feras Boon Alpha perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(2, "FerasB.A.", "Feras Boon Alpha");
				if (player.hasPerk(PerkLib.FerasBoonBreedingBitch) && player.perkv4(PerkLib.FerasBoonBreedingBitch) < 1) addButton(3, "FerasB.B.B.", permanentizePerk2, PerkLib.FerasBoonBreedingBitch);
				else if (player.hasPerk(PerkLib.FerasBoonBreedingBitch) && player.perkv4(PerkLib.FerasBoonBreedingBitch) > 0) addButtonDisabled(3, "FerasB.B.B.", "Feras Boon Breeding Bitch perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(3, "FerasB.B.B.", "Feras Boon Breeding Bitch");
				addButton(4, "Next", ascensionPermeryMenu, page + 1);
				if (player.hasPerk(PerkLib.FerasBoonMilkingTwat) && player.perkv4(PerkLib.FerasBoonMilkingTwat) < 1) addButton(5, "FerasB.M.T.", permanentizePerk2, PerkLib.FerasBoonMilkingTwat);
				else if (player.hasPerk(PerkLib.FerasBoonMilkingTwat) && player.perkv4(PerkLib.FerasBoonMilkingTwat) > 0) addButtonDisabled(5, "FerasB.M.T.", "Feras Boon Milking Twat perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(5, "FerasB.M.T.", "Feras Boon Milking Twat");
				if (player.hasPerk(PerkLib.FerasBoonSeeder) && player.perkv4(PerkLib.FerasBoonSeeder) < 1) addButton(6, "FerasB.S.", permanentizePerk2, PerkLib.FerasBoonSeeder);
				else if (player.hasPerk(PerkLib.FerasBoonSeeder) && player.perkv4(PerkLib.FerasBoonSeeder) > 0) addButtonDisabled(6, "FerasB.S.", "Feras Boon Seeder perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(6, "FerasB.S.", "Feras Boon Seeder");
				if (player.hasPerk(PerkLib.FerasBoonWideOpen) && player.perkv4(PerkLib.FerasBoonWideOpen) < 1) addButton(7, "FerasB.W.O.", permanentizePerk2, PerkLib.FerasBoonWideOpen);
				else if (player.hasPerk(PerkLib.FerasBoonWideOpen) && player.perkv4(PerkLib.FerasBoonWideOpen) > 0) addButtonDisabled(7, "FerasB.W.O.", "Feras Boon Wide Open perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(7, "FerasB.W.O.", "Feras Boon Wide Open");
				if (player.hasPerk(PerkLib.FireLord) && player.perkv4(PerkLib.FireLord) < 1) addButton(8, "FireLord", permanentizePerk2, PerkLib.FireLord);
				else if (player.hasPerk(PerkLib.FireLord) && player.perkv4(PerkLib.FireLord) > 0) addButtonDisabled(8, "FireLord", "FireLord perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(8, "FireLord", "FireLord");
				addButton(9, "Previous", ascensionPermeryMenu, page - 1);
				if (player.hasPerk(PerkLib.Flexibility) && player.perkv4(PerkLib.Flexibility) < 1) addButton(10, "Flexibility", permanentizePerk2, PerkLib.Flexibility);
				else if (player.hasPerk(PerkLib.Flexibility) && player.perkv4(PerkLib.Flexibility) > 0) addButtonDisabled(10, "Flexibility", "Flexibility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(10, "Flexibility", "Flexibility");
				if (player.hasPerk(PerkLib.Hellfire) && player.perkv4(PerkLib.Hellfire) < 1) addButton(11, "Hellfire", permanentizePerk2, PerkLib.Hellfire);
				else if (player.hasPerk(PerkLib.Hellfire) && player.perkv4(PerkLib.Hellfire) > 0) addButtonDisabled(11, "Hellfire", "Hellfire perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(11, "Hellfire", "Hellfire");
				if (player.hasPerk(PerkLib.InkSpray) && player.perkv4(PerkLib.InkSpray) < 1) addButton(12, "InkSpray", permanentizePerk2, PerkLib.InkSpray);
				else if (player.hasPerk(PerkLib.InkSpray) && player.perkv4(PerkLib.InkSpray) > 0) addButtonDisabled(12, "InkSpray", "Ink Spray perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(12, "InkSpray", "Ink Spray");
				if (player.hasPerk(PerkLib.LizanRegeneration) && player.perkv4(PerkLib.LizanRegeneration) < 1) addButton(13, "LizanRegen", permanentizePerk2, PerkLib.LizanRegeneration);
				else if (player.hasPerk(PerkLib.LizanRegeneration) && player.perkv4(PerkLib.LizanRegeneration) > 0) addButtonDisabled(13, "LizanRegen", "Lizan Regeneration perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(13, "LizanRegen", "Lizan Regeneration");
			}
			if (page == 3) {
				if (player.hasPerk(PerkLib.Lustzerker) && player.perkv4(PerkLib.Lustzerker) < 1) addButton(0, "Lustzerker", permanentizePerk3, PerkLib.Lustzerker);
				else if (player.hasPerk(PerkLib.Lustzerker) && player.perkv4(PerkLib.Lustzerker) > 0) addButtonDisabled(0, "Lustzerker", "Lustzerker perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(0, "Lustzerker", "Lustzerker");
				if (player.hasPerk(PerkLib.MagicalFertility) && player.perkv4(PerkLib.MagicalFertility) < 1) addButton(1, "MagicalF.", permanentizePerk3, PerkLib.MagicalFertility);
				else if (player.hasPerk(PerkLib.MagicalFertility) && player.perkv4(PerkLib.MagicalFertility) > 0) addButtonDisabled(1, "MagicalF.", "Magical Fertility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(1, "MagicalF.", "Magical Fertility");
				if (player.hasPerk(PerkLib.MagicalVirility) && player.perkv4(PerkLib.MagicalVirility) < 1) addButton(2, "MagicalV.", permanentizePerk3, PerkLib.MagicalVirility);
				else if (player.hasPerk(PerkLib.MagicalVirility) && player.perkv4(PerkLib.MagicalVirility) > 0) addButtonDisabled(2, "MagicalV.", "Magical Virility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(2, "MagicalV.", "Magical Virility");
				if (player.hasPerk(PerkLib.MaraesGiftButtslut) && player.perkv4(PerkLib.MaraesGiftButtslut) < 1) addButton(3, "MaraesGiftB.", permanentizePerk3, PerkLib.MaraesGiftButtslut);
				else if (player.hasPerk(PerkLib.MaraesGiftButtslut) && player.perkv4(PerkLib.MaraesGiftButtslut) > 0) addButtonDisabled(3, "MaraesGiftB.", "Maraes Gift Buttslut perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(3, "MaraesGiftB.", "Maraes Gift Buttslut");
				addButton(4, "Next", ascensionPermeryMenu, page + 1);
				if (player.hasPerk(PerkLib.MaraesGiftFertility) && player.perkv4(PerkLib.MaraesGiftFertility) < 1) addButton(5, "MaraesGiftF.", permanentizePerk3, PerkLib.MaraesGiftFertility);
				else if (player.hasPerk(PerkLib.MaraesGiftFertility) && player.perkv4(PerkLib.MaraesGiftFertility) > 0) addButtonDisabled(5, "MaraesGiftF.", "Maraes Gift Fertility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(5, "MaraesGiftF.", "Maraes Gift Fertility");
				if (player.hasPerk(PerkLib.MaraesGiftProfractory) && player.perkv4(PerkLib.MaraesGiftProfractory) < 1) addButton(6, "MaraesGiftP.", permanentizePerk3, PerkLib.MaraesGiftProfractory);
				else if (player.hasPerk(PerkLib.MaraesGiftProfractory) && player.perkv4(PerkLib.MaraesGiftProfractory) > 0) addButtonDisabled(6, "MaraesGiftP.", "Maraes Gift Profractory perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(6, "MaraesGiftP.", "Maraes Gift Profractory");
				if (player.hasPerk(PerkLib.MaraesGiftStud) && player.perkv4(PerkLib.MaraesGiftStud) < 1) addButton(7, "MaraesGiftS.", permanentizePerk3, PerkLib.MaraesGiftStud);
				else if (player.hasPerk(PerkLib.MaraesGiftStud) && player.perkv4(PerkLib.MaraesGiftStud) > 0) addButtonDisabled(7, "MaraesGiftS.", "Maraes Gift Stud perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(7, "MaraesGiftS.", "Maraes Gift Stud");
				if (player.hasPerk(PerkLib.MilkMaid) && player.perkv4(PerkLib.MilkMaid) < 1) addButton(8, "MilkMaid", permanentizePerk3, PerkLib.MilkMaid);
				else if (player.hasPerk(PerkLib.MilkMaid) && player.perkv4(PerkLib.MilkMaid) > 0) addButtonDisabled(8, "MilkMaid", "MilkMaid perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(8, "MilkMaid", "MilkMaid");
				addButton(9, "Previous", ascensionPermeryMenu, page - 1);
				if (player.hasPerk(PerkLib.Misdirection) && player.perkv4(PerkLib.Misdirection) < 1) addButton(10, "Misdirection", permanentizePerk3, PerkLib.Misdirection);
				else if (player.hasPerk(PerkLib.Misdirection) && player.perkv4(PerkLib.Misdirection) > 0) addButtonDisabled(10, "Misdirection", "Misdirection perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(10, "Misdirection", "Misdirection");
				if (flags[kFLAGS.NEW_GAME_PLUS_LEVEL] >= 2) {
					if (player.hasPerk(PerkLib.NinetailsKitsuneOfBalance) && player.perkv4(PerkLib.NinetailsKitsuneOfBalance) < 1) addButton(11, "9TKitsOfB", permanentizePerk3, PerkLib.NinetailsKitsuneOfBalance);
					else if (player.hasPerk(PerkLib.NinetailsKitsuneOfBalance) && player.perkv4(PerkLib.NinetailsKitsuneOfBalance) > 0) addButtonDisabled(11, "9TKitsOfB", "9T Kitsune Of Balance perk is already made permanent and will carry over in all subsequent ascensions.");
				}
				else addButtonDisabled(11, "9TKitsOfB", "9T Kitsune Of Balance");
				if (player.hasPerk(PerkLib.OneTrackMind) && player.perkv4(PerkLib.OneTrackMind) < 1) addButton(12, "OneTrackMind", permanentizePerk3, PerkLib.OneTrackMind);
				else if (player.hasPerk(PerkLib.OneTrackMind) && player.perkv4(PerkLib.OneTrackMind) > 0) addButtonDisabled(12, "OneTrackMind", "One Track Mind perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(12, "OneTrackMind", "One Track Mind");
				if (player.hasPerk(PerkLib.PureAndLoving) && player.perkv4(PerkLib.PureAndLoving) < 1) addButton(13, "Pure&Loving", permanentizePerk3, PerkLib.PureAndLoving);
				else if (player.hasPerk(PerkLib.PureAndLoving) && player.perkv4(PerkLib.PureAndLoving) > 0) addButtonDisabled(13, "Pure&Loving", "Pure And Loving perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(13, "Pure&Loving", "Pure And Loving");
			}
			if (page == 4) {
				if (player.hasPerk(PerkLib.PurityBlessing) && player.perkv4(PerkLib.PurityBlessing) < 1) addButton(0, "PurityBlessing", permanentizePerk4, PerkLib.PurityBlessing);
				else if (player.hasPerk(PerkLib.PurityBlessing) && player.perkv4(PerkLib.PurityBlessing) > 0) addButtonDisabled(0, "PurityBlessing", "Purity Blessing perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(0, "PurityBlessing", "Purity Blessing");
				if (player.hasPerk(PerkLib.RapierTraining) && player.perkv4(PerkLib.RapierTraining) < 1) addButton(1, "RapierTrain", permanentizePerk4, PerkLib.RapierTraining);
				else if (player.hasPerk(PerkLib.RapierTraining) && player.perkv4(PerkLib.RapierTraining) > 0) addButtonDisabled(1, "RapierTrain", "Rapier Training perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(1, "RapierTrain", "Rapier Training");
				if (player.hasPerk(PerkLib.SensualLover) && player.perkv4(PerkLib.SensualLover) < 1) addButton(2, "SensualLover", permanentizePerk4, PerkLib.SensualLover);
				else if (player.hasPerk(PerkLib.SensualLover) && player.perkv4(PerkLib.SensualLover) > 0) addButtonDisabled(2, "SensualLover", "Sensual Lover perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(2, "SensualLover", "Sensual Lover");
				if (player.hasPerk(PerkLib.TechOverdrive) && player.perkv4(PerkLib.TechOverdrive) < 1) addButton(3, "TechOverdrive", permanentizePerk4, PerkLib.TechOverdrive);
				else if (player.hasPerk(PerkLib.TechOverdrive) && player.perkv4(PerkLib.TechOverdrive) > 0) addButtonDisabled(3, "TechOverdrive", "Tech Overdrive perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(3, "TechOverdrive", "Tech Overdrive");

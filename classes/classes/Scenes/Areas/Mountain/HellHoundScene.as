...
//Merae's Lethicite
		...
		public function rapeCerberusStyle():void
		{
			...
			if(player.isRaceCached(Races.CERBERUS) && player.hasMutation(IMutationsLib.AlphaHowlIM) && player.hasMutation(IMutationsLib.HellhoundFireBallsIM) && player.perkv1(IMutationsLib.HellhoundFireBallsIM) >= 2) {
				var size:Number = 2.5;

...
public class EmberScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private function getMilkFromEmber():void {
        ...
        if (emberAffection() <= 25) {
            ...
            if ((player.hasStatusEffect(StatusEffects.DragonQuadElementBreathCooldown) && !player.perkv1(IMutationsLib.DrakeLungsIM) >= 2) || ((player.hasStatusEffect(StatusEffects.DragonDarknessBreathCooldown) || player.hasStatusEffect(StatusEffects.DragonFireBreathCooldown) || player.hasStatusEffect(StatusEffects.DragonIceBreathCooldown) || player.hasStatusEffect(StatusEffects.DragonLightningBreathCooldown)) && !player.perkv1(IMutationsLib.DrakeLungsIM) >= 1)) {
                if (player.hasStatusEffect(StatusEffects.DragonQuadElementBreathCooldown)) player.removeStatusEffect(StatusEffects.DragonQuadElementBreathCooldown);

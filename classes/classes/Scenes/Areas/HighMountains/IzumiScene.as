...
/**
	...
	public class IzumiScene extends BaseContent
	{
		...
		// Turn down the pipe -- still receive SOME effect from the smoke in the cave
		...
		protected function smokeJoins():void
		{
			...
			if (player.tallness < 108)
			{
				...
				outputText("\"<i>I think it’s about time you repaid me for my hospitality.</i>\"  She says, her eyes glittering dangerously in the firelight.  \"<i>After all, you came into my camp uninvited... that’s pretty rude, you know?  I think I might take offense to that.</i>\"  As she speaks, she slinks closer to you on all fours like some kind of predatory cat, about to make the final killing leap upon its helpless prey... Her personality has changed completely from the gentle giant you were speaking with a second ago.  You suddenly wonder if perhaps the smoke is somehow affecting her.\n\n");
		...
		protected function cowedIntoPuttingItInIntoHerGiantOniButt():void
		{
			...
			outputText("Her growing arousal is clearly beginning to get to her, as evidenced by her distant, lust-fogged stare - and the increasing force behind the backwards thrusting of her hips. Before long, she’s slamming her hips back into you with such vigor that you’re gripping her waist less for leverage and more simply to hold on.\n\n");
			...
			outputText("\"<i>Ohh, enjoying yourself too much to respond, huh?</i>\"  Izumi grins lazily, completely misconstruing your silence. Her arousal is written clear across her face, and her transparently lewd expression causes your already strained erection to ache urgently.  With herculean effort, you slam your waist upwards with renewed vigor, hammering home with punishing force as you feel your orgasm begin to rise up within you.  Your fingers clench tighter, digging into the yielding softness of Izumi’s hips, while she grunts and pants in equal parts surprise and arousal at your sudden enthusiasm.\n\n");
		...
		protected function littleChampLittleChampFuckhugeOniIsCominTaEatcha():void
		{
			...
			outputText("If Izumi finds your behavior odd, she doesn’t show it; her pace doesn’t let up for a second, and before long you find yourself hurtling towards an explosive orgasm.  You tremble in Izumi’s grip as you feel it building, and when it hits, it hits hard: You actually lose your grip, tumbling free of Izumi, wailing in tortured ecstasy as the Oni’s talented tongue brings you over the top.  Even while you jackknife in her grip, Izumi doesn’t give you any leeway, continuing her heartless assault in order to drag out your orgasm for as long as humanly possible.  By the time it finally ends, you’re hoarse from screaming - you’re almost certain that Izumi actually managed to make you orgasm over again while still in the middle of your spasming madness.\n\n");
		...
		protected function gonnaGetMeSomeRevengeButtsexin():void
		{
			...
			function bigF():void {
				...
				outputText("\"<i>Hey!  Hang on!  I mean, wait, n-no, you can’t- Nnngh!</i>\"  Izumi gabbles helplessly as your rapid-fire thrusts combine with your assault on her breasts to overwhelm her defenses.  She throws back her head and lets out a strangled squeak, her eyes roll back into her head, and suddenly you feel as though her entire body has just clamped down on your dick at once.\n\n");

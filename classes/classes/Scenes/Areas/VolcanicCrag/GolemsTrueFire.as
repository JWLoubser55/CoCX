...
public class GolemsTrueFire extends AbstractGolem
	{
		...
		override protected function performCombatAction():void
		{
			if ((this.lust100 >= 85 && rand(2) == 0) || this.lust100 < 85) {
				if (hasStatusEffect(StatusEffects.Provoke)) {
					...
					if (choiceP == 1) backhand2(2);
					if (choiceP == 2) overhandSmash2(2);
		...
		public function GolemsTrueFire() 
		{
			...
			this.plural = true;
			initStrTouSpeInte(675, 635, 490, 20);

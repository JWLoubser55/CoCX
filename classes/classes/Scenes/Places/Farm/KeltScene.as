...
private function keltFirstTime():void {
	...
	outputText("As you get closer, however, the figure comes into view.  The rider is not Whitney, but rather a muscular man.  And the horse has no head... where its head should be is... with a start, you realize that this is no horse and rider.  The figure is a large, male centaur!\r\r");
	outputText("Wariness growing, you slow down.  But it is too late... the centaur has seen you.  With a snort, he gallops closer, imposingly tall.  You drop into a fighting stance, ready if he should attack you, and the centaur draws to a halt a few feet away.\r\rHe looks scornfully at you, and laughs, ");
	outputText("\"<i>Don't be stupid.  You'd never even get close to me.  If I wanted to kill you, you would have been dead a long time ago.  My name is Kelt.</i>\"\r\r");
	...
	outputText("\"<i>Like my bow?  As well, you should.  This is a real warrior's weapon!  If you want to learn someday, visit me again.  Maybe if you're not too stupid, you will be able to learn something.  I won't cross my fingers.</i>\"\r\r");
...
private function defySubmission():void {
	clearOutput();
	outputText("In defiance to your submissiveness to Kelt, you suddenly shake your head and return to your camp.");
	doNext(camp.returnToCampUseOneHour);
}
private function defySubmissionAndFight():void {
	clearOutput();
	outputText("In defiance to your submissiveness to Kelt, you suddenly shake your head and you finally decide. That's it. That centaur must be punished! It's time you turn the tables against him.");
	doNext(kelly.fightToBeatKelt);
}

public function fightToBeatKeltVictoryHP():void {
	clearOutput();
	outputText("Too weak to continue fighting, Kelt collapses.");
	chooseToFinishKelt()
}
public function fightToBeatKeltVictoryLust():void {
	clearOutput();
	outputText("Overwhelmed by his desires, Kelt collapses.");
	chooseToFinishKelt()
}
...
private function youBadEndKeltForGood():void {
	...
	inventory.takeItem(weaponsrange.BOWKELT, camp.returnToCampUseOneHour);
}
...
private function keltRequiresNakedness():void {
	...
	outputText("\"<i>I can't teach you like this,</i>\" he sneers.  \"<i>Your balance is all fucked up.  I know colts who can shoot better than you.  You really want to learn the skill?  Then you're gonna have to practice like a centaur.  You'd never see me wearing armor!</i>\"\r\r");
	...
	if(player.cor + player.lib + player.lust >= 180) {
		outputText(" Of course, you do.  You love putting on a show.");
		// go eagerly.
...
private function keltEagerlyGetNaked():void {
	...
	if(player.gender == 1 && player.biggestTitSize() < 1) outputText("\"<i>What are you, a girl?  Get on with it so I can see what I'm dealing with.</i>\"\r\r");
	else {
		...
		else outputText("\"<i>Oooh, doesn't that look yummy?  Be honest... you wanna learn to shoot?  You'll be slapping yourself in the tits with every shot!  Heh... I bet that's the way you like it too!  Time to change your profession, slut.  Wet nurse and milk cow... they're just about all you're suited for!</i>\"\r\r");
	}
	...
	if(player.butt.type < 6) outputText("\"<i>Well, someone works out!  Got a nice, tight little ass there! Probably a little too tight, huh?  Don't worry, you can tell me... do the mean old monsters hurt when they fuck that poor little ass of yours? HA!</i>\"\r\r");
	//(Medium, Large to Heavy:
	else if(player.butt.type < 13) outputText("\"<i>Hey, nice little cushion you got back here!  Do you get that from sitting around all day?  Nah, can't be that.  I'm sure you get more than a workout on this baby... of course, cock is no substitute for a little exercise, you know!</i>\"\r\r");
...
private function keltReluctantlyGetNaked():void {
	...
	outputText("He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But when I tell you to strip, you do it a little faster next time... or I might not be so generous.</i>\"\r\r");
...
private function keltRequiresBlowjobs():void {
	...
	outputText("\"<i>Enjoying the sights, are we?</i>\"\r\r");
	outputText("You blink, startled.  While you were thinking, Kelt approached you, and you were staring directly at his crotch.  He leers down at you with an arrogant grin.  Flushed, you stammer out that you're here for more archery lessons.  He snorts, clearly amused.\r\r");
	outputText("\"<i>Yeah, I'll bet.  When they talk about firing shafts, whore, they're talking about arrows.  Bet you would prefer the other kind though, huh?</i>\"\r\r");
	...
	outputText("\"<i>Well, I think you've had enough freebies.  Maybe I don't wanna teach you anymore.  After all... what do I get from it?  I spend all day teaching a moron how not to shoot [him]self in the foot, and I got nothing to show for it.  I think it's about time you put down a little payment.</i>\"\r\r");
	...
	outputText("\"<i>I don't want your fucking money.  What am I gonna buy... hentai comics and scholar tea?  Fuck off.  You want to learn more about archery?  Then it's about time you showed some gratitude.</i>\"\r\r");
	...
	outputText("\"<i>You know the price, slut. You want archery lessons, and I want to blow my load in that throat of yours. Everyone wins. Now get started.</i>\"\r\r");
...
private function keltBlowjobRequirementNever(newl:Boolean = true):void {
	...
	outputText("You have just a moment to react, as the tone suddenly shifts.  Kelt, who has been stomping and cussing angrily, has decided on a new target.  Training remembered, you roll to the side just as Kelt rears and brings his front two hooves down where your head was moments earlier.\r\r");
	...
	outputText("\"<i>Stupid slut.  Refuse me, huh?  ME?  Well FUCK you and the [legs] you walked in on!  You wanna shoot arrows, go learn how to do it yourself!  Better idea... go to the fucking desert, find a demon, and fucking BEG him to make you his ass slave.  Go on!  Fuck off, slut!</i>\"\r\r");
	...
	outputText("But the feeling is weaker now.  Whatever it was that kept you bound to him seems to be fading now, albeit slowly.  A shiver of desire runs through you, even so.  It may be a long recovery.\r\r");
	//(Kelt never encountered again)
	player.createStatusEffect(StatusEffects.KeltOff,0,0,0,0);
	doNext(camp.returnToCampUseOneHour);
}
...
private function keltBlowjobRequirementShamefully(newl:Boolean = true):void {
	...
	outputText("The thought of going through with it is appalling.  The thought of not wrapping your lips around that glorious member is equally unthinkable.\r\r");
	...
	outputText("\"<i>Mmm...I knew it from the moment I saw you.  Quite the talented little cocksucker you are.  Deeper, bitch.  I want you to choke on my spunk.</i>\"\r\r");
	...
	outputText("\"<i>Ahhh, yeah... fuck, bitch, you sure feel pretty good.  I could get used to this.  How about you, huh?  You like the taste of my cock, little whore?</i>\"\r\r");
	...
	outputText("\r\rKelt moves aside, looking down at you with a smug look of satisfaction.  You weakly wave him off, embarrassed by what you just did, and he laughs nastily.\r\r");
	outputText("\"<i>Get used to it, bitch.  Gotta say, you took that pretty well.  Barely a drop lost.  Good.  Because if you tried to spit up my cum, I'd have to make sure to deposit a second load.</i>\"\r\r");
	outputText("\"<i>Here's the rule.  You want archery lessons?  Fine.  I'll keep teaching you, stupid bitch that you are.  But when I say so, you kneel and take your turn.  If I have to teach an ugly slut like you, the least you can do is choke one down.  Lesson's over.  See you tomorrow, bitch.</i>\"\r\r");
	...
	outputText("It may be unhealthy, to keep going back to him.  Of course, you could always say no, right?  He is a good teacher.  And... and would it be so bad to suck him off a few more times?  That wouldn't be so bad... would it?\r\r");
...
private function keltBlowjobRequirementEagerly(newl:Boolean = true):void {
	...
	outputText("It is like someone answered your prayers.  You eagerly agree, babbling your thanks to Kelt as you are faced with the massive cock, growing harder and harder.  He snorts scornfully.\r\r");
	outputText("\"<i>I didn't ask for your thanks, slut,</i>\" he says cruelly.  \"<i>I asked for you to suck my cock.  Now open wide and choke it down, or I'm aiming for your ass.</i>\"\r\r");
...
private function keltMainEncounter():void {
	...
	//(Submissive 30-70:
	else if(player.statusEffectv2(StatusEffects.Kelt) <= 70) outputText("You nod reluctantly, and Kelt grins.  He may be arrogant, but he is rather good.  ");
	//(Submissive 70-100:
	else outputText("You nod enthusiastically, almost begging him to teach you.  ");

	//(Before Naked Requirement)
	if(player.statusEffectv3(StatusEffects.Kelt) <= 3) {
		outputText("Kelt seems to find the idea of training a human almost comical, but suggests that if you want to follow him around for a while, he has no problem with it.  Though his attitude is annoying, you resolve to learn what you can.\r\r");
	}
...
private function keltMainEncounterAfterNakedReq():void {
	...
	if(player.hasStatusEffect(StatusEffects.NakedOn)) {
		outputText("He nods, smirking slightly, and gestures at your clothes impatiently.  With some pleasure, you strip down before him, discarding your clothes with a little flair.  Kelt is grinning by the end, openly admiring your body, and you feel a little more aroused for obeying his dominant command.\r\r");
		//(+5 Submissive)
	...
	//(Naked Off)
		...
		if(rand(10) <= 5) {
			...
			//(Otherwise:
				...
				outputText("\r\rYou're not certain you want to practice naked again... particularly with the way Kelt is looking at you, his arrogant smirk plastered on his face.  Do you agree to his terms?");
...
private function keltMainEncounter2():void {
	...
	//(Bow equipped)
		...
		outputText("Kelt sneers as he looks at your range weapon, \"<i>You're still using that rotten old thing?  Well, it will do.  We'll just have to shoot for the close targets.</i>\"\r\r");
		outputText("Together, the two of you head off to the practice field.\r\r");
	}
...
private function keltMainEncounter3():void {
	...
	//(Clothed)
	if(!player.hasStatusEffect(StatusEffects.NakedOn)) {
		outputText("Kelt is arrogant, crude, and all too often cruel as he mocks your attempts at archery again and again.  Despite all this, however, he obviously does know what he's doing.  You try to ignore his insults and lewd comments as good as you can and focus on the archery.  In the end, you feel you've learned a lot, though Kelt remains snide.\r\r");
		switch (rand(4)) {
			case 0:
	...
	//NAKERS
		...
		if (player.inHeat && player.gender > 1) {
			...
			outputText("You lean over to pluck the arrow from the haystack, and feel a sharp blow to the back of your head, knocking you over and sending your consciousness spinning.  Dizzily, you realize Kelt is standing over you, tossing aside the bow he just used to crack you in the head.  Between his horse legs, a massive manhood is dropping from his sheath, flanked by testes the size of softballs.  A lewd grin is on his face.\r\r");
			outputText("\"<i>Did you think I wouldn't notice, slut?  You reek like a mare in heat.  I could smell it on you the moment you arrived.  Fortunately, I know just what to do with a fertile bitch.  Let's put a baby centaur in that tight pussy of yours.</i>\"\r\r");
			outputText("Kelt's forelegs rear up just enough to plant them around your shoulders, his massive weight bearing down on you.  The bale of hay lifts you just high enough to line up with his fat erection, which presses between your asscheeks even now.\r\r");
			//(Submissive, 0-30:
			if(player.statusEffectv2(StatusEffects.Kelt) <= 30) outputText("You struggle as good as you can, but Kelt weighs a good deal more than you do.  As his thrusting hips anxiously press his cock to your nether-lips, you realize this is going to happen, whether you want it to or not.  The thought fills you with an undeniable shiver of pleasure.\r\r");
			//(Submissive, 30-70:
			...
			//(Vagina, Small:
			if(player.vaginalCapacity() <= 16) outputText("The fit seems impossible, but Kelt couldn't care less about your comfort, and shoves the flared head into you without hesitation.  You let out a scream, feeling like you are being torn apart by his cock as it rudely presses against your insides, spreading you wide open.  Kelt thrusts with growing frustration, but can fit no more than half his cock inside of you, despite his best efforts.  Every twitch makes you cry out as your tight pussy squeezes and milks that massive organ.\r\r");
			//(Vagina, Medium:
			...
			outputText("\"<i>Not too bad, not too bad!  You make for a pretty decent fuck!  Maybe after you bear a couple of my foals, I'll add you to my harem.  You'd like that, wouldn't you?  You just can't wait to get a bellyful of centaurs, can you?</i>\"\r\r");
			//(Submissive, 0-30:
			if(player.statusEffectv2(StatusEffects.Kelt) <= 30) outputText("You shiver and groan, unable to help yourself.  It is clear that Kelt has every intention of breeding you, and you are helpless to stop the urges of your body.  Terrifying images of being raped daily by this cruel beast fill your head... of your belly swelling with his young again and again.  You let out a moaning cry, and orgasm helplessly even as Kelt laughs.\r\r");
			//(Submissive, 30-70:
			...
			outputText("\"<i>Alright, slut... here comes your baby!</i>\"\r\r");
		...
		if(temporary == 3) {
			...
			outputText("To your surprise, he suddenly leans forward, fist moving towards your head.  You raise your arms to deflect the blow, but he changes tactics suddenly and grabs one of your " + breastDescript(0) + " instead.  You stiffen, but before you can react further, he squeezes them brutally, mauling your breasts roughly with his hands.\r\r");
			//(Small Size, A-DD:
			if(player.biggestTitSize() <= 5) outputText("\"<i>Ha!  Even with your itty-bitty-titty, you have to admit to a certain... weakness, is it?  Awfully sensitive, aren't they?  Ooh, am I making the little girl wet?  Naughty slut!</i>\"\r\r");
			//(Medium Size, E-HHH:
			else if(player.biggestTitSize() <= 11) outputText("\"<i>Just look at these mommy melons!  You want to be an archer?  I'm amazed you don't slap yourself in the tits with every shot!  Easy target to grab onto.  But hey, I bet you like it that way.  Like it when people grope these fat titties of yours?</i>\"\r\r");
			//(Big Size, Watermelon and beyond:
			else outputText("\"<i>Look at you! You're a miracle of science, you are... any other creature would break their back, trying to haul these milk bags around!  Tell the truth, now... which one of your parents was actually a cow?</i>\"\r\r");
			outputText("Despite his cruel words, you can't help but groan a little bit as he brutalizes your sensitive chest.  Kelt seems to take a good deal of pleasure in how helpless you are, pinching and flicking your " + nippleDescript(0) + "s.\r\r");
			//(Milk)
			if(player.biggestLactation() > 1) {
				outputText("Inevitably, beads of milk appear on the tips of your breasts, and Kelt lets out a hoot of laughter.\r\r");
				outputText("\"<i>Oh, boy!  Mommy here brought snacks for everyone!  Don't mind if I do!</i>\"\r\r");
				...
				outputText("\"<i>Not bad, for a cow.  You certainly seemed to enjoy it too.</i>\"\r\r");
				outputText("Even released, your teat continues to drizzle slightly, spilling your milk shamefully on the ground as Kelt continues to squeeze your breasts.\r\r");
				//You've now been milked, reset the timer for that
				player.addStatusValue(StatusEffects.Feeder,1,1);
				player.changeStatusValue(StatusEffects.Feeder,2,0);
			}
			outputText("\"<i>Take it from me, bitch.  Know your place.  Breasts are for women, and women are for fucking until their bellies are full of foals.  'Teach me archery, Kelt!'  Ha!  Now that's a joke.</i>\"\r\r");
		...
		if(temporary == 4)
		{
			...
			outputText("\"<i>THERE.  Is that what you fucking wanted, whore?  Something nice to fill that ass of yours?  Bet it feels good, huh? Bet you were fucking DREAMING of a nice, fat cock up your ass.  Well, here you go!  Feel better now that you're being fucked, slut?</i>\"\r\r");
			...
			outputText("\"<i>Okay.  Now that our little bitch is getting an assfuck, maybe she'll be satisfied enough to hit the fucking target.  Now shoot... and don't you dare fuck this up again.</i>\"\r\r");
			outputText("Groaning, distracted and unnerved, you hurriedly line up the shot as good as you can.  Kelt's fingers flex, forcing you to stand up straighter.  Your arm shakes as you take aim, and you can feel Kelt's hot breath on your hair, and then the arrow is flying!  Ten meters... five... bullseye!\r\r");
			outputText("With a snort, Kelt shoves you to the ground, removing his fingers as he does so.  Wincing, you sit up with the centaur staring down at you snidely.\r\r");
...
private function keltMainEncounterPostBlowjob():void {
	...
	if(player.hasStatusEffect(StatusEffects.BlowjobOn)) {
		...
		if (player.lust >= 75 || player.statusEffectv2(StatusEffects.Kelt) >= 90 && rand(2) == 0) {
			...
			outputText("\"<i>Bitch!  I said get in there.  Do I need to repeat myself, you stupid whore?\"</i>\r\r");
			...
			if(player.looseness(false) < 3) outputText("\"<i>Fuck!  About time!  Sure got a tight little ass back here, but don't worry, slut.  We'll stretch it out in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\r\r");
			...
			outputText("\"<i>Now stay there for a while, bitch.  Let it get good and stuck up there.  Come back tomorrow, and maybe, if you're lucky, I'll fuck you again.  You do, after all, make a pretty good cumdump.</i>\"\r\r");
			...
			player.slimeFeed();
			//(+10 Submissiveness)
			if(player.buttChange(70,true)) outputText("\r\r");
			player.addStatusValue(StatusEffects.Kelt,2,10);
			player.orgasm();
			dynStats("cor", 1);
			return;
		...
		//(Otherwise)
			...
			outputText("\"<i>Alright, bitch.  Swallow my cock.</i>\"\r\r");
			...
			outputText("\"<i>Pretty good, slut.  I knew there was a reason I kept you around.  I've indulged you enough, though.  Get over there and shoot some arrows, before I get bored with you.</i>\"\r\r");
	...
	//(Blowjob Requirement Off, 40% Chance)
		...
		outputText("You move towards the practice field, trying to ignore the way Kelt openly and hungrily eyes your naked body.  He has become more and more open about his lust for you.  Despite yourself, you can't help but enjoy his attentions.\r\r");
		outputText("Once at the field, you move to draw an arrow and begin practice, when Kelt roughly pushes you down to your knees.\r\r");
...
private function keltSubmitGivingBJ():void {
	...
	outputText("Reluctantly, with shame burning in your cheeks and desire ravaging your mind, you lower yourself before him and do just that.\r\r");
...
private function keltCentaurBadEnd():void {
	...
	outputText("\"<i>So... just had to get a taste of what it is like, huh?  Good for you... I like you this way.  Yes... I can work with this.</i>\"\r\r");
	outputText("He paces around you, and you stand at attention, quivering with pleasure at his compliments.  Involuntarily, you feel your horselike tail raise high into the air, as if to show off your nethers as well.  Kelt takes a moment to inspect them, obviously enjoying himself.\r\r");
	sceneHunter.selectGender(dickF, vagF, assF, null, -1);

	//==================================================
	//(Male)
	function dickF():void {
		outputText("\"<i>Hmph.  Still technically male, huh?  What, you call this a cock?</i>\"\r\r");
		...
		outputText("\"<i>Well, I've got no use for males, slut.  Fortunately, you still have something I can use in the meantime.</i>\"\r\r");
		outputText("His legs rear suddenly, wrapping around the barrel of your body. You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ");
		outputText("<b>... It was for him to fuck you!</b>\r\r");
	...
	function assF():void {
		outputText("\"<i>");
		if(player.gender == 0) outputText("Ha!  What the fuck are you supposed to be?  No cock, no cunt?  ");
		outputText("Well, no matter, bitch.  You've still got what I want.</i>\"\r\r");
		...
		outputText("\"<i>Well, man or woman, it doesn't matter to me.  You're still only good for one thing.  Time to give you a purpose, slut.</i>\"\r\r");
		outputText("His legs rear suddenly, wrapping around the barrel of your body.  You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ");
		outputText("<b>... It was for him to fuck you!</b>\r\r");
		outputText("Kelt does not hesitate in aserting his dominance, and immediately pushes his shaft towards your ass, inserting it with ease.  You let out an almost feral cry of pleasure, and Kelt laughs nastily as he gets a better grip and sinks his erection in deeper, humping away at your hindquarters needfully.  His human hands wrap around you, taking hold of your chin and forcing you to turn enough to face him as he savors your wincing moans.\r\r");
		outputText("\"<i>As I thought,</i>\" he sneers, thrusting particularly hard and making you whimper with need.  \"<i>You're no stud.  Just another gelding, wishing to be a real woman.  Well, I could use another cumdump, slut.  So consider this your initiation.  You're mine now, to use whenever I feel like it.  Hope you like the feeling of my cock, bitch.  It's gonna be the only thing you feel for a long time.</i>\"\r\r");
	...
	function vagF():void {
		...
		if(player.gender == 3) {
			clearOutput();
			outputText("\"<i>Ooh, the slut is packing, is she?  Tell me, how's that cock working out for you?</i>\"\r\r");
			outputText("It isn't, of course.  Not at all... you are entirely flaccid, and Kelt knows it.  He grasps the base of your cock roughly, giving it a few experimental tugs, laughing derisively as he does so.  There is no reaction... save that your cunt gets a little wetter.\r\r");
			outputText("\"<i>Well, no matter.  This here is what I came for.</i>\"\r\r");
		}
		//(Both)
		...
		outputText("\"<i>Aww... we sure got a pretty little filly here, don't we?  Still, a filly isn't really happy unless she's being fucked.  Unless her stomach is full of foals for her master.  And since you've gone to the trouble of preparing yourself for me, bitch... I guess I'll just have to do the job.</i>\"\r\r");
...
private function keltSubmissiveBadEnd():void {
	...
	outputText("\"<i>Archery?  I've had enough of this game, bitch.  I've decided that I won't be teaching you archery anymore.</i>\"\r\r");
	outputText("A sense of dread fills you.  No more lessons?  No more... Kelt?  Then, another shock of pain as he roughly grabs you by the hair, drags you over to a nearby bale of hay, and throws you onto it facedown.  Moments later, his heavy weight rests on top of you, swollen cock pressing into your back.\r\r");
	outputText("\"<i>No, no more archery.  Time for your real education, bitch.  Lesson one... you are a slut, only here for my pleasure.  No more adventuring, no more exploring.  From now on, you are nothing but a hole for me to bust a nut into.  Got it?</i>\"\r\r");
	outputText("You whimper with joy, thanking him over and over again.  A great weight has been lifted, your true purpose revealed.  How could you have not known it before?  Kelt is your master, and you are nothing but his needy slut!  The revelation fills you with ecstasy.  Eagerly you thrust back up against him, eager to be filled, desperate for satisfaction.  He grinds into you, grinning wickedly all the time.  Then, mercifully, he pulls back enough to line up his shot, and fills your ass with his cock.\r\r");
	outputText("\"<i>Ungh!  There's a good bitch.  From now on, you're mine, and mine only.  If you dare to fuck another creature, I will kill you.  Be a good slut, though, and maybe I'll give you a few foals to fill that belly.  Now moan for me, bitch.  I wanna hear you scream as I make you mine.</i>\"\r\r");
...
private function keltBadEndEpilogue():void {
	...
	outputText("\"<i>Ha!  Little bitch human, who thinks she knows how to use a sword.  You use that little stick to ward off the big bad monsters when they come for your little pussy?  Give me a break.  This is a real man's weapon.</i>\"\r\r");
	outputText("He touched the bow strung across his broad chest arrogantly.  The heroine hesitated, looking at the weapon.  They had bows like that in her hometown, but she didn't have one.  It could be a useful tool... and the centaur seemed to know what he was doing with it.  He didn't seem threatening... maybe a little arrogant, and more than a little rude.  Maybe...\r\r");
	outputText("The centaur noticed her looking, and grinned.  \"<i>You like what you see?  Maybe I could teach you a few things.  If you're not as stupid as that slut, of course.</i>\"\r\r");
	outputText("He waved confidently at the mare, still nursing her young with a rapturous look on her face.  Cum slowly oozed out of her pussy, pooling on the ground beneath her, and the heroine felt a little envious for a moment.  Most horses had harems, the virile male satisfying many women at once.  How many times a day was this mare fucked?\r\r");
...
public function fuckKeltsShitUp():void {
	...
	if (player.faceType == Face.SNAKE_FANGS && player.tongue.type == Tongue.SNAKE && player.isNaga()) {
		...
		sceneHunter.selectGender(
			curry(sceneHunter.callBigSmall, nagaDickF, 10, -1, "length"),
			player.hasVagina() ? nagaVagF : null,
			player.hasVagina() ? null : nagaAssF
		);

		//==========================================
		//If male/hermaphrodite
		function nagaDickF(x:int):void {
			var x1:int = x + 1;

			//Single cock:
			if(player.cockTotal() == 1) {
				outputText("\"<i>Pretty pony stepped on a snake.  Now pretty pony has to pay the price,</i>\" you say, sighing as you part your lips and allow your [cock "+x1+"] to slide out and feel the fresh air.\n\n\"<i>You put that in my mouth and I will bite it off,</i>\" snarls Kelt.\n\n\"<i>Will you?</i>\" you sneer. \"<i>I will grow one back.  You, on the other hand, will die a slow, agonising death.  Be smart.</i>\" He stares up at you, and yes, it's fear: pure, animalistic fear of a horse for a viper.  You open your mouth and bare your fangs in a wide, triumphant smile at him; venom dribbles down your chin.  He lowers his eyes and opens his mouth in submission.  Needing no further invitation, you slide your [cock "+x1+"] into his mouth, massaging your hands into his hair as you do so.\r\r");
			...
			//Multiple dick:
				...
				outputText("\"<i>Pretty pony stepped on a snake.  Now pretty pony has to pay the price,</i>\" you say, sighing as you part your lips and allow your cocks to slide out and feel the fresh air.  You idly slap your [cock "+x1+"] against his face. \"<i>You put that in my mouth and I will bite it off,</i>\" snarls Kelt.\n\n\"<i>Will you?</i>\" you sneer.  \"<i>I will fuck your mouth with the next one. Then I'll grow the first one back and come and fuck you with that one again!  Be smart.</i>\"  He stares up at you, and yes, it's fear: pure, animalistic fear of a horse for a viper.  You open your mouth and bare your fangs in a wide, triumphant smile at him; venom dribbles down your chin.  He lowers his eyes and opens his mouth in submission.  Needing no further invitation, you slide your [cock "+x1+"] into his mouth, massaging your hands into his hair as you do so; your semi-distended " + cockDescript((x+1) % player.cockTotal()) + " bumps into his chin, an impossible-to-ignore reminder of your threat.\r\r");
			...
			if(player.cocks[x].cockLength < 10) {
				...
				outputText("\"<i>Oh, you're soooo good at that,</i>\" you sigh, as he silently drinks your seed, his face a rictus of agonised arousal.  \"<i>That's right, take it all down.  Who would've guessed that you're a champion cocksucker?  Maybe if you drop the tough guy act, I'll let you do it some more.  We can find some pink dye for you, maybe some succubus milk, and then you can look like the pretty pony you... really... are!</i>\"\r\r");

				outputText("You punctuate these last words with three final thrusts and then, spent, slowly withdraw your [cock "+x1+"] from his mouth, spit and cum trailing on your captive's lips.  Smirking, you loosen your bonds just a little by withdrawing your tail from his ass.  Kelt doesn't even orgasm; he raggedly moans as cum simply drools out of his abused dick by the bucket load.\r\r");
			} else {
				outputText("Slowly but surely you feed more of your formidable member into his mouth until you feel the back of his throat, with most of your [cock "+x1+"] still outside his lips.  The centaur is now entirely engaged with your length, moving his head back and forth as his tongue slathers it with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, moving his head in rhythm with your own movements.\r\r");

				outputText("You feel a mighty groan around your [cock "+x1+"] and your snake tip feels Kelt's cock begin to pulse urgently.  Quickly and expertly, you wrap the end of your tail around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cock.\r\r");

				outputText("\"<i>Ah, ah, ah,</i>\" you hiss.  \"<i>Sluts don't get off before their masters.</i>\"  A wicked idea strikes you.  Whilst still holding onto the centaur's cock with your coils, you begin to wind the tip of your tail towards Kelt's ass.  It isn't easy; you have invested the entirety of your frame into holding onto the centaur, so it is by measures that you constrict him tighter as your tail inches towards his anus.  He is bone-crushingly gripped in your coils by the time you find his sphincter, which you softly but surely sink your tip into.  Kelt struggles with the last of his strength against this final humiliation, but there is nothing he can do; with your venom plaguing his limbs, your coils wrapped hard around his frame, and your cock buried in his face, you have robbed him of everything.  Slowly you begin to feed even more of your [cock "+x1+"] into his mouth, until you see his throat bulge with your manhood.  The tightness of it is sensational and you groan.  You let him get used to the sensation of deepthroating you before you begin to pick up the pace, ramming the majority of your dick into his mouth until your [balls] begin to slap against his chin.  At your other end you feel your snake tip touch something which pulses, and you gently probe it as you continue to roughly fuck his mouth, beginning to reach your peak.  Kelt only manages a few muffled screams as you milk his prostate while continuing to deny his cock release, before you silence him with a torrent of cum, pouring it directly into his stomach.\r\r");
		...
		function nagaVagF():void {
			...
			outputText("Girl cum begins to drip down Kelt's chin.  He is now entirely engaged with your " + vaginaDescript(0) + ", moving his head back and forth as his tongue slathers your clit with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, forcing his head this way and that so that no corner of your pink opening goes without attention.\r\r");

			outputText("You feel a mighty groan and Kelt's cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cunt.\r\r");
		...
		function nagaAssF():void {
			...
			outputText("\"<i>Ah, ah, ah,</i>\" you hiss.  \"<i>Sluts don't get off before their masters.</i>\"  A wicked idea strikes you.  Whilst still holding onto the centaur's cock with your coils, you begin to wind the tip of your tail towards Kelt's ass.  It isn't easy; you have invested the entirety of your frame into holding onto the centaur, so it is by measures that you constrict him tighter as your tail inches towards his anus.  He is bone-crushingly gripped in your coils by the time you find his sphincter, which you softly but surely sink your tip into.  Kelt struggles with the last of his strength against this final humiliation, but there is nothing he can do; with your venom plaguing his limbs, your coils wrapped hard around his frame, and his tongue buried in your ass, you have robbed him of everything.  His saliva coats your opening as you clench your muscles and trap his tongue deep inside before roughly rubbing your [butt] against him, face-fucking him for all you are worth; the soft, slippery sensation inside you is immense and you pick up the pace.  At your other end you feel your tip touch something which pulses deep in his anal passage, and you gently probe it as you roughly fuck his mouth, beginning to reach your peak.  Kelt only manages a few muffled screams as you milk his prostate while continuing to deny his cock release, before you feel something clench inside of you and you begin to ride your strange but satisfying anal orgasm.\r\r");
			...
			if (!recalling) player.sexReward("saliva", "Anal");
			sharedEndNaga();
		}
		//All go to:
		function sharedEndNaga():void {
			outputText("You take your time unknotting yourself from the centaur, continuing to enjoy the feeling of your scales brushing against his thoroughbred form.  Kelt is in no shape to retaliate against you; your poison and treatment of him has left him semi-comatose.  His eyes are wide open and vague, as if he can't quite believe what just happened.  You leisurely put on your [armor] and then, with a smile, give him an affectionate slap on the spot you bit him and slither off.  You wonder if he will ever be able to face you again.");
			bothRaceEnd();
		}
	}
	//Standard anti-kelt scene
		...
		sceneHunter.print("Check failed: Naga body and fangs.");
		...
		if(player.tallness < 50 || player.cockTotal() == 0) {
			...
			outputText("You give his ass a hard smack and line your [cock] with his massive pucker.  Pressing forwards, you punch deep into his asshole and taunt, \"<i>Who's the bitch now, you fucking cock-sleeve?</i>\"  You feel your head bump across the hard knot of his prostate, and on contact you can feel his dick twitch in your hand, unloading a torrent of pre-cum into the dirt.  Porking the poor centaur, you laugh as he whinnies in pain, but every time you thrust back inside he spurts more and sticky pre until you feel his cock flare in your hand and start unloading.\r\r");
		}
		...
		function normalDickF():void {
			outputText("You spread your [legs] and expose your [cock].  \"<i>Lick it, bitch,</i>\" you command.   When he doesn't, you give the rope a pull, and his hooves paw at the dirt in pain.  \"<i>I said LICK!</i>\" you scream, and this time he does.  His slightly rough tongue slides up and down your length, gingerly tasting your prick-skin.  \"<i>Take it deep,</i>\" you sigh, and he complies, no longer capable of any form of resistance.  He opens wide and buries his face into your crotch ");
			if(player.cocks[0].cockLength < 10) outputText("taking the entire thing easily as his tongue licks you to ");
			else if(player.cocks[0].cockLength < 25) outputText("taking the entire thing deep into his throat.  Apparently centaurs lack a gag-reflex, and you can see his throat stretched around you as you're brought to ");
			else outputText("taking as much as he can deep into his throat.  Even though his entire neck is distorted by your massive member, his throat simply isn't long enough to take any more.  You writhe as the throat-fucking brings you to ");
			outputText("an explosive orgasm.  You deposit your cream directly into his belly, making him burp when you pull out, dripping on the centaur's abused lips.\r\r");
			if (!recalling) player.sexReward("saliva", "Dick");
			sharedEndNormal();
		}
		function sharedEndNormal():void {
			...
			outputText("You redress before the comatose centaur gets a chance to come to his senses, and wonder if he'll recover enough of his pride to face you again.");
			bothRaceEnd();
		}
	}

	function bothRaceEnd():void {
		if (!recalling) {

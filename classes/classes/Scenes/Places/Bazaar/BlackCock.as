...
/**
	...
	public class BlackCock extends BazaarAbstractContent
	{
		...
		public function enterTheBlackCock():void {
			...
			else if (isChristmas()) outputText("The interior is lit by a combination of black rooster-shaped candles on each table and a large globe sitting in the center of the tent. It looks like they just dumped the glowing creamy fluid from all the small globes into a larger one. You also see a big festive tree tucked into the corner decorated with glowing frosting… oh... wait, that's not frosting.");
		...
		private function orderFoodPlate(foodName:String, gemCost:int, foodEatDesc:String):void {
			...
			if ((player.hunger >= (player.maxHunger() - 10) && flags[kFLAGS.HUNGER_ENABLED] > 0) || (player.hasStatusEffect(StatusEffects.Fullness) && flags[kFLAGS.HUNGER_ENABLED] == 0)) {
		...
		private function eatFoodNomNom(foodName:String, foodEatDesc:String):void {
			...
			switch(foodName) {
				...
				case "P. Potatoes":
					...
					if (flags[kFLAGS.HUNGER_ENABLED] == 0 || (rand(2) == 0 && player.hunger >= (player.maxHunger() * 0.8))) player.butt.type++;
					break;
				case "Spicy Chilli":
					player.refillHunger(60);
					if (flags[kFLAGS.HUNGER_ENABLED] == 0) player.modThickness(player.maxThicknessCap(), 1);
					if (flags[kFLAGS.HUNGER_ENABLED] == 0 || (rand(2) == 0 && player.hunger >= (player.maxHunger() * 0.8))) player.hips.type++;
					break;
				case "Prot. Shake":
		...
		private function listenToAnitaSong():void {
			...
			switch(rand(2)) {
				case 0: //Squirtin Like a Fountain
					outputText("\n\n\"<i>Now ya'll know I'm pleased as a mouse wit a room full of cheese to be singing for y'all good folk this evenin. Now this'un here's a real classic. You good folks are more'in welcome to sing along if ya know the words.</i>\" With that she starts bouncing around. As she does, you hear music coming from the glowing globe of thick creamy liquid, looking to find ripples in its surface as the odd music fills the tent. It honestly sounds as if some guys are vigorously playing a piano, a violin and a set of drums.");
		...
		private function eagleFuckAnita():void { //Eagle fuck, must have wings
			...
			function dickF():void {
				outputText("\n\nThe weightless moment comes to a sudden end as gravity reclaims your bodies. You both begin to fall headlong towards the bone-crushing earth. With a practiced maneuver, she flips and wraps her naked body around yours, her dripping snatch poised above your erect [cock biggest]. Obviously giddy with vertigo, she smashes her lips into yours and you reach around her to shove your [cock biggest] up into her dripping-wet pussy.");
				sceneHunter.callBigSmall(scene, 18, 10, "length");
				
				function scene(x:int):void {
					var x1:int = x + 1;
					if (player.cocks[x].cockLength < 10) outputText("\n\nYou marvel at the fact that there is a lust-consumed maiden straddling you as the wind rushes past. Strong internal muscles clamp around your invading [cock "+x1+"] as she begins to grind against you. You shove forward and she rewards you with another greedy kiss. The odd sensation of vertigo combined with the wet pussy milking your dick sends a giddy, almost intoxicating feeling through your body. You grab at her soft body, reveling in the smooth hairlessness of her milky skin, tasting her neck, her breasts, her lips as the two of you drop towards the earth like a rock.");
					else if (player.cocks[x].cockLength >= 10 && player.cocks[x].cockLength < 18) outputText("\n\nAnita yells in triumph as you impale her with your [cock "+x1+"], obviously enjoying the sensation of your [cock "+x1+"] being pushed into her surprisingly tight pussy. You can feel strong internal muscles clamp around your [cock "+x1+"] as she grinds against you, fucking herself on your bloated baby maker. With a feral grin spread across your [face] you begin to help her, slamming your [cock "+x1+"] into her slick cum-tunnel, heedless of the way the two of you are falling head-first towards the unyielding earth. The odd sense of vertigo combined with the feeling of Anita's dripping pussy lips being pounded by your [cock "+x1+"] is almost intoxicating. Anita must feel the same way too as she rewards you with a firm, possessive kiss.");
					else {
						outputText("\n\nThe fierce slutty harpy lady catches her breath as you shove your [cock "+x1+"] into her saying, \"<i>Oh sweet daddy dick! You're bigger'n my husband.</i>\" With a grin you think about how you'll never get tired of hearing that. As a reward you thrust forward, watching as your [cockhead "+x1+"] indents against her trim little belly, listening to her groans suffused in pained ecstasy. Her pussy is dripping with need around your embedded [cock "+x1+"], the fluid lubing up your fuck-stick and leaving a glistening trail in the sky. You begin to pull her up and down your entire length with a snarl while falling with the grace of a stone.");
						outputText("\n\nSuddenly her lips smash against yours and she's kissing you hard. As your tongues wrestle, you desecrate her hungry pussy with recklessly hard thrusts. Internal muscles grip you and massage your bloated sex organ, milking your [cock "+x1+"]. Anita screams in pure elation the moment she disconnects from your lips, her pretty pink pussy gushing gobs of harpy-girl juice down your [cock "+x1+"] and into the air above the two of you as she shudders from her unexpected climax.");
					}
					outputText("\n\nYou look down at the ground and realize there isn't much time for you to get your orgasm. With a snarl you grit your teeth, double down and fuck the little harpy's very accommodating pussy with rough needy strokes. Laughter as loud as screams come from her throat as you fuck her at full force until you feel the familiar tingling sensation of fluid rushing through your [cock "+x1+"].");
					outputText("\n\nYou yell, a sound that rings with triumph and finality, as your [cock "+x1+"] explodes into Anita's already soaked pussy. You hold yourself inside of her, your trembling body stuck in that position as you flood Anita's more than accepting snatch with globs of baby batter, some of which flies behind the two of you, most of which is lost into your married fuck buddy's hungry pussy.");
			...
			function vagF():void {
				...
				outputText("\n\nSuddenly your face is even wetter, and then there is a gushing of a lady cum squirting from her pretty pink pussy as above you the harpy lady screams her ecstasy for only you and the whistling wind to hear. She is left trembling and screeching and you have to remind her that you haven't cummed yet.");
		...
		private function vaginalFuckAnita():void { //Vaginal fuck, must have penis
			...
			if (player.isBiped() || player.isGoo() || player.isDrider()) {
				...
				function sceneBiped(x:int):void {
					var x1:int = x + 1;
					outputText("\n\nSoft hands reach down and encircle your [cock " + x1 + "], pulling it towards Anita's dripping wet pussy. The lust-crazed harpy groans the moment your [cockhead "+x1+"] begins to push into her gushy wetness of her salivating vagina.");
					if (player.cocks[x].cockLength < 10) {
						outputText("\n\nWith a groan she drops your [cock " + x1 + "], allowing you to take over. Feeling triumphant, a growl surges up from deep inside your chest as you hike her legs up and push forward. She gives a hoot and a holler when you begin to slide in and out, enjoying the wetness of her ecstasy-flooded pussy as she flexes those strong internal muscles.");
						outputText("\n\nFuck me hard, stud,</i>\" she says in that country drawl. Holding her light, soft, milky white body in the air with your arms you begin to vigorously fuck her dripping cunt.[if (hasBalls = true) \"You can feel it slobbering down your [balls] and dripping onto your [legs].\"] Soft tits rise and fall in time with your strokes as the harpy's hands clutch at your [ass]. You just continue to hammer her to the fence she's propped against, watching her scream, groan and pant in response to your [cock " + x1 + "] greedily using her like an onahole.");
					}
					else if (player.cocks[x].cockLength >= 10 && player.cocks[x].cockLength < 18) {
						outputText("\n\nWith a groan she drops your [cock " + x1 + "] and lets you take over. She wiggles with need as you sit inside her, obviously impatient after having touched your shaft. When you begin to move her sky-blue eyes go wide and you slowly push into her, enjoying the feeling of her dripping pussy as she squeezes your slowly invading [cock " + x1 + "]. Once you fully hilt her she gives a soft little spasm and you feel evidence of her ecstasy running down your [legs] and squirting onto your trunk.");
						...
						outputText("\n\nWith a groan she drops your [cock " + x1 + "] and lets you take over. As you push forward, Anita Roswell sings a single wobbling note. Her juicy pussy is being stretched to the limit around your [cock " + x1 + "]. You slide your [cock " + x1 + "] into her dripping gash with clenched teeth. Once you've managed to hilt the sexy slut, a spasm rocks her body and once again her lusty secretions are gushing and squirting as she screams at the top of her powerful lungs. After Anita's second orgasm has subsided you begin sawing your [cock " + x1 + "] in and out of her amazingly wet pussy, watching her body bulge as you shaft her again and again. She cums again, and again as you pump her full of your apparently perfect [cock " + x1 + "], all evidence of her ecstasy running down your [legs].");
						outputText("\n\n");
					}
					outputText("\n\nAfter fucking her for a few more minutes you begin to feel a familiar tingle streaming through your [cock " + x1 + "]. With clenched teeth you double down and pound Anita as hard as you can. She's trembling but so are you and with a final thrust forward you reach climax just as she does, your [cock " + x1 + "] pouring seed into her squirting vulva as the two of you groan between ragged breaths.[if (cumextreme) Once you've recovered from your orgasm you open your eyes to find Anita's belly swollen as if she's pregnant. She rubs your cum baby with obvious delight and tells you not to worry she can't get pregnant unless she takes some pill. When you pull your [cock " + x1 + "] from her your cum comes flooding out like a waterfall and soon she's back to normal.");
				...
				sceneHunter.callBigSmall(sceneTaur, 18, 10, "length");

				function sceneTaur(x:int):void {
					var x1:int = x + 1;
					outputText("\n\nShe smiles big as she turns away and falls to her hands and knees, her ass pointed towards you as she assumes the perfect position. Her dripping wet pussy greets you, salavating for [eachCock] and sending a stirring heat through your body. You very unceremoniously raise your front two legs to mount her, shoving your [cockhead "+x1+"] into her dripping snatch.");
					if (player.cocks[x].cockLength < 10) {
						outputText("\n\nA growl comes from somewhere deep inside when you push forward. \n\n\"<i>You like that there tight pussy, doncha?</i>\" She groans through clenched teeth and you have to admit you're enjoying her tight wetness as she flexes her strong internal muscles against your embedded [cock " + x1 + "]. \"<i>Fuck me hard stud,</i>\" she groans in that country drawl.");
						outputText("\n\nYou bear down, pressing her into the ground as you fuck her wet cunt with body- jarring hammer blows. She screams beneath you, a shrill sound filled with so much ecstasy you know she has had another orgasm. You just continue to hammer her slim form into the dirt, listening her scream, groan and pant in response to your [cock " + x1 + "] forcing its way in and out of her tiny body.");
					}
					else if (player.cocks[x].cockLength >= 10 && player.cocks[x].cockLength < 18) {
						outputText("\n\nShe wiggles with desperate need as your [cock " + x1 + "] sits inside her. You hear a throaty whine as you slide into the tightly- stretched vaginal sleeve. \"<i>You like that tight pussy?</i>\" sShe says as she wiggles her ass beneath you, and you have to admit you're enjoying the way her dripping pussy squeezes your [cock " + x1 + "] with those strong internal muscles. Once you've managed to fully hilt her you feel a spasm rock her body and the evidence of her ecstasy floods around your [cock " + x1 + "]. \"<i>Oh daddy,.</i>\" She groans, shivering as you begin to actually fuck her. You give a raucous yell of triumph as you easily fuck her with your entire length. Despite the tightness you know she's got plenty of experience. With deep body jarring thrusts you make a dripping mess as you pound her raw. She screams and whines before reaching forward and grabbing two fist fulls of grass as if holding on for dear life.");
					}
					else {
						outputText("\n\nAs you push forward, Anita Roswell sings a single wobbling note of pure ecstasy. Her juicy pussy is being stretched to the limit around your [cockhead "+x1+"] and you're surprised to feel another gushing of lady- juice flooding around your embedded [cock " + x1 + "]. As she trembles from orgasm you push forward more, listening to the incoherent babble this produces with a proud grin on your face. Once you've managed to hilt the sexy slut another intense spasm rocks her body and once again her lusty secretions are gushing and squirting as she screams at the top of her powerful lungs. After Anita's second orgasm has subsided you begin sawing your [cock " + x1 + "] in and out of her amazingly wet pussy, watching her body bulge as you shaft her again and again. She cums again, and again as you pump her full of your apparently perfect [cock " + x1 + "], all evidence of her ecstasy running down your [legs].");
					}
					outputText("\n\nAfter fucking her for a few more minutes you begin to feel a familiar tingle streaming through your [cock " + x1 + "]. With clenched teeth you double down and pound Anita as hard as you can. She's trembling beneath you, like a vibrating onahole milking your [cock " + x1 + "]. With a final brutal thrust forward you reach climax just as she does, your [cock " + x1 + "] pouring seed into her squirting vulva as the two of you groan between ragged breaths.[if (cumExtreme) Once you've recovered from your orgasm you open your eyes to find Anita's standing in front of your. Her belly is swollen as if she's pregnant. She rubs your cum baby with obvious delight and tells you not to worry: she can't get pregnant unless she takes some pill.");
				...
				sceneHunter.callBigSmall(sceneNaga, 18, 10, "length");

				function sceneNaga(x:int):void {
					var x1:int = x + 1;
					outputText("\n\nYou rise up and begin swirling around her as you wrap her up in your coils, your [cockhead "+x1+"] pressed against her still drooling pussy. You use the strength in your lower snake half to slowly and gently guide her to the ground where you take her hands in yours and press them into the grass. With a grin spread across your [face] you tighten your coils, pulling her closer until your [cockhead "+x1+"] pushes into her slobbering, hungry pussy.");
					if (player.cocks[x].cockLength < 10) outputText("\n\nAs you begin to work your coils, undulating each one to twist your [cock " + x1 + "] around inside the girl and shoving forward to drill deeper into her in a sensual motion that sends shivers of longing up into your chest, the harpy girl trembles beneath you. With a holler she reaches out and grabs your [ass], begging to be fucked hard. You oblige her, increasing the tempo of your [hips] as you begin writhing against the girl, your [cock " + x1 + "] twisting around and pumping in and out in the same motion, driving her mad as you fuck that blissfully dripping pussy.");
					else if (player.cocks[x].cockLength >= 10 && player.cocks[x].cockLength < 18) outputText("\n\nYou begin to work your coils, squeezing and loosening each one, causing your embedded [cock " + x1 + "] to swirl around inside the sexy harpy lady as you keep her pressed to the ground. She openly groans and shudders as you move in and out of her pretty little harpy lady pussy. Then you add a sharp thrust, dipping in and out of the dripping hole squeezing your [cock " + x1 + "] with surprisingly strong internal muscles. Anita goes berserk, her voice climbing higher and higher only to break when you slam forward, fully hilting the little cock lover. Without needing further instruction you speed it up and watch that pretty little country girl begin to grimace as you shudder out another orgasm, her lusty secretions squirting around your still rapidly fucking [cock " + x1 + "] and drooling down your writhing [legs].");
					...
					outputText("\n\nAfter a few seconds of blissful rest you begin the process of disengaging your coils from the dozing harpy lady. [if (cumExtreme) As you do, you notice a large amount of your own jism leaking from her slightly distended snatch, her pussy unable to soak it up. Looking down you see a huge puddle of mixed cum around the two of you, most of it yours.</i>] Once you've managed to release her the married woman stands on visibly wobbly legs and leaves you after saying, \"<i>You cum back here anytime, darlin'…</i>\" and with a smile you slither back to camp.");
					sharedEnd();
				}
			}
			function sharedEnd():void {
		...
		private function sex69Anita():void { //69 with Anita, must not be a taur.
			...
			sceneHunter.selectGender(curry(sceneHunter.callFitNofit, dickF_caller, 25, "length"), vagF, assF);

			//================================================================
			function dickF_caller(x:int = -1):void {
				if (player.cocks[x].cockLength >= 25) dickF(x); //nofit
				else sceneHunter.callBigSmall(dickF, 13, 7, "length", 25); //fit
			}
			function dickF(x:int):void { //Males and hermaphrodites
				...
				if (player.cocks[x].cockLength < 7) outputText("\n\nAs you dip your [cock "+x1+"] into her lips she opens wide and swallows you whole. You groan at the feeling of her hot mouth embracing your dick. Then you press her legs further down, determined to make her feel every bit as good as her lips are making you feel as you open your mouth and drag your tongue across her pussy. You taste sweet girl-cum on your tongue and looking down you can see the shine of wetness flooding her pussy, the pearly liquid dripping down her body as she balances on her head and shoulders while sucking your [cock "+x1+"]. When you return to her lady parts you suck the excess liquid and begin to twirl your tongue across her swollen clit. Beneath you, she screams around your [cock "+x1+"], trembling as her pussy suddenly explodes in your face, squirting a massive deluge of her sweet pussy juice.");
				else if (player.cocks[x].cockLength >= 7 && player.cocks[x].cockLength < 13) outputText("\n\nAs you dip your [cock "+x1+"] into her lips she opens wide and takes your hard rod into her lips. As you move, reveling in the feeling of her hot mouth, you find yourself only able to get the first seven inches of your [cock "+x1+"] into her lips, but after a few thrusts she swallows and your [cock "+x1+"] curves into her throat, allowing you to hilt her mouth. With a groan you bounce for a few moments, losing yourself in the feeling. Then you press her legs further down, determined to make her feel every bit as good as her lips are making you feel as you open your mouth and drag your tongue across her pussy. You taste sweet girl-cum on your tongue, and looking down you can the shine of wetness flooding her pussy, the pearly liquid dripping down her body as she balances on her head and shoulders while sucking your [cock "+x1+"]. When you return to her lady parts you suck the excess liquid and begin to twirl your tongue across her swollen clit. Beneath you she screams around your [cock "+x1+"], trembling as her pussy suddenly explodes in your face, squirting a massive deluge of her sweet pussy juice.");
				else if (player.cocks[x].cockLength >= 13 && player.cocks[x].cockLength < 25) outputText("\n\nAs you dip your [cock "+x1+"] into her lips she gags. Looking down you watch her lips stretch to encompass your dick, smearing her red lipstick all over your rigid [cock "+x1+"]. As you move, reveling in the feeling of her hot mouth, you find yourself only able to get the first seven inches of your [cock "+x1+"] into her lips but after a few thrusts she swallows and your [cock "+x1+"] curves into her throat. Yet still some of your [cock "+x1+"] hangs out as you feel Anita taking furious breaths through her nostrils; it appears this is the limit of her deep-throating capabilities. With a groan you bounce for a few moments, losing yourself in the feeling. Then you press her legs further down, determined to make her feel every bit as good as her lips are making you feel as you open your mouth and drag your tongue across her pussy. You taste sweet girl-cum on your tongue and looking down you can see the shine of wetness flooding her pussy, the pearly liquid dripping down her body as she balances on her head and shoulders while sucking your [cock "+x1+"]. When you return to her lady parts you suck the excess liquid and begin to twirl your tongue across her swollen clit. Beneath you she screams around your [cock "+x1+"], trembling as her pussy suddenly explodes in your face, squirting a massive deluge of her sweet pussy-juice.");
				else outputText("\n\nIt's easy to see that your [cock "+x1+"] isn't going to fit in her mouth as you press your [cockhead "+x1+"] against her lips. As you press your shaft against her mouth your [cock "+x1+"] slides up and she licks it, suckling the underside as she grabs her tits and presses them against your [cock "+x1+"]. She squeezes your shaft with her perky tits, the tender flesh massaging either side of your shaft as you groan from the sensation. Then you press her legs further down, determined to make her feel every bit as good as her lips are making you feel as you open your mouth and drag your tongue across her pussy. You taste sweet girl-cum on your tongue and looking down you can see the shine of wetness flooding her pussy, the pearly liquid dripping down her body as she balances on her head and shoulders while giving your [cock "+x1+"] a slobbery titjob. When you return to her lady parts you suck the excess liquid and begin to twirl your tongue across her swollen clit. Beneath you she screams around your [cock "+x1+"], trembling as her pussy suddenly explodes in your face, squirting a massive deluge of her sweet pussy-juice.");
				outputText("\n\nStill trembling from orgasm she redoubles her efforts. ");
				//Vagina check
				if (player.hasVagina()) outputText("She even begins to finger your [vagina], The added sensation pushes you over the edge and your [cock "+x1+"] swells as you reach climax. ");
				else outputText("She begins to suck harder, using her hands to massage your [legs] and pull you harder against her. Your [cock "+x1+"] slides, free of her mouth as she kisses its rigid underside. The added sensation pushes you over the edge and your [cock "+x1+"] swells as you reach climax. ");
				...
				else if (player.cumQ() >= 1000 && player.cumQ() < 2500) outputText("You feel the hot evidence of your climax slam into your chin, a huge glob of your cum painting your jaw white. You groan as you orgasm rages on, painting both your bodies in a liberal coating of jism as Anita continues to lick the belly of your [cock "+x1+"].");
				else if (player.cumQ() >= 2500) outputText("A tidal wave of baby-batter fills your vision with white, your [cock "+x1+"] expelling gigantic torrents of seed with every contraction that rains back down to the earth. By the time your orgasm has subsided you're quietly convulsing with you and Anita covered in spunk and surrounded by a pool of hot seed.");
				player.sexReward("vaginalFluids", "Lips");
				player.sexReward("saliva", "Dick");
				sharedEnd();
			}
			function vagF():void { //Females
			...
			function assF():void  { //Genderlesses
		...
		private function checkAndyStash():void {
			...
			if (flags[kFLAGS.BLACK_COCK_ANDY_STASH_STATE] == 0) {
				...
				outputText("\n\nOnce you've caught up to the satyr you look at him and are greeted with his bare ass. He is bent over and fishing something out from between the barrels. Once he has it he straightens up and shows you a multicolored lamp made from crystalline glass in one hand and a bag of ground plant in another.");
		...
		private function grabAndysDongAfterSmoking():void {
			...
			sceneHunter.selectGender(dickF, vagF, assF);
		...
		private function stayAfterNoSmoke():void {
			...
			menu();
			addButtonIfTrue(0, "Suck my Cock", haveAndySuckYouOff, "You'll need a cock to have Andy do this.", player.hasCock(), "Have Andy suck you off.");
			addButtonIfTrue(1, "Lick my Pussy", haveAndyLickYouOut, "You'll need a vagina to have Andy do this.", player.hasCock(), "Have Andy lick your pussy.");
		...
		private function rompUpWithAndyTheSatyr():void {
			...
			menu();
			if (player.hasCock()) addButton(0, "Fuck Him", fuckAndyTheSatyr_selector).hint("Take Andy from behind and put your cock to good use.");
		...
		private function fuckAndyTheSatyr_selector():void {
			if (player.isTaur())
				...
				sceneHunter.callBigSmall(fuckAndyTheSatyr, 19, 12);
			}
		}

		private function fuckAndyTheSatyr(x:int):void {
			var x1:int = x + 1;
			clearOutput();
			outputText(images.showImage("andy-sex-analpitch"));
			//Height
			if (player.tallness < 64) outputText("You look up into Andy’s eyes and tell him you’re going to be fucking him today. He smiles as he looks down into your eyes and says, \"<i>So long as you fuck me hard, lil’ " + player.mf("guy", "gal") + "..</i>\" He obviously likes the idea of having your [cock "+x1+"] stuffed into his tailhole; you’ll have to oblige him and fuck the cocky bastard as hard as you can for insinuating that your height might be a problem.");
			else if (player.tallness >= 64 && player.tallness < 68) outputText("You look straight into Andy’s eyes and tell him he’s going to be taking your [cock "+x1+"] today. He nods as you grab his trim waist and says, \"<i>Yes " + player.mf("sir", "ma'am") + "</i>\". From the way his dick jumps at the brief contact you can tell he quite likes the idea of you stuffing your [cock "+x1+"] into his tailhole.");
			else outputText("You grab Andy by his polished horns and make him look up, tearing his gaze away from your body and directing it toward your face. His mouth drops open as you tell him you’re going to be fucking his little satyr ass today and his only response is a husky, \"<i>Oh fuck yes.</i>\" You can see his little knotted dog dick twitch at the thought of you ramming your [cock "+x1+"] into his tailhole. When you release his horns he rubs the spot with a smile; he is obviously a fan of the rough treatment, and maybe even a little giddy about you being taller than him.");
			//Taur or not?
			if (player.isTaur()) {
				outputText("\n\nYou begin removing your [armor] slowly, sensually revealing your bare form. Andy quietly massages his leaking doggy dick as he watches, eyes hypnotized by your bare flesh. All you have to do is nod towards the barrel and the satyr climbs atop it, face down and ass in the air with his tiny little tail wagging in delight. His back is perfectly arched and his soft round ass cheeks spread, revealing a black rosebud winking in invitation. You give [eachCock] a quick flex before sliding your [cock "+x1+"] against the satyrs hungry derrière. He presses back, his plump rump obviously inviting you to tunnel into his soft little bud to your heart’s content. Arching your own back you thrust forward and slide up his crack. All it takes is a single order and the satyr reaches back and guides your erect length into his ass.");
				...
				if (player.cockTotal() > 1) {
					outputText("[eachCock] spits hot white semen, most of which travels through your [cock "+x1+"] and inseminates Andy’s upturned backside. ");
					...
					outputText("You hold your [cock "+x1+"] deep inside Andy’s wrecked hole, pressed against him like a husband and wife snuggling for warmth. Your body trembles like a scared mouse as you unload into his tightly clenching bowels. ");
				...
				if (player.cocks[x].cockLength < 7) {
					outputText("\n\nAs you pull out your [cock "+x1+"] Andy’s shoulders slump for a moment but he falls to his knees and sucks your rigid length into his mouth regardless of how he feels about your size. ");
					if (player.cockTotal() == 2) outputText("He takes your remaining dick into his hand and fists it with a sure and practiced hand. ");
					...
					outputText("He hums as he sucks you in, drool leaking from the side of his mouth as you grab his curly hair and pull his talented mouth up and down your [cock "+x1+"], fucking his face hard due to his reaction to your size.");
				}
				else if (player.cocks[x].cockLength >= 7 && player.cocks[x].cockLength < 12) {
					outputText("\n\nAs you reveal [eachCock] Andy gives you an approving grunt as he falls to his knees and takes your [cock "+x1+"] into his mouth with the hungry slurp of a dick loving slut. In one deft motion he sucks your entire length in, his throat muscles massaging your [cockhead "+x1+"] as he smashes his face against your trunk. ");
					...
					outputText("\n\nHe doesn’t choke or gag or even flinch when the sensation of his dick pleasing machinations cause you to thrust into his mouth. Throwing caution and decorum to the wind you grab a fist full of curly hair and pull the little sub up and down your [cock "+x1+"], roughly fucking his throat as strings of spit fly off the blur that is your [cock "+x1+"].");

				}
				else {
					outputText("\n\nAs you reveal your [eachCock] Andy’s jaw drops. Your [fullChest] swells with pride as he falls to his knees like a reverent priest praying at a treasured alter. He wraps a trembling hand around your [cock "+x1+"] and pulls it to his lips. He gags as you greedily shove forward but the little satyr sub doesn’t give up; he accepts your challenge and begins to furiously bob up and down the length of your [cock "+x1+"], fighting through the gagging sensation until he’s able to take about a foot of your dick into his hungry mouth.");
					if (player.cockTotal() == 2) outputText("He takes your remaining dick into his hand and fists it with a sure and practiced hand. ");
					else if (player.cockTotal() > 2) outputText("He takes two of your remaining dicks and fists them with two sure and practiced hands. ");
					outputText("\n\nOn a whim you wrap twin fists around the base of his polished black horns, a greedy smile spreading across your [face]. He stops, looking up into your eyes and silently begging you to do exactly what you’re about to do. With a snarl you begin fucking his face as hard as you can, listening to him choke and gag as you force his mouth wide and pump your [cock "+x1+"] deep into his throat. ");
					if (player.cockTotal() > 1) outputText("He even drops your other dicks as he grabs your [legs] and lets you soundly and deeply fuck his throat.</i>\" You feel his voice vibrate your dick as he groans and his face jerks, but looking down at him, you see pure and utter bliss in his happy face with tears leaking down the side as you pump his mouth full of [cock "+x1+"].");
				}
				outputText("\n\nYou have to tug Andy Mathis off your [cock "+x1+"] to keep from filling his belly from the wrong end. As you do you remind him that you wanted his ass, even though his mouth was a nice treat.");
				outputText("\n\nWithout rising he leans back and tucks his hands behind his legs, firmly lifting his little furry satyr rump so you can see his little hungry black cherry. You give his sexy little cheeks a hard slap and watch the fuzz covered skin ripple; it feels soft and perfect for a quick hard fuck. As you grab your spit covered [cock "+x1+"] and aim it for his rear entrance his tail flits about and he bites his lip; he’s ready. With a feral grin down at your temporary lover you aim your spit shined cum filled trouser snake at the horny little sub’s hungry ass and dive right in.");
				if (player.cocks[x].cockLength < 12) {
					outputText("\n\nAs you sink into the satyr’s fuzzy little rump he croons, lifting his legs as he smiles up at you like an eager kid being given a new toy. You look down at the little happy sub and pull your rigid shaft out until nothing but the head remains, then shove forward in a sudden hard thrust. You watch his reaction, pleased to see his eyes roll back into his head as you grind your [cock "+x1+"] around inside him. When you begin fucking his fuzzy rump with vicious body jarring strokes, he begins to convulse. Each powerful thrust sends a clap through the air and forces a sheep-like bleat from his howling maw. Then his hungry ass begins to flutter and clench around your madly fucking [cock "+x1+"]. With one long bleat the satyr ejaculates, his knotted dog dick firing ropes of funky seed onto his fuzzy chest as you continue to wreck his ass, working like a madman towards your own release. He gives you a tired grin as he looks up at you, obviously happy you came.");
				}
				else if (player.cocks[x].cockLength >= 12 && player.cocks[x].cockLength < 19) {
					outputText("\n\nAs you push into the satyr’s fuzzy little tight ass he grunts, shifting slightly as he bites his lip and looks up at you with a cocky, daring look. He reaches up and pulls your [face] into his without warning, kissing you deeply as you work your [cock "+x1+"] into him. Once you’ve pushed a foot of your [cock "+x1+"] into him, he jerks away and releases a whoosh of air, his breath smelling like fine wine. You feel the light hair on his arm tickling your back as he holds you close, grunting as you work your full length into him until you’ve fully hilted the little guy.");
					outputText("\n\nHe clutches you as if holding on for dear life until you begin to pry his arms from around your body and lift your [fullChest] from his. He tries to smile up at you but your [cock "+x1+"] has him gritting his teeth. His ass is insanely tight, holding you where you are as the little sub shivers. Without warning you watch a funky stream of hot baby batter shoot from his doggy dong, and then another and yet another still. He cums and cums and cums until his fuzzy chest and belly are covered in crisscrossing streams that pool around his gorgeous abs. He pants like a dog, his clenching hole finally giving out and allowing you to begin working towards your own release. With a grin you shove his legs into his jizz splattered chest and draw your [cock "+x1+"] out until the only thing still inside the blissfully tight hole is your [cockhead "+x1+"]. Soon you correct this by diving back into that hot little tail hole, thankful for the spit lube that allows you to fuck this little guy this hard. He grunts and groans at first, sounding uncomfortable. The next thing you know his hole is completely relaxed and he’s screaming for you to fuck him harder. You oblige, reaching top speed and listening to him bleat and groan as you fuck him in rough, body jarring strokes.");
				}
				else {
					outputText("\n\nAs you push your big bloated trouser snake into the satyr’s tiny tail hole he yelps, managing to pull his not-so-tight tailhole out the way. You can tell he isn’t a virgin but not experienced enough to easily take your entire length. Even so you know he can do it, and even if he can’t, he’s about to. You grab your [cock "+x1+"] and use your free hand to press down on the clasped fists keeping the satyr’s legs in the air and push. As your [cockhead "+x1+"] is pressed again and again against his ripe little cherry you watch his face contort in a mixture of pleasure and pain. Then he takes a deep, deep breath and suddenly you pop inside.");
					outputText("\n\nThe Satyr’s entire body convulses as he screams as if in intense pain as his dog dick erupts, sending gushing arks of funky satyr jizz into the air. The long ropes of potent seed land in his hair and on his face and shoulders and his fuzzy chest and finally his depleted and softening doggy dong flattens, the last of his copious load pooling inside his belly button. You can’t help but smile at the intensity of Andy’s orgasm, your [fullChest] swelling with pride at the knowledge of what you did with your size alone. Your [cock "+x1+"] reminds you that the only part of it inside the satyr is the head and with a grin you begin to push into the now completely relaxed back door.");
					outputText("\n\nAndy is delirious as you work your [cock "+x1+"] into his upturned rear. He babbles like a madman, making sounds that range between horror and elation. Ignoring his indecisive ecstasy you press onward. You can see the outline of your [cockhead "+x1+"] distend his stomach, your [cock "+x1+"] reaching into unexplored territory and reforming his body to suit your needs. You can’t help swirling your bloated baby maker around inside him, watching your [cockhead "+x1+"] move around inside the satyr and listening to the noises he makes.");
					outputText("\n\nYou finish playing and pull your [cock "+x1+"] halfway out before slamming it into the satyr. He bleats as you fail to fully hilt him, his body halting your progress and denying you the ability to completely submerge your [cock "+x1+"] in his tight little ass. When you begin fucking him with slowly mounting force he looks up into your face with eyes glazed over by pure bliss. Knowing that in his present state he can’t possibly not enjoy your [cock "+x1+"] tunneling through him you throw caution to the wind and begin fucking Andy for all you’re worth. His orgasm addled brain can only spread his legs and hold them to his chest as you watch your giant dong slam into his stomach over and over again.");
				}
				...
				if (player.hasKnot()) {
					outputText("\n\nWith a hoarse yell you shove your knot into the satyr who gives a yelp as your [cock "+x1+"] spasms inside him, spurting into his now gaping love tunnel with a vengeance. ");
					...
					outputText("\n\nWith a soul aching groan you shove your [cock "+x1+"] into the satyr and unload a massive torrent of your own batch of spunky jism. ");
		...
		private function haveAndyFuckYou(isVaginal:Boolean):void {
			var vagOrAss:String = isVaginal ? "[vagina]" : "[ass]";
			clearOutput();
			...
			if (player.isTaur()) { //Tauric lower body
				...
				//Looseness check
				if (player.looseness(isVaginal) < 2) {
				...
				else if (player.looseness(isVaginal) < 4) {
			...
			player.sexReward("cum", isVaginal ? "Vaginal" : "Anal");
			dynStats("sens", 1);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private function haveHarryFuckYou():void {
			...
			if (player.analCapacity() < 40) {
				sceneHunter.print("Not enough anal capacity!");
				...
				sceneHunter.print("Enough anal capacity!");
		...
		private function letTheSatyrsHaveTheirWayWithYou():void {
			...
			if (player.hasCock()) {
				...
				outputText(".");
				if (player.biggestCockLength() < 10) outputText("The satyr's hungry well fucked ass swallows your [cock biggest] whole without a single problem. The dual sensations of being fucked and ridden have your head swimming in ecstasy. His ass feels wet and you're pretty sure one of the satyrs fucking around your table were fucking him and lost a load in his ass. The fact that you're being pounded and ridden is quickly getting to you, and you know it won't be long before you lose a load into the satyrs well fucked cum tunnel.");
				else if (player.biggestCockLength() >= 10 && player.biggestCockLength() < 14) outputText("\n\nThe satyr groans as he is forced down your [cock biggest]. You can feel the creamy wetness of another man's seed as your [cock biggest] stretches this satyr's little black cherry. Once he has sunk all the way down your length he begins to bounce, his hungry little ass working your [cock biggest] like full time job. The dual sensations of being fucked and ridden have your head swimming in ecstasy. The fact that you're being pounded and ridden is quickly getting to you, and you know it won't be long before you let loose your own load into the cum caked back door.");
				else outputText("\n\nThe satyr flinches and whines as he is forced down your [cock biggest] with clenched teeth. The dual sensations of being ridden and fucked have your head swimming in ecstasy. As your length forcibly stabs into his ass, your eyes roll back and your neck goes slack, your head now hanging off the table. The bleating becomes more hurried as you reach down and help the satyr fucking your ass to push the little whining guy down your full length. Once he's hilted he trembles, his ass milking your dick as yet another load of funky satyr jizz fires onto your [fullChest]. The ass massaging your [cock biggest] is blissfully tight as he unloads and soon you're pulling the little guy up and down your length, slapping his ass to make him ride your [cock biggest] for all he's worth.");
				outputText("\n\nWhen you open your eyes you see two satyrs wrestling, attempting to dominate each other as you are fucked and ridden. Turning your head, you see two satyrs fucking a third, filling him from both ends as the staff and patrons watch the satyr orgy with you in the middle. Then a furred groin darkens your view. Your chin is gripped and a thick cockhead slathers leaking pre onto your [face]. The satyr seems taller than the others, and you open your lips to accept the dick being shoved against your lips.");
				//multicock options were too low-q, so I cut them out
				...
				outputText("\n\nIt's not nearly as big as you would've thought, and as you breathe through your nose, you smell the bitter-sweet stink of his arousal. When he pulls out, every dick and ass lifts and pulls out as well. When he shoves forward, they do the same. Like a synchronized team the satyrs begin fucking and riding you hard, sending your lust into overdrive as you inhale their sweet sex.");
				outputText("\n\nThe wet feeling of cold beer splashing down your [fullChest] and mixing with the semen already there only serves to heighten the pleasure of the synchronized assault on your genitals.");
			}
		...
		public function echidnaTFs():void {
			...
			//Gain Echidna ears
			if (rand(3) == 0 && changes < changeLimit && player.lowerBody != LowerBody.GARGOYLE && player.ears.type != Ears.ECHIDNA) {
				outputText("\n\n");
			...
			if (rand(3) == 0 && changes < changeLimit && player.ears.type == Ears.ECHIDNA && player.tailType != Tail.ECHIDNA) {
				...
				switch(player.tailType) {
					...
					case Tail.DOG:
						...
						break;
					case Tail.WOLF:
						outputText("Your wagging wolf tail begins to feel chilly as all of its fur falls out. It becomes tight as the majority of the tail’s length recedes into your body, leaving you with just a little stump for a tail.");
						break;
					case Tail.KANGAROO:
			...
			//Gain Echidna legs
			if (rand(3) == 0 && changes < changeLimit && player.ears.type == Ears.ECHIDNA && player.tailType && Tail.ECHIDNA && player.lowerBody != LowerBody.ECHIDNA) {
				outputText("\n\n");
				switch(player.lowerBody) {
					//Irregular lower body type
					case LowerBody.CENTAUR: // should be done in other way now...
			...
			if (rand(3) == 0 && changes < changeLimit && player.gender == Gender.GENDER_MALE && player.averageBreastSize() > 2 && flags[kFLAGS.HYPER_HAPPY] == 0) {
			...
			if (rand(2.4) == 0 && changes < changeLimit && player.hasVagina() && player.mf("m", "f") == "f" && player.hips.type < 14) {

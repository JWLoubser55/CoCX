...
//-----------------
	...
	private function PurityElixir():void {
		clearOutput();
		if (player.getAllMinStats().cor == -10) {
			outputText("You take out the elixir, but reconsider. ");
			if (player.cor > -10) outputText("All of your corruption can be removed using simpler methods.");
	...
	public function rest():void {
		...
		if (timeQ == 0) {
			...
			if (SceneLib.alvinaFollower.AlvinaPurified) {
				...
				if (player.cor <= -10 || player.cor <= mincor) {}
				else {

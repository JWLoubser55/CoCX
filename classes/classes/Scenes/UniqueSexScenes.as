...
public class UniqueSexScenes extends BaseContent
	{
		...
		public function trueDemonSuccubusFeast():void {
			clearOutput();
			outputText("You eye the [themonster]'s " + monster.cockDescriptShort() + " with a hungry smile, licking your lips. You can practically feel it in your drooling demon-twat already...but first, you need to establish your dominion. Your hand lifts the [themonster]'s chin to stare into your eyes, and you feel [monster his] " + monster.cockDescriptShort() + " lift and aim for your [vagina] automatically.\n\n");
			...
			outputText("[monster He] whimpers something, but your attention has already shifted to the other important parts of your new toy.  You caress [monster his] balls next, your finger tracing out the pattern of a cursed mark on each.  The [themonster] groans with need as the dark magic fuels them, your power making [monster his] orbs swell outward and churning with seed.  In half a minute, [monster his] virility has doubled from your vile spellwork.  You growl lustfully, aroused beyond mortal measure at the sight, the smell, the echoes of your captive's emotional torment.\n\n");
			outputText("The [themonster] tries to shove you off, but a succubus seeking a meal can't be pushed off of her meat.  Still, you press a finger ");
			if (monster.hasCock()) {
		...
		public function trueDemonSuccubusFeastCum():void {
			outputText("You make your decision and lean into the [themonster]'s ear, lovingly murmuring, \"<i>Good toy.  Now it's your turn to cum.  Do make sure to make a mess in my cunt, will you?</i>\"\n\n");

...
public class CharybdisFollower extends NPCAwareContent implements SaveableState
{
	...
	public function charyLoss():void {
		...
		if (CharySpar) {
			...
			pc.HPChange(Math.round(player.maxHP() * 0.5), false, false);
			cleanupAfterCombat();
		}
		else {
			if (player.cor > 80) {
	...
	public function charyTalk():void {
		...
		if (CharyAffectionMeter > 89 && CharyLandShipQuestState == 7) addButton(7, "CampJoin", charyJoinCamp);

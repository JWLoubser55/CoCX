...
public function resetToPC():void {
	...
	player = player2;
	player.itemSlots[0] = urtaQItems1;
	player.itemSlots[1] = urtaQItems2;
	player.itemSlots[2] = urtaQItems3;
	player.itemSlots[3] = urtaQItems4;
	player.itemSlots[4] = urtaQItems5;
	player.itemSlots[5] = urtaQItems6;
	player.itemSlots[6] = urtaQItems7;
	player.itemSlots[7] = urtaQItems8;
	player.itemSlots[8] = urtaQItems9;
	player.itemSlots[9] = urtaQItems10;
	player.itemSlots[10] = urtaQItems11;
	player.itemSlots[11] = urtaQItems12;
	player.itemSlots[12] = urtaQItems13;
	player.itemSlots[13] = urtaQItems14;
	player.itemSlots[14] = urtaQItems15;
	player.itemSlots[15] = urtaQItems16;
	player.itemSlots[16] = urtaQItems17;
	player.itemSlots[17] = urtaQItems18;
	player.itemSlots[18] = urtaQItems19;
	player.itemSlots[19] = urtaQItems20;
	player.itemSlots[20] = urtaQItems21;
	player.itemSlots[21] = urtaQItems22;
	player.itemSlots[22] = urtaQItems23;
	player.itemSlots[23] = urtaQItems24;
	player.itemSlots[24] = urtaQItems25;
	player.itemSlots[25] = urtaQItems26;
	player.itemSlots[26] = urtaQItems27;
	player.itemSlots[27] = urtaQItems28;
	player.itemSlots[28] = urtaQItems29;
	player.itemSlots[29] = urtaQItems30;
	player.itemSlots[30] = urtaQItems31;
	player.itemSlots[31] = urtaQItems32;
	player.itemSlots[32] = urtaQItems33;
	player.itemSlots[33] = urtaQItems34;
	player.itemSlots[34] = urtaQItems35;
	player.itemSlots[35] = urtaQItems36;
	player.itemSlots[36] = urtaQItems37;
	player.itemSlots[37] = urtaQItems38;
	player.itemSlots[38] = urtaQItems39;
	player.itemSlots[39] = urtaQItems40;
	player.itemSlots[40] = urtaQItems41;
	player.itemSlots[41] = urtaQItems42;
	player.itemSlots[42] = urtaQItems43;
	player.itemSlots[43] = urtaQItems44;
	player.itemSlots[44] = urtaQItems45;
	player.itemSlots[45] = urtaQItems46;
	player.itemSlots[46] = urtaQItems47;
	player.itemSlots[47] = urtaQItems48;
	player.itemSlots[48] = urtaQItems49;
	player.itemSlots[49] = urtaQItems50;
...
public function startUrtaQuest():void {
	...
	urtaQItems1 = player.itemSlots[0];
	urtaQItems2 = player.itemSlots[1];
	urtaQItems3 = player.itemSlots[2];
	urtaQItems4 = player.itemSlots[3];
	urtaQItems5 = player.itemSlots[4];
	urtaQItems6 = player.itemSlots[5];
	urtaQItems7 = player.itemSlots[6];
	urtaQItems8 = player.itemSlots[7];
	urtaQItems9 = player.itemSlots[8];
	urtaQItems10 = player.itemSlots[9];
	urtaQItems11 = player.itemSlots[10];
	urtaQItems12 = player.itemSlots[11];
	urtaQItems13 = player.itemSlots[12];
	urtaQItems14 = player.itemSlots[13];
	urtaQItems15 = player.itemSlots[14];
	urtaQItems16 = player.itemSlots[15];
	urtaQItems17 = player.itemSlots[16];
	urtaQItems18 = player.itemSlots[17];
	urtaQItems19 = player.itemSlots[18];
	urtaQItems20 = player.itemSlots[19];
	urtaQItems21 = player.itemSlots[20];
	urtaQItems22 = player.itemSlots[21];
	urtaQItems23 = player.itemSlots[22];
	urtaQItems24 = player.itemSlots[23];
	urtaQItems25 = player.itemSlots[24];
	urtaQItems26 = player.itemSlots[25];
	urtaQItems27 = player.itemSlots[26];
	urtaQItems28 = player.itemSlots[27];
	urtaQItems29 = player.itemSlots[28];
	urtaQItems30 = player.itemSlots[29];
	urtaQItems31 = player.itemSlots[30];
	urtaQItems32 = player.itemSlots[31];
	urtaQItems33 = player.itemSlots[32];
	urtaQItems34 = player.itemSlots[33];
	urtaQItems35 = player.itemSlots[34];
	urtaQItems36 = player.itemSlots[35];
	urtaQItems37 = player.itemSlots[36];
	urtaQItems38 = player.itemSlots[37];
	urtaQItems39 = player.itemSlots[38];
	urtaQItems40 = player.itemSlots[39];
	urtaQItems41 = player.itemSlots[40];
	urtaQItems42 = player.itemSlots[41];
	urtaQItems43 = player.itemSlots[42];
	urtaQItems44 = player.itemSlots[43];
	urtaQItems45 = player.itemSlots[44];
	urtaQItems46 = player.itemSlots[45];
	urtaQItems47 = player.itemSlots[46];
	urtaQItems48 = player.itemSlots[47];
	urtaQItems49 = player.itemSlots[48];
	urtaQItems50 = player.itemSlots[49];
	player.itemSlots[0] = new ItemSlotClass();
	player.itemSlots[1] = new ItemSlotClass();
	player.itemSlots[2] = new ItemSlotClass();
	player.itemSlots[3] = new ItemSlotClass();
	player.itemSlots[4] = new ItemSlotClass();
	player.itemSlots[5] = new ItemSlotClass();
	player.itemSlots[6] = new ItemSlotClass();
	player.itemSlots[7] = new ItemSlotClass();
	player.itemSlots[8] = new ItemSlotClass();
	player.itemSlots[9] = new ItemSlotClass();
	player.itemSlots[10] = new ItemSlotClass();
	player.itemSlots[11] = new ItemSlotClass();
	player.itemSlots[12] = new ItemSlotClass();
	player.itemSlots[13] = new ItemSlotClass();
	player.itemSlots[14] = new ItemSlotClass();
	player.itemSlots[15] = new ItemSlotClass();
	player.itemSlots[16] = new ItemSlotClass();
	player.itemSlots[17] = new ItemSlotClass();
	player.itemSlots[18] = new ItemSlotClass();
	player.itemSlots[19] = new ItemSlotClass();
	player.itemSlots[20] = new ItemSlotClass();
	player.itemSlots[21] = new ItemSlotClass();
	player.itemSlots[22] = new ItemSlotClass();
	player.itemSlots[23] = new ItemSlotClass();
	player.itemSlots[24] = new ItemSlotClass();
	player.itemSlots[25] = new ItemSlotClass();
	player.itemSlots[26] = new ItemSlotClass();
	player.itemSlots[27] = new ItemSlotClass();
	player.itemSlots[28] = new ItemSlotClass();
	player.itemSlots[29] = new ItemSlotClass();
	player.itemSlots[30] = new ItemSlotClass();
	player.itemSlots[31] = new ItemSlotClass();
	player.itemSlots[32] = new ItemSlotClass();
	player.itemSlots[33] = new ItemSlotClass();
	player.itemSlots[34] = new ItemSlotClass();
	player.itemSlots[35] = new ItemSlotClass();
	player.itemSlots[36] = new ItemSlotClass();
	player.itemSlots[37] = new ItemSlotClass();
	player.itemSlots[38] = new ItemSlotClass();
	player.itemSlots[39] = new ItemSlotClass();
	player.itemSlots[40] = new ItemSlotClass();
	player.itemSlots[41] = new ItemSlotClass();
	player.itemSlots[42] = new ItemSlotClass();
	player.itemSlots[43] = new ItemSlotClass();
	player.itemSlots[44] = new ItemSlotClass();
	player.itemSlots[45] = new ItemSlotClass();
	player.itemSlots[46] = new ItemSlotClass();
	player.itemSlots[47] = new ItemSlotClass();
	player.itemSlots[48] = new ItemSlotClass();
	player.itemSlots[49] = new ItemSlotClass();
	player2 = player;
...
//		doNext(combat.combatMenu);
	...
	pc.HPChange(Math.round(player.maxHP()*0.75),false,false);
	fatigue(-200);
...
public function urtaLosesToSirriusSnakeRadio():void {
	...
	outputText("\n\nHe chuckles at your words.  \"<i>Yesss, you are right.  Sssorry for my confusion.  As an apology, you may request anything you want from me.</i>\"  \"<i>You don't need to apologize to me, you silly, sexy snake, you,</i>\" you reply with a smile.  \"<i>You shouldn't be so confused about my love for you... but, if you really want to apologize to me... will you fuck me?  My pussy's sooo hot and wet and empty; it aches for you.  Please, ravage your silly fox with your glorious cock,</i>\" you beg him.");
...
private function urtaSleepsArmored():void {
	...
	pc.HPChange(.5 * player.maxHP(),false,false);
	fatigue(-50);
	player.orgasm();
	menu();

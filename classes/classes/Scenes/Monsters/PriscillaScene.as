...
public class PriscillaScene extends BaseContent
	{
		...
		private function startforeplay():void {
			...
			function dickF_sub():void {
				outputText("You tell Priscilla you’re here to fuck.  A big, wide grin grows on her face as she starts to shed out of her spider silk loincloth and bone armor, watching you intently as you strip off your " + player.armorName + ".  Fully nude, Priscilla’s tiny hands dart towards her breasts, kneading them slowly as you walk towards her, fondling your " + player.cockDescript(0) + " at the sight of her exotic body.  Her ears perk up in excitement as she sees your " + player.cockDescript(0) + ", now completely hardened, reach its fully erect size of " + player.cockVsClitCockLenght(player, 0) + ".  Priscilla starts to seductively sway her body towards you, her ample hips and round ass cheeks jiggling slightly, as her fingers thread from her breasts to her soft thighs.\n\n");
		...
		private function assfuck():void {
			...
			outputText("\"<i>Wait, wait!</i>\"  Priscilla slurred, dazed, and laying on her stomach with her gaping hole winking at you like a slut, but you take your " + player.cockVsClitCockLenght(player, x) + " hard cock and push it in past her rim.  Her eyes widen larger than the size of dinner plates as you grab her by the waist and thrust deep and hard!  Priscilla’s mouth opens to exclaim \"<i>G-gah!</i>\"  As her body spasms, as you pull her onto and off your throbbing " + player.cockDescript(x) + ", using her as a living clocksleeve");
			if (player.cockVsClitCockLenghtNumber(player, x) > 14) outputText("Slamming her into your meat, you took delight not only in her tightness, but at how her stomach bulged out when forced to take your cock.  ");
		...
		private function mouthfuck():void {
			...
			if (player.cockVsClitCockLenghtNumber(player, 0) > 14) outputText("\"<i>So much meat...And it’s all mine!</i>\"  ");

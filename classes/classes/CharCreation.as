...
//		private var boxNames:ComboBox;
		...
		*/
		...
		public function chooseBloodlineorNot():void {
			if (player.hasPerk(PerkLib.AscensionCruelChimerasThesis) && flags[kFLAGS.NEW_GAME_PLUS_LEVEL] >= 3) chooseBloodline1();
			else chooseHistory();
		}
		...
		public function chooseBloodline3():void {
			...
			if (!player.hasPerk(PerkLib.BloodlineCaveWyrm)) addButton(8, "C.Wyrm", confirmBloodline3, PerkLib.CaveWyrmsDescendant).hint("(+2 to cave wyrm score)");
			else addButtonDisabled(8, "C.Wyrm", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineRhino)) addButton(10, "Rhino", confirmBloodline3, PerkLib.RhinosDescendant).hint("(+2 to rhino score)");
			else addButtonDisabled(10, "Rhino", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineMoth)) addButton(11, "Moth", confirmBloodline3, PerkLib.MothsDescendant).hint("(+2 to moth score)");
			else addButtonDisabled(11, "Moth", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineGhost)) addButton(12, "Ghost", confirmBloodline3, PerkLib.GhostsDescendant).hint("(+2 to poltergeist / banshee score)");
			else addButtonDisabled(12, "Ghost", "You already have this bloodline!");
			//13
		...
		public function chooseBloodline4():void {
			menu();
			if (!player.hasPerk(PerkLib.BloodlineWerefox)) addButton(0, "Werefox", confirmBloodline4, PerkLib.WerefoxsDescendant).hint("(+2 to werefox score)");
			else addButtonDisabled(0, "Werefox", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineWerewolf)) addButton(1, "Werewolf", confirmBloodline4, PerkLib.WerewolfsDescendant).hint("(+2 to werewolf score)");
		...
		public function chooseBloodline5():void {
			...
			if (!player.hasPerk(PerkLib.CommonHumanBloodline)) {
				if (flags[kFLAGS.HUMAN_BLOODLINE] >= 1) addButton(0, "CommonH", confirmBloodline5, PerkLib.CommonHumansDescendant).hint("(+2 to human score)");
			...
			if (!player.hasPerk(PerkLib.NobleHumanBloodline)) {
				if (flags[kFLAGS.HUMAN_BLOODLINE] >= 2) addButton(1, "NobleH", confirmBloodline5, PerkLib.NobleHumansDescendant).hint("(+4 to human score)");
			...
			if (!player.hasPerk(PerkLib.RoyalHumanBloodline)) {
				if (flags[kFLAGS.HUMAN_BLOODLINE] >= 3) addButton(2, "RoyalH", confirmBloodline5, PerkLib.RoyalHumansDescendant).hint("(+6 to human score)");
			...
			if (!player.hasPerk(PerkLib.PrimarchBloodline)) {
				if (flags[kFLAGS.HUMAN_BLOODLINE] >= 4) addButton(3, "PrimarchB", confirmBloodline5, PerkLib.PrimarchsDescendant).hint("(+10 to human score)");
			...
			if (!player.hasPerk(PerkLib.BloodlineAvian)) addButton(5, "Avian", confirmBloodline5, PerkLib.AviansDescendant).hint("(+2 to avian / gryphon / peafowl score)");
			else addButtonDisabled(5, "Avian", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineUrsine)) addButton(6, "Ursine", confirmBloodline5, PerkLib.UrsinesDescendant).hint("(+2 to bear / panda / red panda score)");
			else addButtonDisabled(6, "Ursine", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineFeline)) addButton(7, "Feline", confirmBloodline5, PerkLib.FelinesDescendant).hint("(+2 to cat / hellcat / cheshire cat / displacer beast / nekomata score)");
			else addButtonDisabled(7, "Feline", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineCanine)) addButton(8, "Canine", confirmBloodline5, PerkLib.CaninesDescendant).hint("(+2 to anubis / dog / wolf score)");
			else addButtonDisabled(8, "Canine", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlinePlant)) addButton(10, "Plant", confirmBloodline5, PerkLib.PlantsDescendant).hint("(+2 to plant-morph / alraune / barometz score)");
			else addButtonDisabled(10, "Plant", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineLamia)) addButton(11, "Lamia", confirmBloodline5, PerkLib.LamiasDescendant).hint("(+2 to apophis / couatl / gorgon / marilith / naga / vouivre score)");
			else addButtonDisabled(11, "Lamia", "You already have this bloodline!");
			if (!player.hasPerk(PerkLib.BloodlineMustelid)) addButton(12, "Mustelid", confirmBloodline5, PerkLib.MustelidsDescendant).hint("(+2 to ferret / kamaitachi score)");
			else addButtonDisabled(12, "Mustelid", "You already have this bloodline!");
		...
		private function confirmBloodline2(choice:PerkType):void {
			...
			switch (choice) {
				...
				case PerkLib.YukiOnnasDescendant:
					...
					break;
				case PerkLib.BunnysDescendant:
					outputText("Your ancestor was a bunny?");
					break;
				case PerkLib.LizardsDescendant:
					outputText("Your ancestor was a lizan?");
					break;
				case PerkLib.HarpysDescendant:
					outputText("Your ancestor was a harpy?");
					break;
				case PerkLib.TanukisDescendant:
					outputText("Your ancestor was a raccoon/tanuki?");
					break;
				...
				case PerkLib.SpidersDescendant:
					...
					break;
				case PerkLib.TrollsDescendant:
					outputText("Your ancestor was a troll?");
					break;
				case PerkLib.BatsDescendant:
					outputText("Your ancestor was a bat?");
					break;
		...
		private function confirmBloodline3(choice:PerkType):void {
			...
			switch (choice) {
				case PerkLib.CancersDescendant:
					...
					break;
				case PerkLib.GazersDescendant:
					outputText("Your ancestor was a gazer?");
					break;
				case PerkLib.DeersDescendant:
					outputText("Your ancestor was a deer?");
					break;
				case PerkLib.MousesDescendant:
					outputText("Your ancestor was a mouse?");
					break;
			...
			menu();
			addButton(0, "Yes", setBloodline, choice);
			addButton(1, "No", chooseBloodline3);
		}

		private function confirmBloodline4(choice:PerkType):void {
			clearOutput();
			switch (choice) {
				...
				case PerkLib.DemonsDescendant:
					...
					break;
				case PerkLib.DevilsDescendant:
					outputText("Your ancestor was a devil?");
					break;
				default:
					outputText("Your ancestor was a werefox?");
			}
			menu();
			addButton(0, "Yes", setBloodline, choice);
			addButton(1, "No", chooseBloodline4);
		}

		private function confirmBloodline5(choice:PerkType):void {
			clearOutput();
			switch (choice) {
				case PerkLib.CommonHumansDescendant:
					outputText("Your ancestor was a common human?");
					break;
				case PerkLib.NobleHumansDescendant:
					outputText("Your ancestor was a noble human?");
					break;
			...
			menu();
			addButton(0, "Yes", setBloodline, choice);
			addButton(1, "No", chooseBloodline5);
		}
		...
		private function bloodlineACQ():void {
			...
			else if (player.hasPerk(PerkLib.BunnysDescendant)) {
				player.removePerk(PerkLib.BunnysDescendant);
				player.createPerk(PerkLib.BloodlineBunny,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.LizardsDescendant)) {
				player.removePerk(PerkLib.LizardsDescendant);
				player.createPerk(PerkLib.BloodlineLizard,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.HarpysDescendant)) {
				player.removePerk(PerkLib.HarpysDescendant);
				player.createPerk(PerkLib.BloodlineHarpy,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.TanukisDescendant)) {
				player.removePerk(PerkLib.TanukisDescendant);
				player.createPerk(PerkLib.BloodlineTanuki,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.SharksDescendant)) {
				player.removePerk(PerkLib.SharksDescendant);
				player.createPerk(PerkLib.BloodlineShark,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.SpidersDescendant)) {
				player.removePerk(PerkLib.SpidersDescendant);
				player.createPerk(PerkLib.BloodlineSpider,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.TrollsDescendant)) {
				player.removePerk(PerkLib.TrollsDescendant);
				player.createPerk(PerkLib.BloodlineTroll,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.BatsDescendant)) {
				player.removePerk(PerkLib.BatsDescendant);
				player.createPerk(PerkLib.BloodlineBat,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.BeesDescendant)) {
				player.removePerk(PerkLib.BeesDescendant);
				player.createPerk(PerkLib.BloodlineBee,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.CancersDescendant)) {
				player.removePerk(PerkLib.CancersDescendant);
				player.createPerk(PerkLib.BloodlineCancer,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.GazersDescendant)) {
				player.removePerk(PerkLib.GazersDescendant);
				player.createPerk(PerkLib.BloodlineGazer,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.DeersDescendant)) {
				player.removePerk(PerkLib.DeersDescendant);
				player.createPerk(PerkLib.BloodlineDeer,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.MousesDescendant)) {
				player.removePerk(PerkLib.MousesDescendant);
				player.createPerk(PerkLib.BloodlineMouse,0,0,0,1);
				bloodlineACQ2();
			}
			else if (player.hasPerk(PerkLib.MantisesDescendant)) {
				player.removePerk(PerkLib.MantisesDescendant);
			...
			else if (player.hasPerk(PerkLib.DevilsDescendant)) {
				player.removePerk(PerkLib.DevilsDescendant);
				player.createPerk(PerkLib.BloodlineDevil,0,0,0,1);
				bloodlineACQ2();
			}
		...
		private function ascensionPermeryMenu(page:int = 1):void {
			...
			if (page == 1) {
				...
				if (player.hasPerk(PerkLib.DragonDarknessBreath) && player.perkv4(PerkLib.DragonDarknessBreath) < 1) addButton(5, "D.DarknessB.", permanentizePerk1, PerkLib.DragonDarknessBreath);
				else if (player.hasPerk(PerkLib.DragonDarknessBreath) && player.perkv4(PerkLib.DragonDarknessBreath) > 0) addButtonDisabled(5, "D.DarknessB.", "Dragon Darkness Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(5, "D.DarknessB.", "Dragon Darkness Breath");
				//6 DragonEarthBreath
				if (player.hasPerk(PerkLib.DragonFaerieBreath) && player.perkv4(PerkLib.DragonFaerieBreath) < 1) addButton(7, "D.FaerieB.", permanentizePerk1, PerkLib.DragonFaerieBreath);
				else if (player.hasPerk(PerkLib.DragonFaerieBreath) && player.perkv4(PerkLib.DragonFaerieBreath) > 0) addButtonDisabled(7, "D.FaerieB.", "Dragon Faerie Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(7, "D.FaerieB.", "Dragon Faerie Breath");
				if (player.hasPerk(PerkLib.DragonFireBreath) && player.perkv4(PerkLib.DragonFireBreath) < 1) addButton(8, "D.FireB.", permanentizePerk1, PerkLib.DragonFireBreath);
				else if (player.hasPerk(PerkLib.DragonFireBreath) && player.perkv4(PerkLib.DragonFireBreath) > 0) addButtonDisabled(8, "D.FireB.", "Dragon Fire Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(8, "D.FireB.", "Dragon Fire Breath");
				addButton(9, "Previous", ascensionPermeryMenu, page + 3);
				if (player.hasPerk(PerkLib.DragonIceBreath) && player.perkv4(PerkLib.DragonIceBreath) < 1) addButton(10, "D.IceB.", permanentizePerk1, PerkLib.DragonIceBreath);
				else if (player.hasPerk(PerkLib.DragonIceBreath) && player.perkv4(PerkLib.DragonIceBreath) > 0) addButtonDisabled(10, "D.IceB.", "Dragon Ice Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(10, "D.IceB.", "Dragon Ice Breath");
				if (player.hasPerk(PerkLib.DragonLightningBreath) && player.perkv4(PerkLib.DragonLightningBreath) < 1) addButton(11, "D.LightningB.", permanentizePerk1, PerkLib.DragonLightningBreath);
				else if (player.hasPerk(PerkLib.DragonLightningBreath) && player.perkv4(PerkLib.DragonLightningBreath) > 0) addButtonDisabled(11, "D.LightningB.", "Dragon Lightning Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(11, "D.LightningB.", "Dragon Lightning Breath");
				if (player.hasPerk(PerkLib.DragonLustPoisonBreath) && player.perkv4(PerkLib.DragonLustPoisonBreath) < 1) addButton(12, "D.LustPoisonB.", permanentizePerk1, PerkLib.DragonLustPoisonBreath);
				else if (player.hasPerk(PerkLib.DragonLustPoisonBreath) && player.perkv4(PerkLib.DragonLustPoisonBreath) > 0) addButtonDisabled(12, "D.LustPoisonB.", "Dragon Lust Poison Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(12, "D.LustPoisonB.", "Dragon Lust Poison Breath");
				if (player.hasPerk(PerkLib.DragonPoisonBreath) && player.perkv4(PerkLib.DragonPoisonBreath) < 1) addButton(13, "D.PoisonB.", permanentizePerk1, PerkLib.DragonPoisonBreath);
				else if (player.hasPerk(PerkLib.DragonPoisonBreath) && player.perkv4(PerkLib.DragonPoisonBreath) > 0) addButtonDisabled(13, "D.PoisonB.", "Dragon Poison Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(13, "D.PoisonB.", "Dragon Poison Breath");
			}
			if (page == 2) {
				if (player.hasPerk(PerkLib.DragonPoisonousSapBreath) && player.perkv4(PerkLib.DragonPoisonousSapBreath) < 1) addButton(0, "D.PoisonSapB.", permanentizePerk2, PerkLib.DragonPoisonousSapBreath);
				else if (player.hasPerk(PerkLib.DragonPoisonousSapBreath) && player.perkv4(PerkLib.DragonPoisonousSapBreath) > 0) addButtonDisabled(0, "D.PoisonSapB.", "Dragon Poisonous Sap Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(0, "D.PoisonSapB.", "Dragon Poisonous Sap Breath");
				if (player.hasPerk(PerkLib.DragonRegalBreath) && player.perkv4(PerkLib.DragonRegalBreath) < 1) addButton(1, "D.RegalB.", permanentizePerk2, PerkLib.DragonRegalBreath);
				else if (player.hasPerk(PerkLib.DragonRegalBreath) && player.perkv4(PerkLib.DragonRegalBreath) > 0) addButtonDisabled(1, "D.RegalB.", "Dragon Regal Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(1, "D.RoyalB.", "Dragon Royal Breath");
				if (player.hasPerk(PerkLib.DragonWaterBreath) && player.perkv4(PerkLib.DragonWaterBreath) < 1) addButton(2, "D.WaterB.", permanentizePerk2, PerkLib.DragonWaterBreath);
				else if (player.hasPerk(PerkLib.DragonWaterBreath) && player.perkv4(PerkLib.DragonWaterBreath) > 0) addButtonDisabled(2, "D.WaterB.", "Dragon Water Breath perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(2, "D.WaterB.", "Dragon Water Breath");
				if (player.hasPerk(PerkLib.DarkSlimeEmpressCore) && player.perkv4(PerkLib.DarkSlimeEmpressCore) < 1) addButton(3, "E.D.Essence", permanentizePerk2, PerkLib.DarkSlimeEmpressCore);
				...
				addButton(4, "Next", ascensionPermeryMenu, page + 1);
				if (player.hasPerk(PerkLib.EnlightenedKitsune) && player.perkv4(PerkLib.EnlightenedKitsune) < 1 && player.hasPerk(PerkLib.EnlightenedNinetails) && player.perkv4(PerkLib.EnlightenedNinetails) < 1) addButton(5, "EnlightenedK", permanentizePerkEnlightenedKitsuneAndNinetails);
				else if (player.hasPerk(PerkLib.EnlightenedKitsune) && player.perkv4(PerkLib.EnlightenedKitsune) > 0 && player.hasPerk(PerkLib.EnlightenedNinetails) && player.perkv4(PerkLib.EnlightenedNinetails) > 0) addButtonDisabled(5, "EnlightenedK", "Enlightened Kitsune and Enlightened Ninetails perks are already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(5, "EnlightenedK", "Enlightened Kitsune and Enlightened Ninetails");
				if (player.hasPerk(PerkLib.FerasBoonAlpha) && player.perkv4(PerkLib.FerasBoonAlpha) < 1) addButton(6, "FerasB.A.", permanentizePerk2, PerkLib.FerasBoonAlpha);
				else if (player.hasPerk(PerkLib.FerasBoonAlpha) && player.perkv4(PerkLib.FerasBoonAlpha) > 0) addButtonDisabled(6, "FerasB.A.", "Feras Boon Alpha perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(6, "FerasB.A.", "Feras Boon Alpha");
				if (player.hasPerk(PerkLib.FerasBoonBreedingBitch) && player.perkv4(PerkLib.FerasBoonBreedingBitch) < 1) addButton(7, "FerasB.B.B.", permanentizePerk2, PerkLib.FerasBoonBreedingBitch);
				else if (player.hasPerk(PerkLib.FerasBoonBreedingBitch) && player.perkv4(PerkLib.FerasBoonBreedingBitch) > 0) addButtonDisabled(7, "FerasB.B.B.", "Feras Boon Breeding Bitch perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(7, "FerasB.B.B.", "Feras Boon Breeding Bitch");
				if (player.hasPerk(PerkLib.FerasBoonMilkingTwat) && player.perkv4(PerkLib.FerasBoonMilkingTwat) < 1) addButton(8, "FerasB.M.T.", permanentizePerk2, PerkLib.FerasBoonMilkingTwat);
				else if (player.hasPerk(PerkLib.FerasBoonMilkingTwat) && player.perkv4(PerkLib.FerasBoonMilkingTwat) > 0) addButtonDisabled(8, "FerasB.M.T.", "Feras Boon Milking Twat perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(8, "FerasB.M.T.", "Feras Boon Milking Twat");
				addButton(9, "Previous", ascensionPermeryMenu, page - 1);
				if (player.hasPerk(PerkLib.FerasBoonSeeder) && player.perkv4(PerkLib.FerasBoonSeeder) < 1) addButton(10, "FerasB.S.", permanentizePerk2, PerkLib.FerasBoonSeeder);
				else if (player.hasPerk(PerkLib.FerasBoonSeeder) && player.perkv4(PerkLib.FerasBoonSeeder) > 0) addButtonDisabled(10, "FerasB.S.", "Feras Boon Seeder perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(10, "FerasB.S.", "Feras Boon Seeder");
				if (player.hasPerk(PerkLib.FerasBoonWideOpen) && player.perkv4(PerkLib.FerasBoonWideOpen) < 1) addButton(11, "FerasB.W.O.", permanentizePerk2, PerkLib.FerasBoonWideOpen);
				else if (player.hasPerk(PerkLib.FerasBoonWideOpen) && player.perkv4(PerkLib.FerasBoonWideOpen) > 0) addButtonDisabled(11, "FerasB.W.O.", "Feras Boon Wide Open perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(11, "FerasB.W.O.", "Feras Boon Wide Open");
				if (player.hasPerk(PerkLib.FireLord) && player.perkv4(PerkLib.FireLord) < 1) addButton(12, "FireLord", permanentizePerk2, PerkLib.FireLord);
				else if (player.hasPerk(PerkLib.FireLord) && player.perkv4(PerkLib.FireLord) > 0) addButtonDisabled(12, "FireLord", "FireLord perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(12, "FireLord", "FireLord");
				if (player.hasPerk(PerkLib.Flexibility) && player.perkv4(PerkLib.Flexibility) < 1) addButton(13, "Flexibility", permanentizePerk2, PerkLib.Flexibility);
				else if (player.hasPerk(PerkLib.Flexibility) && player.perkv4(PerkLib.Flexibility) > 0) addButtonDisabled(13, "Flexibility", "Flexibility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(13, "Flexibility", "Flexibility");
			}
			if (page == 3) {
				if (player.hasPerk(PerkLib.Hellfire) && player.perkv4(PerkLib.Hellfire) < 1) addButton(0, "Hellfire", permanentizePerk3, PerkLib.Hellfire);
				else if (player.hasPerk(PerkLib.Hellfire) && player.perkv4(PerkLib.Hellfire) > 0) addButtonDisabled(0, "Hellfire", "Hellfire perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(0, "Hellfire", "Hellfire");
				if (player.hasPerk(PerkLib.InkSpray) && player.perkv4(PerkLib.InkSpray) < 1) addButton(1, "InkSpray", permanentizePerk3, PerkLib.InkSpray);
				else if (player.hasPerk(PerkLib.InkSpray) && player.perkv4(PerkLib.InkSpray) > 0) addButtonDisabled(1, "InkSpray", "Ink Spray perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(1, "InkSpray", "Ink Spray");
				if (player.hasPerk(PerkLib.LizanRegeneration) && player.perkv4(PerkLib.LizanRegeneration) < 1) addButton(2, "LizanRegen", permanentizePerk3, PerkLib.LizanRegeneration);
				else if (player.hasPerk(PerkLib.LizanRegeneration) && player.perkv4(PerkLib.LizanRegeneration) > 0) addButtonDisabled(2, "LizanRegen", "Lizan Regeneration perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(2, "LizanRegen", "Lizan Regeneration");
				if (player.hasPerk(PerkLib.Lustzerker) && player.perkv4(PerkLib.Lustzerker) < 1) addButton(3, "Lustzerker", permanentizePerk3, PerkLib.Lustzerker);
				else if (player.hasPerk(PerkLib.Lustzerker) && player.perkv4(PerkLib.Lustzerker) > 0) addButtonDisabled(3, "Lustzerker", "Lustzerker perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(3, "Lustzerker", "Lustzerker");
				addButton(4, "Next", ascensionPermeryMenu, page + 1);
				if (player.hasPerk(PerkLib.MagicalFertility) && player.perkv4(PerkLib.MagicalFertility) < 1) addButton(5, "MagicalF.", permanentizePerk3, PerkLib.MagicalFertility);
				else if (player.hasPerk(PerkLib.MagicalFertility) && player.perkv4(PerkLib.MagicalFertility) > 0) addButtonDisabled(5, "MagicalF.", "Magical Fertility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(5, "MagicalF.", "Magical Fertility");
				if (player.hasPerk(PerkLib.MagicalVirility) && player.perkv4(PerkLib.MagicalVirility) < 1) addButton(6, "MagicalV.", permanentizePerk3, PerkLib.MagicalVirility);
				else if (player.hasPerk(PerkLib.MagicalVirility) && player.perkv4(PerkLib.MagicalVirility) > 0) addButtonDisabled(6, "MagicalV.", "Magical Virility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(6, "MagicalV.", "Magical Virility");
				if (player.hasPerk(PerkLib.MaraesGiftButtslut) && player.perkv4(PerkLib.MaraesGiftButtslut) < 1) addButton(7, "MaraesGiftB.", permanentizePerk3, PerkLib.MaraesGiftButtslut);
				else if (player.hasPerk(PerkLib.MaraesGiftButtslut) && player.perkv4(PerkLib.MaraesGiftButtslut) > 0) addButtonDisabled(7, "MaraesGiftB.", "Maraes Gift Buttslut perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(7, "MaraesGiftB.", "Maraes Gift Buttslut");
				if (player.hasPerk(PerkLib.MaraesGiftFertility) && player.perkv4(PerkLib.MaraesGiftFertility) < 1) addButton(8, "MaraesGiftF.", permanentizePerk3, PerkLib.MaraesGiftFertility);
				else if (player.hasPerk(PerkLib.MaraesGiftFertility) && player.perkv4(PerkLib.MaraesGiftFertility) > 0) addButtonDisabled(8, "MaraesGiftF.", "Maraes Gift Fertility perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(8, "MaraesGiftF.", "Maraes Gift Fertility");
				addButton(9, "Previous", ascensionPermeryMenu, page - 1);
				if (player.hasPerk(PerkLib.MaraesGiftProfractory) && player.perkv4(PerkLib.MaraesGiftProfractory) < 1) addButton(10, "MaraesGiftP.", permanentizePerk3, PerkLib.MaraesGiftProfractory);
				else if (player.hasPerk(PerkLib.MaraesGiftProfractory) && player.perkv4(PerkLib.MaraesGiftProfractory) > 0) addButtonDisabled(10, "MaraesGiftP.", "Maraes Gift Profractory perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(10, "MaraesGiftP.", "Maraes Gift Profractory");
				if (player.hasPerk(PerkLib.MaraesGiftStud) && player.perkv4(PerkLib.MaraesGiftStud) < 1) addButton(11, "MaraesGiftS.", permanentizePerk3, PerkLib.MaraesGiftStud);
				else if (player.hasPerk(PerkLib.MaraesGiftStud) && player.perkv4(PerkLib.MaraesGiftStud) > 0) addButtonDisabled(11, "MaraesGiftS.", "Maraes Gift Stud perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(11, "MaraesGiftS.", "Maraes Gift Stud");
				if (player.hasPerk(PerkLib.MilkMaid) && player.perkv4(PerkLib.MilkMaid) < 1) addButton(12, "MilkMaid", permanentizePerk3, PerkLib.MilkMaid);
				else if (player.hasPerk(PerkLib.MilkMaid) && player.perkv4(PerkLib.MilkMaid) > 0) addButtonDisabled(12, "MilkMaid", "MilkMaid perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(12, "MilkMaid", "MilkMaid");
				if (player.hasPerk(PerkLib.Misdirection) && player.perkv4(PerkLib.Misdirection) < 1) addButton(13, "Misdirection", permanentizePerk3, PerkLib.Misdirection);
				else if (player.hasPerk(PerkLib.Misdirection) && player.perkv4(PerkLib.Misdirection) > 0) addButtonDisabled(13, "Misdirection", "Misdirection perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(13, "Misdirection", "Misdirection");
			}
			if (page == 4) {
				if (flags[kFLAGS.NEW_GAME_PLUS_LEVEL] >= 2) {
					if (player.hasPerk(PerkLib.NinetailsKitsuneOfBalance) && player.perkv4(PerkLib.NinetailsKitsuneOfBalance) < 1) addButton(0, "9TKitsOfB", permanentizePerk4, PerkLib.NinetailsKitsuneOfBalance);
					else if (player.hasPerk(PerkLib.NinetailsKitsuneOfBalance) && player.perkv4(PerkLib.NinetailsKitsuneOfBalance) > 0) addButtonDisabled(0, "9TKitsOfB", "9T Kitsune Of Balance perk is already made permanent and will carry over in all subsequent ascensions.");
				}
				else addButtonDisabled(0, "9TKitsOfB", "9T Kitsune Of Balance");
				if (player.hasPerk(PerkLib.OneTrackMind) && player.perkv4(PerkLib.OneTrackMind) < 1) addButton(1, "OneTrackMind", permanentizePerk4, PerkLib.OneTrackMind);
				else if (player.hasPerk(PerkLib.OneTrackMind) && player.perkv4(PerkLib.OneTrackMind) > 0) addButtonDisabled(1, "OneTrackMind", "One Track Mind perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(1, "OneTrackMind", "One Track Mind");
				if (player.hasPerk(PerkLib.PureAndLoving) && player.perkv4(PerkLib.PureAndLoving) < 1) addButton(2, "Pure&Loving", permanentizePerk4, PerkLib.PureAndLoving);
				else if (player.hasPerk(PerkLib.PureAndLoving) && player.perkv4(PerkLib.PureAndLoving) > 0) addButtonDisabled(2, "Pure&Loving", "Pure And Loving perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(2, "Pure&Loving", "Pure And Loving");
				if (player.hasPerk(PerkLib.PurityBlessing) && player.perkv4(PerkLib.PurityBlessing) < 1) addButton(3, "PurityBlessing", permanentizePerk4, PerkLib.PurityBlessing);
				else if (player.hasPerk(PerkLib.PurityBlessing) && player.perkv4(PerkLib.PurityBlessing) > 0) addButtonDisabled(3, "PurityBlessing", "Purity Blessing perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(3, "PurityBlessing", "Purity Blessing");
				addButton(4, "Next", ascensionPermeryMenu, page - 3);
				if (player.hasPerk(PerkLib.RapierTraining) && player.perkv4(PerkLib.RapierTraining) < 1) addButton(5, "RapierTrain", permanentizePerk4, PerkLib.RapierTraining);
				else if (player.hasPerk(PerkLib.RapierTraining) && player.perkv4(PerkLib.RapierTraining) > 0) addButtonDisabled(5, "RapierTrain", "Rapier Training perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(5, "RapierTrain", "Rapier Training");
				if (player.hasPerk(PerkLib.SensualLover) && player.perkv4(PerkLib.SensualLover) < 1) addButton(6, "SensualLover", permanentizePerk4, PerkLib.SensualLover);
				...
				if (player.hasPerk(PerkLib.TechOverdrive) && player.perkv4(PerkLib.TechOverdrive) < 1) addButton(7, "TechOverdrive", permanentizePerk4, PerkLib.TechOverdrive);
				else if (player.hasPerk(PerkLib.TechOverdrive) && player.perkv4(PerkLib.TechOverdrive) > 0) addButtonDisabled(7, "TechOverdrive", "Tech Overdrive perk is already made permanent and will carry over in all subsequent ascensions.");
				else addButtonDisabled(7, "TechOverdrive", "Tech Overdrive");
				//8
				addButton(9, "Previous", ascensionPermeryMenu, page - 1);
				//10
				//11
		...
		private function permanentizePerk4(perk:PerkType):void {
			//Not enough points or perk already permed? Cancel.
			if (player.ascensionPerkPoints < 5) return;
			if (player.perkv4(perk) > 0) return;
			//Deduct points
		...
		private function reincarnate():void {
			...
			if (flags[kFLAGS.NEW_GAME_PLUS_LEVEL] == 0.5) flags[kFLAGS.NEW_GAME_PLUS_LEVEL] = 0;
		...
		private function isSpecialKeyItem(keyName:* = null):Boolean {//tylko sky poison pearl zostawić tutaj (only leave sky, poison, pearl here)
			return (keyName == "Ascension" || keyName == "Sky Poison Pearl" || keyName == "Dimensional Pocket" || keyName == "Nieve's Tear");
		}

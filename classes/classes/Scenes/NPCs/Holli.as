...
//attack noun: lash
		...
		public function escapeFailWithHolli():void
		{
			...
			if (!player.hasPerk(PerkLib.Juggernaut) && armorPerk != "Heavy") {var damage:int = 15;
...
//constrict -Z
		...
		public function struggleOutOfHolli():void
		{
			...
			else if (rand(Math.round(player.strStat.core.value * 0.8)) < player.strStat.core.value || player.hasPerk(PerkLib.FluidBody)) {

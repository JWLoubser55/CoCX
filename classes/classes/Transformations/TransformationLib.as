...
//======================================================================================================================
	...
	public const EyesSpider: Transformation			= eyes.EyesSpider.registerTfMultiple(AS_EYES, AE_SPIDER, AE_USHI_ONI);
	...
	public const EyesFrog: Transformation			= eyes.EyesFrog.registerTfMultiple(AS_EYES, AE_FROG, AE_MOBOGO);
//=================================
//                                =
//   EYE COLORS                   =
//                                =
...
//======================================================================================================================
    ...
    public const FaceFrog: Transformation 				= face.FaceFrog.registerTfMultiple(AS_FACE, AE_FROG, AE_MOBOGO);
...
//======================================================================================================================
	...
	public function LowerBodyDemonClawed(legCount: int = undefined): Transformation 			{ return lowerBody.LowerBodyDemonClawed(legCount); }
	public const LowerBodyDemonClawedBipedal: Transformation = lowerBody.LowerBodyDemonClawed(2).registerTf(AS_LEGS, AE_DEMON);
	public function LowerBodyDemonClawedToggle(toggleTaur:Boolean = false): Transformation 		{ return lowerBody.LowerBodyDemonClawed(player.legCount, toggleTaur); }
	public function LowerBodyDemonHoofed(legCount: int = undefined): Transformation 			{ return lowerBody.LowerBodyDemonHoofed(legCount); }
	public const LowerBodyDemonHoofedBipedal: Transformation = lowerBody.LowerBodyDemonHoofed(2).registerTf(AS_LEGS, AE_DEMON);
	public function LowerBodyDemonHoofedToggle(toggleTaur:Boolean = false): Transformation 		{ return lowerBody.LowerBodyDemonHoofed(player.legCount, toggleTaur); }
	public function LowerBodyDemonClovenHoofed(legCount: int = undefined): Transformation 		{ return lowerBody.LowerBodyDemonClovenHoofed(legCount); }
	public const LowerBodyDemonClovenHoofedBipedal: Transformation = lowerBody.LowerBodyDemonClovenHoofed(2).registerTf(AS_LEGS, AE_DEMON);
	public function LowerBodyDemonClovenHoofedToggle(toggleTaur:Boolean = false): Transformation{ return lowerBody.LowerBodyDemonClovenHoofed(player.legCount, toggleTaur); }
...
//======================================================================================================================
    ...
    public function VaginaDragon(vagina:int = 0): Transformation { return vaginas.VaginaDragon(vagina); }
	public const VaginaAnyDragon:Transformation = VaginaDragon(-1).registerTfMultiple(AS_VAGINA, AE_DRAGON, AE_FROST_WYRM, AE_FAERIE_DRAGON, AE_JABBERWOCKY);
...
//======================================================================================================================
	...
	public const WingsLevitation: Transformation 				= wings.WingsLevitation.registerTfMultiple(AS_WINGS, AE_GAZER, AE_WENDIGO, AE_YUKI_ONNA, AE_LICH).withAlchemyNames("Levitation","Levitation");

...
public function helSprite():void {
...
internal function loseToSalamander():void {
	...
	function dickF():void {
		...
		outputText("She moans lustily at the taste of cockflesh, and begins to pump your [cock] with one hand as her other wanders up and begins to caress her heavy tits, grasping one for a moment, then reaching over and tweaking the other's nipple so hard she winces.  She continues the show for a good minute or two, pumping your cock in time with her self-pleasuring.  You're as hard as you'll ever be, and when you manage to tear your gaze away from her luscious tits, you can see trickles of moisture running down her thighs, signaling her own readiness for you.\n\n");
		...
		outputText("Finally, you can take no more.  You feel the mounting pressure in your crotch, signaling impending orgasm.  You clamp down hard on her pillowy tits and give a mighty last suck on the tip of her tail as you pump a burst of spunk deep inside her");
		if(player.gender == 3) outputText(" and your vag begins to squirt girlcum onto her scaled thighs");
	...
	function vagF():void {
		...
		if(player.hasCock()) outputText(", your cock shooting a massive rope of spunk onto her face as your vag cums from the tailfucking");
		outputText(".\n\n");
...
private function helDefeatedNormal():void {
	...
	if(flags[kFLAGS.HEL_TIMES_ENCOUNTERED] == 1) {
		...
		outputText("She suddenly grins, tossing her sword aside.  \"<i>Speaking of getting some blood up... Hey, to the victor go the spoils, and all that.  What do you say we blow off some steam, huh?  Nothing better after a good fight than a good fuck, you know?</i>\"");
	}
	else {
...
internal function fuckHelsVag():void {
	...
	if(player.hasVagina()) outputText(" while releasing her breasts to finger your " + vaginaDescript(0));
...
internal function helBlowsYou():void {
	...
	outputText("You agree to her proposition, and tell her to get on her knees as you draw out your " + cockDescript(x) + " and slip out of your [armor].  She grins and drops to her knees, quickly discarding her scaled bikini as you stroke yourself to hardness.  You close the distance between you and the salamander is quick to take your cock into her mouth, lustily sucking it in as she starts to fondle her breasts enticingly.\n\n");
	...
	if(player.cocks[x].cockLength >= 6) outputText(", making her deepthroat you");
	outputText(" as you cum and fill her mouth with ");
	if(player.cumQ() <= 30) outputText("squirts");
	else if(player.cumQ() <= 100) outputText("ropes");
...
internal function getLickedByHel():void {
	...
	outputText("You can only endure a minute or so of this treatment before you come, screaming your pleasure as you thrust into her face, soaking her with girl cum");
	if(player.hasCock()) {
		outputText(" while " + sMultiCockDesc() + " shoots its load into her red hair");
		if(player.cumQ() >= 500) outputText(", bathing her in streams of jism");
	}
...
internal function helTailPegging(loss:Boolean = false):void {
	...
	outputText("\n\n");
	outputText("Firmly within your depths, she plants her smooth, scaled hands on your [butt] and starts to hammer your ass, quickly thrusting her tail in and out.  You gasp and moan like a whore, barely able to support your own weight as she fucks your ass hard and fast, threatening to tear your tender insides up with her rough fucking.\n\n");
	outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, sensing this from the fashion you're wringing her tail, gives your [butt] a hard slap and slams in as far as it can go.  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt");
	if(player.gender > 0) {
		...
		outputText(" contracting and squirting all over your lover");
	}
...
private function nagaCoilsUpHel():void {
	...
	outputText("With your lover now completely at your mercy, you lean back and draw her close, lining her crotch up with your " + cockDescript(x));
	if(y >= 0) outputText(" and her ass up with your " + cockDescript(y));
	...
	outputText("You reward her by pulling her half way off your cock");
	if(y >= 0) outputText("s");
...
private function nagaCoilsUpAnalNaga():void {
	...
	outputText("You slither closer to the salamander and tell her that, yeah, you could stand to work off some steam.  She grins at that and closes the distance between you, reaching out to caress your serpentine half.  \"<i>Mmm.  Sexy tail, lover,</i>\" she says, reaching around and giving your [butt] a squeeze in her smooth, scaled hands.  \"<i>It'd be a real shame for such beautiful coils to go unused, you know...</i>\" she adds, giving you a little wink.\n\n");
	outputText("You get an idea in a hurry, and quickly discard your [armor] as she does the same.  She drops to her hands and knees before you, and like a child, snatches at your tail.  Once in hand, she eagerly puts her mouth to it, sucking your tail's tip like a cock.  You shudder at the odd sensation, but when she raises her tail up toward you, you reciprocate the gesture, taking her extinguished tip into your mouth and slathering it with spittle.\n\n");
	outputText("Once both your tails are sufficiently lubricated, the salamander crawls behind you, and presses her back tightly to yours.  In an odd show of kindness, she even takes your hands in hers as her tail slithers between the cheeks of your [butt].  You return the favor, soon pressing the tip of your tail to her tight but relaxed asshole as hers begins to slip into your " + assholeDescript() + ".  You gasp with the sensation of the hot, writhing tail-cock pushing inside you, fighting every inch to wring sensation out of it even as you push yours deep inside her, hard enough to make her take a sharp breath and knock her knees.");
	player.buttChange(40,true,true,false);
	outputText("\n\n");
...
private function mountHel():void {
	...
	outputText("You fuck and rut and thrust until the salamander lets out a sharp cry, and her steaming inner muscles clamp down like a vice.  You grunt and impale her one last time before your " + cockDescript(x) + " explodes within, filling her to the brim with your centaur spunk");
	if(player.cumQ() >= 500) outputText(" until it begins to pour out around your cock, pooling between her spread legs");
	outputText(".\n\n");
	...
	outputText("\"<i>You sure I can't convince you to stick around?  I was serious about needing a warhorse... doubly one that can make me feel like a wild animal being bred...</i>\"  ");
	if(player.cor < 50) outputText("Sadly, your duties as Champion prevent you from accepting her offer, even if you wanted to.  You tell her as much, and she sighs heavily.");
	else outputText("You can't imagine committing to just one of this world's many eager pussies when so many more will go unfilled, though you fob her off with a more polite excuse.");
...
private function helVaginaTaur69():void {
	...
	outputText("You start trotting, letting the hands on your withers guide you this way and that across the wide open plains.  All the while, she whispers gentle encouragements into your ear, occasionally stopping to rub her tits tantalizingly into your back, letting her dangling tail flicker across your " + vaginaDescript(0) + " and [butt].  Eventually, though, she sets her sights on a patch of particularly tall, green grass, almost up to your ears.  As soon as you arrive, she slips gracefully from your back and laughs aloud.  \"<i>Oh, that was so much fun.  Thank you, friend.  I've never ridden a horse – a centaur – before you, but I think I could get used to it.  Oh!  Imagine, you and I, valiant adventurer and her trusty warhorse, wading into battle like – hey, I see that look on your face.  Don't laugh, dammit!</i>\"\n\n");
	outputText("You stifle a chuckle, and gently remind her of a certain obligation of hers.  \"<i>Mmm.  Well, you let me ride you, so I guess it's only fair,</i>\" she says, walking up to you with her wide, muscular hips swaying, tail swishing.  \"<i>... If I tend to my trusty steed.</i>\"  She pulls your face close to hers and gives you a kiss on the lips, slipping in a bit of her long, forked tongue.  She breaks the kiss, and soon after has your [armor] discarded on the ground, and her own bikini tossed haphazardly aside, then takes a step back; you can hardly reach out to her before she's vanished in the tall grass!\n\n");
	...
	outputText("You're hardly prepared for what comes next.  Without warning, the salamander slams her arm into your cunt, punching hard into your cervix.");
	...
	outputText("She hammers your cervix, fist-fucking you like a massive knotted cock.  It takes a minute to reconcile yourself to the enormous penetration, but soon you're shaking your hips and whinnying with pleasure.  ");
	if(player.hasCock()) {
		outputText("Now that you're calmer, the salamander takes the opportunity to grasp " + oMultiCockDesc() + " with her free hand and guide it into her mouth.  Her forked, reptilian tongue flicks out, running across your girth as more and more of you slips past her thin lips and down her throat");
		if(player.shortestCockLength() <= 24) outputText(" , until you're buried to the hilt");
		outputText(".  You moan lewdly as she begins to suck in time with her fist-fucking, doubling up on you until your mind is almost numb with pleasure.  ");
	}
	...
	outputText(".  Getting a good grip on her hot, red tail, you start to fuck her hard, fast, and perhaps vengefully as she continues to assault your " + vaginaDescript(0));
	if(player.hasCock()) outputText(" and swelling member");
	outputText(".\n\n");
	outputText("It cannot go on forever.  You soon feel the tell-tale pressure of impending orgasm building behind your " + vaginaDescript(0));
...
private function rapingHelsAssMeansYourCorruptCauseAnalIsEvil():void {
	...
	outputText("She's too exhausted, and you're too skilled, for the attack to land.  Instead, you grab her wide hips and lunge forward, ramming your " + cockDescript(x) + " into her ass");
	if(y >= 0) outputText(", and your " + cockDescript(y) + " into her waiting vag, doubling the assault on the helpless berserker");
...
private function receiveCorruptRimjobsFromHel():void {
	helSprite();
	clearOutput();
	outputText("The sight of the salamander berserker on her knees stirs the fire in your loins, and in moments you've stripped out of your [armor] and advanced upon her.  She looks up at you, gritting her teeth as if preparing to strike – you preempt her with a hard kick in the chest, knocking her on her back, then kneel down and straddle her, pinning her arms down underneath your knees as you bring your " + assholeDescript() + " to hover over her face.\n\n");
	...
	if(player.hasVagina()) outputText("  Her tongue begins to zero in on your " + vaginaDescript(0) + ", but you give her a quick penalty swat on the tits.  You've got other plans!");
	outputText("\n\n");
	outputText("After a few moments of this, her long tongue traces its way along your [butt], causing small shudders of pleasure to rock through you, but she's only just getting to the main event.  You force yourself to relax your sphincter as her tongue flicks once, twice, thrice across your " + assholeDescript() + ".  In a heartbeat, she's in!  You gasp as her long, slender tongue flicks and writhes within you, teasing and pleasuring the sensitive muscles of your ass as she works more and more of it in.\n\n");
	outputText("Firmly within your depths, she plants her smooth, scaled hands on your [butt] and starts to flick her tongue as fast as she can, withdrawing and ramming it back into your ass.  You gasp and moan like a whore");
	if(player.biggestTitSize() >= 1) outputText(", groping your tits,");
	...
	outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, possibly sensing this by the way you wring her tongue, gives your [butt] a hard slap and rams in as far as she can go!  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt, writhing in pleasure as her tongue slowly withdraws from your " + assholeDescript() + ".\n\n");
...
public function helMinotaurThreesome():void {
	...
	outputText("You can't help but laugh at the absurdity of it.  She grins over her shoulder at you, but stops to gasp as the minotaur between her legs bucks his hips, burying his dick deep in her welcoming cunt.  \"<i>Well, don't just stand there, killer!  ");
	if(player.hasCock()) outputText("I've got another hole needs filling!</i>\"");
	else outputText("There's enough 'taur to go around, so come on!</i>\"");
	///Player's Options:
...
private function helMinoThreeSomeLickItsDick():void {
	...
	if(player.hasVagina()) outputText("crotch");
	else outputText("ass");
	...
	if(player.hasCock()) outputText(" while " + sMultiCockDesc() + " ejects its load into the mess on the 'taur's chest");
	outputText(".\n\n");
...
private function askHelAboutHer():void {
	...
	outputText("You laugh, and extend a hand to her. \"<i>The name's [name].  Pleased to meet you.</i>\"\n\n");
	outputText("\"<i>I'm Helia.  Or Hel, if you'd like.  And the pleasure's mine, [name],</i>\" she says, shaking your hand.\n\n");
	...
	outputText("She gives you another kiss, and falls silent.");
...
private function leaveHelAfterMinoThreeSomeChat():void {
	helSprite();
	clearOutput();
	outputText("Sadly, you know you have things to tend to, and so you give your salamander lover a quick peck goodbye as you get to your feet and clean off your [armor].  As you're getting ready to head back to camp, however, you feel her powerful arms wrap around your waist, locking you in place as her long, reptilian tongue snakes out to tease your ear.\n\n");
...
public function salamanderXIsabellaPlainsIntro():void {
	...
	outputText("You make your way onto the vast expanse of Mareth's plainsland and soon find yourself submerged in the tall grass, wading through it like a sea of weeds.  After a few minutes of wandering, you hear what sounds like a surprised, throaty moo in the distance, followed shortly by the crack of steel on steel.  Knowing Isabella makes camp not far from here, you ready your [weapon] and make best haste toward the cow-girl's camp.\n\n");
	outputText("You burst into Isabella's camp, [weapon] raised high.  To your horror, the red-headed cow-girl is standing with her massive tower shield braced, eyeing down Hel the salamander.  The salamander stands with sword in hand, poised to strike!\n\n");
	...
	outputText("Before Isabella can say any more, the salamander leaps into the air and slams her sword down upon the cow-girl's narrowly-interposed shield.  The force of the blow staggers both of them, giving you a moment to intervene before there's bloodshed!");
...
private function salamanderXIsabellaDiplomacy():void {
	...
	if(player.str > 60) {
		...
		outputText("\"<i>[name]!?</i>\" They both blurt at once, surprised by your intervention.");
	}
	//(PC fails the Strength check)
		...
		outputText("To your relief, after a few seconds you hear \"<i>[name]!</i>\" from both Isabella and Hel.  The two women momentarily stop their squabbling to help you; your head is soon resting upon Isabella's sizable cleavage while Hel ties a long length of plains grass over a cut in your sternum.\n\n");
	}
...
private function salamanderXIsabellaDiplomacy2():void {
	...
	outputText("Isabella makes an indignant huff and turns her nose up at the salamander.  \"<i>Do not listen to zis little liar, [name].  I found it in ze hands of ze gnolls, and most certainly did not steal it.</i>\"\n\n");
	outputText("\"<i>Hey...  How does she know your name, [name]?</i>\" Hel asks, crossing her arms over her sizable chest and frowning at you.\n\n");
	outputText("The cow-girl's brow furrows.  \"<i>Ja!  I could ask much ze same question.</i>\"\n\n");
	outputText("You spend the next few minutes explaining how you met each of the women in turn, receiving suspicious nods from Hel and Isabella.  Once you've explained yourself to the pair of women attempting to intimidate you, you ");
	...
	outputText("\"<i>Yeah,</i>\" Hel answers with a little scoff, \"<i>And, I guess if you're [name]'s friend... you're probably all right.  Although I was winning, you impertinent bitch.</i>\"\n\n");
	...
	outputText("\"<i>Oh... und here,</i>\" Isabella says, breaking the ");
	if(silly()) outputText("(milk)");
	...
	outputText("\"<i>You are... velcome,</i>\" Isabella says before bidding the two of you goodbye.  You soon follow suit, saying goodbye to the girls and making your way back to camp, proud to have fostered what could well be a friendship between the two.");
...
public function followrIzzyxSallyThreesomePretext():void {
	...
	outputText("\"<i>[name]!</i>\" Isabella gasps, relieved to see you approach. \"<i>");
	...
	outputText("You raise your [weapon] and prepare to fight the shadowy villain... only to see Hel the salamander step forward, staring at you with wide eyes.\n\n");
	outputText("\"<i>[name]!  What the fuck!?</i>\" Hel demands, looking from you to the redheaded cow-girl.\n\n");
	outputText("Taken off guard, you start to introduce Hel to your companion.  Scowling, Isabella says, ");
	if(isabellaAccent()) outputText("\"<i>I know ze little beech, [name].</i>\"\n\n");
	else outputText("\"<i>I know the little bitch, [name].</i>\"\n\n");
	...
	outputText("\"<i>[name]!</i>\" they both shout, frustrated at their inability to close the distance with their opponent without going through you.\n\n");
	outputText("Now that you have their undivided attention, you demand an explanation that's so sorely lacking.\n\n");
	outputText("Glaring at Isabella, Hel says, \"<i>This... cow... stole my bandanna a few months ago and won't give it back.</i>\"\n\n");
	outputText("Isabella makes an indignant huff and turns her nose up at the salamander. ");
	if(isabellaAccent()) outputText("\"<i>Do not listen to ze little liar, [name].  I found it in ze hands of ze gnolls, and most certainly did not steal it.</i>\"\n\n");
	else outputText("\"<i>Do not listen to the little liar, [name].  I found it in the hands of the gnolls, and most certainly did not steal it.</i>\"\n\n");
	outputText("\"<i>Yes you fucking well did!</i>\" Hel snaps, waving her sword around.  \"<i>[name], why the hell are you protecting that fat cow, huh?  Lemme at her!</i>\"\n\n");
	...
	outputText("\"<i>Yeah,</i>\" Hel answers with a little scoff, \"<i>And, I guess if you're [name]'s friend... you're probably all right.</i>\"\n\n");
	...
	outputText("\"<i>Oh, here,</i>\" Isabella says, breaking the ");
	if(silly()) outputText("(milk)");
	else outputText("hand");
	outputText("shake to pull the blue bow from her tail and hand it over to Hel.  With a happy gasp, Hel grabs it and ties it around her forehead – making herself look like some kind of half-naked commando in the process – though it's quickly hidden under her long red hair.\n\n");
	outputText("\"<i>Yeah.  You're all right.</i>\" Hel says, finally sheathing her sword.  \"<i>Thanks for giving me my mom's bandana back.</i>\"\n\n");
	outputText("\"<i>You are... welcome,</i>\" Isabella says as Hel disappears into the night.  Heaving a relieved sigh, you return to the camp proper and try to get some shut-eye before the sun rises.");
	flags[kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] = 1;
	doNext(playerMenu);
}
...
public function isabellaXHelThreeSomeCampStart():void {
	...
	outputText("\"<i>[name]... it is –moo– good to see youuuuu.</i>\"  She trails off into a long, ecstatic moan as Hel continues to suckle from her massive teat, acknowledging your presence only with a little waggle of her tail and a wink.  ");
...
private function nomOnIzzyTitWithSallyMancer():void {
	...
	if(player.hasCock()) outputText(", and your [armor] is tenting visibly, displaying your excitement as you take her soft, delightfully warm and full breast in hand");
	else outputText(", and your nipples stiffen with excitement as you take her soft, delightfully warm and full breast in hand");
	outputText(".\n\n");
	...
	else outputText("Unfortunately, you don't have much to contribute...");
...
private function stuffIzzyAndSalamanderWithDicks():void {
	...
	outputText("You stand up and start stripping out of your [armor].  " + SMultiCockDesc() + " pops free as soon as your crotch is clear, already at full hardness thanks to the sight of Hel crawling atop Isabella, pressing her E-cups into the cow's milky teats and giving her a full kiss on the lips.  You stay back for a moment, watching the kiss, able to catch just a glimpse of Isabella's massive flat tongue entwining with Hel's long, slender one.\n\n");
	...
	outputText("That's all the invitation you need.  You drop to your knees behind the two redheads and thrust your " + cockDescript(x) + " into Hel's snatch, eliciting a sharp moan from the salamander.  ");
	...
	outputText(" with quick, short strokes that keep ");
	if(y == -1) outputText("her");
	else outputText("them");
	...
	//(Player has 2-3 cocks)
		...
		outputText("Now fucking both girls at once with your super-human twin endowments, you settle into a good solid rut.  The girls squeal and moan under your intense fucking, only stopping in their sweetly feminine vocalizations to kiss or suckle each other.  Just as you've hit your rhythm, though, you're suddenly pushed to the ground as both Isabella and Hel give you a playful kick with their hoofed-or-scaled feet.  They switch positions so that Isabella is fore-most and facing you atop your " + cockDescript(x) + " while Hel sits behind her, impaled on your " + cockDescript(y));
		if(z > -1) outputText(" with your " + cockDescript(z) + " even now spearing her tight ass");
		outputText(".\n\n");
		outputText("Grinning over Isabella's shoulder, Hel grabs the cow-girl's milky udders and takes one of her quad-nipples between her thumbs and forefingers.  \"<i>Isabella, I think our dear [name] is getting pretty sweaty...</i>\"\n\n");
		...
		outputText("Meanwhile, your cocks are still being ridden hard by the redheads.  Both of them are thrusting their hips forward in time with the other, keeping up a steady but intense rhythm on ");
		if(z == -1) outputText("both");
		else outputText("all three");
		...
		outputText("Their now disparate and intensifying speeds bring you over the edge, and hard.  You throw your head back and cum, shooting out thick ropes of cum into both of their wombs");
		if(z > -1) outputText(" and Hel's ass");
		outputText(".  You buck your hips into them, forcing your cocks as deep as they'll go as you unleash a second spurt, and a third, until your jism begins to sputter out of the girls' holes, coating their thighs and your hips and legs with your spunk.");
		//(Play Scene End)
	}
...
private function izzySallyThreeSomeFollowup():void {
	helSprite();
	clearOutput();
	outputText("Now a sweat-and-cum soaked mess, the girls collapse onto their backs around you.  Sighing contentedly, Isabella rolls over and nuzzles her head on your chest; a moment later sees Hel doing the same, wrapping her warm tail around your [cock] lovingly.\n\n");
...
private function izzySallyThreeSomeVagoozlaz():void {
	...
	outputText("The combination of the cow-girl's finger-and-tongue fuck");
	//(IF HERM:
	if(player.hasCock()) outputText(" and Hel jerking your [cock] off");
	...
	if(player.hasCock()) outputText(" and salamander double-team");
	...
	outputText("Now a sweat-and-cum-soaked mess, the girls collapse onto their backs around you.  Sighing contentedly, Isabella rolls over and nuzzles her head on your chest; a moment later and Hel does the same");
	if(player.hasCock()) outputText(", wrapping her warm tail around your [cock] lovingly");
	outputText(".\n\n");
	outputText("\"<i>That was amazing.  Seriously,</i>\" the salamander says, still panting from the experience.  \"<i>I mean, holy shit, you two.  We... we really need to do this more often.</i>\"\n\n");
	if(isabellaAccent()) outputText("\"<i>Mmm, ja,</i>\" Isabella says with a long yawn.  \"<i>Ve must indeed.  But for now, ve must rest.</i>\"\n\n");
	else outputText("\"<i>Mmm, yes,</i>\" Isabella says with a long yawn.  \"<i>We must indeed.  But for now, we must rest.</i>\"\n\n");
...
public function heliaPlusFoxyFluffs():void {
	...
	if(flags[kFLAGS.HEL_FOXY_FOURSOME_WARNED] == 0) {
		...
		outputText("Hel grins as you notice the sisters' extra hardware.  \"<i>Miko, Mai, meet [name],</i>\" she says, running one of her scaled hands along... Miko's?... thighs, eliciting a sensual moan from the fox-girl.  In response, Mai buries her face in your neck, her full lips brushing along your sensitive flesh.  Your skin tingles with delight at her light caresses as her rigid prick presses further into your stomach, leaving a little wet stain on your [armor].\n\n");
	...
	//Fox Girls -- Repeat Intro
		...
		outputText("Amused, Hel gives Miko's bountiful bosom a playful grope and says, \"<i>My, my, [name], looking for a little foxy foursome?  Well, I think that can be arranged, what do you say, girls?</i>\"");
...
private function heliasFoxyFourSomeFluffs():void {
	...
	//[If Herm]
	if (player.gender == 3) {
		outputText("\"<i>So what parts do you want to use?</i>\" she asks, looking to your mixed endowments.");
...
private function telHelToGetOffTheMInoCock():void {
	...
	if(player.minotaurAddicted() || player.hasPerk(PerkLib.LactaBovineImmunity)) outputText("you know firsthand");

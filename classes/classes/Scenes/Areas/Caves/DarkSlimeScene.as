...
public class DarkSlimeScene extends BaseContent
{
    ...
    public function defeatedByDarkSlime():void {
        ...
        menu();
        addButton(0, "Let her", tfScene);
        addButtonIfTrue(1, "Struggle", defeatedByDarkSlimeStruggle, "You have nothing to hold her at bay!", player.hasKeyItem("Torch") >= 0);
    }
    ...
    public function defeatedByDarkSlimeStruggle():void {
        ...
        cleanupAfterCombatTFEvent(); //using "TF" to avoid losing gems
    }
    ...
    public function tfScene(letzRape:Boolean = false):void {
        ...
        if (player.blockingBodyTransformations()) {
            ...
            cleanupAfterCombatTFEvent(); //no gems lost
            return;
        }
        //normal scene
        if (!letzRape) {

...
public function eggySuggest():void {
	...
	outputText("[benoit Ey] brushes your shoulder as [benoit ey] walks past you, feeling around the stockroom until [benoit ey] finds a chest of drawers.  [benoit Ey] opens a compartment and withdraws a small woolen bag, stuffed with pungent green leaves.");
...
private function takeBenoitsContraceptives():void {
	clearOutput();
	outputText("You gladly accept the herbal contraceptive and push it into your mouth, enjoying the pleasantly sharp, citrus flavor.");
	doNext(camp.returnToCampUseOneHour);
}
...
public function femoitSexIntro():void
{
	...
	else if (benoitRegularPreggers() && (!player.isTaur() || (player.isTaur() && (player.tallness * (5/6) < player.cocks[player.longestCock()].cockLength))))
	{
		...
		outputText("\n\n\"<i>Promises, promises,</i>\" is the cheeky retort you get, which prompts you to playfully slap her right asscheek with your hand.  Your [cock] is already beginning to swell with arousal, and you tantalizingly brush it against the outer lips of Benoite's pussy, sliding it back and forth and occasionally bumping its tip into her swollen belly.  Soon, it's hard as a rock, and slick with both pre-cum and Benoite's feminine equivalent.  The genderbent reptilian moans and growls in the back of her throat, arching her magnificent ass towards you to make it easier for you to tantalize her, your hands instinctively moving to grope and squeeze her luscious cheeks.");

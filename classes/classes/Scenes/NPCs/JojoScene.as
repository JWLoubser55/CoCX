...
public class JojoScene extends NPCAwareContent implements TimeAwareInterface, SaveableState {

	public function stateObjectName():String {
		return "JojoScene";
	}
	public function resetState():void {
		JojoTalkedBimbo=false;
		JojoRapeRoleplay=false;
	}

	public function saveToObject():Object {
		return {
			"JojoTalkedBimbo": JojoTalkedBimbo,
			"JojoRapeRoleplay": JojoRapeRoleplay
		};
	}

	public function loadFromObject(o:Object, ignoreErrors:Boolean):void {
		if (o) {
		JojoTalkedBimbo= o ["JojoTalkedBimbo"];
			JojoRapeRoleplay=o ["JojoRapeRoleplay"];
		} else {
...
public function corruptCampJojo():void {
	...
	if (flags[kFLAGS.FOLLOWER_AT_FARM_JOJO] == 0)
	{
		...
		if(!player.hasStatusEffect(StatusEffects.JojoTFOffer) && player.hasKeyItem("Marae's Lethicite") >= 0 && player.keyItemvX("Marae's Lethicite", 1) > 0 && player.cor >= (50 - player.corruptionTolerance) && player.gender > 0) {
			jojoMutationOffer();
	...
	endEncounter();
		...
		public function jojosFirstRape():void {
			...
			if (!JojoRapeRoleplay) {
				...
				outputText("You and Jojo head out into the woods. Jojo seems a little nervous, but also clearly excited, his robes not really hiding his mousey erection. You grin, playing it slow. You talk, do a little meditation...Jojo almost seems disappointed, but as you turn around, heading back towards camp, he turns his back. He stumbles on a river rock, and you pounce!\n\n");
			}
			...
			function dickF():void
			{
				...
				if (JojoRapeRoleplay) {
					outputText("It takes Jojo a while to recover from the thorough dicking you gave him. You wait by his side, keeping an eye out for anything that could attack, and as his breathing slows, Jojo gets up, a big smile on his face.\n\n");
					outputText("\"<i>That was fantastic.\"</i> Jojo says breathlessly. \"<i>...While I...Would never want that to happen normally, I...Really enjoyed it.\"</i> He seems a little nervous at that. \"<i>...Is that...A corrupt thought?\"</i> \n\n");
					outputText("You wrap one arm around your mousey fuckbuddy, assuring him that it's fine. Sex isn't demonic by nature...and as long as it's consentual, there's nothing to worry about.\n\n");
					outputText("The two of you head back to camp, arm in arm, Jojo reluctantly leaving you to go back to his part of camp.\n\n");
				}
				if (!recalling) {
		...
		public function jojosSecondRape():void {
			...
			function vagF():void {
				...
				if (JojoRapeRoleplay) {
					outputText("It takes Jojo a while to recover from the thorough fucking you gave him. You wait by his side, keeping an eye out for anything that could attack, and as his breathing slows, Jojo gets up, a big smile on his face.\n\n");
					outputText("\"<i>That was fantastic.\"</i> Jojo says breathlessly. \"<i>...While I...Would never want that to happen normally, I...Really enjoyed it.\"</i> He seems a little nervous at that. \"<i>...Is that...A corrupt thought?\"</i> \n\n");
					outputText("You wrap one arm around your mousey fuckbuddy, assuring him that it's fine. Sex isn't demonic by nature...and as long as it's consentual, there's nothing to worry about.\n\n");
					outputText("The two of you head back to camp, arm in arm, Jojo reluctantly leaving you to go back to his part of camp.\n\n");
				}
		...
		public function jojosThirdRape():void {
			...
			if (JojoRapeRoleplay) {
				outputText("Jojo seems eager, but he plays along, joining you in the forest for a walk. You discuss the lotus path forms as you wander, until you end up by a creek. Jojo looks back at you, a small smile on his face, and he turns his back, leaning over to take a drink from the water.\n\n");
			}
			...
			function sharedEnd(vag:Boolean):void {
				if(player.lib > 60 && player.cor > 0 - player.corruptionTolerance) {
		...
		public function jojosFourthRape():void {
			...
			function dickF():void {
				...
				if(player.lib > 50 && player.cor > 40 - player.corruptionTolerance && !JojoRapeRoleplay) {
				...
				if (JojoRapeRoleplay) {
					outputText("It takes Jojo a while to recover from the thorough face-fucking you gave him. You wait by his side, keeping an eye out for anything that could attack, and as his breathing slows, Jojo gets up, a big smile on his face.\n\n");
					outputText("\"<i>That was fantastic.\"</i> Jojo says breathlessly. \"<i>...While I...Would never want that to happen normally, I...Really enjoyed it.\"</i> He seems a little nervous at that. \"<i>...Is that...A corrupt thought?\"</i> \n\n");
					outputText("You wrap one arm around your mousey fuckbuddy, assuring him that it's fine. Sex isn't demonic by nature...and as long as it's consentual, there's nothing to worry about.\n\n");
					outputText("The two of you head back to camp, arm in arm, Jojo reluctantly leaving you to go back to his part of camp.\n\n");
					doNext(camp.returnToCampUseOneHour);
			...
			function vagF():void {
				...
				if(player.lib > 50 && player.cor > 40 - player.corruptionTolerance) {
				...
				if (JojoRapeRoleplay) {
					outputText("You fall off of Jojo, breathing heavily as his cum leaks from your twat. Seconds pass, then a few minutes, and when you regain your composure, Jojo is standing over you.\n\n");
					outputText("\"<i>That was fantastic.\"</i> Jojo says breathlessly. \"<i>...While I...Would never want that to happen normally, I...Really enjoyed it.\"</i> He seems a little nervous at that. \"<i>...Is that...A corrupt thought?\"</i> \n\n");
					outputText("You wrap one arm around your mousey fuckbuddy, assuring him that it's fine. Sex isn't demonic by nature...and as long as it's consentual, there's nothing to worry about.\n\n");
					outputText("The two of you head back to camp, arm in arm, Jojo reluctantly leaving you to go back to his part of camp.\n\n");
				}
...
//[Appearance] [Talk] [Train] [Meditate] [Night Watch toggle]
	...
	if (RuinedTownRebuilt.Intown) {
		addButton(14, "Leave", SceneLib.ruinedTown.enterVillage);
	}
	if (!RuinedTownRebuilt.Intown) {
...
{
	if (flags[kFLAGS.JOJO_BIMBO_STATE] == 4 || flags[kFLAGS.JOJO_BIMBO_STATE] < 3) {jojoSprite(); }
	...
	if (flags[kFLAGS.JOJO_BIMBO_STATE] > 3) {
		addButton(11, "Bimboed", JoJoyBimboTalk);
	}
	if (flags[kFLAGS.JOJO_BIMBO_STATE] > 3) {
		addButton(12, "Gender", JoJoyGender);
	}
	if (flags[kFLAGS.JOJO_BIMBO_STATE] > 3) {
		addButton(13, "Demons", JoJoyTalkDemons);
	}
	if (RuinedTownRebuilt.Intown) {
		addButton(14, "Back", SceneLib.ruinedTown.MouseTownJojo);
	}
	else  addButton(14, "Back", jojoCamp) ;
...
//Jojo’s Past
	...
	public function jojoTalkVillage():void
	{
		...
		outputText("You decide to ask " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " village.\n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " speaks softly with a smile on " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " face and in " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " voice, \"<i>It was a small village near a large beautiful lake. We were peaceful people who laughed and trusted one another, just good simple folk you know?\"\n\n");
		outputText("\"Most of the people of Belridge were either fishers or farmers with huge families that stayed near the village. There were a few hunters and a few craftsmen. We made enemies of no one and sought to do no harm to others,</i>\" Jojo says, " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " smile fading.\n\n");
		outputText("Before you can muster a reaction to " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " sadness, " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " fuzzy cheeks spread again as he looks up at you with bright eyes.\n\n");
		...
		if (player.cor < 40)
		{
			outputText("Looks like " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "'s childhood wasn't so bad... you thank the mouse morph monk for sharing  treasured memories with you now that the conversation is over.\n\n");
		}
		else
		{
			outputText("Looks like Jojo’s childhood wasn’t so bad. A little sickly sweet and void of wet pussies and drooling dicks but not bad. You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " you’re happy to have " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " near you and he smiles for ear to ear, ignorant of your thoughts.\n\n");
		}
...
//Joining the Monks convo
	public function jojoTalkJoiningTheMonks():void
	{
		...
		flags[kFLAGS.TIMES_TALKED_WITH_JOJO]++;
		outputText("You decide to ask " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " why " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "decided to become a monk in the first place.\n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "gives you a warm smile as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "speaks, \"<i>Well I grew up in a big family of 19 so when I was younger I was always the quiet one.  I guess I was just introverted but being quiet meant that I didn’t always get a lot of attention.  It didn’t bother me, quite the opposite actually, I enjoyed quiet introspection but with so many brothers and sisters it was next to impossible to get a quiet moment at home.</i>\"\n\n");
		...
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " wears this quiet little smile as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "finishes.  Then " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "chuckles and says, \"<i>Thank you for the memories, [name].  I enjoy our talks.</i>\"\n\n");
		doNext(talkMenu);
		advanceMinutes(5);
	}
...
//Fall of the Monks convo
	public function jojoTalkFallOfTheMonks():void
	{
		...
		outputText("You watch as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " bows  head in shame for a moment. Yet when " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "looks back up there’s fire in  eyes.\n\n");
		outputText("\"<i>Never again....</i>\"\n\n");
		outputText("You try to comfort " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + ", telling " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "couldn’t have made a difference being but a single mouse, but " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "waves you off.  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "tells you " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "is fine and thanks you for your concern.\n\n");
		outputText("You can tell the story has affected " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + ", but you’re surprised to hear the resolve in  voice and see the defiant strength in  eyes. Excusing yourself, you rise and leave " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " to do as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "will.\n\n");
		doNext(talkMenu);
		advanceMinutes(5);
	}
...
//Forest Convo
	public function jojoTalkForestConvo():void
	{
		...
		flags[kFLAGS.TIMES_TALKED_WITH_JOJO]++;
		outputText("You think for a while and decide to ask " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " how " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " ended up in the forest.\n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " looks at you with suddenly tired eyes as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " says, \"<i>Well, I was training in the fields with one of the senior brothers when we saw the monastery was under attack.  He sent me to the village to save me since I was a novice.  I decided to rally the people there.  I figured that I had ran like a coward, I wasn’t going to hide like one.  It was the village where I was born and a home to many of my brothers and sisters, both figuratively and literally.  I ran towards the village with everything I had, hoping to redeem my cowardice by returning with a militia of mice to aid the members of my order.</i>\"   voice catches and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "looks away, obviously struggling to form words.\n\n");
		outputText("When you open your mouth to speak " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " raises a hand, asking for a moment with a single furry finger.\n\n");
		...
		if (player.cor < 35)
		{
			outputText("That's terrible... you can only imagine what you'd feel like if you returned to Ignam and saw it destroyed... your family, your friends... You put a hand on the monk's shoulder, intent on comforting " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " for the moment.\n\n");
		}
		else if (player.cor >= 35 && player.cor <= 75)
		{
			outputText("Tough luck... thankfully your village still stands and you doubt any demons would dare attack on your watch...  You feel like you should do something for the monk though, so you put a hand on  shoulder, comforting " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " for the moment.\n\n");
		}
		else
		{
			outputText("Mice... must've been a village of wimps if a few demons could take them out... The monk is obviously distressed... maybe you should comfort " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " for the moment, if only to make " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " stop.  You put a hand on  silent shoulder...\n\n");
		}
		outputText("\"<i>Thank you [name].  I was born there and seeing that...</i>\"  The monk falls silent again.\n\n");
		if (player.cor < 35)
		{
			outputText("You slide an arm around " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "’s shoulders in an attempt to reassure the monk.  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "manages a smile in response as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "looks up at you.  A single tear manages to slide down  muzzle as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "says, \"<i>Thank you, my friend.</i>\"\n\n");
		}
		else if (player.cor >= 35 && player.cor <= 75)
		{
			outputText("You try to further console the distressed monk by moving your hand to  back and giving " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " a few friendly taps.  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " visibly pulls " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + "self together. \"Thank you, I’m alright now,\" he tells you as he looks up and gives you a weak smile.\n\n");
		}
		else
		{
			outputText("Seeing an opportunity, you wrap your arms around the monk as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "silently tries to reign in  emotions.  Holding " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " close you can feel the mouse morph’s lean muscles as you rub  back ‘accidentally’ going too low and feeling the base of  tail and the top of " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " tight little pert ass.  As you ‘hug’ the mouse you make sure " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "doesn’t notice your true intentions and when you release " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "actually thanks you.\n\n");
			dynStats("lus+", 10);
		}
		outputText("After you’ve comforted the monk you ask " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " what " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "did next.\n\n");
		outputText("When " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "answers you  shoulders are squared and  voice has regained some of its former volume, \"<i>I did what anyone looking at the shattered remains of their life would.  I buried them.  For the next few hours I took the time to lay each and every villager to rest before praying over them all.  Then I went back to my monastery, praying with all my heart that they had managed to hold out, at least long enough to escape rather than to be captured and twisted into perverse shells of their former selves.  Yet the monastery was another graveyard.  I found many bodies there.  Some were of the order but there were also countless imps and more than a few demons.  The place was defiled with semen and milk reeking of corruption.</i>\"\n\n");
		outputText("You see anger in the monk’s eyes as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "clenches  fists, \"<i>They had utterly defiled the monastery and there was nothing I could do about it but honor its memory.  I labored for what felt like days; burying the fallen; seeking out survivors; gathering what few items of my faith had escaped demonic desecration.</i>\"  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "touches the large beads around  neck meaningfully.\n\n");
...
//Origin
	public function jojoTalkYourOrigin():void // Prob tack on some interaction count or something to unlock this
	{
		...
		flags[kFLAGS.TIMES_TALKED_WITH_JOJO]++;
		outputText("As you start up a conversation with " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + ", the two of you speak at length about nothing really important or noteworthy, just small talk.  That is until the monk brings up the subject of your background.  You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " about Ingnam and your family there, and the tradition of sending a champion through the portal.  When " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "asks why anyone would choose to come here, you tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " how legends say that in years a champion wasn’t sent through the portal, terrible things happened to the village.\n\n");
		outputText("\"<i>That portal?</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " asks, pointing to the very portal you stumbled through. You nod and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "asks, \"<i>So... what were you like in Ingnam?</i>\"\n\n");
		if (player.hasPerk(PerkLib.HistoryAlchemist)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " that you were the assistant to Riku, an alchemist residing in your village.  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "asks questions about your time with the alchemist and how your family felt about you taking up alchemy.  You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " that you were just about to go into advanced studies when it was announced that you were the next champion and all you really learned was how to increase the potency of certain types of items.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryCultivator)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent your time training to become a soul cultivator.  Hearing this little monk get slight more interested and asked you to say more about this cultivator and his chosen path, on which you gladly reply telling all you remembered.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryFighter)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how, growing up, you got into fights a lot.  You name names and tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " why and how each of those little brats had got what was coming to them. You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " how you had planned to join the village guard, but that became a pipe dream when it was announced that you were the next champion.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryFortune)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you're lucky and you've made quite a bit of money.  When the monk asks how, you shrug and tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " it's just plain luck.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryHealer)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent a lot of your time at the side of Dende, the village healer. You talk about why you wanted to spend time with the older man as he looked after the sick and infirm and the skills you learned there. You let " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " know how you had just decided to train to become an official healer when you were announced to be the next champion.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryReligious)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent most of your time in the temple. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "seems to really like hearing about the differences in religious practices between the Celestial Lotus and your village. You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " about the various clergy of your hometown and how Sister Esther took time to teach you about meditation.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryScholar)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about your insatiable thirst for knowledge and how you spent a lot of time in school. You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " the story about how you ‘convinced’ Mr. ");
			...
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent your time training with any bow you could find.  You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " how you had planned to join the village hunters squad, but that became a pipe dream when it was announced that you were the next champion.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistorySlacker)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent your time basically relaxing with your fiends.  You gloss over how big of a lazy bum you were with stories of the times you generally made a nuisance of yourself.  You don’t tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " that you’re pretty sure you were chosen as the next champion in order to be gotten rid of.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistorySlut)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent time... making friends.  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " looks at you weirdly and when you tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " you had a lot of friends....\n\n");
			outputText("\"<i>That’s nice I guess [name] but didn’t you have aspirations beyond being, erm... popular?</i>\" he questions.\n\n");
			outputText("You laugh and tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " that you were just really good and making friends, instead of the truth about how much of a slut you actually were.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistorySmith)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent your time training to become a blacksmith.  Not knowing much about smithing " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "asks questions about the things you learned and you answer them to the best of your ability.  To finish you describe the process of fitting armor in great detail and how you were going to start learning advanced techniques but were announced to be the next champion.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryTactician)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent your time learning many different war tactics from a retired commander that lived in your village. Especially on making anyone under your following put more than 100% of their effort.\n\n" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " seems disinterested in the many violent tactics you have learned. Eventually, he changes the subject.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryWhore)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent a lot of your time... making money.  When the naive little monk asks how, you just smile as you fondly remember the older whore, Poison, showing you the ropes and teaching the tricks of the trade.  Regardless of how it made people think of you, it was certainly good money.  In an attempt to hide some of the messier details of your past from the monk, you explain how you accepted... odd jobs for people, important work that not many others in the village would be willing to accept.  He seems confused but shrugs it off.\n\n");
		}
		else if (player.hasPerk(PerkLib.HistoryFeral)) {
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how you spent a lot of your time in the wild. You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " that before arriving in Mareth, you were living your life among a pack of wild wolves.  \n\n");  // I am not a writer, feel free to amend.
		}
		else {
		...
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " smiles now that " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "has gotten to know you a little better. After a little bit more small talk, the two of you decide the conversation is over and part ways.\n\n");
		doNext(talkMenu);
		advanceMinutes(5);
	}
...
//Requirements: Completed Demon Factory -- flags[kFLAGS.FACTORY_SHUTDOWN] > 0
	public function jojoTalkFactory():void
	{
		...
		flags[kFLAGS.TIMES_TALKED_WITH_JOJO]++;
		outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about your having successfully found and stopped the demonic factory.  You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " how you found out the factory was there and how you defeated the demons inside. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "seems impressed.\n\n");
		if (flags[kFLAGS.FACTORY_SHUTDOWN] == 2)
		{
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " ears perk at the news as you continue, telling " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " that you destroyed the factory controls, which permanently shut down the factory - but released an enormous quantity of corrupted fluids into the environment.\n\n");
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " cocks " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " head to the side as he considers " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " words carefully before speaking, \"<i>I guess it seems like the right move.  Permanently disabling the factory would not only deal a heavy blow to the demons, but also give the rest of us time to reclaim the forest... but I don’t know.  If the release of fluids was as much as you say it was then there’s a chance that it’ll do more harm than good.  I’ve seen what corruption does to this world and that much corrupted fluid flooding out all at once could really hurt our cause. I’m not saying it was the wrong thing to do, or lessening your accomplishment, but you have to be careful.  The demons aren’t just powerful, they’re deceptive.</i>\"\n\n");
			outputText("You listen to the monk’s council and despite " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " concerns " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "seems genuinely happy to hear you’ve struck a blow against the demonic regime.\n\n");
		}
		else
		{
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " ears perk at the news as you continue, telling " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " that you shut down the factory and destroyed the controls, for the sake of the surrounding environment.\n\n");
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "’s chest swells with pride as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "looks at you with new eyes before saying, \"<i>Wow [name], I don’t know what to say.  I know it uprooted your life and took you away from the ones you love but I sincerely believe that the day you came through that portal was a good day for all of Mareth.  I am proud of you and humbled by the fact that I can call you my friend.</i>\"  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "rises and gives you a hug of fierce devotion and friendly affection before pulling away and saying, \"<i>We’ll have to watch the factory though... the demons can’t be allowed to reopen that evil place.</i>\"\n\n");
		}
		outputText("Once the two of you are done discussing the demonic factory " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " excuses " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + "self to think on what you’ve told " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + ".\n\n");
		doNext(talkMenu);
		advanceMinutes(5);
	}
...
public function jojoTalkSandCave():void
{
	...
	flags[kFLAGS.TIMES_TALKED_WITH_JOJO]++;
	outputText("You tell" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "about your discovery of a cave that served as a base for the sand witches of the desert. You tell" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + "about the whole ordeal, and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " listens with wide eyes and jaw agape. When you tell him about meeting the Sand Mother " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " gasps.\n\n");
	...
	{
		outputText("You describe your battle with the Sand Mother in an animated blow-by-blow fashion, and when you get to the end where you raped the Sand Mother you look at" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "and... lie.  You completely gloss over the fact that you sexually assaulted the Sand Mother, because despite " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " interest, " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " is a little naive and offended by the world of sexual conquest.  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " appraises your actions, ignorant of what actually occurred.\n\n");
	}
	...
	{
		 outputText("You describe your battle with the Sand Mother in an animated blow by blow. When you get to the end you tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " about how reasonable the Sand Mother actually was after you beat her.\n\n");
		 outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "’s head tils to the side as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " says, \"<i>Maybe the whole thing didn’t need to come to an altercation in the first place, a little diplomacy on both sides....</i>\"  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " gives you a pointed look, \"<i>Might have gone a long way.</i>\"\n\n");
	}
	//if PC just spoke to the Sand Mother
	else if (flags[kFLAGS.SAND_WITCHES_FRIENDLY] == 1 && flags[kFLAGS.SAND_MOTHER_DEFEATED] == 0)
	{
		outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how the Sand Mother spoke with you once you had battled your way to her.  You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " she was reasonable and how the whole thing was, in the end, a simple misunderstanding.\n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " marvels at the way you handled the situation, \"<i>Many would have expected her trying to talk to them to be a trap [name] and hurried to attack her but not you... that is... wow [name], you are truly a great individual.</i>\"\n\n");
	}
	//[if {PC met bath slut}
	if (flags[kFLAGS.MET_MILK_SLAVE] == 1)
	{
		outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about the poor mind addled thing you found sitting in a tub of milk acting as a slave to the sand witch coven.\n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " shudders like a child being told a scary story and asks, \"<i>What did you do?</i>\"\n\n");
		...
		{
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about how the Sand Mother told you the bath girl was unfit to be free and how they care for her because she can’t care for herself.\n\n");
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " reacts by putting " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " chin in his hands and thinking, \"<i>Well... I guess that’s the human thing to do, especially since she doesn’t seem to be corrupted.  Maybe these sand witch covens aren’t all bad, still hard to believe that they’re on our side though....</i>\"  " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " looks up and shrugs, \"<i>Any act of charity though is a good thing.  I do hope the poor girl will be alright.</i>\"\n\n");
		}
		// [if {PC has bath slut in camp}
		else if (flags[kFLAGS.MILK_NAME] is String)
		{
			outputText("As the question leaves his lips you give Jojo a confused look and, with a glance, direct " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " gaze toward " + flags[kFLAGS.MILK_NAME] + ".\n\n");
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " slaps " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " own forehead and says, \"<i>Oh... yeah... right.</i>\" Obviously embarrassed by not putting two and two together. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " smiles good naturedly though, \"<i>I don’t know I guess I just assumed you found some poor mind addled soul and decided to save her.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " says as " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " looks over at " + flags[kFLAGS.MILK_NAME] + ".\n\n");
			//[if (bathSlutStage1 - unaltered)
			if (flags[kFLAGS.MILK_SIZE] == 0)
			{
				outputText("\"<i>She’ll fare much better in our care than in the coven’s,</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " states with conviction.\n\n");
			}
			//[if (bathSlutStage2 - HHH)
			else if (flags[kFLAGS.MILK_SIZE] == 1)
			{
				outputText("\"<i>She’s already much better than she was when she got here,</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " says with a grin.\n\n");
			}
			//[if (bathSlutStage3 - DD)
			else
			{
				outputText("\"<i>The coven wouldn’t have done what you’ve done for her.  You’ve given her a much, much better life and even aided in fixing her condition, you truly are a champion, [name],</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " says, giving you a fond smile and a pat on the back.\n\n");
			}
		}
	}
	...
	{
		outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " about the cum witch, the herm witch responsible for inseminating the witches there, acting as a father to the others.  When you do " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " scratches " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " ear, \"<i>Like I said, I don’t get why sex is so overly important to these creatures but whatever, continue.</i>\"\n\n");
		//[if {PC allowed Cum Witches to increase their numbers}
		if (flags[kFLAGS.MORE_CUM_WITCHES] == 1)
		{
			outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " how you tried to remedy the current cum witch’s situation by asking the Sand Mother to make more cum witches.\n\n");
			outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " whistles low, \"<i>That’s a bold move [name].  It seems like they would want that though, it’d allow them to, er, you know... more often, and make more sand witches in the long run wouldn’t it?</i>\" As the question sound rhetorical you plow on ahead.\n\n");
		}
		//[if {PC allowed Cum Witches to rome}
		else if (flags[kFLAGS.CUM_WITCHES_FIGHTABLE] == 1)
		{
			outputText("You describe to " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " how you convinced the Sand Mother to allow her cum witches to roam the desert along with the sand witches and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " looks at you with astonishment, \"<i>You are a generous spirit [name]... and this Sand Mother doesn’t seem entirely unreasonable.</i>\"\n\n");
		}
		//[if {PC did nothing to help Cum Witch}
		else
		{
			outputText("\"You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " that you’re actually done. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " says, \"<i>Oh... well that’s weird.</i>\" and after an awkward silence, the two of you burst out laughing.\n\n");
		}
	}
	outputText("Having concluded the conversation the two of you stand and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " gives you an appreciative pat on the shoulder, seeming more fond of you.\n\n");
	doNext(talkMenu);
	advanceMinutes(5);
}
...
public function pureJojoSexMenu():void {
	...
	if (JojoRapeRoleplay) {
		addButton(4, "RapeRP", JojoRapeRoleplayMenu).hint("RP with Jojo.");
	}
...
public function giveBirthToPureJojoBabies():void {
	...
	if (flags[kFLAGS.AMILY_FOLLOWER] == 1) {
		...
		RuinedTownRebuilt.JojoyLitters = true;
		RuinedTownRebuilt.MousetownPopulation += 6;
	}
...
public function afterDebimboTalk():void {
    ...
    if (flags[kFLAGS.JOY_TWINS_BIRTHED] > 0 || flags[kFLAGS.JOJO_LITTERS] > 0)
	...
	flags[kFLAGS.JOJO_BIMBO_STATE] = 4;
    flags[kFLAGS.DISABLED_JOJO_RAPE] = 1;
	...
	public function joJoyCampMenu():void {
		...
		switch (rand(3)) {
			case 0:
				...
				addButton(1, "Talk", talkMenu).hint("Chat with Joy.");
				...
				if (player.hasStatusEffect(StatusEffects.Infested)) addButton(5, "Purge", wormRemoval).hint("Request her to purge the worms from your body.");
			...
			case 1:
				...
				break;
			case 2:
				if (flags[kFLAGS.NADIA_FOLLOWER] == 5) {
	...
	public function joJoyFuckMenu():void {
		...
		addButton (14, "Camp", joJoyCampMenu);
	}
		...
		addButton (1, "SexTime", joJoySexMenu);
			...
			public function joJoyTraining():void {
				...
				else if (player.hasPerk(PerkLib.ControlledBreath) && player.hasPerk(PerkLib.CleansingPalm) && !player.hasPerk(PerkLib.Enlightened))
				{
					...
					outputText("Largely due to your increased endurance and improved technique the two of you spend more time sparring and dancing through the forms Joy knows.  When it comes time for a brief lecture, Joy pants as she sits with you, taking a minute to regain her breath.  Joy’s lectures, instead of dealing with how to strike and defend oneself, deal with the nature of the soul.  You learn much about individuality, willpower and determination and after the lecture the two of you meditate on what you’ve learned for a few silent moments.\n\n");
				...
				else
				{
					...
					switch (choice0) {
						case 0:
							outputText("\"<i>We’re here.</i>\" Joy says simply, taking a wide-legged stance. \"<i>The creek here is both fresh to drink, and creates enough ambient sound for relaxing meditation.</i>\" She has a serious look on her face. \"<i>Let’s begin.</i>\"  \n\n");
							...
							outputText("After you’ve both worked up a sweat, she holds up a hand. \"<i>I think that’s enough for now</i>\", she gasps, planting her ass on the grass. \"<i>We should head back to camp.</i>\" \n\n");
							doNext(playerMenu);
							break;
						case 1:
							outputText("\"<i>One moment</i>\", she says simply, walking over to the water. She leans way over, her too-small robe hiking up, giving you a clear view of her bubble-butt and juicy snatch as she drinks. She seems to be taking longer than necessary, and occasionally, you notice her sneaking a peak back at you. \n\n");
							outputText(" \n\n");
							menu();
			...
			public function joJoyWaitforTraining():void {
				...
				outputText("\"<i>Sorry, [Name], I was a little…Thirsty.</i>\" She plants her feet, taking a martial artist’s stance. \"<i>Alright, so the first form…</i>\" Joy walks you through the forms of the Lotus, occasionally stopping to ‘correct’ your posture, or telling you to hold your form so she can study it. For an hour, you go through the forms, until Joy, breathing heavily, stops for a moment. \n\n");
				outputText("\"<i>Sorry, [Name]. I…Am having a bit of trouble focusing right now. If you would excuse me for a moment…?</i>\" \n\n");
				menu();
				addButton (1, "Wait", joJoyJillsOff);
				addButton (2, "Advance", joJoyGetSome);
			}
			public function joJoyJillsOff():void {
				...
				outputText("After another hour, you and Joy return to camp, and head your separate ways. As you leave her, Joy sighs, leaning in, and kisses you on the cheek. \"<i>I should start charging for lessons</i>\", she jokes, before heading back to her rock. \n\n");
				if (player.canTrain('str', player.trainStatCap("str",80))) {
					dynStats("str", 2); //Str boost to 80
					player.trainStat("str", 2, player.trainStatCap("str",80));
				}
				if (player.canTrain('int', player.trainStatCap("int",80))){
					dynStats("int", 2); //Int boost to 80
					player.trainStat("int", 2, player.trainStatCap("int",80));
				}
				if (player.canTrain('wis', player.trainStatCap("wis",100))){
					dynStats("wis", 6); //Wisdom boost to 100
					player.trainStat("wis", 4, player.trainStatCap("wis",100));
				}
				if (RuinedTownRebuilt.Intown) {
					doNext(SceneLib.ruinedTown.enterVillage);
				}
			...
			public function joJoyGetSome():void {
				...
				outputText("\"<i>I know that…But you asked me to train you, and here I am, acting like…some sort of demon!</i>\"  \n\n");
				...
				outputText("Joy bites her lip, looking down at your groin. \"<i>I-I suppose so.</i>\" Her knees wobble a bit, and she puts one hand in front of her womanhood. \"<i>Would you please…Help me with that?</i>\"  \n\n");
				outputText("You ask if she wants to make love to you, and Joy, a little annoyed now, steps in, as close as she can. \"<i>No, I want you to fuck me.</i>\" \n\n");
				outputText(" \n\n");
				menu();
				addButton (1, "SexTime", joJoySexMenu);
			}
			public function joJoySlapDat():void {
				clearOutput();
				outputText("You sneakily make your way behind Joy, and before your mousey lover can react, you bring one hand back, slapping her ass with a sound that echoes through the forest. Almost as loud as the startled \"<i>Eep!</i>\" that comes out of Joy’s mouth, as she straightens up, water from her furry snout splashing onto her front. Her arms are rigid, at her side, and as she straightens up, you step in, wrapping your free arm around her waist.  \n\n");
				outputText("Joy turns her head, catching sight of you, and she stammers a little, face beet-red. \"<i>Wh-what was that for?</i>\" She asks, and you chuckle a little. You tell Joy that she was putting that ass of hers out a little too far for it to be a coincidence. Rubbing her asscheek, you ask Joy if that was her plan. To lure you out here and seduce you.  \n\n");
				outputText("Maybe.</i>\" Joy says slyly. \"<i>You don’t seem to be able to focus on anything else.</i>\" You tell Joy that you’d never have expected her to be  her forward, especially considering how you met \n\n");
				outputText("\"<i>Meeting you changed me, [Name]. I would have thought that was obvious.</i>\" Joy says, giving you a smouldering look. \"<i>I love you, you know.</i>\" \n\n");
				menu();
			...
			public function joJoyHotDog():void {
				...
				outputText("\"<i>Well…You seem to have your mind set on something other than training.</i>\" Joy giggles, moving her hips slightly.  her allows her bubble butt to run up and down your shaft, sending a warm shock through you. \"<i>And you already know I want you.</i>\" You take Joy’s outstretched hands, pulling her in towards you. Your thighs hit Joy’s cheeks, and her tail swings happily, wrapping around your hips. \n\n");
				outputText("\"<i>Well…What now, love?</i>\" Joy asks whimsically. \"<i>It’s up to you.</i>\" \n\n");
			...
			public function joJoyBimboMenu():void {
				menu();
				outputText("\n");
				addButton(0, "Vaginal Fuck", joyScene.penetrateJoysPussy).hint("Penetrate Joy vaginally with your cock.")
						.disableIf(player.cockThatFits(joyScene.joyVagCapacity()) < 0, "Req. a cock fitting "+joyScene.joyVagCapacity()+" area!");
				addButton(1, "Anal Fuck", joyScene.fuckJoyInTheAss).hint("Take Joy from behind and make sure she gets it good!")
						.disableIf(player.cockThatFits(joyScene.joyAnalCapacity()) < 0, "Req. a cock fitting "+joyScene.joyAnalCapacity()+" area!");
				addButton(1, "Anal Fuck", joyScene.fuckJoyInTheAss).hint("Take Joy from behind and make sure she gets it good!")
						.disableIf(player.cockThatFits(joyScene.joyAnalCapacity()) < 0, "Req. a cock fitting "+joyScene.joyAnalCapacity()+" area!");
				addButton(4, "Frottage", joyScene.frotWithJoy).hint("Do some cock play with Joy.")
						.disableIf(!player.hasCock(), "Req. a cock!")
						.disableIf(!joyScene.joyHasCock(), "She doesn't have a cock for that...");
				addButton(5, "Get Blown", joyScene.haveJoySuckYouOff).hint("Have Joy suck your off and give her a taste of your cum.")
						.disableIf(!player.hasCock(), "Req. a cock!");
				addButton(6, "Get Licked", joyScene.haveJoyLickYourGinas).hint("Have Joy lick your pussy.")
						.disableIf(!player.hasVagina(), "Req. a vagina!");
				addButton(7, "Get Penetrated", joyScene.haveJoyStuffYourPussy).hint("Have Joy penetrate you vaginally with her cock.")
						.disableIf(!player.hasVagina(), "Req. a vagina!")
						.disableIf(!joyScene.joyHasCock(), "She doesn't have a cock for that...");
				addButton(2, "Lick Joy", joyScene.lickJoysGina).hint("Get a taste of Joy's pussy but you're sure she has a lot of pussy juice in store for you!");
				addButton(3, "Blow Joy", joyScene.suckJoysCock).hint("Suck Joy's cock and get some taste of her cum!")
						.disableIf(!joyScene.joyHasCock(), "She doesn't have a cock for that...");
				addButton(8, "Get Anal", joyScene.haveJoyStuffYourButthole).hint("Have Joy take you from behind and put her cock to a good use.")
						.disableIf(!joyScene.joyHasCock(), "She doesn't have a cock for that...");
				addButton(14, "Back", joJoySexMenu);
			}

	public function JoJoyBimboTalk():void {
		clearOutput();
		outputText("You decide to ask " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " what " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " thinks about " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " time as a Bimbo.  \n\n");
		outputText("\"<i>Honestly, I remember a decent chunk of it.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " responds neutrally. \"<i>Mainly, the…well… ‘fun times’.</i>\" You give " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " a smirk, and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " blushes. \"<i>...Well, I really enjoyed sharing that with you…circumstances aside. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " shudders slightly. \"<i>I did not appreciate being so dumb, however. I am very happy to be rid of that, at least.  \n\n");
		outputText("You ask " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " whether or not " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "’d be willing to revisit that time…maybe a bit of roleplay? \n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + "’s eyes widen, and " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " blushes, nodding once. \"<i>Only with you, though…It’s embarrassing.</i>\"  \n\n");
		outputText("You give your mousey lover a hug, telling him that it was pretty sexy. \n" + "\"<i>...Well, if you enjoyed it, like, I’m sure I could sort of, put it on for you.\n \n\n");
		outputText("Wait…Did Jojo just admit to enjoying bimbo sex? Maybe there’s a way to keep that side of…Her? Him? Them? \n\n");
		JojoTalkedBimbo = true;
		outputText(" \n\n");
		menu();
		addButton(14, "Back", talkMenu);
	}
	public function JoJoyTalkDemons():void {
		clearOutput();
		outputText("\"<i>I…Understand them now, more than I did before.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " crosses " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " legs, sitting on " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " rock, tail whipping back and forth. \"<i>I still hate them, make no mistake, but…Being with you…And after imbibing that…beverage…?</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " shivers. \"<i>It’s easy, so very easy, to give in to the pleasure. Having never experienced it before, I suppose I didn’t know what I was missing.</i>\"  \n\n");
		outputText("" + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " gives you a pleased smile. \"<i>I have you to thank for that. For breaking me from my shell, so to speak.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " closes " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " eyes, inhaling deeply. \"<i>If anything, I feel sorry for them, those who have lost themselves.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " shudders, and you sit down beside " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + ", putting a supportive hand on " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "Her": flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "His":"") + " shoulder.  \n\n");
		outputText("\"<i>If you had been more nefarious…Or had been corrupted…</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " hugs " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + "self. \"<i>I don’t think I would have been able to stop. Without my mind functioning…I wanted you to ravish me, do things unspeakable…Because I know that’s expected in the world we now live in…Because I didn’t want anyone else to corrupt you.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " laughs, mirthlessly. \"<i>I didn’t care what else happened. I would have followed you into depravity without a second thought, so long as you were there with me. And it goes against everything I’ve stood for...And those feelings...Haven't entirely gone away.</i>\"  \n\n");
		outputText("Clearly this has been bothering your de-bimboed mouse lover. \n\n");
		menu();
		addButton(1, "Comfort", JoJoyTalkDemonsComfort);
		addButton(2, "Ew", JoJoyTalkDemonsWeird);
	}
	public function JoJoyTalkDemonsComfort():void {
		clearOutput();
		outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " that even when " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " was a bimbo, " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " did their best to try and help. The \"<i>Training</i>\" was odd, but that Bimbo Joy was still " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + " on the inside, just…not as smart. You tell your mousey lover that " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " needs to have more faith in " + (flags[kFLAGS.JOJO_BIMBO_STATE] !=4? "himself": flags[kFLAGS.JOJO_BIMBO_STATE] ==4? "herself":"") + ".\n\n");
		outputText("\"<i>But…I still have some of those feelings, [name]!</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " cries. \"<i>Even though it’s…just you I want…Some of the things I want to do…They’re not…</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " blushes. \"<i>Not…exactly pure.</i>\"  \n\n");
		outputText("You tell " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + " that there’s no need to be shy about it. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " blushes, and looks down. \"<i>Well…We met in the forest.</i>\" " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " fidgets nervously, and you gently encourage " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "her": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "him":"") + ". \n" +
				"\"<i>I’ve been…wondering…what would have happened…If you had been a little more forceful…</i>\" \n" +
				"You’re slightly taken aback by this. The (formerly) Chaste monk? Thinking about such things? You ask if " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + "’d be interested in trying that out in the forest sometime. " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "she": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "he":"") + " nods, and you bring your hands to " + (flags[kFLAGS.JOJO_BIMBO_STATE] ==5? "Joy": flags[kFLAGS.JOJO_BIMBO_STATE] !=5? "Jojo":"")  + "’s furry cheeks. You tell your mousey monk that you’d be okay with accommodating such desires. \n \n\n");
		outputText("(Jojo rape scenes have been unlocked under his sex menu. \n\n");
		JojoRapeRoleplay = true;
		menu();
		addButton(1, "Back", talkMenu);
	}
	public function JoJoyTalkDemonsWeird():void {
		clearOutput();
		outputText("You tell your mousey lover that considering everything they've been through, this shouldn't really be a worry for them. It's not like they were thinking about getting raped by you, or something like that.\n\n");
		outputText("\"<i>O-of c-course not! That would be weird. SUPER weird. You'd never do anything like that to me, and I-I certainly wouldn't w-want that.</i>\"\n\n");
		outputText("You agree...But you get the distinct feeling that your mousey sexpal was telling you they'd be into it. \n\n");
		menu();
		addButton(1, "Back", talkMenu);
	}
	public function JoJoyGender():void {
		...
		if (flags[kFLAGS.JOJO_BIMBO_STATE]==4) {
			...
			outputText(" \n\n");
			menu();
			addButton(1, "GoJoy", GetJoyBack);
			addButton(2, "StayJojo", JojoGoodBoi);
		}
		if (flags[kFLAGS.JOJO_BIMBO_STATE]==5) {
			outputText("\"<i>Being a man comes with advantages and disadvantages. It is a bit easier to practise my forms, when I don’t have…</i>\" Joy looks down at her bountiful bosom, smiling slightly. \"<i>My breasts this large.</i>\" She smiles at you. \"<i>But at the same time…This form…opened my eyes to new experiences and…Joys.</i>\" She chuckles at that. \"<i>I wouldn’t reduce my size if I’m staying as a woman, but I don’t have any strong feelings one way or the other…So what would you think, if I went back to being Jojo?</i>\"   \n\n");
			menu();
			addButton(1, "JojoMojo", GoJojo);
			addButton(2, "MoreJoy", IWantTehMouseTittehs);
		}
	}
	public function GetJoyBack():void {
		clearOutput();
		outputText("You tell Jojo that you very much enjoyed it when he was female. Even though you enjoy spending time with your mousey monk, you liked the look of Joy better. \n" +
				"Jojo gives you a small smile, and stretches. \"<i>Then I’ll see you in a bit.</i>\" Jojo dashes off towards the desert. You’re assuming he’s heading to Tel’adre.  \n\n");
		outputText("Two hours later, you're sitting down at the fireplace, relaxing. Your [ears] perk up, and you hear slight footsteps headed your way. You stand, turning around as Joy runs at you, a big ol’ grin on her face, her bouncy breasts returned to their bimboed glory.  \n\n");
		...
		outputText("\"<i>Uh…Whee?</i>\" She folds her arms, raising one eyebrow. \"<i>Just because I’m Joy again doesn’t mean I returned to that…mental state, [name].</i>\" You apologise again, and Joy gives you a sly little smile, wrapping her tail around your [leg]. \"<i>Well, if you’re sorry, there’s a way to make it up to me.</i>\" Well, at least some parts of the old Joy remain. \n\n");
		outputText("Joy seems more confident then Jojo ever was, and she's clearly in the mood for some fun. What do you do with the newly reawakened Joy? \n\n");
		flags[kFLAGS.JOJO_BIMBO_STATE]=5;
		menu();
		addButton(0, "Sex", joJoySexMenu);
		addButton(1, "Sex", joJoySexMenu);
		addButton(2, "Fuck", joJoySexMenu);
		addButton(3, "Pound", joJoySexMenu);
		addButton(4, "Pork", joJoySexMenu);
		addButton(5, "Nookie", joJoySexMenu);
	...
	public function JojoGoodBoi():void {
		clearOutput();
		outputText("You tell Jojo that you like him the way he is. He gives you a wry smile, putting a hand on your cheek. \"<i>That’s very sweet. Thank you.</i>\" He stands back up, stretching his legs. \"<i>Anything else you wanted from me?</i>\" \n\n");
		menu();
		addButton(1, "Back", talkMenu);
	}
	public function GoJojo():void {
		clearOutput();
		outputText("You say that you’d prefer to have Jojo back for now. Joy nods, giving you a bow. \"<i>I will be back soon</i>\". \n\n");
		outputText("Deciding that it would be disrespectful to Jojo for you to leave camp while they're away, you stay around camp, contemplating your life. You'd never have thought you'd be with a gender-fluid mouse when you were back home. Hell, even the three words sound almost amusing when strung together... \n\n");
		outputText("A tap on your shoulder shocks you out of your thoughts, and Jojo snickers, sitting down in front of you. \n\n");
		outputText("\"<i>What were you thinking about, [Name]?</i>\" Jojo asks. You give your mousey friend a grin, saying that you were contemplating the absurdity of life. How you’d never have thought of anything like this, even in a fever dream.\n\n");
		outputText("\"<i>Ah. I suppose outside of Mareth, talking mice with no care for their sexual presentation are rather rare?</i>\" You laugh at that, and Jojo joins you. \"<i>I understand. Frankly, if someone had told me that I’d be willing to ignore my vows, shacking up with a [race] from another world who’d come from a portal, working together to fend off sex-obsessed, soulless maniacs…And somehow enjoying every moment of it, I’d probably have wondered what drugs they’d put into their system.</i>\" \n\n");
		outputText("You and Jojo make more small talk, but eventually you feel the need to keep moving. You give Jojo a hug, which he returns tightly, before excusing yourself. \n\n");
		flags[kFLAGS.JOJO_BIMBO_STATE]=4;
		menu();
		addButton(1, "Back", talkMenu);
	}
	public function IWantTehMouseTittehs():void {
		clearOutput();
		outputText("You take Joy’s hand, telling her that you love her just the way she is. If being Joy makes her happy, then you’re happy for her. Joy’s face lights up, and she exhales through her nose, nodding slightly. \"<i>I was hoping you’d say that.</i>\" Joy leans in, giving you a chaste kiss on your nose. \"<i>Is there anything else you wanted, [name]?</i>\" \n\n");
		menu();
		addButton(1, "Back", talkMenu);
	}

	public function JojoRapeRoleplayMenu():void {
		clearOutput();
		outputText("You lean over, whispering into Jojo's ear. You ask him, in as predatory a voice you can, if he wants to go for a walk in the woods. He seems confused, but gets the message when you grasp his tail with one hand, telling him that he asked you for something...And you intend on providing. \n\n");

		menu();
		addButton(0, "Roleplay1st", jojosFirstRape);
		addButton(1, "Roleplay2nd", jojosSecondRape);
		addButton(2, "Roleplay3rd", jojosThirdRape);
		addButton(3, "Roleplay4th", jojosFourthRape);
		addButton(14, "Back", talkMenu);
	}
}
}

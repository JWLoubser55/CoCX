...
public class MinotaurKingScenes extends BaseContent
	{
		...
		public function hailToTheKingBaby(hpVictory:Boolean, pcCameWorms:Boolean):void
		{
			...
			if (player.hasPerk(PerkLib.BimboBrains) || player.hasPerk(PerkLib.FutaFaculties) || player.hasPerk(PerkLib.GentleGiant) || player.cor >= 33) outputText(" You’re long past the point of having a gag reflex and glad for it.");
		...
		private function leavethem():void
		{
			...
			if (player.hasPerk(PerkLib.BimboBrains) || player.hasPerk(PerkLib.FutaFaculties) || player.hasPerk(PerkLib.GentleGiant)) outputText("Ummm, like, I’m not </i>that<i> horny. Besides, I can fuck all I want once I take you out, cutie!");

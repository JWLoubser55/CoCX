...
public class PriscillaScene extends BaseContent
	{
		...
		private function assfuck():void {
			...
			if (player.cockVsClitCockLenght(player, x) > 14) outputText("Slamming her into your meat, you took delight not only in her tightness, but at how her stomach bulged out when forced to take your cock.  ");
		...
		private function mouthfuck():void {
			...
			if (player.cockVsClitCockLenght(player, 0) > 14) outputText("\"<i>So much meat...And it’s all mine!</i>\"  ");

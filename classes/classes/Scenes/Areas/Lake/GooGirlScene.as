...
//[Beach]
		...
		{
			if (rand(4) == 0 && player.hasStatusEffect(StatusEffects.SlimeCraving) && !player.isSlime() && player.isGoo() && player.racialScore(Races.SLIME, false) >= 4) {
...
//goo-girl Bad End – If the player loses to 3-5 goo encounters while under full goo Transformation
		...
		private function gooGirlBadEnd2():void
		{
			...
			outputText("Gripping her in your gentle hands, you lower the girl to the junction of your groin.  ");
			if (player.hasCock()) outputText("A pseudopod extends from your crotch, a gooey penis the size of a minotaur. It snakes through the air toward the girl, its tip flaring to expose a wide, urethra-like opening.  ");
...
//===============
		public function getBeatByGooGirl():void
		{
			...
			if (flags[kFLAGS.GOOGIRL_CONSECUTIVE_LOSSES] >= 5 && player.racialScore(Races.SLIME, false) >= 4) {
				gooGirlBadEnd();
				return;
			}
			...
			if (sceneHunter.uniHerms && !sceneHunter.lossSelect) {
				...
				if (player.hasVagina()) choices.push(femaleLoseToGooGal);
				if (player.isHerm()) choices.push(hermLoseToGooGal);
				choices[rand(choices.length)]();
			}
			else {
				if (sceneHunter.uniHerms) {
					clearOutput();
					outputText("You can't win, and you're not in the state to get away in time. But, since goo-girls react to heat, you can try to attract her attention by rubbing specific parts of your body... or you can <i>try</i> to 'hide' from her, hoping she won't notice your sexy bits.");
				}
				sceneHunter.selectGender(dudeLoseToGooGal, femaleLoseToGooGal, ["Hide!", genderlessLoseToGooGal], hermLoseToGooGal, 1);
			}
			flags[kFLAGS.TIMES_FUCKED_NORMAL_GOOS]++;
		}

//Defeat – Neuter
		//adapted for non-genderless
		private function genderlessLoseToGooGal():void
		{
			...
			if (player.gender == 0)
				outputText(" She pokes slurping, blobby hands across your groin without finding anything");
			else
				outputText("She manages to find your organs, which you tried to hide from her");
			outputText(", and her blank, " + gooColor() + " eyes roll theatrically in annoyance. She flicks your nose in a sullen huff and rests her amorphous fists on her jiggling hips, as she considers what to do with you.\n\n");
			...
			outputText("You awaken with a sputtering hack, water and gooey " + gooColor() + " cum spilling from your lungs. You've been returned to shore and other than a full-body soreness and a splitting headache, you seem none the worse for wear. Who knew cute little slimes could be so aggressive when they " + (player.gender == 0 ? "don't have" : "can't find") +  " sex organs to suck on?");
...
//Defeat – Male
		private function dudeLoseToGooGal():void
		{
			...
			if (player.hasBalls()) outputText("The lithe layer of ooze that creeps across your body wraps around your [balls], its silken touch like the caressing tips of dozens of fingers, nestling against your swollen testicles, cradling them to feel the rush of cum inflating your sac at the building suction of her mouth.  Even with your [armor] still on, it feels like she's licking your bulging pouch with her sylphlike hands.  The slime's gooey grip presses against your scrotum with steady strokes, rolling your overinflated balls in their pouch as if the silent girl were playing some mischievous game. You shake your head as your [balls] bloat fuller and fuller at the coy girl's sport.\n\n");
			...
			outputText("She clenches her rippling body, mouth squeezing tighter than a fist and softer than a pussy on your sensitive organ. Your abdomen bulges outward as her gooey arm grows more solid inside your ass, filling you with a painless pressure that mirrors the straw-like tongue that you can see impatiently wriggling in your shaft. Her head ignites with the heat of anticipation and your muscles unclench, orgasm washing over you at last.");
			if (player.hasBalls()) outputText("  Your scrotum lurches with the force of your load, balls slapping against her cobalt chin as thick cum churns against the obstructing tongue plugging your release. Some chemical in her saliva seems to be reacting inside your [balls], the gurgling ejaculate multiplying, semen filling your pouch and bloating it before your eyes. The rubbing pressure on your prostate just worsens the condition and, for a moment, you fear your balls will swell too large for you to move!\n\n");

			outputText("Just in time, the thin tongue pistoning its way into your abdomen opens, the tube-like appendage mirroring the thirsty suckling of her " + gooColor5() + " mouth. Your body feels like it melts just a bit as your potent seed is greedily slurped up her tongue and bursts into her mouth with enough force to kick against the back of her maw, nearly blowing clear out of her head! Pumping her slimy fist inside your rear, the goo-girl milks your prostate for every drop of cum in your body.  ");
...
//Defeat – Herm
		private function hermLoseToGooGal():void
		{
			...
			outputText("When you finally run dry, every muscle in your body aches with exhaustio,n and it feels like you haven't had anything to drink in months.  The slime slowly disentangles herself from your twitching form, ejecting you from the womb-like ardor of her squishy interior.  When she reforms her slender body, the goo-girl's belly bulges with your creamy load.  She gives you a beaming smile and pats her belly, sending ripples through her body with each wobbling slap.  The girl waves goodbye and slides back into the "+GooLocation+", giving you enough time to catch your breath and let your body recover.");
			player.sexReward("vaginalFluids","Dick");
...
//Defeat – Female
		...
		{
			clearOutput();
			outputText("You sway, finding it difficult to maintain your balance. When you fall, your [butt] splashes wetly in the enveloping folds of the goo-girl's eager slime. You weakly hold your hand up to keep her back, but the wide-eyed victor disregards the gesture with playful disdain. She slithers against you, moist muck slurping at your flesh with a hungry heat. Her semi-solid hands take yours, pulling your arms apart to bare your chest. She cranes her dripping head around your shoulders, skillfully removing your [armor] with only her mouth. Your " + chestDesc() + " heave as the irrepressible heat of the slime sears your " + nippleDescript(0) + "s until beads of sweat well up on your [skin] and trickle down your curves, leaving a wet sheen over your body.\n\n");
			...
			//	[If the player is not obviously pregnant/small breasts/not lactating]
				...
				sceneHunter.print("Check failed: visibly pregnant.");
			...
			//[Pregnancy continued]
			if (player.hasVisiblePregnancy()) {
				outputText("The fluid woman squeezes her goopy breasts against yours, and the globes jiggle with their liquid weight. The " + gooColor() + " girl wriggles against you with an ecstatic expression, delighting in the quivering vibrations of your body. She presses her palms to your breasts, and the warm goo engulfs your " + nippleDescript(0) + " with a wet plop. She plays with your tits, rolling them in her hands while the slurping goop of her body sucks at your swollen mammaries. She bends down to pepper your pulsing tit-flesh with tiny, moist kisses that leave " + gooColor() + " lip prints on your [skin]. Rocking her body against yours, the girl's expression mimicks the helpless, agonized bliss of your face, her cheeks even flushing indigo to imitate your blush. She darts in and gives you a deep, full-bodied kiss of pregnant joy, and your [allbreasts] burst with creamy milk, even as your climax leaves your body as quivering as the goo-girl's. Feeding on your sexual release, she arches her back, and her hearts flicker wildly, her body losing some of its focus as it appears to melt under her orgasmic heat.\n\n");

				outputText("Thick trails of milk squirt into the slime's hands and down her arms, filling the girl's " + gooColor() + " body with your creamy milk.");
				if (player.lactationQ() <= 1000) outputText("  She drains you in no time, hands hungrily sucking for more in goopy kisses on your overtaxed nipples.");
				//[medium milk only:
				else if (player.lactationQ() <= 2000) outputText("  She drinks gratefully, nursing you with her permeable body until the pout of her belly sloshes heavily with the pale ivory of your motherly bounty.");
				else outputText("  You bite your lip and let go, torrents of rich, pearl fluid rushing through her arms and inflating the surprised girl before your eyes. The milk gushing into her fills the goo from base to breast, giving the once-" + gooColor5() + " girl an opalescent shine, her over-filled body bloated as if she were carrying triplets.");
				outputText("  She gives you a fond bop on the chin, and a loving stroke on your belly before sloshing back into the "+GooLocation+", her seething heat still clinging to your body like a lingering hug.");
			}
			//[If the player isn't pregnant]
			else {
				outputText("The goo-girl flashes a broad smile and tickles under your chin to get your attention. Apparently trying to communicate her intent, she puffs out her cheeks and pats her belly, jiggling her amorphous frame in the process. Next, she taps your nose and pats your belly, slapping your [skin] with a moist splat of her hand. Your expression remains blank, and she sighs soundlessly, turning cold in annoyance. The slime presses you on your back and lifts your [legs] into the air. In a splattering motion, the goo lets her lower half sink into the thick sludge of her feet until only her upper torso remains. Then, with impatient force, she descends on your " + vaginaDescript(0) + ", her yielding breasts rolling across your lower body.\n\n");
				...
				outputText("You try to stop the girl's progress, frantically, wagging your legs and clenching your inner walls together, but your strength has left you and her " + gooColor() + " skin is much too slippery to gain ground against. A moment later, all thoughts of stopping the invading goo are lost to the waves of gushing heat pouring into your body as her neck feeds into your aching cunt, filling your uterus with the sentient slime. She braces her hands at the widening mouth of your sex before slipping those in as well, working her arms and shoulders into your now gaping body.  ");
				//[Small vaginal capacity:
				if (player.vaginalCapacity() <= 30) outputText("She bottoms out quickly, filling every inch of your pussy with her squished form, wriggling inside of you happily, her membrane molding to your birth canals every crevasse.");
...
//VICTORY
			...
			if (player.gender == 0 || player.lust < 33) {
				...
				if (player.armor == armors.GOOARMR && !player.isButtPregnant() && !player.isPregnant()) {
					...
					if (flags[kFLAGS.TIMES_VALERIA_GOO_THREESOMED] == 0)
						...
						outputText("Do you offer a threesome with the girl to Valeria? She'll likely try flood with you with more sloshing, shuddering pleasure than your body can handle.");
					addButton(10, "Valeria", SceneLib.valeria.valeriaAndGooThreeStuff);
				}
				...
				if (latexGoo_canThink && flags[kFLAGS.PC_KNOWS_ABOUT_BLACK_EGGS] > 0 && player.cor >= 50) {
					...
					if (latexGoo_hasItems) {
						outputText("  Good thing you have those handy!");
						addButton(11, "Make Slave", SceneLib.latexGirl.meanGooGirlRecruitment)
					}
				}
		...
		private function gooMaleRape():void {
			flags[kFLAGS.TIMES_FUCKED_NORMAL_GOOS]++;
			clearOutput();
			var x:Number = player.findCock(1, -1, 24, "length");
...
//Ooze and Goo scene (one shot voyeur scene similar to the minotaur peep-show)–
		...
		{
			clearOutput();
			outputText("You stand triumphantly over the goo-girl, pondering how best to use her to sate your needs.  The girl doesn't seem quite interested in you anymore however, looking down between your feet instead.  Curious as to what grabbed her attention all of a sudden you look down behind you to find a small puddle of honey forming on the ground.  Your ovipositor twitches delightedly, dripping - and that's when you know just how to deal with your urges.");

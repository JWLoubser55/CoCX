...
public class WyrmCursedBloodMutation extends IMutationPerkType
    {
        ...
        override public function mDesc(params:PerkClass, pTier:int = -1):String {
			...
			if (pTier >= 2) descS += ". If you got a dragon mouth or fang you can inject your blood into opponents as part of your natural attack dealing "+ruin+"% strength drain as a continuous poison effect";
            if (pTier >= 3) descS += ". The ruinous blood now also decays the opponent's total health by "+(pTier-2)+"%";
            if (pTier >= 4) descS += ". Poisoning an opponent with ruinous blood through any means now raises your damage dealt by 10% permanently against that opponent";
            if (descS != "")descS += ".";
            return descS;
        }

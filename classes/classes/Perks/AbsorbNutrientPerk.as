package classes.Perks
{
	...
	public class AbsorbNutrientPerk extends PerkType
	{
		...
		override public function desc(params:PerkClass = null):String {
			...
			if (params.value1 > 6) descS += "a royal myconid. Increase Total intelligence by 50%, +200% total sensitivity, Increase servant damage by 200%, Gain Regeneration 1% and Esper ability are 50% stronger. ";
			else if (params.value1 > 5) descS += "a royal myconid. Increase Total intelligence by 40%, +175% total sensitivity, increase servant damage by 100% and gain Regeneration 0.5%. ";
			else if (params.value1 > 4) descS += "a high noble myconid. Increase total intelligence by 30%, +150% total sensitivity, increase servant damage by 50%. ";
			else if (params.value1 > 3) descS += "a noble myconid. Increase total intelligence by 20% +125% total sensitivity. ";
			else if (params.value1 > 2) descS += "an evolved matango. Your intelligence is as good as that of a common human +100% total sensitivity. ";

...
public class ProjectTyrant extends Monster {
    ...
    override public function won(hpVictory:Boolean, pcCameWorms:Boolean):void {
        if (inDungeon) SceneLib.dungeons.demonLab.BadEndExperiment();
			...
			outputText("You slump to the ground, unable to continue the fight. You hear a muffled, guttural laugh, and the pounding of legs getting closer…but keeping your eyes open is too much to bear. You barely feel the Tyrant slam into you, bodily throwing your limp frame across the ground.[pg]");
			cleanupAfterCombat();
		}
    }
}

...
public class Clara extends Monster
	{
		...
		public function claraCastsBlind():void
		{
			...
			//Successful:
			if((!player.perkv1(IMutationsLib.GorgonEyesIM) >= 1 && player.inte / 5 + rand(20) + 1 < 14) && !player.isImmuneToBlind())
			{
		...
		public function Clara()
		{
			...
			this.hairLength = 13;
			initStrTouSpeInte(86, 98, 52, 90);
			initWisLibSensCor(90, 35, 65, 40);

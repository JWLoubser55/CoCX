...
//Ceraph's fluids boost PC libido and sensitivity massively either way.
		internal function maleFuckCeraphsPussy():void
		{
			...
			function fitF():void {
				...
				outputText("Her purple-hued pussy spasms around you, its oddly textured interior rippling and sucking in time with your ejaculations, drinking down your cum.  Ceraph squirms happily while her body absorbs your jizz with her impossibly pleasurable hole.");
			...
			function nofitF():void {
				...
				if (monster.lust >= monster.maxOverLust()) outputText("Ignoring her squeals of pleasure, you force Ceraph onto her back, oogling her perky breasts, indecent cock, and soaked cunt.  She looks up at you hungrily, and you have the feeling that on some level you're still giving her what she wants.  Wary of the demon's wiles, you pull her hands together and use some scraps of cloth to bind them up.  Moaning with helpless desire, the demon grinds her crotch against your [leg], spreading her thighs apart into a near split and giving you a world-class view of her juicy purple cunt.\n\n");
				//[hp]
				...
				outputText(cockDescript(x) + ". Ceraph's smooth skin and soft thigh-flesh form a comfortably tight masturbation tube.  Starting slowly, you begin rocking back and forth, sawing your prodigious cock-flesh over her body.  The demoness swivels her hips underneath your [cock], her slippery gash and near-crushed member feverishly rubbing into you.  Though you didn't get to truly violate her, her thighs and unblemished skin are more than good enough to bring you to the brink of orgasm.\n\n");
				...
				outputText("Underneath your own mammoth erection, you can feel Ceraph's smaller cock twisting and squirming, unloading its own hot fluids onto her sweat-slicked belly.  She wriggles and twitches under you, her thigh muscles clenching and releasing in time with her spurts as they push you beyond your limit.  You watch your [cock] as it strains and squirts, dumping your thick load into the demon's ");
...
//[OH SHIT SON YOU LOST GET EARS PIERCED]
		private function loseToCeraphAndGetPiercingsInEarsOrSomethingSomehow():void
		{
			clearOutput();
			spriteSelect(SpriteDb.s_ceraph);
			outputText("Ceraph advances on your ");
			if (player.HP < 1) outputText("prone ");
			else outputText("lust-consumed ");
			...
			if (player.earsPierced > 0) outputText("With a dismissive gesture, Ceraph murmurs words of dark magic and the piercings in your ears drop to the ground, leaving behind smooth, unbroken flesh.  ");
			//(BUSINESS AS USUAL GENTLEMEN)
			outputText("The demon places a hand on your forehead and rubs your temples.  Strength drains from your body with every touch, until you're left helpless and paralyzed.  She snaps an earring into your left ear, and dizziness washes over you.  A moment later she's piercing the other side, and the now-familiar vertigo that accompanies it seems to come and go quicker than before.  You hope she doesn't take your [armor] while you're paralyzed, leaving you to roam the realm totally exposed.  Confusion and waves of new desire battle in your mind as you try to come to grips with the odd thought.\n\n");
			...
			outputText("Judging by how hot the idea is getting you, Ceraph is right – <b>whether you like it or not, you're an exhibitionist now.</b>");
...
//[OH SHIT SON MOAR SHIT GETTING PIERCEDEDEDED] – NIPPLEZ GO
		private function loseToCeraphAnGetPierced2():void
		{
			clearOutput();
			spriteSelect(SpriteDb.s_ceraph);
			outputText("Ceraph giggles as she closes in on you once again.  Unable to fight back, you lie there as she once again massages your temples, using her magic to paralyze your body.  She's all too happy to build up the suspense as she pulls out a pair of shining black studs, \"<i>Oh, did you want to know what these are going to teach you?  Well, how about I slide them into your ");
			if (player.hasFuckableNipples()) outputText("slut");
			...
			//If already pierced
			if (player.nipplesPierced > 0) outputText("With a dismissive gesture, Ceraph murmurs words of dark magic, and the piercings in your nipples drop to the ground, leaving behind smooth, unbroken flesh.  ");
			//Business as usual!
...
//[Agree to become Ceraph's Fuckpet Bondage Toy bitch slut]
		private function agreeToBecomeCeraphsFuckpetBondageToyBitchSlut():void
		{
			clearOutput();
			spriteSelect(SpriteDb.s_ceraph);
			outputText("At this point, you know she's right.  The desires Ceraph has awakened inside you will never go away.  In spite of the hassle they've caused, you've come to love being so uncontrollably aroused by such humiliating treatment.");
			if (player.hasVagina()) outputText("  Your " + vaginaDescript(0) + " tingles as you wonder how many piercings and fetishes she could fit into your labia.");
			else if (player.cockTotal() > 0) outputText("  Your [cock] grows rock hard as you wonder if she'll give you a Jacob's ladder full of new fetishes and thoughts.");
			else outputText("  Your body hums with arousal as you wonder if she'll give you a cock and cunt, pierce them both, and fill you with new fetishes and sexy submissive thoughts.");
			...
			outputText("She spends a few moments undressing you, then gives your [butt] a few smacks to suitably redden it.  Horrified at the treatment but more turned on than ever, you endure the humiliation, crawling after your mistress as she leads you to a new, sexy life on an impromptu leash.  You lose track of time, just focusing on putting one hand in front of the other.  Multiple times you catch glimpses of demons and monsters from the fringe of your vision, but none of them seem keen on approaching your mistress or her new slave, you.  Every time you feel their eyes on your naked [skin.type], you're rocked with sexual pleasure.\n\n");
			...
			outputText("Not seeing the harm and seeking to endear yourself to your mistress, you thrust your lower lip out.  Your obediance is rewarded by a sharp snap of dazzling pain.  Licking experimentally, you feel the smooth band that loops over the center of your lip. ");
			//if pierced there
			if (player.lipPierced > 0) outputText("The previous piercing has vanished!  ");
...
//[Initial Meeting Text]
		...
		{
			clearOutput();
			spriteSelect(SpriteDb.s_ceraphGoblin);
			...
			outputText("Do you let her put the earrings in your ears?");
...
//[No]
		private function ceraphFirstTimeDecline():void
		{
			...
			outputText("Ceraph adopts a suggestive pose and tweaks her nipple, clearly more intent on turning you on than physically harming you.");
			//FIGHTO
			startCombat(new Ceraph());
		}
...
//[PC @ 2 piercings, Ceraph offers 3rd]
		private function level3CeraphOffer():void
		{
			...
			outputText("Do you let her pierce you?");
			//[Yes] [No]
...
//[No]
		private function level3CeraphOfferNo():void
		{
			...
			outputText("<b>You've got a fight on your hands!</b>");
			startCombat(new Ceraph());
		}
...
//[YES OH YES]
		private function yesOHGODYESPIERCELEVEL3():void
		{
			...
			//[cunts]
				...
				outputText("spreads your lips");
				if (player.vaginas[0].clitPierced > 0) outputText(", the old piercing clattering to the ground as it slides out of your flesh,");
				outputText(" and gets ahold of the flesh around the base of your " + clitDescript() + ".  With practiced ease, she snaps the piercing closed, attaching the diamond stud to you while the pain fuzzes your vision red.");
				player.vaginas[0].clitPierced = 1;
				player.vaginas[0].clitPShort = "seamless, diamond clit-stud";
				player.vaginas[0].clitPLong = "seamless, diamond clit-stud";
			}
			else {
				outputText("gives you a mildly annoyed look before she snaps the diamond stud into your eye-brow, piercing it.  ");
				if (player.eyebrowPierced > 0) {
					outputText("She discards your old jewelry like a piece of garbage.  ");
				}
				outputText("It hurts more than it ought to, fuzzing your vision red.");
				player.eyebrowPierced = 1;
		...
		public function rapeOptions(leave:Function):void {
			if (player.lust >= 33 && player.gender > 0) {
				...
				addButton(4, "Leave", leave);
				if (player.isRaceCached(Races.CERBERUS))
					addButton(5, "Use demon", rapeCerberusStyle);
			} else {
		...
		public function ceraphRapesYouBADDAWGYODIGGITY():void
		{
			...
			spriteSelect(SpriteDb.s_ceraph);
			clearOutput();
            if ((!CoC.instance.inCombat) && flags[kFLAGS.PC_FETISH] < 3) outputText("The demoness touches your forehead, and suddenly your mind is awash with fetishes!  Judging by the playful look she has, it's temporary, and you play along.  ");
			...
			if (player.hasVagina()) {
				outputText("Your " + vaginaDescript(0) + " twitches, aching with the desire to be touched or filled, and your hips twitch lewdly, desperate for sensation.  ");
			}
...
//(REQ's – HUGE WANG, Exgartuan or Jojo corruption, and !centaur)
		private function hugeCorruptionForceFuckCeraph():void
		{
			...
			outputText("You laugh at Ceraph's ");
			...
			outputText("She's quite the sore loser!  You drop your [armor] on the ground and stroke your ");
			if (player.cockTotal() > 1) outputText("largest ");
			outputText(cockDescript(x) + ", feeling the blood pump into it.  The thick, penile flesh inflates to the ludicrous size it adopts every time you get hard.  Ceraph's eyes widen into dinner plate-sized saucers of shock as she beholds the behemoth that sprouts from your loins.  She actually tries to scrabble away in the dirt, but she fails miserably.  ");
			if (monster.HP < 1) outputText("Her hands are too busy starting to pump away at her nodule-covered demon-dick to help her crawl away.");
			else outputText("Both her hands are too busy at her groin to help her escape.");
			outputText("\n\n");
			...
			outputText("Please?  She said the magic words.  ");
			if (SceneLib.exgartuan.dickPresent()) outputText("You pat your " + cockDescript(x) + " and say, \"<i>A little help please, Exgartuan?</i>\"  ");
			else outputText("You blink your eyes closed and focus your corruptive powers in your crotch.  ");
			...
			if (player.cocks[x].cockLength > 84) outputText("You've still got a lot more dick to get wet, and you start pushing the rest through her, using her like a plus-sized, organic onahole.  ");
				...
				outputText(" against her slippery, split slit, before you pull back and start fucking her like a plus-sized, organic onahole.  ");
			}
			outputText("The once-formidable demon sighs happily each time you pull back out of her throat, and the obscene 'schlick' her cunt makes as you penetrate it is auditory heaven.  You slap her tits and watch them jiggle, but the absurd eroticism of it all overwhelms even your perverse standards.  Ceraph slides down, bottoming out on you while her full-body cunt convulses with orgasm.  ");
			if (player.cumQ() < 100) outputText("You squirt your load into the dirt, but some rolls back along the underside of your urethra, catches on Ceraph's upper lip, and drips up her cheek into her tangled hair.");
			else if (player.cumQ() < 1000) outputText("You squirt your copious cum everywhere, splattering the dirt and dripping white goo onto Ceraph's face, forehead, and hair.  By the time you finish she's got a nice glaze going on.");
			...
			outputText("You push the used fuck-toy off your " + cockDescript(0));
			...
			if (flags[kFLAGS.PC_FETISH] > 0) outputText("I'll remove some of my magic from you if you want, and I'll even let you keep the piercing.  Would you like that?");
		...
		private function ceraphsNiceOffer():void
		{
			...
			spriteSelect(SpriteDb.s_ceraph);
			if (flags[kFLAGS.PC_FETISH] > 0) {
				outputText("Ceraph touches your forehead, and it feels like her claws are raking through your brain, plowing through the surface of your thoughts.  She pulls away, leaving you feeling a little dazed.  You blink and mentally go over your fetishes - ");
				if (flags[kFLAGS.PC_FETISH] == 1) outputText("your exhibitionism is gone!");
				else if (flags[kFLAGS.PC_FETISH] == 2) outputText("your bondage fetish is gone!");
				else outputText("your pacifism is gone!");
				flags[kFLAGS.PC_FETISH]--;
			}
			else {
				outputText("Ceraph shakes some of the jism out of her hair and reaches under the tangled mass.  Her hand comes out with a small pouch of gems, and she tosses them to you.  You open it up and are surprised to find 10 gems inside.");
				player.gems += 10;
			}
			outputText("\n\nThe abused demon-dom laughs, \"<i>What?  Did you expect me to trick you?  No, I liked today.  It's so hard to find someone who can go toe to toe with me AND find incredible ways to abuse my body.</i>\"\n\nShe lays back and relaxes, falling asleep after the intense fuck.");
			cleanupAfterCombat();
		}
		...
		public function friendlyNeighborhoodSpiderManCeraph():void
		{
			clearOutput();
			spriteSelect(SpriteDb.s_ceraph);
			outputText("While exploring, a sudden compulsion to strip naked runs through your body, ");
			if (player.cor > 66) outputText("and without a second thought you disrobe, tossing your [armor] to the side.  It thumps heavily in the dry mountain dust.");
			else if (player.cor > 33) outputText("and you squirm and writhe within your [armor], the material itching on your skin.  Ultimately, you manage to resist.");
			...
			outputText("  Your [skin] burn[skin vs]");
			...
			outputText("\"<i>Oh my, does someone like what they see?  ");
			if (player.cor > 66) outputText("I can see just how hot I'm making you, I'm so glad you gave in and got undressed for me");
			else outputText("You can't take your eyes off me.  It's a shame you didn't get undressed.  Didn't anyone tell you this mountain has a dress code?  Or should I say, an undress code");
			outputText(",</i>\" she says.\n\n");

			outputText("You ready your [weapon], but Ceraph just throws her head back and laughs in your face.  \"<i>");
			if (player.cor > 66) outputText("Are you going to try to fight me in the buff?  If you're going to do that then you can go ahead and get dressed, I wouldn't want to accidentally leave a scar in the wrong place.");
			else outputText("Are you going to try to fight me?  If you're going to do that, I suppose we can.  You do seem to need some practice at indulging your fetishes.");
			outputText("</i>\"\n\n");
...
//[Trade]
		private function tradeCeraphSomething():void
		{
			...
			if (player.hasItem(consumables.BIMBOLQ)) {
				outputText("She finishes and smiles widely.  \"<i>Is that bimbo liqueur?  That stuff is so hard to find, even for a demon like me.  I tell you what, I'll release you from ");
				if (flags[kFLAGS.PC_FETISH] > 1) outputText("all the fetishes");
				else outputText("the fetish");
				outputText(" I've placed upon you if you'll trade me that stuff.  There's a naughty boy in my harem whose quick wit I've begun to tire of.");
				if (player.gender > 0 || player.biggestTitSize() > 2) outputText("  Or if you'd rather keep it, I could take one of your endowments for my own use and remove a single fetish.  It's always fun giving one of my old pets a new part to play with.");
			...
			//(No Bimbo Liquer)
				...
				outputText("She finishes and perks up, leering lewdly at you.  \"<i>I tell you what.  Let me take one of your endowments to use on my pets and I'll get rid of ");
			...
			//(NO TRADE)
				...
				outputText("She finishes and frowns.  \"<i>I don't think you've got a single thing worth trading.");
				if (flags[kFLAGS.PC_FETISH] < 2) {
					armor = getCeraphsArmor;
					outputText("Don't fret your " + player.mf("pretty little head", "charming little head") + ", Mistress Ceraph is nothing if not generous to her pets.  I can give you some beautiful armor to entice your foes with, wouldn't that be lovely?");
				}
				outputText("</i>\"\n\n");
			}
...
//[Trade Genitals]
		private function tradeCeraphCrotchityBits():void
		{
			...
			if (choice == 0) outputText("FUCK AN ERROR HAPPENED GET FENOXO ON THE HORN!");
			//(DICKS)
			else if (choice == 1) {
				temp2 = rand(player.cockTotal());
				outputText("She pipes up, \"<i>");
				if (player.cocks[temp2].cockType == CockTypesEnum.HORSE) outputText("Oooh, is that a horse-cock?  Those are quite nice.  I love the feel of a flare inside me, or even better, plunging one deep into a slut's poor, abused asshole.");
				else if (player.cocks[temp2].cockType == CockTypesEnum.DOG) outputText("Oooh, is that a dog-cock?  Those are quite nice.  It's oh-so-fun to enhance the knots on those and then watch them puff up enough to distend some poor slave's gut.");
				else if (player.cocks[temp2].cockType == CockTypesEnum.DEMON) outputText("Oooh, is that a demon-cock?  As you can see I'm QUITE familiar with those, but it might be fun to replace one of my girl's tongues with it.");
				else if (player.cocks[temp2].cockType == CockTypesEnum.CAT) outputText("Oooh, is that a kitty-dick?  The spines on those feel so good while they rub down all your walls or catch your prostate.  Meow.");
				else if (player.cocks[temp2].cockType == CockTypesEnum.LIZARD) outputText("Wow, you've got a snake-dick?  I haven't seen one of those in a while.  I love the bulbous, knot-like texture.  Maybe I'll graft it onto a chair and make one of my boys sit on it for a few days.");
				else if (player.cocks[temp2].cockType == CockTypesEnum.TENTACLE) outputText("Oooh, a tentacle cock?  How lucky to find one of those on you!  I've been meaning to add another poor tentacle-slave.");
				else if (player.cocks[temp2].cockType == CockTypesEnum.ANEMONE) outputText("Oooh, an anemone-cock?  Simply marvelous!  I might have to crank up the strength of the venom and use it myself!");
				else outputText("Oooh, a normal, uncorrupted cock.  How utterly droll!  You'd think these would be more common, but it's quite a treat to come across one.");
				if (player.cockTotal() > 1) {
					outputText("  Of course that's not the only prick you're packing, hrmmm?  Maybe I should take ");
					if (player.cockTotal() == 2) outputText("the other one");
					else outputText("one of the others");
				}
				outputText(".");
				outputText("</i>\"\n\n");
			}
			//(Cunts)
				...
				outputText("The demon's gaze drops down between your [legs], and she remarks, \"<i>");
				if (player.wetness() >= 5) outputText("My, my, what a juicy box you have there.  Tell me, doesn't it bother you to be soaking in your own lubricants all the time?  Perhaps I'll put it on one of my slaves and mount her on the wall.  Then I can simply slip in and lube up before giving one of my other pets a proper lesson.");
				else if (player.wetness() >= 3) outputText("My, my, what a nice wet pussy you have there.  I really feel that you have a perfect blend of moisture and practicality down there.  I might have to snatch that snatch and give it to one of my drier pets.");
				else if (player.vaginalCapacity() >= 150) outputText("My, my, what a terrifically gaped hole you have there.  Do minotaurs even feel anything while they rail you?  Perhaps I could use that when I'm playing with Shenandoah.  She's had a few too many incubi drafts and can be a little difficult to handle.");
				else outputText("My, my, such a pretty pussy.  I bet it would be fun to replace one of my noisier pet's mouth with.  She never did learn not to bite.");
				outputText("</i>\"\n\n");
			}
			//(Tits)
			else {
				outputText("Ceraph's hands reach up to cup the swell of your " + biggestBreastSizeDescript() + " as she asks, \"<i>");
				if (player.biggestTitSize() > 14) outputText("Oh wow... just wow.  How do you walk?  With melons like this you could tit-fuck three or four people at once!  Absolutely exquisite.");
				else if (player.biggestTitSize() > 6) outputText("Tell me dear, are they real?  I mean, were they always this size, or did you have to get a little bit of work done?");
				else outputText("Well, these are a bit small.  Have you ever considered trying some Gro Plus?  I hear it's all the rage with Lethice's lackeys nowadays.");
				outputText("</i>\"\n\n");
			}
			outputText("A long, silent moment passes before Ceraph makes up her mind.  She points at your ");
			if (choice == 1) {
				outputText("manhood");
				if (player.cockTotal() > 1) outputText("s");
				outputText(" ");
			}
			else if (choice == 2) outputText("vagina ");
			else outputText("breasts ");
			outputText("and declares, \"<i>I think I'll have ");
			if (choice <= 2) outputText("one ");
			else outputText("two ");
...
//[Yes]
		private function giveUpYourBallsOrWhateverForLessFetishes():void
		{
			...
			if (flags[kFLAGS.CERAPH_STOLEN_BODYPART] == 1) {
				...
				outputText("She pirouettes away, practically dancing through the mountains while she strokes and teases the cock you just lost.  Thankfully she was true to her word – your mind feels significantly clearer, at least when a burning hot demon-tongue isn't enveloping Ceraph's new toy.");
				//PYOING!
			...
			//(Pussy)
				...
				outputText("You work your jaw in consternation, trying to dredge up a response or stop her, but before you can do anything, she pushes your old " + vaginaDescript(0) + " down on her throbbing demon-shaft.  It knocks the strength out of your [legs], and you lie there moaning while Ceraph prances off, masturbating herself with your disembodied pussy.  Eventually you cum to the feeling of demon-cum spurting inside you, but it's a strange, empty orgasm.");
...
//*Orgy floor Drain
		public function ceraphBodyPartDreams():void
		{
			...
			if (choice == 2) {
				...
				if (subChoice == 0) {
					outputText("You can feel an odd sensation in your nethers during your dreams, and as the warm, slick feeling grows you recognize it for what it is – cum dripping into your pussy.  ");
					if (!player.hasVagina()) outputText("You don't have a vagina anymore, do you?");
					else outputText("No, that doesn't feel right – it isn't your vagina.");
					...
					outputText("You're a useless cum-dump, there only to slurp up the leavings from Ceraph's more treasured pets, but it makes you oh-so horny.  You pant in your sleep, hopelessly aroused but denied release by the fading dream.");
					//(+4 sens, +200 lust)
					dynStats("sen", 4, "lus", 200);
				}
				//PUSSY CLITPUMP
				else if (subChoice == 1) {
					outputText("An insistent suction pulls on your lower lips, engorging them.  You squirm, rolling your hips back and forth to escape the pull, even as your clit begins to grow from its hood.  ");
					if (!player.hasVagina()) outputText("Wait... you don't have a clit anymore... Ceraph took that away.  ");
					else outputText("Wait... that's not your " + clitDescript() + "... it's the one Ceraph took from you.  ");
				...
				//PUSSY FLESHLIGHT
					...
					outputText("A sudden prodding at your vagina's entrance nearly rouses you from your sleep.  ");
					if (!player.hasVagina()) outputText("Wait... you don't have a pussy anymore.  ");
					else outputText("Wait... your pussy doesn't feel like that!  ");
					...
					outputText("The vision and feelings slowly fade, letting you out of their grip and leaving faint after-images of Ceraph cleaning you with her tongue.");
			...
			//COCKUUUU
				...
				//FUCK A BUTT
					...
					outputText("Oh gods, she's so perfect.  You submit completely, emptying every ounce of your loins into her perfect purple-skinned ass.  Totally spent, your cock gives a few waning twitches and starts to soften.  Ceraph smiles and lifts off, spunk dripping from her gaping asshole as she slides it up your chest.  The dream-sequence fades before you can see anymore, fading away along with the wilting strength of your former penis.\n\n");

					outputText("With the sensation and scenario fading, your confused dreams shift before resuming a more normal flow.  You've no doubt you'll feel sated in the morning, but the lingering echoes of Ceraph's pet in your mind wishes you'd go submit to her.");
		...
		internal function buttRapeCeraph():void
		{
			...
			if (x < 0) x = 0;
			clearOutput();
			outputText("Completely defeated, the haughty demoness lies face down in the dirt, ");
			if (monster.HP < 1) outputText("her tail hanging limp between her legs.  She spits a wad of bloody saliva and says, \"<i>What's the matter?  Beat a girl senseless and lose your nerve?  I thought you were going to rape me.</i>\"");
			...
			outputText(" and shutting her up while you tear off your [armor].\n\n");
			...
			if (monster.HP < 1) outputText("wet ");
			else outputText("achingly wet ");
			...
			if (monster.HP < 1) outputText("  Cunt-juice splatters over your [legs] as Ceraph's now-energetic tail plunges into her sodden box, pumping into it in time with the penetration of her asshole.");
			else outputText("  Cunt-juice dribbles over your [legs] as Ceraph's tail slowly and purposefully plows her box, mimicking the penetration of her asshole.");
			outputText("\n\n");
			...
			outputText("Like hell!  You pull harder, splitting her asscheeks until they're squished into your body, her cock-gaped asshole ");
			if (!player.hasSheath()) outputText("barely touching your groin");
			else outputText("rubbing your sheath");
			...
			outputText("Ropes of jism splatter into the demon's rectum, and while it turns her tight back-door into a drooling wet fuck-hole, it actually lowers the temperature to a saner threshold.  ");
			if (player.cumQ() >= 500 && player.cumQ() < 1500) outputText("Her belly bulges slightly from the cummy deposit, marking her even more obviously as a cum-bucket for your cock.  ");
			else if (player.cumQ() >= 1500) outputText("Her belly burbles and swells, bulging out to look positively pregnant, though you know she's packed from the other end.  ");
			outputText("You pull out, and Ceraph's ");
			if (player.cocks[x].cockThickness < 3) outputText("slightly-gaped");
			else if (player.cocks[x].cockThickness < 5) outputText("gaped");
			else outputText("gaping-wide");
		...
		public function rapeCerberusStyle():void {
			flags[kFLAGS.TIMES_BEATEN_SERAPH_WITHOUT_LOSING]++;
			spriteSelect(SpriteDb.s_ceraph);
			outputText("[Themonster] slowly backs away from you as her strength and charms wane, replaced by sheer terror. Your sensitive nose picks up a scent… the scent of a bitch in heat, ready to be bred by a mighty alpha… the slut is actually wet and ready for you and your twinned pricks react accordingly, hardening as a blob of steaming semen drops from your tip.[pg]");
			outputText("Ceraph seeing your instincts kick in starts to panic ”<i>By Lethice, [name] you beast! You can’t be serious. Get a hold of yourself, I’m supposed to be the one in control here! Not…</i>”([pg]");

...
import classes.Scenes.NPCs.AetherTwinsFollowers;
	...
	public class AetherS extends Shield {
		...
		override public function get description():String {
			...
			|| AetherTwinsFollowers.AetherTwinsShape == "Human-tier Rapier and Shield"|| AetherTwinsFollowers.AetherTwinsShape == "Human-tier Spear and Shield") desc += "Medium Shield";
			else desc += "Gauntlet";
			desc += ")";
			//Block Rating
			desc += "\nBlock: " + String(block);

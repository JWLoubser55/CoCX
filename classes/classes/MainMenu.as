...
//------------
	public function howToPlay():void {
		...
		outputText("<b>Combat:</b>\nCombat is won by raising an opponent's lust to maximum lust or taking their HP to 0 (later on some enemies won't lose until they are brought to a specific negative HP value).  You lose if your enemy does the same to you.  Losing isn't game over, but some losses may make future encounters harder by lowering your stats.  Beware.  Don't be afraid to spam the <b>Run</b> option when you're in over your head.\n\n");

...
public function encounterAiko():void {
	...
	if (flags[kFLAGS.AIKO_TIMES_MET] == 1) {
		...
		+"One of the pale flames breaks from the group, gently wafting down to float in front of your face. It dances about your arms, sending a cool tingling sensation across your limbs, and then flies away, disappearing behind the trunk of the tree. You follow it, chasing it around the tree, but trip on one of the exposed roots. As you stand, rubbing your jaw tenderly, you notice a small, featureless white star sphere resting in a cavity in the tree, and curiously reach out to grab it. \n\n"
		...
		if (player.isRace(Races.KITSUNE, 1, false)) {
			if (player.tailCount == 9) {
				...
				+"Embarrassed, she lower her ears in shame and accepts your help, moving nervously her seven swishy tails. <i>\"I-I just can't resist playing with newcomers, but since you fell for my prank, I thought you were some kind of illusionist with your tails!\"</i> Giving a very nervous laugh, she successfully tries to mask her embarrassed blush. <i>\"My name is Aiko, the guardian of these woods. My village didn't inform me that a nine-tails was on their way to visit us.. can I ask yours, my "+ player.mf("lord", "lady") +"\"</i>\n\n"
				...
				+"\n\n<i>\""+ player.mf("Lord", "Lady") +" [name]... no... [name]...It can be a bit sudden.. but can I ask you for my star sphere back, please? You know how important is for us, considering you have one of your own, too.\"</i> She seems much more relaxed after you told her to not worry about formalities.\n\n"
				...
				+"\n\n<i>\"[name], huh? Well, [name], would it be terribly too much trouble for you to give me back my star sphere? You know how important is for us since you're my kind.\"</i> You know how important the sphere is for a kitsune, but before you can make the decision, she cuts you off <i>\"Of course, I'm not afraid to get rough when I need to. So tell me, [name], do I have to get rough?\"</i>");
			}
		}
		else {
			...
			+"You give her your name, somewhat relieved to find another resident of this world that is interested in more than beating you into submission and raping you—at least so far.\n\n<i>\"[name], huh? Well, [name], would it be terribly too much trouble for you to give me back my star sphere?\"</i> she says, pointing to the white star sphere in your hand. Wary of simply taking anything at face value, you ask her why it’s so important to her, and what exactly she’s guarding all the way out here in the wilderness."
			+"\n\n\"<i>As the chosen guardian of my clan, it’s my duty to protect these woods, and all the kitsune who reside in it,\"</i> she explains, gesturing around. <i>\"It’s not as glamorous as it all sounds,\"</i> she assures you, <i>\"I mostly just use my illusions to scare off imps and other demonic vermin. And tourists. Like you!\"</i>"
		...
		//[Yes][No]
		menu();
		addButton(0, "Yes", aikoAggroGreeting).hint("I want to keep this star sphere!");
	...
	// Second encounter with Aiko
		...
		+(player.isRace(Races.DOG, 1, false) || player.isRace(Races.WEREWOLF, 1, false) ? "Your canine chase instinct overrides your previous sentiments of paranoia, and you dash headlong through" : "You hesitate at first, but then decide to give chase, dashing into") +" the bushes after it.\n\n"
		...
		if (flags[kFLAGS.AIKO_AFFECTION] >= 55)	{
			...
			+"\n\nShe starts to make her way toward you, swaying gently as she walks. <i>\"I wanted to say thank you again for returning my star sphere…"+ (flags[kFLAGS.AIKO_FIRST_CHOICE] == 6 ? " and especially… for the other things you did,\"</i> she says with a slight blush" : "\"</i> she says") +". <i>\"Most people probably wouldn’t have been that nice.\"</i>\n\n"
	...
	// Third encounter with Aiko
		...
		if (flags[kFLAGS.AIKO_BOSS_INTRO] > 0) {
			...
			if (player.isRace(Races.KITSUNE, 1, false)) {
				...
				outputText("You loosen your grip a little, and ask why it’s such a big deal that another kitsune found her star sphere.\n\n"
			...
			outputText("<i>\"She’s already drained most of my power from it... every minute that goes by I can feel my link to it fading more... I’ve.... I’ve failed... She’s gone ahead into the village already... who knows what kind of things she’s doing to everyone... I’ve failed as a protector,\"</i> she says, dropping to almost a whisper, clutching her head in despair.\n\n"
			...
			if (player.isRace(Races.KITSUNE, 1, false)) {
				...
				outputText("You ask what the big deal is, if it was another kitsune that found it.\n\n"
						+"<i>\"It’s a BIG FUCKIN’ DEAL!\"</i> she snarls, snapping her fingers. Her bill-hook wobbles a bit in its place, but stays where it is, refusing to return to her hand. <i>\"She drained my magic, and she’s using it to fuck up my village now! I couldn't care less what happens to them, but I WANT MY STAR SPHERE BACK!\"</i>\n\n"
						+"You smirk. Serves her right for being so stuck up.\n\n");
			}
			outputText("She puts a hand up to her face, trying her best to calm down. <i>\"I can feel my link with it fading every passing minute... As much as I hate it... I need... help. Don’t look so smug! I’m asking you because you’re the only one I can come to who might stand a chance of getting it back for me!\"</i>\n\n"
			+"You cross your arms, asking her why she can’t just get the star sphere back herself.\n\n"
		...
		if (flags[kFLAGS.AIKO_CORRUPTION] < 0 || flags[kFLAGS.AIKO_CORRUPTION_ACTIVE]==0) {
			...
			if (temp == 1) //33% chance
				outputText("The crazed priestess drags herself out of the underbrush, grinning maniacally. Judging by the nature of her wounds, you guess that she has been terrorizing the Giant Bees, a thought further supported by the sticky golden residue that she is still licking off her forearms.");
			if (temp == 2) //33% chance
...
private function initialCorruptionSetting():void {
	...
	addButton(1, "Disable corruption", aikoDisableCor).hint("Aiko's corruption will not progress and all pure scenes will be used.");
}
...
private function aikoAggroGreeting():void {
	...
	addButton(4, "Fight", aikoFight).hint("This star sphere is mine!");
...
private function aikoE1Riches():void {
	...
	+"Aiko, with a grin, thrusts the chest into your hands, bouncing girlishly. At her behest, you open it, finding it filled to the brim with gems! Pleased with your transaction, you honor your end of the bargain, tossing the star sphere to her and bidding her farewell."
...
private function aikoE1Power():void {
	...
	+"Once you figure out how to power the sword down, you wrap it back up and thank Aiko. Pleased with your transaction, you honor your end of the bargain, tossing the star sphere back to her and bidding her farewell.\n\n"
	+"<i>\"Oh, don’t even mention it. My pleasure entirely,\"</i> she says with a wink, and you can’t help but feel like she knows something you don’t. Shrugging it off, you make your way back to camp, your new bounty in tow…"
...
private function aikoTouchFluffTail():void {
	...
	if (player.isRace(Races.KITSUNE, 1, false)) { //if (flags[kFLAGS.PC_KITSUNE_TAILFLUFFED] == 1) { // Need a flag here please. But only after the scene for PC experiencing it him/herself. So this is just placeholder. #NTMel
	...
	if (player.isRace(Races.KITSUNE, 1, false)) { //If Kitsune, this, else: #NTMel
	...
	if (player.isRace(Races.KITSUNE, 1, false)) { //#NTMel Again, needs the flag[kFLAGS.PC_KITSUNE_TAILFLUFFED] == 1. For now, can be this. Side note, is there a way to use the : thing to switch later on?
	...
	outputText("It seems Aiko is enjoying this a lot more than you would have thought! You can hardly complain, cradling the cute fox girl and her many tails in your arms and stroking them as you laugh lightly, one hand moving to gently scratch the back of her ears."
	+"You continue to pet her for the better part of an hour, feeling as if the weight of this world’s corruption is being lifted from your shoulders. Finally, sadly, you tell her that you need to return and check up on your camp. Honoring your end of the bargain, you place her star sphere back into her hands and begin on your way.\n\n"
	+"<i>\"…come back soon…\"</i>");
	flags[kFLAGS.AIKO_BALL_RETURNED] = 1;
	...
	if (flags[kFLAGS.AIKO_TIMES_MET] == 1) {
		if (player.racialScore(Races.KITSUNE, false) > 0) {
			if (player.tail.type == Tail.FOX && player.tailCount == 9) { //what's the difference in tail.type == Tail.FOX here and tailtype == 13 above?
				...
				outputText("<i>\"I didn't want to do this, but you forced me\"</i> she states while lowering her bow, allowing it to disappear in a puff of smoke. Keeping her guard up, she approaches you surrounding herself with fireballs. Cautiously she leans down and snatches the white star sphere from your pouch.\n\n"
				+"<i>\"This star sphere is just too important for me to leave it in the hands of a stranger.\"</i>\n\n"
				+"She carefully tucks the star sphere into her cleavage, stepping back and keeping the fireballs pointed toward you at arm’s length. Holding her first two fingers up near her face, she whispers an incantation, and as the last syllables leave her lips, your vision begins to swim. Just before you black out, you can hear Aiko’s voice calling out as if from miles away.\n\n"
				+"<i>\"I'm sorry... you were kinda charming...\"</i>");
			}
		} else {
			outputText("<i>\"Just remember, you brought this on yourself,\"</i> she says as she lowers her bow, allowing it to disappear in a puff of smoke. She keeps her eyes trained on you as she walks over, cautiously preparing a fireball in one hand, and reaches down to retrieve the white star sphere from your pouch.\n\n"
			+"<i>\"I really never wanted to hurt you, I just needed this back.\"</i>\n\n"
			+"She carefully tucks the star sphere into her cleavage, stepping back and keeping the fireball pointed toward you at arm’s length. Holding her first two fingers up near her face, she whispers an incantation, and as the last syllables leave her lips, your vision begins to swim. Just before you black out, you can hear Aiko’s voice calling out as if from miles away.\n\n"
			+"<i>\"It’s too bad, you were kinda cute…\"</i>\n\n"
			//+"8 Hours Pass…" //Don't need this if it doesn't actually jump by 8 hours.
...
private function aikoRequestsBallAfterLose():void {
	...
	//[Give][Don't Give]
	menu();
	addButton(0, "Give", aikoLoseGiveBall).hint("Give her the damn star sphere already...");
...
private function aikoLoseRefuseBall():void {
	...
	+"\n\nOnce you have made it some distance from the clearing, you happen upon a stream that cuts through the woods. You reach into your pack and pull the white star sphere out, chucking it into the rushing waters and watching as it tumbles downstream."
...
private function aikoApologize1():void {
	...
	+"<i>\"But… If you really mean it…\"</i> she says, thinking for a moment. <i>\"And don’t think you’re getting off scot-free!\"</i>she’s quick to add, scowling briefly before softening again.<i>\"I’m still not very happy with you, but I’m willing to try a fresh start.\"</i>");
	//[Sincere][Trick Her]
	menu();
...
private function aikoApologyTrick():void {
	...
	if (player.str > 35) {
		...
		+"You give her a swift smack across the face to let her know who’s the boss. Despite her indignant glare, you have her pinned and overpowered—she’s not going anywhere. How will you rape her?");
		doNext(aikoRapeSex);
	} else {
...
private function  talkTentacles():void {
	...
	+"<i>\"A lot of people assume just because they look like that they’re nothing but wild beasts, but they’re actually pretty smart—just a little enslaved by their feeding habits. If you keep them well-fed though, they’re docile as kittens. Sometimes they can get a bit rambunctious, but you know how it is.\"</i>\n\n"
...
private function talkCulture():void {
	...
	+(player.racialScore(Races.KITSUNE, false) >0 ?"expanding your knowledge of the culture of your race":(flags[kFLAGS.AIKO_TALK_CULTURE] >0?"hearing what she has to say about kitsune culture":"learning more about kitsune culture"))+".\n\n"
	...
	+(player.racialScore(Races.KITSUNE, false)>0 ?"You've noticed that she has a fondness for tricks, so you ask her about it.\n\n":"You ask if all kitsune are as fond of tricks as she is.\n\n")
	+"<i>\"Heheh, yes. It’s a really satisfying experience for us, if you catch my drift.\"</i>\n\n"
	+(player.racialScore(Races.KITSUNE, false)>0 ?"You respond with a light chuckle, confirming her statement.\n\n":"With a slightly confused blink, you ask if she means what you think she does.\n\n")
	...
	+"You snort a bit, nodding, and tell her that you feel like you understand a bit more about the kitsune now.\n\n"); //lazy workaround.
...
private function  talkAiko():void {
	...
	+(player.racialScore(Races.KITSUNE, false) > 0?	"Here's the basics of how it works. ":"<i>\"It’s difficult to explain to a non-kitsune, but... Let me see if this works. ")
	...
	+"You pause for a moment, wondering if your next question might be too insulting. Taking a deep breath, you resolve to take the risk, and you ask her if kitsunes are some type of demon.\n\n"
...
private function  talkNineTails():void {
	...
	if (player.isRace(Races.KITSUNE, 1, false) && player.tailCount == 9) { //#NTMel
...
public function aikoConsSex():void {
	...
	menu();
	addButton(0, "Missionary", aikoSexMissionary)
		.disableIf(!player.hasCock(), "Req. a cock!");
	addButton(1, "DoggyStyle", aikoSexDoggy)
		.disableIf(!player.hasCock(), "Req. a cock!");
	...
	if (flags[kFLAGS.AIKO_AFFECTION]>= 75) {
		addButton(4, "Tailjob", aikoSexTailjob).hint("Ask her to surround your cock with her luxurious tails")
			.disableIf(!player.hasCock(), "Req. a cock!");
		addButton(5,"Kitsune Tailjob", aikoSexKitsuneTailjob)
			.hint(silly()? "Kitsune tailplay! Floofing all the floofs!": "Kitsune tailplay, in the way only Kitsunes can understand.")
			.disableIf(!player.hasCock() && !player.hasVagina() || !player.isRace(Races.KITSUNE, 1, false),
				"Req. to have a cock or vagina and be a kitsune too!");
	} else {
		addButtonDisabled(4, "???", "You don't know her close enough for that.")
...
public function aikoRapeSex():void {
	...
	addButton(1, "Fuck Ass", aikoRapeFuckAss).hint("Get some of that tight, juicy ass!").disableIf(!player.hasCock(),"Requires a dick you moron!").disableIf(player.cockThatFits(50) < 0,"You dick too huge man, she is delicate!");
...
private function aikoRapeFuckVag():void {
	...
	+(flags[kFLAGS.AIKO_BALL_RETURNED] == 0 ?"<i>\"You got what you wanted…\"</i> she says, almost whispering. <i>\"Now will you give me back my star sphere?\"</i>\n\n"
	+"You have no use for it, you reason, and she was a decent fuck, so you reach into your pouch and pull out the star sphere, haphazardly tossing it over. It lands in the sticky pool of cum forming between Aiko’s legs, a bit of it splattering up onto her thighs"+ (player.cor >= 50 || player.hasPerk(PerkLib.Sadist) ? ", and for good measure, you hock a wad of spit onto it as well":"") +". ":"")
...
private function aikoRapeFuckAss():void {
	...
	+(player.cor >= 50 ||player.hasPerk(PerkLib.Sadist) ?"You backhand her across the face, reminding her to shut up and be a good little whore if she wants her star sphere back.":"You give her a disciplinary tap, reminding her to sit still if she wants to get her star sphere back.")+" She shrinks away from you and obediently raises her plump hind quarters into the air, her tails rising out of the way, revealing her glistening slit and cute pucker. Giving her a firm exploratory slap on the ass, you turn almost giddy with delight as the pillowy cheeks ripple and jiggle for an extended period of time.\n\n"
	+"The large spiral-shaped tattoos adorning her ass seem to be the perfect place for you to grab hold of both cheeks as you run your [cock] along her slit, getting coated in her slick juices in preparation. She lets out a soft whimper as she feels you push your [cock] flush against her pucker, lowering her shoulders toward the ground and gripping the dirt.\n\n"
	+"<i>\"Please be gentle…\"</i> she says as the tight ring of flesh begins to expand around your tip. Her face turns a deep crimson as you sink the first inch inside her, squeezing her ample cheeks around your [cock] and moaning needily.\n\n"
...
private function aikoRapeHumiliate():void {
	...
	+"She cuts off in mid-sentence as your fingers lightly stroke her ears, her neck twitching back involuntarily as her words turn to whimpers. You tell her that if she wants her star sphere back, she’ll behave like a good pet. After rubbing her ears and running your fingers through her soft silver-blonde hair for a few moments, Aiko looks up and gives you a tearful nod, hanging her head shamefully as she accepts your degrading treatment.\n\n"
	...
	+"You "+ (player.cor >= 50 || player.hasPerk(PerkLib.Sadist) ? "promptly slap her":"give her a small disciplinary tap on the nose") +", silencing the meager defiance—you let her know that "+ (player.cor <= 50 ? "for now":"") +" she belongs to you, regardless of her past experiences, especially if she ever hopes to get her star sphere back. Commanding her to get on all fours, the defeated fox girl can do nothing but obey as she hesitantly gets in position, blushing meekly"+ (player.cor >= 50 || player.hasPerk(PerkLib.Sadist) ? " and tearing up":"") +" as she whimpers on.\n\n"
	...
	if (player.hasCock()) {
		...
		if (!player.hasVagina())
			...
			outputText("You raise your hips and angle your [cock] toward her mouth, pressing the head against her tightly pursed lips. Reaching down, you pinch her nose tightly, forcing her to open her mouth lest she suffocate, and she reluctantly begins swallow your mass[if (player.cocks["+(x+1)+"].cockThickness >= 3), gagging on your girth].\n\n"
...
private function aikoFistHer():void {
	...
	+"When you pull back, your arm is thoroughly drenched, [if(player.isFurCovered())the [furcolor] fur matted down with her juices] and Aiko is still rolling from side to side in pleasure, her fuckhole gaping obscenely with the absence of your fist. You wipe yourself off on her discarded robes, flipping her onto her stomach and untying her as an afterthought, leaving the insensate kitsune to recover from her pleasure coma as you head back to camp.");
	postRapeUpdate();
	cleanupAfterCombat();
}
...
private function aikoRapeGetLicked():void {
	...
	outputText("She glares up at you "+(player.hasCock()?"[if (player.cocks.length > 1)between|around] your [cocks]":"")+", tonguing your [pussy] eagerly as her nine tails swish back and forth behind her. Regardless of any spite she may feel against you, her moans vibrate through your body, and it isn’t long before you can’t stand it anymore. You bear down on her face with all your weight, drowning her in your slick girlcum, and she has no choice but to swallow it as quickly as she can. "+(player.hasCock()?"At the same time, your [cocks] swell with pleasure from her continuous stroking, releasing jets of cum that spray onto the ground behind her.":"")+"\n\n"
...
private function aikoSexMissionary():void {
	...
	+ (player.isTaur() ? "" : "You move your hands down her sides, groping at the delicious globes of her derriere lightly. The soft, jiggly cheeks feel incredibly plump and juicy, like perfectly ripened fruit, and you can’t help but let out a soft moan as the warm flesh spills over your fingers.\n\n")
	...
	+"Her walls give one final muscular contraction, clamping down on your [cock] with unbelievable tightness and pulling you in with an incredible suction. "
...
private function aikoSexDoggy():void {
	...
	+"\n\nYou strip out of your [armor] eagerly, smiling as the lovely kitsune lowers herself down to the ground, reaching up to take hold of your [cocks]. Her hands begin to stroke and knead, and your shaft[if (player.cocks.length>1)s] soon grow[if (player.cocks.length==1)s] hard under her skillful technique. She gives the tip of your [cock] a playful lick, and then changes position, moving down to her hands and knees in front of you with her luscious ass raised high in the air, tails fanned out like a peacock.\n\n"
	+"With a grin, you lower yourself down, placing your palms on the exotic spiral tattoos that adorn her heavy, jiggling butt cheeks and positioning yourself behind her. The tip of your [cock] gently brushes up against her lady lips, and you can feel a veritable fountain of juices spilling out over it. You can see Aiko blush in embarrassment from how wet she is already, but she quickly deflects your attention back to her loins as she backs up onto your shaft a few inches, letting out a lewd moan.\n\n"
	...
	(flags[kFLAGS.AIKO_AFFECTION] >= 65?(player.hasKnot(x)||player.hasKnot(y)?"She wiggles her ass tighter into you, still linked tightly by your knot":"She curls up against you")+", as all "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"eight":"seven")+" of her tails wrap around you like a large blanket. She then presses her "+(player.hasKnot(x)||player.hasKnot(y)?"nose":"head")+" into your shoulder sweetly, closing her eyes. The two of you cuddle together on the grass for the remainder of the hour, but you finally have to tell her you need to go back to camp. "+(player.hasKnot(x)||player.hasKnot(y)?"You pull out of her, your knot finally having deflated and stand up. ":"")+"She waves goodbye, curling up underneath the tree and wrapping her tails around herself with a warm smile on her face.\n\n":
...
private function aikoSexBJ():void {
	sceneHunter.callBigSmall(aikoSexBJscene, 40);
}

private function aikoSexBJscene(x:int):void {
	var x1:int = x + 1;
	clearOutput();
	spriteSelect(SpriteDb.s_aiko);
	...
	+"\n\nShe smirks as your [cocks] bob[if (player.cocks.length==1)s] up into view, looking up to you with a mischievous smirk as she wraps her fingers around your [cock "+x1+"], beginning to stroke it gently. <i>\"Mmm… you’re already so hard,\"</i> she says, gently rubbing her cheek into your groin, moving her nose to the base of your [cocks] and taking in your scent.\n\n"
	+"She purses her lips against your base, sucking on the side of your shaft gently as her palm wraps around the head, squeezing drops of pre out and using them to lubricate her hand as she lavishes your [cocks] with passionate kisses and strokes. She pulls her hand away for a moment, summoning a pale blue flame into her palm, and returns it to your main shaft, coating it with cool wisps of fire that send shudders up your spine. "+(player.hasBalls()?"Her other hand gently lifts your [balls], squeezing them softly as she runs her tongue up the underside of your [cock "+x1+"].":"")+"\n\n");
	if (player.cockArea(x) < 40) {
		outputText("Her lips smack loudly as she plants kisses up and down your shaft, sending your senses into a frenzy as her hand works its way up and down your [cock "+x1+"], dragging her fingertips along the length. "+((player.hasBalls())?"Cupping your "+ player.ballsDescriptLight() + ",":"")+" Aiko gently glides her tongue up the underside of your shaft one last time, opening her lips into a wide O and engulfing you in her warm, moist mouth.\n\n"
		+"Keeping one hand wrapped tightly around the base, she begins to bob her head forward and back, letting your [cock "+x1+"] hit the back of her throat with each gentle thrust. Her crystal blue eyes stare up at you coyly as she does so, her mouth curled into a smile around your quivering manhood. Pressing you against the back of her mouth, she swallows several times, the gentle rippling of her throat muscles massaging the head of your [cock "+x1+"].\n\n"
		...
		+"You hover your hands above her head momentarily, hesitating, but Aiko looks up at you with her glittering blue eyes and nods softly, her lips squeezing down tightly around your [cock "+x1+"]. With her permission, you bury your fingertips in her silvery mane and begin to thrust your hips forward, driving your shaft down her throat. She moans, slurping and making lewd gulping noises as you start to throat-fuck her, her eyes rolling back a bit as spittle and precum begins to dribble down her chin.\n\n"
		...
		+".\n\nOnce your orgasm is finished, she locks her mouth tightly around your deflating shaft and pulls back, squeezing the last bits of cum from your urethra and leaving your [cock "+x1+"] clean as a whistle as her lips leave it with a soft smack. Using the corner of one of her sleeves, she cleans the remainder of your cum off her face, and then lets out a cute burp, patting her chest and saying <i>\"Mn, oh, excuse me.</i>");
	} else {
		outputText("Her lips smack loudly as she plants kisses up and down your shaft, sending your senses into a frenzy as her hand works its way up and down your [cock "+x1+"], dragging her fingertips along the length. "+((player.hasBalls())?"Cupping your "+ player.ballsDescriptLight() + ",":"")+" Aiko gently glides her tongue up the underside of your shaft one last time, opening her lips into a wide O and wrapping them around the head."
		...
		+"Letting out an obscene moan, you lose yourself in pleasure as your [cock "+x1+"] shoots out hot ropes of semen all over Aiko’s face and chest, twitching like mad. Stream after stream spills out, several orgasms’ worth of cum finally allowed to fly free, making a thick, warm mess all over her face and breasts. "+(player.cumQ() >350 ?"Your orgasm seems to go on forever, and by the time it is all over, Aiko’s face is almost unrecognizable, hidden under a sticky mask of your cum.":"")+"\n\n"
...
private function aikoSexTailjob():void {
	clearOutput();
	spriteSelect(SpriteDb.s_aiko);
	outputText((playerchoice?"You ask Aiko if she can use her tails this time as you seductively let your [armor] slide off your body, exposing to the skittish kitsune your [cock]. She instantly blushes and lowers her ears, aww.\n\n"
	...
	+"As the kitsune continues to torment your rod, you notice that a second tail has joined the action, encircling the tip of your [cock] while the other one firmly remains wrapped around the base[if (player.hasBalls()), caressing your balls]. "
	...
	+(player.hasVagina() ?" [vagina] is tickled by the continuous motion of the tail caressing your [if (player.hasBalls())balls|cock]. Occasionally one of her tails push against your mound, the silky texture feeling quite exquisite against your folds.\n\n":"\n\n")
...
private function aikoSexKitsuneTailjob():void {
	...
	outputText("You ask her to come sit beside you, "+((player.tailCount==9)?"which she promptly does, ":"")+"and turn around. Curiosity gets the better of her, so she does so, albeit slowly, with furtive glances back towards you. You tell her to calm down, and that she will enjoy this as much as you.\n\n"
			...
			+"Aiko grins, and with noticable effort (and a lot of whimpering in between,) says <i>Heh.. This is a trick that only we..hahh.. kitsunes can do..ahh!.. when we are engaging in such lewd.. gahhh.. acts! </i> she shouts, fluids gushing out of her box, soaking your lower half. You weren't going to last much longer, the flames doing a number on your sex-charged nerves, when she pulls one final trick,"+((player.gender == 1)?"and wraps your neglected, but rock solid shaft with her foxfire inside and out":(player.gender == 2)?"and shunts a few of her foxfire up your drooling cunt":" and surrounds both your lower tools with foxfire, inside and out")+ ", pushing you over the edge and inducing one of the largest climaxes you've ever had.\n\n"
...
private function submitToAiko():void {
	clearOutput();
	spriteSelect(SpriteDb.s_aiko);
	outputText("You tell her that you’re just itching for a little "+(player.hasPerk(PerkLib.Masochist) ?"release":"abuse")+", and you’re not really looking to fight her for it.\n\n"
...
private function aikoFootjob():void
	...
	if (rand(4)==0) {
		...
		+"<i>\"Oh, fine, deny a girl her fun, you selfish little pervert,\"</i> she says, grinning vindictively as her tail[if(player.cocks.length>1)s] recede, and at the same time she squeezes your shaft down with her foot, using the motion to aid your body in expelling your load. Your cum spurts across your chest, splattering up into your face with incredible force[if (player.hasBalls()) as the contents of your balls empty themselves all over you].\n\n"
...
private function yamataTalk():void {
	...
	if (flags[kFLAGS.AIKO_CORRUPTION] < 0 && flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] <= 0) {
		...
		+"<i>\"The night after I was inducted as guardian, Yamata broke into the shrine and stole one of the treasures our clan was protecting. She went on a rampage, and then before she could be subdued, she left without a trace. No one’s seen her since, until she showed up out of the blue, with my star sphere in hand.\"</i>\n\n"
		...
		+"<i>\"The night after I was inducted as guardian, Yamata broke into the shrine and stole one of the treasures our clan was protecting. She went on a rampage, and I’m talking total carnage here, it was just beautiful! She disappeared without a trace, until she came up out of the blue, with MY STAR SPHERE!\"</i> she growls, baring her teeth.\n\n"
		+"You ask if she can tell you anything about this treasure she stole, hoping to glean as much information as you can.\n\n"
...
private function yamataIntro():void {
	...
	+"<i>\""+ (player.racialScore(Races.CAT, false) > 0 ?"Well, well... look who the cat dragged in!":"Well, well... look who we have here...")+"\"</i>\n\n"
...
public function yamataLoses():void {
	...
	+"<i>\"IMPOSSIBLE! You have such strength, "+(player.racialScore(Races.KITSUNE, false) == 0 ? "for a lowly mortal!" : "even if you are weaker than I am!")+"\"</i>\n\n"
	...
	+"You stand over the defeated nine-tails who, with a grunt of rage, again tries to reach her Muramasa. You anticipated her and stomp down on her hand, pinning her down. With a quick movement, you snatch Aiko's star sphere from Yamata's cleavage, looking down on the defeated corrupted demon kitsune.\n\n"
	...
	//FFS, stop showing your NYI stuff!
	/*
	if (player.cor > 60) {
...
private function releaseYamata():void {
	...
	+"You tell her she had her star sphere back and Yamata is now defenseless. Now that she knows your strength, she won't be bothering you anytime soon. Yamata looks speechless, but after that she giggles and looks at you.\n\n"
...
private function yamataAftermath():void {
	...
	+"Aiko arrives and narrows her eyes, peering at the sword. <i>\"This is a very powerful weapon... if ever it falls into demonic hands again, it will be disasterous... "+(flags[kFLAGS.AIKO_BOSS_COMPLETE] == 1 ? "Perhaps I can purify it with my magic" : "I can use it to locate Yamata, I think I'll be able to use it against her when I'm ready")+".\"</i> You stand still and watch Aiko grab the hilt of the katana and pull it out of the ground. You are tempted to warn her of its demonic influence, though she probably already knows more about the blade than you do, and can sense the taint regardless. She clearly understands the dangers of her actions.\n\n"

...
public class TranceSkill extends AbstractSoulSkill {
    ...
    override public function doEffect(display:Boolean = true):void {
		...
		if (player.hasPerk(PerkLib.FleshBodyFoMApprenticeStage)) TranceBoost -= 5;
		if (player.hasPerk(PerkLib.FleshBodySoDApprenticeStage)) TranceBoost -= 5;
		if (player.hasPerk(PerkLib.FleshBodyVoLApprenticeStage)) TranceBoost -= 5;

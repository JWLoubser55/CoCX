...
private function srslyPimpinGuyz():void {
	...
	if (player.armor != armors.GOOARMR) outputText("All that is left is a suit of comfortable clothes that you put on.  ");
...
public function amilyUrtaSex():void {
	...
	outputText("Once the three of you are in an empty room, you lock the door behind you as Urta and Amily both strip down, eyeing each other and you with equal attention.  \"<i>So... are you going to partake?  Or just watch?</i>\" Amily asks, hesitantly.");

...
public class HarpyQueen extends Monster
	{
		...
		public function eldritchRopes():void {
			...
			var damage:int = 50 + rand(this.inte / 2);
		...
		public function lustSpikeAttack():void {
			...
			player.takeLustDamage((100 + rand(this.lib / 2)), true);
		}
		...
		public function windSlamAttack():void {
			...
			//(Effect; Heavy Damage)
			var damage:Number = 200 + rand(this.wis*2);
		...
		public function whitefire():void {
			...
			var damage:int = (inte*3) + rand(50) * SpellMod();
		...
		public function HarpyQueen()
		{
			...
			this.hairLength = 15;
			initStrTouSpeInte(500, 450, 850, 200);
			initWisLibSensCor(200, 160, 90, 0);
